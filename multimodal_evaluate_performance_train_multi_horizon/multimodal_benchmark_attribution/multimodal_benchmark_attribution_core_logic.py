"""
  ...
  File       : multimodal_benchmark_attribution_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_benchmark_attribution_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalBenchmarkAttributionCoreLogicConfig:
...
class MultimodalBenchmarkAttributionEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalBenchmarkAttributionCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalBenchmarkAttributionCoreLogicConfig()
