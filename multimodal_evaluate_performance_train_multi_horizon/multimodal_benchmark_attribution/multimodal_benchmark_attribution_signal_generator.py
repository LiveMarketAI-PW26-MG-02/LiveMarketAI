"""
  ...
  Folder     : multimodal_benchmark_attribution
  File       : multimodal_benchmark_attribution_signal_generator.py
  Purpose    : Evaluate Performance — Benchmark Attribution
"""
...
MULTIMODAL_MODULE = 'multimodal_benchmark_attribution_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalBenchmarkAttributionSignalGeneratorConfig:
    """Multimodal multi-horizon config for benchmark_attribution."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalBenchmarkAttributionEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: evaluate performance — benchmark attribution.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalBenchmarkAttributionSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalBenchmarkAttributionSignalGeneratorConfig()
