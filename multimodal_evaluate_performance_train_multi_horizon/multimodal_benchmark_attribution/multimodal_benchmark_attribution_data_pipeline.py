"""
  ...
  File       : multimodal_benchmark_attribution_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_benchmark_attribution_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalBenchmarkAttributionDataPipelineConfig:
...
class MultimodalBenchmarkAttributionEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalBenchmarkAttributionDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalBenchmarkAttributionDataPipelineConfig()
