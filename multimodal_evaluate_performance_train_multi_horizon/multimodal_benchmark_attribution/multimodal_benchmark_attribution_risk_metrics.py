"""
  ...
  File       : multimodal_benchmark_attribution_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_benchmark_attribution_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalBenchmarkAttributionRiskMetricsConfig:
...
class MultimodalBenchmarkAttributionEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalBenchmarkAttributionRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalBenchmarkAttributionRiskMetricsConfig()
