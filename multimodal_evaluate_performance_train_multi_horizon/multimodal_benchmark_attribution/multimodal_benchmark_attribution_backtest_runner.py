"""
  ...
  File       : multimodal_benchmark_attribution_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_benchmark_attribution_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalBenchmarkAttributionBacktestRunnerConfig:
...
class MultimodalBenchmarkAttributionEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalBenchmarkAttributionBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalBenchmarkAttributionBacktestRunnerConfig()
