"""
  ...
  File       : multimodal_calmar_ratio_bench_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_calmar_ratio_bench_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalCalmarRatioBenchCoreLogicConfig:
...
class MultimodalCalmarRatioBenchEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCalmarRatioBenchCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalCalmarRatioBenchCoreLogicConfig()
