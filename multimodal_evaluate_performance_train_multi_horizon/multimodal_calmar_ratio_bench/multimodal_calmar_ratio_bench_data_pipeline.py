"""
  ...
  File       : multimodal_calmar_ratio_bench_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_calmar_ratio_bench_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalCalmarRatioBenchDataPipelineConfig:
...
class MultimodalCalmarRatioBenchEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCalmarRatioBenchDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalCalmarRatioBenchDataPipelineConfig()
