"""
  ...
  File       : multimodal_calmar_ratio_bench_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_calmar_ratio_bench_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalCalmarRatioBenchRiskMetricsConfig:
...
class MultimodalCalmarRatioBenchEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCalmarRatioBenchRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalCalmarRatioBenchRiskMetricsConfig()
