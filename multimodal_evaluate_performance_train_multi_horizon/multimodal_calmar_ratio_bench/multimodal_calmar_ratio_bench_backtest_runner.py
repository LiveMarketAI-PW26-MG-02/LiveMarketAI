"""
  ...
  File       : multimodal_calmar_ratio_bench_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_calmar_ratio_bench_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalCalmarRatioBenchBacktestRunnerConfig:
...
class MultimodalCalmarRatioBenchEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCalmarRatioBenchBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalCalmarRatioBenchBacktestRunnerConfig()
