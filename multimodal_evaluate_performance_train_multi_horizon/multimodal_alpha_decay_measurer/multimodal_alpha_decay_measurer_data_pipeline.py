"""
  ...
  File       : multimodal_alpha_decay_measurer_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_alpha_decay_measurer_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalAlphaDecayMeasurerDataPipelineConfig:
...
class MultimodalAlphaDecayMeasurerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalAlphaDecayMeasurerDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalAlphaDecayMeasurerDataPipelineConfig()
