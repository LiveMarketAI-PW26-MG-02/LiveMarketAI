"""
  ...
  File       : multimodal_alpha_decay_measurer_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_alpha_decay_measurer_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalAlphaDecayMeasurerCoreLogicConfig:
...
class MultimodalAlphaDecayMeasurerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalAlphaDecayMeasurerCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalAlphaDecayMeasurerCoreLogicConfig()
