"""
  ...
  Folder     : multimodal_alpha_decay_measurer
  File       : multimodal_alpha_decay_measurer_signal_generator.py
  Purpose    : Evaluate Performance — Alpha Decay Measurer
"""
...
MULTIMODAL_MODULE = 'multimodal_alpha_decay_measurer_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalAlphaDecayMeasurerSignalGeneratorConfig:
    """Multimodal multi-horizon config for alpha_decay_measurer."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalAlphaDecayMeasurerEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: evaluate performance — alpha decay measurer.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalAlphaDecayMeasurerSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalAlphaDecayMeasurerSignalGeneratorConfig()
