"""
  ...
  File       : multimodal_alpha_decay_measurer_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_alpha_decay_measurer_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalAlphaDecayMeasurerBacktestRunnerConfig:
...
class MultimodalAlphaDecayMeasurerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalAlphaDecayMeasurerBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalAlphaDecayMeasurerBacktestRunnerConfig()
