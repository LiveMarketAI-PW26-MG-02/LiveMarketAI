"""
  ...
  File       : multimodal_alpha_decay_measurer_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_alpha_decay_measurer_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalAlphaDecayMeasurerRiskMetricsConfig:
...
class MultimodalAlphaDecayMeasurerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalAlphaDecayMeasurerRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalAlphaDecayMeasurerRiskMetricsConfig()
