"""
  ...
  File       : multimodal_sortino_scorer_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_sortino_scorer_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalSortinoScorerBacktestRunnerConfig:
...
class MultimodalSortinoScorerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSortinoScorerBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalSortinoScorerBacktestRunnerConfig()
