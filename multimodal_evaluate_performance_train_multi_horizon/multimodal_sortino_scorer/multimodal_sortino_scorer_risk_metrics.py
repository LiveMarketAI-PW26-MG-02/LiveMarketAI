"""
  ...
  File       : multimodal_sortino_scorer_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_sortino_scorer_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalSortinoScorerRiskMetricsConfig:
...
class MultimodalSortinoScorerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSortinoScorerRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalSortinoScorerRiskMetricsConfig()
