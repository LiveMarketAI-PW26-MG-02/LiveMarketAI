"""
  ...
  File       : multimodal_sortino_scorer_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_sortino_scorer_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalSortinoScorerDataPipelineConfig:
...
class MultimodalSortinoScorerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSortinoScorerDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalSortinoScorerDataPipelineConfig()
