"""
  ...
  File       : multimodal_sortino_scorer_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_sortino_scorer_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalSortinoScorerCoreLogicConfig:
...
class MultimodalSortinoScorerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSortinoScorerCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalSortinoScorerCoreLogicConfig()
