"""
  ...
  Folder     : multimodal_sortino_scorer
  File       : multimodal_sortino_scorer_signal_generator.py
  Purpose    : Evaluate Performance — Sortino Scorer
"""
...
MULTIMODAL_MODULE = 'multimodal_sortino_scorer_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalSortinoScorerSignalGeneratorConfig:
    """Multimodal multi-horizon config for sortino_scorer."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalSortinoScorerEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: evaluate performance — sortino scorer.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalSortinoScorerSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalSortinoScorerSignalGeneratorConfig()
