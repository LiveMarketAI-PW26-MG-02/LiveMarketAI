"""
  ...
  File       : multimodal_turnover_cost_auditor_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_turnover_cost_auditor_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalTurnoverCostAuditorCoreLogicConfig:
...
class MultimodalTurnoverCostAuditorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalTurnoverCostAuditorCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalTurnoverCostAuditorCoreLogicConfig()
