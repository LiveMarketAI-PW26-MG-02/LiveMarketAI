"""
  ...
  File       : multimodal_turnover_cost_auditor_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_turnover_cost_auditor_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalTurnoverCostAuditorDataPipelineConfig:
...
class MultimodalTurnoverCostAuditorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalTurnoverCostAuditorDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalTurnoverCostAuditorDataPipelineConfig()
