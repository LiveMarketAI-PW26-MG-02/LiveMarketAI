"""
  ...
  File       : multimodal_turnover_cost_auditor_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_turnover_cost_auditor_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalTurnoverCostAuditorRiskMetricsConfig:
...
class MultimodalTurnoverCostAuditorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalTurnoverCostAuditorRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalTurnoverCostAuditorRiskMetricsConfig()
