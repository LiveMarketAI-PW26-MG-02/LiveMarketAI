"""
  ...
  Folder     : multimodal_turnover_cost_auditor
  File       : multimodal_turnover_cost_auditor_signal_generator.py
  Purpose    : Evaluate Performance — Turnover Cost Auditor
"""
...
MULTIMODAL_MODULE = 'multimodal_turnover_cost_auditor_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalTurnoverCostAuditorSignalGeneratorConfig:
    """Multimodal multi-horizon config for turnover_cost_auditor."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalTurnoverCostAuditorEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: evaluate performance — turnover cost auditor.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalTurnoverCostAuditorSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalTurnoverCostAuditorSignalGeneratorConfig()
