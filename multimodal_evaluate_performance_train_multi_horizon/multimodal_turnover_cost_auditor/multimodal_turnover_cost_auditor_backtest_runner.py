"""
  ...
  File       : multimodal_turnover_cost_auditor_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_turnover_cost_auditor_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalTurnoverCostAuditorBacktestRunnerConfig:
...
class MultimodalTurnoverCostAuditorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalTurnoverCostAuditorBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalTurnoverCostAuditorBacktestRunnerConfig()
