"""
  ...
  File       : multimodal_max_drawdown_eval_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_max_drawdown_eval_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalMaxDrawdownEvalCoreLogicConfig:
...
class MultimodalMaxDrawdownEvalEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMaxDrawdownEvalCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalMaxDrawdownEvalCoreLogicConfig()
