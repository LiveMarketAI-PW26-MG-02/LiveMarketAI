"""
  ...
  File       : multimodal_max_drawdown_eval_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_max_drawdown_eval_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalMaxDrawdownEvalDataPipelineConfig:
...
class MultimodalMaxDrawdownEvalEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMaxDrawdownEvalDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalMaxDrawdownEvalDataPipelineConfig()
