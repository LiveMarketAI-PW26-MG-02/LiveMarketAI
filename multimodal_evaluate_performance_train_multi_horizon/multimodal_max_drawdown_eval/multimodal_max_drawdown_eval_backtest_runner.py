"""
  ...
  File       : multimodal_max_drawdown_eval_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_max_drawdown_eval_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalMaxDrawdownEvalBacktestRunnerConfig:
...
class MultimodalMaxDrawdownEvalEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMaxDrawdownEvalBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalMaxDrawdownEvalBacktestRunnerConfig()
