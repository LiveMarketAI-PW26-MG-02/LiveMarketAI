"""
  ...
  Folder     : multimodal_max_drawdown_eval
  File       : multimodal_max_drawdown_eval_signal_generator.py
  Purpose    : Evaluate Performance — Max Drawdown Eval
"""
...
MULTIMODAL_MODULE = 'multimodal_max_drawdown_eval_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalMaxDrawdownEvalSignalGeneratorConfig:
    """Multimodal multi-horizon config for max_drawdown_eval."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalMaxDrawdownEvalEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: evaluate performance — max drawdown eval.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalMaxDrawdownEvalSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalMaxDrawdownEvalSignalGeneratorConfig()
