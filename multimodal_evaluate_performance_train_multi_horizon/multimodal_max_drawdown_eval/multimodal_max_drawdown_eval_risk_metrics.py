"""
  ...
  File       : multimodal_max_drawdown_eval_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_max_drawdown_eval_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalMaxDrawdownEvalRiskMetricsConfig:
...
class MultimodalMaxDrawdownEvalEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMaxDrawdownEvalRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalMaxDrawdownEvalRiskMetricsConfig()
