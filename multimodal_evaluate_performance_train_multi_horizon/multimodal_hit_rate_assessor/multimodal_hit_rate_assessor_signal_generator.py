"""
  ...
  Folder     : multimodal_hit_rate_assessor
  File       : multimodal_hit_rate_assessor_signal_generator.py
  Purpose    : Evaluate Performance — Hit Rate Assessor
"""
...
MULTIMODAL_MODULE = 'multimodal_hit_rate_assessor_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalHitRateAssessorSignalGeneratorConfig:
    """Multimodal multi-horizon config for hit_rate_assessor."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalHitRateAssessorEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: evaluate performance — hit rate assessor.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalHitRateAssessorSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalHitRateAssessorSignalGeneratorConfig()
