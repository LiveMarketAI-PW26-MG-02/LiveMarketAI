"""
  ...
  File       : multimodal_hit_rate_assessor_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_hit_rate_assessor_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalHitRateAssessorRiskMetricsConfig:
...
class MultimodalHitRateAssessorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalHitRateAssessorRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalHitRateAssessorRiskMetricsConfig()
