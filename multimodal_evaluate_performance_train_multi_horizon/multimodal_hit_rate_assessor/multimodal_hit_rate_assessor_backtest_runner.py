"""
  ...
  File       : multimodal_hit_rate_assessor_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_hit_rate_assessor_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalHitRateAssessorBacktestRunnerConfig:
...
class MultimodalHitRateAssessorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalHitRateAssessorBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalHitRateAssessorBacktestRunnerConfig()
