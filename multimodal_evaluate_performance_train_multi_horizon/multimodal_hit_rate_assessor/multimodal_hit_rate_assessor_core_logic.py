"""
  ...
  File       : multimodal_hit_rate_assessor_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_hit_rate_assessor_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalHitRateAssessorCoreLogicConfig:
...
class MultimodalHitRateAssessorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalHitRateAssessorCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalHitRateAssessorCoreLogicConfig()
