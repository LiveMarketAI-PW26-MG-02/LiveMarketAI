"""
  ...
  File       : multimodal_hit_rate_assessor_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_hit_rate_assessor_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalHitRateAssessorDataPipelineConfig:
...
class MultimodalHitRateAssessorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalHitRateAssessorDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalHitRateAssessorDataPipelineConfig()
