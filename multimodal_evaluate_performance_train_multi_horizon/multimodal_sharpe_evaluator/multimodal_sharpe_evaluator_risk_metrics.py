"""
  ...
  File       : multimodal_sharpe_evaluator_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_sharpe_evaluator_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalSharpeEvaluatorRiskMetricsConfig:
...
class MultimodalSharpeEvaluatorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSharpeEvaluatorRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalSharpeEvaluatorRiskMetricsConfig()
