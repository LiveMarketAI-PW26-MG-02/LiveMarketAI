"""
  ...
  File       : multimodal_sharpe_evaluator_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_sharpe_evaluator_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalSharpeEvaluatorBacktestRunnerConfig:
...
class MultimodalSharpeEvaluatorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSharpeEvaluatorBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalSharpeEvaluatorBacktestRunnerConfig()
