"""
  ...
  Folder     : multimodal_sharpe_evaluator
  File       : multimodal_sharpe_evaluator_signal_generator.py
  Purpose    : Evaluate Performance — Sharpe Evaluator
"""
...
MULTIMODAL_MODULE = 'multimodal_sharpe_evaluator_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalSharpeEvaluatorSignalGeneratorConfig:
    """Multimodal multi-horizon config for sharpe_evaluator."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalSharpeEvaluatorEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: evaluate performance — sharpe evaluator.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalSharpeEvaluatorSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalSharpeEvaluatorSignalGeneratorConfig()
