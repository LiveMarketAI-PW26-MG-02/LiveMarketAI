"""
  ...
  File       : multimodal_sharpe_evaluator_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_sharpe_evaluator_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalSharpeEvaluatorDataPipelineConfig:
...
class MultimodalSharpeEvaluatorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSharpeEvaluatorDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalSharpeEvaluatorDataPipelineConfig()
