"""
  ...
  File       : multimodal_sharpe_evaluator_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_sharpe_evaluator_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalSharpeEvaluatorCoreLogicConfig:
...
class MultimodalSharpeEvaluatorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSharpeEvaluatorCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalSharpeEvaluatorCoreLogicConfig()
