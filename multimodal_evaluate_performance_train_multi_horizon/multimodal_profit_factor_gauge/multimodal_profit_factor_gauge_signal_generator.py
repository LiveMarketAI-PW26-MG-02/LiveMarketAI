"""
  ...
  Folder     : multimodal_profit_factor_gauge
  File       : multimodal_profit_factor_gauge_signal_generator.py
  Purpose    : Evaluate Performance — Profit Factor Gauge
"""
...
MULTIMODAL_MODULE = 'multimodal_profit_factor_gauge_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalProfitFactorGaugeSignalGeneratorConfig:
    """Multimodal multi-horizon config for profit_factor_gauge."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalProfitFactorGaugeEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: evaluate performance — profit factor gauge.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalProfitFactorGaugeSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalProfitFactorGaugeSignalGeneratorConfig()
