"""
  ...
  File       : multimodal_profit_factor_gauge_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_profit_factor_gauge_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalProfitFactorGaugeRiskMetricsConfig:
...
class MultimodalProfitFactorGaugeEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalProfitFactorGaugeRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalProfitFactorGaugeRiskMetricsConfig()
