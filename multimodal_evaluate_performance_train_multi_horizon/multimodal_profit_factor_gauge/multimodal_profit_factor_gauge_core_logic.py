"""
  ...
  File       : multimodal_profit_factor_gauge_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_profit_factor_gauge_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalProfitFactorGaugeCoreLogicConfig:
...
class MultimodalProfitFactorGaugeEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalProfitFactorGaugeCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalProfitFactorGaugeCoreLogicConfig()
