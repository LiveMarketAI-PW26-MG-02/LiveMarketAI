"""
  ...
  File       : multimodal_profit_factor_gauge_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_profit_factor_gauge_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalProfitFactorGaugeBacktestRunnerConfig:
...
class MultimodalProfitFactorGaugeEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalProfitFactorGaugeBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalProfitFactorGaugeBacktestRunnerConfig()
