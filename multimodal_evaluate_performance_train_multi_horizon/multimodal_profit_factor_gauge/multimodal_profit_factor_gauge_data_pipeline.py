"""
  ...
  File       : multimodal_profit_factor_gauge_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_profit_factor_gauge_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalProfitFactorGaugeDataPipelineConfig:
...
class MultimodalProfitFactorGaugeEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalProfitFactorGaugeDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalProfitFactorGaugeDataPipelineConfig()
