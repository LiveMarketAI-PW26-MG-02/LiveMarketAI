"""
  ...
  File       : multimodal_information_ratio_calc_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_information_ratio_calc_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalInformationRatioCalcDataPipelineConfig:
...
class MultimodalInformationRatioCalcEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalInformationRatioCalcDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalInformationRatioCalcDataPipelineConfig()
