"""
  ...
  File       : multimodal_information_ratio_calc_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_information_ratio_calc_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalInformationRatioCalcRiskMetricsConfig:
...
class MultimodalInformationRatioCalcEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalInformationRatioCalcRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalInformationRatioCalcRiskMetricsConfig()
