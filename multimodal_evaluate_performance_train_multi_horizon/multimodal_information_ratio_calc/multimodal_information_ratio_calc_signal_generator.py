"""
  ...
  Folder     : multimodal_information_ratio_calc
  File       : multimodal_information_ratio_calc_signal_generator.py
  Purpose    : Evaluate Performance — Information Ratio Calc
"""
...
MULTIMODAL_MODULE = 'multimodal_information_ratio_calc_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalInformationRatioCalcSignalGeneratorConfig:
    """Multimodal multi-horizon config for information_ratio_calc."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalInformationRatioCalcEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: evaluate performance — information ratio calc.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalInformationRatioCalcSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalInformationRatioCalcSignalGeneratorConfig()
