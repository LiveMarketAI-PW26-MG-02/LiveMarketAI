"""
  ...
  File       : multimodal_information_ratio_calc_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_information_ratio_calc_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalInformationRatioCalcBacktestRunnerConfig:
...
class MultimodalInformationRatioCalcEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalInformationRatioCalcBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalInformationRatioCalcBacktestRunnerConfig()
