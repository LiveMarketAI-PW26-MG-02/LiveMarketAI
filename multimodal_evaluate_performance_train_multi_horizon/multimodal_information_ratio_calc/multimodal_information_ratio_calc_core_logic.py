"""
  ...
  File       : multimodal_information_ratio_calc_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_information_ratio_calc_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalInformationRatioCalcCoreLogicConfig:
...
class MultimodalInformationRatioCalcEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalInformationRatioCalcCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalInformationRatioCalcCoreLogicConfig()
