"""
  ...
  File       : multimodal_tail_gain_inspector_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_tail_gain_inspector_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalTailGainInspectorDataPipelineConfig:
...
class MultimodalTailGainInspectorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalTailGainInspectorDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalTailGainInspectorDataPipelineConfig()
