"""
  ...
  File       : multimodal_tail_gain_inspector_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_tail_gain_inspector_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalTailGainInspectorCoreLogicConfig:
...
class MultimodalTailGainInspectorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalTailGainInspectorCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalTailGainInspectorCoreLogicConfig()
