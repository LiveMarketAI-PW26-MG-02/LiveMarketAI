"""
  ...
  File       : multimodal_tail_gain_inspector_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_tail_gain_inspector_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalTailGainInspectorRiskMetricsConfig:
...
class MultimodalTailGainInspectorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalTailGainInspectorRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalTailGainInspectorRiskMetricsConfig()
