"""
  ...
  Folder     : multimodal_tail_gain_inspector
  File       : multimodal_tail_gain_inspector_signal_generator.py
  Purpose    : Analyze Improvements — Tail Gain Inspector
"""
...
MULTIMODAL_MODULE = 'multimodal_tail_gain_inspector_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalTailGainInspectorSignalGeneratorConfig:
    """Multimodal multi-horizon config for tail_gain_inspector."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalTailGainInspectorEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: analyze improvements — tail gain inspector.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalTailGainInspectorSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalTailGainInspectorSignalGeneratorConfig()
