"""
  ...
  File       : multimodal_tail_gain_inspector_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_tail_gain_inspector_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalTailGainInspectorBacktestRunnerConfig:
...
class MultimodalTailGainInspectorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalTailGainInspectorBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalTailGainInspectorBacktestRunnerConfig()
