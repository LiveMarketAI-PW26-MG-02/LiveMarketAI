"""
  ...
  File       : multimodal_factor_contribution_anal_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_factor_contribution_anal_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalFactorContributionAnalDataPipelineConfig:
...
class MultimodalFactorContributionAnalEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalFactorContributionAnalDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalFactorContributionAnalDataPipelineConfig()
