"""
  ...
  File       : multimodal_factor_contribution_anal_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_factor_contribution_anal_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalFactorContributionAnalCoreLogicConfig:
...
class MultimodalFactorContributionAnalEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalFactorContributionAnalCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalFactorContributionAnalCoreLogicConfig()
