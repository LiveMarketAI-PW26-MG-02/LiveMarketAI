"""
  ...
  Folder     : multimodal_factor_contribution_anal
  File       : multimodal_factor_contribution_anal_signal_generator.py
  Purpose    : Analyze Improvements — Factor Contribution Anal
"""
...
MULTIMODAL_MODULE = 'multimodal_factor_contribution_anal_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalFactorContributionAnalSignalGeneratorConfig:
    """Multimodal multi-horizon config for factor_contribution_anal."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalFactorContributionAnalEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: analyze improvements — factor contribution anal.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalFactorContributionAnalSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalFactorContributionAnalSignalGeneratorConfig()
