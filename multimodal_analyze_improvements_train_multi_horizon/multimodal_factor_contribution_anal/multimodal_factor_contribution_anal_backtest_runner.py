"""
  ...
  File       : multimodal_factor_contribution_anal_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_factor_contribution_anal_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalFactorContributionAnalBacktestRunnerConfig:
...
class MultimodalFactorContributionAnalEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalFactorContributionAnalBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalFactorContributionAnalBacktestRunnerConfig()
