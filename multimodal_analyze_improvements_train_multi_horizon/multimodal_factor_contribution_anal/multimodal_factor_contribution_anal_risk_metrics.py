"""
  ...
  File       : multimodal_factor_contribution_anal_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_factor_contribution_anal_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalFactorContributionAnalRiskMetricsConfig:
...
class MultimodalFactorContributionAnalEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalFactorContributionAnalRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalFactorContributionAnalRiskMetricsConfig()
