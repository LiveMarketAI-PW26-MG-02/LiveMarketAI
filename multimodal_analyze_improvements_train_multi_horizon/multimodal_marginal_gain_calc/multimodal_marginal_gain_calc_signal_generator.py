"""
  ...
  Folder     : multimodal_marginal_gain_calc
  File       : multimodal_marginal_gain_calc_signal_generator.py
  Purpose    : Analyze Improvements — Marginal Gain Calc
"""
...
MULTIMODAL_MODULE = 'multimodal_marginal_gain_calc_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalMarginalGainCalcSignalGeneratorConfig:
    """Multimodal multi-horizon config for marginal_gain_calc."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalMarginalGainCalcEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: analyze improvements — marginal gain calc.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalMarginalGainCalcSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalMarginalGainCalcSignalGeneratorConfig()
