"""
  ...
  File       : multimodal_marginal_gain_calc_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_marginal_gain_calc_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalMarginalGainCalcDataPipelineConfig:
...
class MultimodalMarginalGainCalcEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMarginalGainCalcDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalMarginalGainCalcDataPipelineConfig()
