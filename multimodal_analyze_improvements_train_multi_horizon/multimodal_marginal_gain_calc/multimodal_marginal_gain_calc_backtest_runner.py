"""
  ...
  File       : multimodal_marginal_gain_calc_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_marginal_gain_calc_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalMarginalGainCalcBacktestRunnerConfig:
...
class MultimodalMarginalGainCalcEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMarginalGainCalcBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalMarginalGainCalcBacktestRunnerConfig()
