"""
  ...
  File       : multimodal_marginal_gain_calc_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_marginal_gain_calc_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalMarginalGainCalcRiskMetricsConfig:
...
class MultimodalMarginalGainCalcEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMarginalGainCalcRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalMarginalGainCalcRiskMetricsConfig()
