"""
  ...
  File       : multimodal_marginal_gain_calc_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_marginal_gain_calc_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalMarginalGainCalcCoreLogicConfig:
...
class MultimodalMarginalGainCalcEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMarginalGainCalcCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalMarginalGainCalcCoreLogicConfig()
