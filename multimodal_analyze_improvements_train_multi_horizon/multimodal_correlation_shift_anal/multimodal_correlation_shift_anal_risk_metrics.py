"""
  ...
  File       : multimodal_correlation_shift_anal_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_correlation_shift_anal_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalCorrelationShiftAnalRiskMetricsConfig:
...
class MultimodalCorrelationShiftAnalEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCorrelationShiftAnalRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalCorrelationShiftAnalRiskMetricsConfig()
