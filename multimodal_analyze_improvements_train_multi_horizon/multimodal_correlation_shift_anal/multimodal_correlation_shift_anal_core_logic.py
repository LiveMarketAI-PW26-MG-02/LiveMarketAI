"""
  ...
  File       : multimodal_correlation_shift_anal_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_correlation_shift_anal_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalCorrelationShiftAnalCoreLogicConfig:
...
class MultimodalCorrelationShiftAnalEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCorrelationShiftAnalCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalCorrelationShiftAnalCoreLogicConfig()
