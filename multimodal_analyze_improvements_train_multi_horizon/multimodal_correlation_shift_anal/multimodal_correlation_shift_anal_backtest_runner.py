"""
  ...
  File       : multimodal_correlation_shift_anal_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_correlation_shift_anal_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalCorrelationShiftAnalBacktestRunnerConfig:
...
class MultimodalCorrelationShiftAnalEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCorrelationShiftAnalBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalCorrelationShiftAnalBacktestRunnerConfig()
