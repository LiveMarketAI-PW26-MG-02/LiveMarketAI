"""
  ...
  File       : multimodal_correlation_shift_anal_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_correlation_shift_anal_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalCorrelationShiftAnalDataPipelineConfig:
...
class MultimodalCorrelationShiftAnalEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCorrelationShiftAnalDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalCorrelationShiftAnalDataPipelineConfig()
