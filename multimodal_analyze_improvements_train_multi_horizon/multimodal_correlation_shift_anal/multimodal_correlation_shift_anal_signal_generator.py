"""
  ...
  Folder     : multimodal_correlation_shift_anal
  File       : multimodal_correlation_shift_anal_signal_generator.py
  Purpose    : Analyze Improvements — Correlation Shift Anal
"""
...
MULTIMODAL_MODULE = 'multimodal_correlation_shift_anal_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalCorrelationShiftAnalSignalGeneratorConfig:
    """Multimodal multi-horizon config for correlation_shift_anal."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalCorrelationShiftAnalEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: analyze improvements — correlation shift anal.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalCorrelationShiftAnalSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalCorrelationShiftAnalSignalGeneratorConfig()
