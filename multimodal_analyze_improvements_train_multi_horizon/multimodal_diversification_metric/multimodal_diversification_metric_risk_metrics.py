"""
  ...
  File       : multimodal_diversification_metric_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_diversification_metric_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalDiversificationMetricRiskMetricsConfig:
...
class MultimodalDiversificationMetricEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDiversificationMetricRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalDiversificationMetricRiskMetricsConfig()
