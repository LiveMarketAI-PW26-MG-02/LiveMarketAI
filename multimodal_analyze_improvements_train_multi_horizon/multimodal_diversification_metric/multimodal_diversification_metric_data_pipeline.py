"""
  ...
  File       : multimodal_diversification_metric_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_diversification_metric_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalDiversificationMetricDataPipelineConfig:
...
class MultimodalDiversificationMetricEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDiversificationMetricDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalDiversificationMetricDataPipelineConfig()
