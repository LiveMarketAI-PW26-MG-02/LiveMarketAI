"""
  ...
  File       : multimodal_diversification_metric_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_diversification_metric_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalDiversificationMetricBacktestRunnerConfig:
...
class MultimodalDiversificationMetricEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDiversificationMetricBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalDiversificationMetricBacktestRunnerConfig()
