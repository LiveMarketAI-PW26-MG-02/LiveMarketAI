"""
  ...
  File       : multimodal_diversification_metric_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_diversification_metric_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalDiversificationMetricCoreLogicConfig:
...
class MultimodalDiversificationMetricEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDiversificationMetricCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalDiversificationMetricCoreLogicConfig()
