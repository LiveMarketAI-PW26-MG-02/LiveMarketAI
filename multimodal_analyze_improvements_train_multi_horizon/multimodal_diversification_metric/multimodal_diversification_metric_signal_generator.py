"""
  ...
  Folder     : multimodal_diversification_metric
  File       : multimodal_diversification_metric_signal_generator.py
  Purpose    : Analyze Improvements — Diversification Metric
"""
...
MULTIMODAL_MODULE = 'multimodal_diversification_metric_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalDiversificationMetricSignalGeneratorConfig:
    """Multimodal multi-horizon config for diversification_metric."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalDiversificationMetricEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: analyze improvements — diversification metric.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalDiversificationMetricSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalDiversificationMetricSignalGeneratorConfig()
