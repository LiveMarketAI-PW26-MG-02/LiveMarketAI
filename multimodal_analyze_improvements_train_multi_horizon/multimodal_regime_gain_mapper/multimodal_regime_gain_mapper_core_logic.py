"""
  ...
  File       : multimodal_regime_gain_mapper_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_regime_gain_mapper_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeGainMapperCoreLogicConfig:
...
class MultimodalRegimeGainMapperEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegimeGainMapperCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalRegimeGainMapperCoreLogicConfig()
