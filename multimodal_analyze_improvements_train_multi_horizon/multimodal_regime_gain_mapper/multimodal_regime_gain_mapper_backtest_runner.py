"""
  ...
  File       : multimodal_regime_gain_mapper_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_regime_gain_mapper_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeGainMapperBacktestRunnerConfig:
...
class MultimodalRegimeGainMapperEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegimeGainMapperBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalRegimeGainMapperBacktestRunnerConfig()
