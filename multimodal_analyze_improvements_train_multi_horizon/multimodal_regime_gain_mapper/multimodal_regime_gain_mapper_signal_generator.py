"""
  ...
  Folder     : multimodal_regime_gain_mapper
  File       : multimodal_regime_gain_mapper_signal_generator.py
  Purpose    : Analyze Improvements — Regime Gain Mapper
"""
...
MULTIMODAL_MODULE = 'multimodal_regime_gain_mapper_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeGainMapperSignalGeneratorConfig:
    """Multimodal multi-horizon config for regime_gain_mapper."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalRegimeGainMapperEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: analyze improvements — regime gain mapper.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalRegimeGainMapperSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalRegimeGainMapperSignalGeneratorConfig()
