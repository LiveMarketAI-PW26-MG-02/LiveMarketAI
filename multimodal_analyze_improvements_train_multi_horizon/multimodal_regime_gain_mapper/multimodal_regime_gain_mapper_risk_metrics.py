"""
  ...
  File       : multimodal_regime_gain_mapper_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_regime_gain_mapper_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeGainMapperRiskMetricsConfig:
...
class MultimodalRegimeGainMapperEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegimeGainMapperRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalRegimeGainMapperRiskMetricsConfig()
