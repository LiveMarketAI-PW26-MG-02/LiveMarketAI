"""
  ...
  File       : multimodal_regime_gain_mapper_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_regime_gain_mapper_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeGainMapperDataPipelineConfig:
...
class MultimodalRegimeGainMapperEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegimeGainMapperDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalRegimeGainMapperDataPipelineConfig()
