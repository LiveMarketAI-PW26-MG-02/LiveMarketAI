"""
  ...
  Folder     : multimodal_return_decomp_engine
  File       : multimodal_return_decomp_engine_signal_generator.py
  Purpose    : Analyze Improvements — Return Decomp Engine
"""
...
MULTIMODAL_MODULE = 'multimodal_return_decomp_engine_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalReturnDecompEngineSignalGeneratorConfig:
    """Multimodal multi-horizon config for return_decomp_engine."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalReturnDecompEngineEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: analyze improvements — return decomp engine.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalReturnDecompEngineSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalReturnDecompEngineSignalGeneratorConfig()
