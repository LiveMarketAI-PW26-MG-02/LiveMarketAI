"""
  ...
  File       : multimodal_return_decomp_engine_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_return_decomp_engine_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalReturnDecompEngineBacktestRunnerConfig:
...
class MultimodalReturnDecompEngineEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalReturnDecompEngineBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalReturnDecompEngineBacktestRunnerConfig()
