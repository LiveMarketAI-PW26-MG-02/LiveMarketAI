"""
  ...
  File       : multimodal_return_decomp_engine_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_return_decomp_engine_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalReturnDecompEngineCoreLogicConfig:
...
class MultimodalReturnDecompEngineEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalReturnDecompEngineCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalReturnDecompEngineCoreLogicConfig()
