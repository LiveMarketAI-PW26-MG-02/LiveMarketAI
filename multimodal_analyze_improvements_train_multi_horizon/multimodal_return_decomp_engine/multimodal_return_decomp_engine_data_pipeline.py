"""
  ...
  File       : multimodal_return_decomp_engine_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_return_decomp_engine_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalReturnDecompEngineDataPipelineConfig:
...
class MultimodalReturnDecompEngineEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalReturnDecompEngineDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalReturnDecompEngineDataPipelineConfig()
