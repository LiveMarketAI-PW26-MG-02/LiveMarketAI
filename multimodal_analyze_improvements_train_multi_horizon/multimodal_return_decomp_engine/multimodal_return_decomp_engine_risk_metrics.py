"""
  ...
  File       : multimodal_return_decomp_engine_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_return_decomp_engine_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalReturnDecompEngineRiskMetricsConfig:
...
class MultimodalReturnDecompEngineEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalReturnDecompEngineRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalReturnDecompEngineRiskMetricsConfig()
