"""
  ...
  File       : multimodal_drawdown_improvement_log_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_drawdown_improvement_log_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalDrawdownImprovementLogRiskMetricsConfig:
...
class MultimodalDrawdownImprovementLogEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDrawdownImprovementLogRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalDrawdownImprovementLogRiskMetricsConfig()
