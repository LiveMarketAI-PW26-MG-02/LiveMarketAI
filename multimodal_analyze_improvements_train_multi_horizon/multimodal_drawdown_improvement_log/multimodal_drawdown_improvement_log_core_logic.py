"""
  ...
  File       : multimodal_drawdown_improvement_log_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_drawdown_improvement_log_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalDrawdownImprovementLogCoreLogicConfig:
...
class MultimodalDrawdownImprovementLogEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDrawdownImprovementLogCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalDrawdownImprovementLogCoreLogicConfig()
