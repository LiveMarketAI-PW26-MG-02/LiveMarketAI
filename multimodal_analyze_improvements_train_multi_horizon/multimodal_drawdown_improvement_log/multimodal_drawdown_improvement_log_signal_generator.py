"""
  ...
  ZIP Topic  : AnalyzeImprovements
  Folder     : multimodal_drawdown_improvement_log
  File       : multimodal_drawdown_improvement_log_signal_generator.py
  Purpose    : Analyze Improvements — Drawdown Improvement Log
"""
...
MULTIMODAL_MODULE = 'multimodal_drawdown_improvement_log_signal_generator'
TOPIC             = 'analyze_improvements'
VERSION           = '1.0.0'
HORIZONS          = [1, 5, 10, 21, 63, 126, 252]   # trading-day horizons

# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalDrawdownImprovementLogSignalGeneratorConfig:
    """Multimodal multi-horizon config for drawdown_improvement_log."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalDrawdownImprovementLogEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: analyze improvements — drawdown improvement log.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalDrawdownImprovementLogSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalDrawdownImprovementLogSignalGeneratorConfig()
