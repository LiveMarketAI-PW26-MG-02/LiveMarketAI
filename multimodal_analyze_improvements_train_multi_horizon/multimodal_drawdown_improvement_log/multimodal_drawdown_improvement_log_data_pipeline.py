"""
  ...
  File       : multimodal_drawdown_improvement_log_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_drawdown_improvement_log_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalDrawdownImprovementLogDataPipelineConfig:
...
class MultimodalDrawdownImprovementLogEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDrawdownImprovementLogDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalDrawdownImprovementLogDataPipelineConfig()
