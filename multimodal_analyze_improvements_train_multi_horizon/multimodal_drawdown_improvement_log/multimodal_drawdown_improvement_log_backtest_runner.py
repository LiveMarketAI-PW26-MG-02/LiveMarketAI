"""
  ...
  File       : multimodal_drawdown_improvement_log_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_drawdown_improvement_log_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalDrawdownImprovementLogBacktestRunnerConfig:
...
class MultimodalDrawdownImprovementLogEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDrawdownImprovementLogBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalDrawdownImprovementLogBacktestRunnerConfig()
