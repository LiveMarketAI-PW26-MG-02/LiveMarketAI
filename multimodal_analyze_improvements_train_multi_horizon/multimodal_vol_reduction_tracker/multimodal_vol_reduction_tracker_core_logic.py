"""
  ...
  File       : multimodal_vol_reduction_tracker_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_vol_reduction_tracker_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalVolReductionTrackerCoreLogicConfig:
...
class MultimodalVolReductionTrackerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalVolReductionTrackerCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalVolReductionTrackerCoreLogicConfig()
