"""
  ...
  Folder     : multimodal_vol_reduction_tracker
  File       : multimodal_vol_reduction_tracker_signal_generator.py
  Purpose    : Analyze Improvements — Vol Reduction Tracker
"""
...
MULTIMODAL_MODULE = 'multimodal_vol_reduction_tracker_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalVolReductionTrackerSignalGeneratorConfig:
    """Multimodal multi-horizon config for vol_reduction_tracker."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalVolReductionTrackerEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: analyze improvements — vol reduction tracker.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalVolReductionTrackerSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalVolReductionTrackerSignalGeneratorConfig()
