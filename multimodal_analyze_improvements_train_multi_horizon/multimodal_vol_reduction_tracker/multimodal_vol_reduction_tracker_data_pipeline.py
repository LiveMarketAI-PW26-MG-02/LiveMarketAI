"""
  ...
  File       : multimodal_vol_reduction_tracker_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_vol_reduction_tracker_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalVolReductionTrackerDataPipelineConfig:
...
class MultimodalVolReductionTrackerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalVolReductionTrackerDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalVolReductionTrackerDataPipelineConfig()
