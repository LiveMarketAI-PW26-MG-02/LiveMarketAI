"""
  ...
  File       : multimodal_vol_reduction_tracker_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_vol_reduction_tracker_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalVolReductionTrackerBacktestRunnerConfig:
...
class MultimodalVolReductionTrackerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalVolReductionTrackerBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalVolReductionTrackerBacktestRunnerConfig()
