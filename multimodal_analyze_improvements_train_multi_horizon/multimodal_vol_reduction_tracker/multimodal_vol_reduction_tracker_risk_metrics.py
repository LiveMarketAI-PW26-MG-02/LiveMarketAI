"""
  ...
  File       : multimodal_vol_reduction_tracker_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_vol_reduction_tracker_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalVolReductionTrackerRiskMetricsConfig:
...
class MultimodalVolReductionTrackerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalVolReductionTrackerRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalVolReductionTrackerRiskMetricsConfig()
