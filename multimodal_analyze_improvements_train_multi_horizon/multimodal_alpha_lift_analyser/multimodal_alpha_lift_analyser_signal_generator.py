"""
  ...
  Folder     : multimodal_alpha_lift_analyser
  File       : multimodal_alpha_lift_analyser_signal_generator.py
  Purpose    : Analyze Improvements — Alpha Lift Analyser
"""
...
MULTIMODAL_MODULE = 'multimodal_alpha_lift_analyser_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalAlphaLiftAnalyserSignalGeneratorConfig:
    """Multimodal multi-horizon config for alpha_lift_analyser."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalAlphaLiftAnalyserEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: analyze improvements — alpha lift analyser.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalAlphaLiftAnalyserSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalAlphaLiftAnalyserSignalGeneratorConfig()
