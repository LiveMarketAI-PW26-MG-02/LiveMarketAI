"""
  ...
  File       : multimodal_alpha_lift_analyser_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_alpha_lift_analyser_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalAlphaLiftAnalyserBacktestRunnerConfig:
...
class MultimodalAlphaLiftAnalyserEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalAlphaLiftAnalyserBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalAlphaLiftAnalyserBacktestRunnerConfig()
