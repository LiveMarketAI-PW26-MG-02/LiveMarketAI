"""
  ...
  File       : multimodal_alpha_lift_analyser_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_alpha_lift_analyser_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalAlphaLiftAnalyserCoreLogicConfig:
...
class MultimodalAlphaLiftAnalyserEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalAlphaLiftAnalyserCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalAlphaLiftAnalyserCoreLogicConfig()
