"""
  ...
  File       : multimodal_alpha_lift_analyser_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_alpha_lift_analyser_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalAlphaLiftAnalyserRiskMetricsConfig:
...
class MultimodalAlphaLiftAnalyserEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalAlphaLiftAnalyserRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalAlphaLiftAnalyserRiskMetricsConfig()
