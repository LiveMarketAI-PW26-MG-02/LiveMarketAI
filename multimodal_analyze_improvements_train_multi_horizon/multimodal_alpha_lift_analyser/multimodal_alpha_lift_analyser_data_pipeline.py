"""
  ...
  File       : multimodal_alpha_lift_analyser_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_alpha_lift_analyser_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalAlphaLiftAnalyserDataPipelineConfig:
...
class MultimodalAlphaLiftAnalyserEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalAlphaLiftAnalyserDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalAlphaLiftAnalyserDataPipelineConfig()
