// ═══════════════════════════════════════════════════════════════════════════
// Regime-Aware Graph Neural Network (RAGNN) — Neo4j Graph Schema
// Module: ragnn
// ═══════════════════════════════════════════════════════════════════════════
...
// ── NODE PROPERTIES (sample MERGE for RAGNN) ─────────────────────────────
...
ON CREATE SET
  ...
  al.description    = 'Pump-and-dump pattern detected by RAGNN',
