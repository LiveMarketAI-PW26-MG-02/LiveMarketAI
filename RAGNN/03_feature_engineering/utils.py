#!/usr/bin/env python3
"""
RAGNN - Shared Utility Functions
Common helpers used across all subfolders of the RAGNN module.
"""
...
def get_logger(name: str = "RAGNN", level: str = "INFO") -> logging.Logger:
    """Configure and return a logger for RAGNN module."""
