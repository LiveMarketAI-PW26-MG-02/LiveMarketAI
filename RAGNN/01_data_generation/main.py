#!/usr/bin/env python3
"""
Regime-Aware Graph Neural Network (RAGNN) - Data Generation Module
...
REGIME_TYPES      = ['bull', 'bear', 'sideways', 'crisis', 'recovery']
OUTPUT_DIR        = "outputs/ragnn_data"
...
class SyntheticMarketDataGenerator:
    """
    Generates synthetic OHLCV + microstructure + sentiment data for RAGNN.
...
class SentimentDataGenerator:
    ...
    price manipulation events for RAGNN.
    """
...
class OrderBookGenerator:
    ...
    Critical for RAGNN microstructure-based manipulation detection.
    """
...
def main():
    print(f"\n============================================================")
    print(f"  RAGNN - Data Generation Pipeline")
    ...
    # Summary
    print(f"\n============================================================")
    print(f"  Data Generation Complete for RAGNN")
