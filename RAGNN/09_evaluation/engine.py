#!/usr/bin/env python3
"""
Regime-Aware Graph Neural Network (RAGNN) - Evaluation Engine (Alt Entry)
...
OUTPUT_DIR = "outputs/ragnn_eval"
os.makedirs(OUTPUT_DIR, exist_ok=True)
np.random.seed(42)

class BinaryClassificationEvaluator:
    """Full binary classification metric suite for RAGNN."""
...
class RegimeEvaluator:
    """Regime-stratified evaluation for RAGNN."""
...
class CalibrationEvaluator:
    """ECE and reliability diagram for RAGNN probability calibration."""
...
class GraphEvaluator:
    """Graph-aware metrics for RAGNN GNN evaluation."""
...
def main():
    print(f"\n{'='*60}\n  RAGNN Evaluation Engine (Alt Entry)\n{'='*60}")
    n=200
    ...
    report={"module":"RAGNN","full_name":"Regime-Aware Graph Neural Network","evaluated_at":datetime.utcnow().isoformat()+"Z",
