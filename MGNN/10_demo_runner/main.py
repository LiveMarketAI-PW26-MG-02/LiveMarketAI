#!/usr/bin/env python3
"""
Microstructure Graph Neural Network (MGNN) - Demo Runner — End-to-End Pipeline
...
def main():
    print(f"\n{'='*60}")
    print(f"  MGNN - Demo Runner — End-to-End Pipeline")
    ...
    print(f"\nMGNN Demo Runner — End-to-End Pipeline Complete.\n")
...
7 + np.random.rand(n) * 0.3, 0, 1),
        ...
        explanation_text = f"""
MANIPULATION DETECTION EXPLANATION - MGNN
============================================================
...
"""
        ...
        report  = {
            "module":          "MGNN",
            "full_name":       "Microstructure Graph Neural Network",
