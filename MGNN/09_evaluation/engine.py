#!/usr/bin/env python3
"""
Microstructure Graph Neural Network (MGNN) - Evaluation Engine (Alt Entry)
...
OUTPUT_DIR = "outputs/mgnn_eval"
os.makedirs(OUTPUT_DIR, exist_ok=True)
np.random.seed(42)

class BinaryClassificationEvaluator:
    """Full binary classification metric suite for MGNN."""
...
class RegimeEvaluator:
    """Regime-stratified evaluation for MGNN."""
...
class CalibrationEvaluator:
    """ECE and reliability diagram for MGNN probability calibration."""
...
class GraphEvaluator:
    """Graph-aware metrics for MGNN GNN evaluation."""
...
def main():
    print(f"\n{'='*60}\n  MGNN Evaluation Engine (Alt Entry)\n{'='*60}")
    n=200
    ...
    report={"module":"MGNN","full_name":"Microstructure Graph Neural Network","evaluated_at":datetime.utcnow().isoformat()+"Z",
