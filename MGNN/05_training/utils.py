#!/usr/bin/env python3
"""
MGNN - Shared Utility Functions
Common helpers used across all subfolders of the MGNN module.
"""
...
def get_logger(name: str = "MGNN", level: str = "INFO") -> logging.Logger:
    """Configure and return a logger for MGNN module."""
