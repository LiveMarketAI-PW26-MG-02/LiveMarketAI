...
class MultimodalDecisionLogWriterSignalGeneratorConfig:
    """Multimodal multi-horizon config for decision_log_writer."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalDecisionLogWriterEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: document — decision log writer.
