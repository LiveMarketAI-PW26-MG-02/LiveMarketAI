"""
  ...
  File       : multimodal_data_lineage_recorder_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_data_lineage_recorder_risk_metrics'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalDataLineageRecorderRiskMetricsConfig:
...
class MultimodalDataLineageRecorderEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDataLineageRecorderRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalDataLineageRecorderRiskMetricsConfig()
