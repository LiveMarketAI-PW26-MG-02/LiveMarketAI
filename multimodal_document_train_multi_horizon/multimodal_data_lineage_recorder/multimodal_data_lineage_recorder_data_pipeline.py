"""
  ...
  File       : multimodal_data_lineage_recorder_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_data_lineage_recorder_data_pipeline'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalDataLineageRecorderDataPipelineConfig:
...
class MultimodalDataLineageRecorderEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDataLineageRecorderDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalDataLineageRecorderDataPipelineConfig()
