"""
  ...
  File       : multimodal_data_lineage_recorder_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_data_lineage_recorder_core_logic'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalDataLineageRecorderCoreLogicConfig:
...
class MultimodalDataLineageRecorderEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDataLineageRecorderCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalDataLineageRecorderCoreLogicConfig()
