"""
  ...
  File       : multimodal_data_lineage_recorder_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_data_lineage_recorder_backtest_runner'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalDataLineageRecorderBacktestRunnerConfig:
...
class MultimodalDataLineageRecorderEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDataLineageRecorderBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalDataLineageRecorderBacktestRunnerConfig()
