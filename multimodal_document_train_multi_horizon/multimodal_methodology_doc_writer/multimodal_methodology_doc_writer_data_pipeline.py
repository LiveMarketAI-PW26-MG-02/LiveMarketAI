"""
  ...
  File       : multimodal_methodology_doc_writer_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_methodology_doc_writer_data_pipeline'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalMethodologyDocWriterDataPipelineConfig:
...
class MultimodalMethodologyDocWriterEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMethodologyDocWriterDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalMethodologyDocWriterDataPipelineConfig()
