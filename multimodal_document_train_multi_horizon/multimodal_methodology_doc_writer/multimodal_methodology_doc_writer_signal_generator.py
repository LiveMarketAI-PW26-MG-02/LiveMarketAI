"""
  ...
  ZIP Topic  : Document
  Folder     : multimodal_methodology_doc_writer
  File       : multimodal_methodology_doc_writer_signal_generator.py
  Purpose    : Document — Methodology Doc Writer
"""
...
MULTIMODAL_MODULE = 'multimodal_methodology_doc_writer_signal_generator'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalMethodologyDocWriterSignalGeneratorConfig:
    """Multimodal multi-horizon config for methodology_doc_writer."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalMethodologyDocWriterEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: document — methodology doc writer.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalMethodologyDocWriterSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalMethodologyDocWriterSignalGeneratorConfig()
