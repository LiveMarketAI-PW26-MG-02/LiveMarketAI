"""
  ...
  File       : multimodal_methodology_doc_writer_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_methodology_doc_writer_core_logic'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalMethodologyDocWriterCoreLogicConfig:
...
class MultimodalMethodologyDocWriterEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMethodologyDocWriterCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalMethodologyDocWriterCoreLogicConfig()
