"""
  ...
  File       : multimodal_methodology_doc_writer_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_methodology_doc_writer_risk_metrics'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalMethodologyDocWriterRiskMetricsConfig:
...
class MultimodalMethodologyDocWriterEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMethodologyDocWriterRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalMethodologyDocWriterRiskMetricsConfig()
