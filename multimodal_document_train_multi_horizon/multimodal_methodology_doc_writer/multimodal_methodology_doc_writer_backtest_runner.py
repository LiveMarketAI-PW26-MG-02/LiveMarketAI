"""
  ...
  File       : multimodal_methodology_doc_writer_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_methodology_doc_writer_backtest_runner'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalMethodologyDocWriterBacktestRunnerConfig:
...
class MultimodalMethodologyDocWriterEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMethodologyDocWriterBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalMethodologyDocWriterBacktestRunnerConfig()
