"""
  ...
  File       : multimodal_audit_trail_doc_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_audit_trail_doc_backtest_runner'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalAuditTrailDocBacktestRunnerConfig:
...
class MultimodalAuditTrailDocEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalAuditTrailDocBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalAuditTrailDocBacktestRunnerConfig()
