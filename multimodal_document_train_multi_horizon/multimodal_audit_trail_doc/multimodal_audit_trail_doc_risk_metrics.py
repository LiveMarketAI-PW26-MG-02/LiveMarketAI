"""
  ...
  File       : multimodal_audit_trail_doc_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_audit_trail_doc_risk_metrics'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalAuditTrailDocRiskMetricsConfig:
...
class MultimodalAuditTrailDocEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalAuditTrailDocRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalAuditTrailDocRiskMetricsConfig()
