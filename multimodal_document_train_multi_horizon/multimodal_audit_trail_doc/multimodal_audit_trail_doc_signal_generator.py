"""
  ...
  ZIP Topic  : Document
  Folder     : multimodal_audit_trail_doc
  File       : multimodal_audit_trail_doc_signal_generator.py
  Purpose    : Document — Audit Trail Doc
"""
...
MULTIMODAL_MODULE = 'multimodal_audit_trail_doc_signal_generator'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalAuditTrailDocSignalGeneratorConfig:
    """Multimodal multi-horizon config for audit_trail_doc."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalAuditTrailDocEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: document — audit trail doc.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalAuditTrailDocSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalAuditTrailDocSignalGeneratorConfig()
