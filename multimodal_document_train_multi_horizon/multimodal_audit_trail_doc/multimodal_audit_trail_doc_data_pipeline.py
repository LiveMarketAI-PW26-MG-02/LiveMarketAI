"""
  ...
  File       : multimodal_audit_trail_doc_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_audit_trail_doc_data_pipeline'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalAuditTrailDocDataPipelineConfig:
...
class MultimodalAuditTrailDocEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalAuditTrailDocDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalAuditTrailDocDataPipelineConfig()
