"""
  ...
  File       : multimodal_audit_trail_doc_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_audit_trail_doc_core_logic'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalAuditTrailDocCoreLogicConfig:
...
class MultimodalAuditTrailDocEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalAuditTrailDocCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalAuditTrailDocCoreLogicConfig()
