"""
  ...
  File       : multimodal_model_card_builder_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_model_card_builder_core_logic'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalModelCardBuilderCoreLogicConfig:
...
class MultimodalModelCardBuilderEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalModelCardBuilderCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalModelCardBuilderCoreLogicConfig()
