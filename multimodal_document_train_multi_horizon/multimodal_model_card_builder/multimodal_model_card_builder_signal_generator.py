"""
  ...
  ZIP Topic  : Document
  Folder     : multimodal_model_card_builder
  File       : multimodal_model_card_builder_signal_generator.py
  Purpose    : Document — Model Card Builder
"""
...
MULTIMODAL_MODULE = 'multimodal_model_card_builder_signal_generator'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalModelCardBuilderSignalGeneratorConfig:
    """Multimodal multi-horizon config for model_card_builder."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalModelCardBuilderEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: document — model card builder.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalModelCardBuilderSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalModelCardBuilderSignalGeneratorConfig()
