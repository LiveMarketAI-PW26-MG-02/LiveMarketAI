"""
  ...
  File       : multimodal_model_card_builder_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_model_card_builder_risk_metrics'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalModelCardBuilderRiskMetricsConfig:
...
class MultimodalModelCardBuilderEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalModelCardBuilderRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalModelCardBuilderRiskMetricsConfig()
