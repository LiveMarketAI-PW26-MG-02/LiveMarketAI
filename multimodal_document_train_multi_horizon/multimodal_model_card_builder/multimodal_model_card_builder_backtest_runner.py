"""
  ...
  File       : multimodal_model_card_builder_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_model_card_builder_backtest_runner'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalModelCardBuilderBacktestRunnerConfig:
...
class MultimodalModelCardBuilderEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalModelCardBuilderBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalModelCardBuilderBacktestRunnerConfig()
