"""
  ...
  File       : multimodal_model_card_builder_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_model_card_builder_data_pipeline'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalModelCardBuilderDataPipelineConfig:
...
class MultimodalModelCardBuilderEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalModelCardBuilderDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalModelCardBuilderDataPipelineConfig()
