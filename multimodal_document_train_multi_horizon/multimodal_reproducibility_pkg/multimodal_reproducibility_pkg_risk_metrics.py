"""
  ...
  File       : multimodal_reproducibility_pkg_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_reproducibility_pkg_risk_metrics'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalReproducibilityPkgRiskMetricsConfig:
...
class MultimodalReproducibilityPkgEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalReproducibilityPkgRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalReproducibilityPkgRiskMetricsConfig()
