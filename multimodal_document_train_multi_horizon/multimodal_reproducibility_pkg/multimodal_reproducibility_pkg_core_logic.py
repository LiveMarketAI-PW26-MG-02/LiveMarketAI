"""
  ...
  File       : multimodal_reproducibility_pkg_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_reproducibility_pkg_core_logic'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalReproducibilityPkgCoreLogicConfig:
...
class MultimodalReproducibilityPkgEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalReproducibilityPkgCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalReproducibilityPkgCoreLogicConfig()
