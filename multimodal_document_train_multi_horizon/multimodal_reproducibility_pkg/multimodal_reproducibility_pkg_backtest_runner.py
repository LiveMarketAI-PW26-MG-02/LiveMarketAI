"""
  ...
  File       : multimodal_reproducibility_pkg_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_reproducibility_pkg_backtest_runner'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalReproducibilityPkgBacktestRunnerConfig:
...
class MultimodalReproducibilityPkgEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalReproducibilityPkgBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalReproducibilityPkgBacktestRunnerConfig()
