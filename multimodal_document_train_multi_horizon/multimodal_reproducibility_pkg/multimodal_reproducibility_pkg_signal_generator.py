"""
  ...
  ZIP Topic  : Document
  Folder     : multimodal_reproducibility_pkg
  File       : multimodal_reproducibility_pkg_signal_generator.py
  Purpose    : Document — Reproducibility Pkg
"""
...
MULTIMODAL_MODULE = 'multimodal_reproducibility_pkg_signal_generator'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalReproducibilityPkgSignalGeneratorConfig:
    """Multimodal multi-horizon config for reproducibility_pkg."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalReproducibilityPkgEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: document — reproducibility pkg.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalReproducibilityPkgSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalReproducibilityPkgSignalGeneratorConfig()
