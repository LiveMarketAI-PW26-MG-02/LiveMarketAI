"""
  ...
  File       : multimodal_reproducibility_pkg_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_reproducibility_pkg_data_pipeline'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalReproducibilityPkgDataPipelineConfig:
...
class MultimodalReproducibilityPkgEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalReproducibilityPkgDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalReproducibilityPkgDataPipelineConfig()
