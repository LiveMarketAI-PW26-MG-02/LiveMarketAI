"""
  ...
  ZIP Topic  : Document
  Folder     : multimodal_changelog_tracker
  File       : multimodal_changelog_tracker_signal_generator.py
  Purpose    : Document — Changelog Tracker
"""
...
MULTIMODAL_MODULE = 'multimodal_changelog_tracker_signal_generator'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalChangelogTrackerSignalGeneratorConfig:
    """Multimodal multi-horizon config for changelog_tracker."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalChangelogTrackerEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: document — changelog tracker.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalChangelogTrackerSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalChangelogTrackerSignalGeneratorConfig()
