"""
  ...
  File       : multimodal_changelog_tracker_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_changelog_tracker_backtest_runner'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalChangelogTrackerBacktestRunnerConfig:
...
class MultimodalChangelogTrackerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalChangelogTrackerBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalChangelogTrackerBacktestRunnerConfig()
