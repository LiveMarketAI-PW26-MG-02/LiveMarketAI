"""
  ...
  File       : multimodal_changelog_tracker_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_changelog_tracker_core_logic'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalChangelogTrackerCoreLogicConfig:
...
class MultimodalChangelogTrackerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalChangelogTrackerCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalChangelogTrackerCoreLogicConfig()
