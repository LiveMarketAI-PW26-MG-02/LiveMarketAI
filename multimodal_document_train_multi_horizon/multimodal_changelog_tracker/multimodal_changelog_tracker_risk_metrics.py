"""
  ...
  File       : multimodal_changelog_tracker_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_changelog_tracker_risk_metrics'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalChangelogTrackerRiskMetricsConfig:
...
class MultimodalChangelogTrackerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalChangelogTrackerRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalChangelogTrackerRiskMetricsConfig()
