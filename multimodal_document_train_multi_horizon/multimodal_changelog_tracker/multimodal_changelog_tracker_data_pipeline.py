"""
  ...
  File       : multimodal_changelog_tracker_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_changelog_tracker_data_pipeline'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalChangelogTrackerDataPipelineConfig:
...
class MultimodalChangelogTrackerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalChangelogTrackerDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalChangelogTrackerDataPipelineConfig()
