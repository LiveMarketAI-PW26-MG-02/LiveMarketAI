"""
  ...
  File       : multimodal_hypothesis_archiver_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_hypothesis_archiver_backtest_runner'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalHypothesisArchiverBacktestRunnerConfig:
...
class MultimodalHypothesisArchiverEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalHypothesisArchiverBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalHypothesisArchiverBacktestRunnerConfig()
