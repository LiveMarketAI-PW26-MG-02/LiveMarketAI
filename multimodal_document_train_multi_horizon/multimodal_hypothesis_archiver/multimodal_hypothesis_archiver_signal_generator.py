"""
  ...
  ZIP Topic  : Document
  Folder     : multimodal_hypothesis_archiver
  File       : multimodal_hypothesis_archiver_signal_generator.py
  Purpose    : Document — Hypothesis Archiver
"""
...
MULTIMODAL_MODULE = 'multimodal_hypothesis_archiver_signal_generator'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalHypothesisArchiverSignalGeneratorConfig:
    """Multimodal multi-horizon config for hypothesis_archiver."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalHypothesisArchiverEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: document — hypothesis archiver.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalHypothesisArchiverSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalHypothesisArchiverSignalGeneratorConfig()
