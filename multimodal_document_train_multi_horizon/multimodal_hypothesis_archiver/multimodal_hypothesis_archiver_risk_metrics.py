"""
  ...
  File       : multimodal_hypothesis_archiver_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_hypothesis_archiver_risk_metrics'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalHypothesisArchiverRiskMetricsConfig:
...
class MultimodalHypothesisArchiverEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalHypothesisArchiverRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalHypothesisArchiverRiskMetricsConfig()
