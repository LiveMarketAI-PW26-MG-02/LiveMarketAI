"""
  ...
  File       : multimodal_hypothesis_archiver_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_hypothesis_archiver_core_logic'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalHypothesisArchiverCoreLogicConfig:
...
class MultimodalHypothesisArchiverEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalHypothesisArchiverCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalHypothesisArchiverCoreLogicConfig()
