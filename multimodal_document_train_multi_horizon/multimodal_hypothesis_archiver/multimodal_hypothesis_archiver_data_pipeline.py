"""
  ...
  File       : multimodal_hypothesis_archiver_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_hypothesis_archiver_data_pipeline'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalHypothesisArchiverDataPipelineConfig:
...
class MultimodalHypothesisArchiverEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalHypothesisArchiverDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalHypothesisArchiverDataPipelineConfig()
