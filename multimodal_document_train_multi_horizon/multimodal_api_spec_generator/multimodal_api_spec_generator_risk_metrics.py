"""
  ...
  File       : multimodal_api_spec_generator_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_api_spec_generator_risk_metrics'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalApiSpecGeneratorRiskMetricsConfig:
...
class MultimodalApiSpecGeneratorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalApiSpecGeneratorRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalApiSpecGeneratorRiskMetricsConfig()
