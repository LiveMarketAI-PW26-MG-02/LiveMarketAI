"""
  ...
  File       : multimodal_api_spec_generator_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_api_spec_generator_data_pipeline'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalApiSpecGeneratorDataPipelineConfig:
...
class MultimodalApiSpecGeneratorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalApiSpecGeneratorDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalApiSpecGeneratorDataPipelineConfig()
