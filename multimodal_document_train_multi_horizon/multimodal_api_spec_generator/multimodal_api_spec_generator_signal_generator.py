"""
  ...
  ZIP Topic  : Document
  Folder     : multimodal_api_spec_generator
  File       : multimodal_api_spec_generator_signal_generator.py
  Purpose    : Document — Api Spec Generator
"""
...
MULTIMODAL_MODULE = 'multimodal_api_spec_generator_signal_generator'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalApiSpecGeneratorSignalGeneratorConfig:
    """Multimodal multi-horizon config for api_spec_generator."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalApiSpecGeneratorEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: document — api spec generator.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalApiSpecGeneratorSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalApiSpecGeneratorSignalGeneratorConfig()
