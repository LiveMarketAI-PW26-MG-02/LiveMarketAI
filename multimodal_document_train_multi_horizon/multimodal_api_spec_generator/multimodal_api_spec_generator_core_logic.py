"""
  ...
  File       : multimodal_api_spec_generator_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_api_spec_generator_core_logic'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalApiSpecGeneratorCoreLogicConfig:
...
class MultimodalApiSpecGeneratorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalApiSpecGeneratorCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalApiSpecGeneratorCoreLogicConfig()
