"""
  ...
  File       : multimodal_api_spec_generator_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_api_spec_generator_backtest_runner'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalApiSpecGeneratorBacktestRunnerConfig:
...
class MultimodalApiSpecGeneratorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalApiSpecGeneratorBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalApiSpecGeneratorBacktestRunnerConfig()
