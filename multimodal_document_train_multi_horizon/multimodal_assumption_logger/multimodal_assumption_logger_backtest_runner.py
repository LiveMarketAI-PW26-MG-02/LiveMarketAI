"""
  ...
  File       : multimodal_assumption_logger_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_assumption_logger_backtest_runner'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalAssumptionLoggerBacktestRunnerConfig:
...
class MultimodalAssumptionLoggerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalAssumptionLoggerBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalAssumptionLoggerBacktestRunnerConfig()
