"""
  ...
  File       : multimodal_assumption_logger_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_assumption_logger_data_pipeline'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalAssumptionLoggerDataPipelineConfig:
...
class MultimodalAssumptionLoggerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalAssumptionLoggerDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalAssumptionLoggerDataPipelineConfig()
