"""
  ...
  File       : multimodal_assumption_logger_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_assumption_logger_risk_metrics'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalAssumptionLoggerRiskMetricsConfig:
...
class MultimodalAssumptionLoggerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalAssumptionLoggerRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalAssumptionLoggerRiskMetricsConfig()
