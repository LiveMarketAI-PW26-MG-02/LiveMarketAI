"""
  ...
  File       : multimodal_assumption_logger_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_assumption_logger_core_logic'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalAssumptionLoggerCoreLogicConfig:
...
class MultimodalAssumptionLoggerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalAssumptionLoggerCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalAssumptionLoggerCoreLogicConfig()
