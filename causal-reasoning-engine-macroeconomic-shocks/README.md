...
Builds a structural causal model of macro indicators and simulates how shocks propagate, with explanations of each transmission path.
...
- **10 self-created APIs (routers)**: /health, /auth, /audit, /ingest, /explain, /indicators, /shocks, /causal_links, /scenarios, /forecasts
- **AI primitive**: `causal` — see `causal_reasoning_engine_macroeconomic_shocks/ai/engine.py`. Exposed at `POST /explain`.
...
## Run
    ...
    uvicorn causal_reasoning_engine_macroeconomic_shocks.main:app --reload     # SQLite tables auto-created on boot
...
## Layout
    ...
    causal_reasoning_engine_macroeconomic_shocks/
