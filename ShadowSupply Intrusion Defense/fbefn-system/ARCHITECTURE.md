# ARCHITECTURE — ShadowSupply Intrusion Defense

## System Overview

```
┌─────────────────────────────────────────────────────────────────┐
│                           ShadowSupply Intrusion Defense                        │
...
## Threat Model
  ...
  Attack Vector: Federated Binary Execution Fingerprint Network (FBEFN): Each compute node extracts runtime execution...
