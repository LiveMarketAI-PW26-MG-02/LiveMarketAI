"""
  ...
  File       : multimodal_hansen_spa_tester_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_hansen_spa_tester_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalHansenSpaTesterRiskMetricsConfig:
...
class MultimodalHansenSpaTesterEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalHansenSpaTesterRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalHansenSpaTesterRiskMetricsConfig()
