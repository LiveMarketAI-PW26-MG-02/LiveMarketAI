"""
  ...
  Folder     : multimodal_hansen_spa_tester
  File       : multimodal_hansen_spa_tester_signal_generator.py
  Purpose    : Validate Results — Hansen Spa Tester
"""
...
MULTIMODAL_MODULE = 'multimodal_hansen_spa_tester_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalHansenSpaTesterSignalGeneratorConfig:
    """Multimodal multi-horizon config for hansen_spa_tester."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalHansenSpaTesterEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: validate results — hansen spa tester.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalHansenSpaTesterSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalHansenSpaTesterSignalGeneratorConfig()
