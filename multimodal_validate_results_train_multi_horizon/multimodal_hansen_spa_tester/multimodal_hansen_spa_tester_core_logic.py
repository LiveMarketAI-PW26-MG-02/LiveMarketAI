"""
  ...
  File       : multimodal_hansen_spa_tester_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_hansen_spa_tester_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalHansenSpaTesterCoreLogicConfig:
...
class MultimodalHansenSpaTesterEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalHansenSpaTesterCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalHansenSpaTesterCoreLogicConfig()
