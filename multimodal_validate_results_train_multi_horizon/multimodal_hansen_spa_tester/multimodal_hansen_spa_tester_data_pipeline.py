"""
  ...
  File       : multimodal_hansen_spa_tester_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_hansen_spa_tester_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalHansenSpaTesterDataPipelineConfig:
...
class MultimodalHansenSpaTesterEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalHansenSpaTesterDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalHansenSpaTesterDataPipelineConfig()
