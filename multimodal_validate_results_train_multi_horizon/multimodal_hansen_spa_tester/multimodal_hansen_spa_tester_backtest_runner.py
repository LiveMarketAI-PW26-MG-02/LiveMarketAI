"""
  ...
  File       : multimodal_hansen_spa_tester_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_hansen_spa_tester_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalHansenSpaTesterBacktestRunnerConfig:
...
class MultimodalHansenSpaTesterEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalHansenSpaTesterBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalHansenSpaTesterBacktestRunnerConfig()
