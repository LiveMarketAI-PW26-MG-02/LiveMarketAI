"""
  ...
  File       : multimodal_effect_size_validator_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_effect_size_validator_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalEffectSizeValidatorBacktestRunnerConfig:
...
class MultimodalEffectSizeValidatorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalEffectSizeValidatorBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalEffectSizeValidatorBacktestRunnerConfig()
