"""
  ...
  File       : multimodal_effect_size_validator_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_effect_size_validator_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalEffectSizeValidatorDataPipelineConfig:
...
class MultimodalEffectSizeValidatorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalEffectSizeValidatorDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalEffectSizeValidatorDataPipelineConfig()
