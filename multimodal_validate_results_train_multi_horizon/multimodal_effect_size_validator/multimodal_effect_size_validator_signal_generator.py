"""
  ...
  Folder     : multimodal_effect_size_validator
  File       : multimodal_effect_size_validator_signal_generator.py
  Purpose    : Validate Results — Effect Size Validator
"""
...
MULTIMODAL_MODULE = 'multimodal_effect_size_validator_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalEffectSizeValidatorSignalGeneratorConfig:
    """Multimodal multi-horizon config for effect_size_validator."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalEffectSizeValidatorEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: validate results — effect size validator.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalEffectSizeValidatorSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalEffectSizeValidatorSignalGeneratorConfig()
