"""
  ...
  File       : multimodal_effect_size_validator_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_effect_size_validator_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalEffectSizeValidatorRiskMetricsConfig:
...
class MultimodalEffectSizeValidatorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalEffectSizeValidatorRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalEffectSizeValidatorRiskMetricsConfig()
