"""
  ...
  File       : multimodal_effect_size_validator_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_effect_size_validator_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalEffectSizeValidatorCoreLogicConfig:
...
class MultimodalEffectSizeValidatorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalEffectSizeValidatorCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalEffectSizeValidatorCoreLogicConfig()
