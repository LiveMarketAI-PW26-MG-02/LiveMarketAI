"""
  ...
  Folder     : multimodal_overfitting_detector
  File       : multimodal_overfitting_detector_signal_generator.py
  Purpose    : Validate Results — Overfitting Detector
"""
...
MULTIMODAL_MODULE = 'multimodal_overfitting_detector_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalOverfittingDetectorSignalGeneratorConfig:
    """Multimodal multi-horizon config for overfitting_detector."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalOverfittingDetectorEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: validate results — overfitting detector.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalOverfittingDetectorSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalOverfittingDetectorSignalGeneratorConfig()
