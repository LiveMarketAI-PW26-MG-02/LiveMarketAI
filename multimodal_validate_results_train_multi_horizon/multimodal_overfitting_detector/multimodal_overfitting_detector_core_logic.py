"""
  ...
  File       : multimodal_overfitting_detector_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_overfitting_detector_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalOverfittingDetectorCoreLogicConfig:
...
class MultimodalOverfittingDetectorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalOverfittingDetectorCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalOverfittingDetectorCoreLogicConfig()
