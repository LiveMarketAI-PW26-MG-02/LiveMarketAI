"""
  ...
  File       : multimodal_overfitting_detector_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_overfitting_detector_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalOverfittingDetectorDataPipelineConfig:
...
class MultimodalOverfittingDetectorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalOverfittingDetectorDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalOverfittingDetectorDataPipelineConfig()
