"""
  ...
  File       : multimodal_overfitting_detector_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_overfitting_detector_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalOverfittingDetectorRiskMetricsConfig:
...
class MultimodalOverfittingDetectorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalOverfittingDetectorRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalOverfittingDetectorRiskMetricsConfig()
