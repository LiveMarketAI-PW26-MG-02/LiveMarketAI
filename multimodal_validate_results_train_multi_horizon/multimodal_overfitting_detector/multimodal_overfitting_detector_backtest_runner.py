"""
  ...
  File       : multimodal_overfitting_detector_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_overfitting_detector_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalOverfittingDetectorBacktestRunnerConfig:
...
class MultimodalOverfittingDetectorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalOverfittingDetectorBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalOverfittingDetectorBacktestRunnerConfig()
