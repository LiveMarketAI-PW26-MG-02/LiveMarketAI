"""
  ...
  File       : multimodal_statistical_sig_test_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_statistical_sig_test_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalStatisticalSigTestRiskMetricsConfig:
...
class MultimodalStatisticalSigTestEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalStatisticalSigTestRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalStatisticalSigTestRiskMetricsConfig()
