"""
  ...
  File       : multimodal_statistical_sig_test_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_statistical_sig_test_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalStatisticalSigTestBacktestRunnerConfig:
...
class MultimodalStatisticalSigTestEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalStatisticalSigTestBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalStatisticalSigTestBacktestRunnerConfig()
