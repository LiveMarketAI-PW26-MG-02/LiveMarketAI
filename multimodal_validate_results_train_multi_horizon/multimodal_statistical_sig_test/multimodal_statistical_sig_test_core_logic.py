"""
  ...
  File       : multimodal_statistical_sig_test_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_statistical_sig_test_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalStatisticalSigTestCoreLogicConfig:
...
class MultimodalStatisticalSigTestEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalStatisticalSigTestCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalStatisticalSigTestCoreLogicConfig()
