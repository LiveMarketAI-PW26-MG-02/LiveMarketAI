"""
  ...
  File       : multimodal_statistical_sig_test_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_statistical_sig_test_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalStatisticalSigTestDataPipelineConfig:
...
class MultimodalStatisticalSigTestEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalStatisticalSigTestDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalStatisticalSigTestDataPipelineConfig()
