"""
  ...
  Folder     : multimodal_statistical_sig_test
  File       : multimodal_statistical_sig_test_signal_generator.py
  Purpose    : Validate Results — Statistical Sig Test
"""
...
MULTIMODAL_MODULE = 'multimodal_statistical_sig_test_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalStatisticalSigTestSignalGeneratorConfig:
    """Multimodal multi-horizon config for statistical_sig_test."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalStatisticalSigTestEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: validate results — statistical sig test.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalStatisticalSigTestSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalStatisticalSigTestSignalGeneratorConfig()
