"""
  ...
  File       : multimodal_bh_correction_tool_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_bh_correction_tool_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalBhCorrectionToolRiskMetricsConfig:
...
class MultimodalBhCorrectionToolEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalBhCorrectionToolRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalBhCorrectionToolRiskMetricsConfig()
