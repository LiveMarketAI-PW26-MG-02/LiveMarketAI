"""
  ...
  File       : multimodal_bh_correction_tool_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_bh_correction_tool_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalBhCorrectionToolBacktestRunnerConfig:
...
class MultimodalBhCorrectionToolEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalBhCorrectionToolBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalBhCorrectionToolBacktestRunnerConfig()
