"""
  ...
  File       : multimodal_bh_correction_tool_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_bh_correction_tool_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalBhCorrectionToolCoreLogicConfig:
...
class MultimodalBhCorrectionToolEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalBhCorrectionToolCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalBhCorrectionToolCoreLogicConfig()
