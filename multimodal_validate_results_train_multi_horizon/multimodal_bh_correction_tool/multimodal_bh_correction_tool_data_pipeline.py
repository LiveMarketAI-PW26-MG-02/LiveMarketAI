"""
  ...
  File       : multimodal_bh_correction_tool_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_bh_correction_tool_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalBhCorrectionToolDataPipelineConfig:
...
class MultimodalBhCorrectionToolEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalBhCorrectionToolDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalBhCorrectionToolDataPipelineConfig()
