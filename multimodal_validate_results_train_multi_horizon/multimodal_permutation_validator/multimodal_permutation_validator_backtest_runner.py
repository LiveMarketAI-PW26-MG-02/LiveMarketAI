"""
  ...
  File       : multimodal_permutation_validator_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_permutation_validator_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPermutationValidatorBacktestRunnerConfig:
...
class MultimodalPermutationValidatorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPermutationValidatorBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalPermutationValidatorBacktestRunnerConfig()
