"""
  ...
  File       : multimodal_permutation_validator_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_permutation_validator_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPermutationValidatorRiskMetricsConfig:
...
class MultimodalPermutationValidatorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPermutationValidatorRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalPermutationValidatorRiskMetricsConfig()
