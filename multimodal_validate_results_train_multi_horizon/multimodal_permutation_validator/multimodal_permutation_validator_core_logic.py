"""
  ...
  File       : multimodal_permutation_validator_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_permutation_validator_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPermutationValidatorCoreLogicConfig:
...
class MultimodalPermutationValidatorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPermutationValidatorCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalPermutationValidatorCoreLogicConfig()
