"""
  ...
  File       : multimodal_permutation_validator_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_permutation_validator_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPermutationValidatorDataPipelineConfig:
...
class MultimodalPermutationValidatorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPermutationValidatorDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalPermutationValidatorDataPipelineConfig()
