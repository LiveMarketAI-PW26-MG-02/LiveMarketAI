"""
  ...
  File       : multimodal_bootstrap_ci_engine_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_bootstrap_ci_engine_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalBootstrapCiEngineCoreLogicConfig:
...
class MultimodalBootstrapCiEngineEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalBootstrapCiEngineCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalBootstrapCiEngineCoreLogicConfig()
