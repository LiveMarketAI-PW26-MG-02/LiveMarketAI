"""
  ...
  File       : multimodal_bootstrap_ci_engine_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_bootstrap_ci_engine_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalBootstrapCiEngineDataPipelineConfig:
...
class MultimodalBootstrapCiEngineEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalBootstrapCiEngineDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalBootstrapCiEngineDataPipelineConfig()
