"""
  ...
  Folder     : multimodal_bootstrap_ci_engine
  File       : multimodal_bootstrap_ci_engine_signal_generator.py
  Purpose    : Validate Results — Bootstrap Ci Engine
"""
...
MULTIMODAL_MODULE = 'multimodal_bootstrap_ci_engine_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalBootstrapCiEngineSignalGeneratorConfig:
    """Multimodal multi-horizon config for bootstrap_ci_engine."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalBootstrapCiEngineEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: validate results — bootstrap ci engine.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalBootstrapCiEngineSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalBootstrapCiEngineSignalGeneratorConfig()
