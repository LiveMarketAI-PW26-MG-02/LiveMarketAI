"""
  ...
  File       : multimodal_bootstrap_ci_engine_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_bootstrap_ci_engine_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalBootstrapCiEngineBacktestRunnerConfig:
...
class MultimodalBootstrapCiEngineEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalBootstrapCiEngineBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalBootstrapCiEngineBacktestRunnerConfig()
