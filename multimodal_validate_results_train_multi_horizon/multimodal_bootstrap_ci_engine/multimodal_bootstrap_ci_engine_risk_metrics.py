"""
  ...
  File       : multimodal_bootstrap_ci_engine_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_bootstrap_ci_engine_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalBootstrapCiEngineRiskMetricsConfig:
...
class MultimodalBootstrapCiEngineEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalBootstrapCiEngineRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalBootstrapCiEngineRiskMetricsConfig()
