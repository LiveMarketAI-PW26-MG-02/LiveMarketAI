"""
  ...
  File       : multimodal_monte_carlo_val_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_monte_carlo_val_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalMonteCarloValCoreLogicConfig:
...
class MultimodalMonteCarloValEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMonteCarloValCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalMonteCarloValCoreLogicConfig()
