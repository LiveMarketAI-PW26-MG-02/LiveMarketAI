"""
  ...
  Folder     : multimodal_monte_carlo_val
  File       : multimodal_monte_carlo_val_signal_generator.py
  Purpose    : Validate Results — Monte Carlo Val
"""
...
MULTIMODAL_MODULE = 'multimodal_monte_carlo_val_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalMonteCarloValSignalGeneratorConfig:
    """Multimodal multi-horizon config for monte_carlo_val."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalMonteCarloValEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: validate results — monte carlo val.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalMonteCarloValSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalMonteCarloValSignalGeneratorConfig()
