"""
  ...
  File       : multimodal_monte_carlo_val_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_monte_carlo_val_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalMonteCarloValDataPipelineConfig:
...
class MultimodalMonteCarloValEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMonteCarloValDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalMonteCarloValDataPipelineConfig()
