"""
  ...
  File       : multimodal_monte_carlo_val_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_monte_carlo_val_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalMonteCarloValRiskMetricsConfig:
...
class MultimodalMonteCarloValEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMonteCarloValRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalMonteCarloValRiskMetricsConfig()
