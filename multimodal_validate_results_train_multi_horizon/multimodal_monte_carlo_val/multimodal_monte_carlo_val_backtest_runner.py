"""
  ...
  File       : multimodal_monte_carlo_val_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_monte_carlo_val_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalMonteCarloValBacktestRunnerConfig:
...
class MultimodalMonteCarloValEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMonteCarloValBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalMonteCarloValBacktestRunnerConfig()
