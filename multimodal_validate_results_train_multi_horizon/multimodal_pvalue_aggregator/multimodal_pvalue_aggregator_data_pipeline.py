"""
  ...
  File       : multimodal_pvalue_aggregator_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_pvalue_aggregator_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPvalueAggregatorDataPipelineConfig:
...
class MultimodalPvalueAggregatorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPvalueAggregatorDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalPvalueAggregatorDataPipelineConfig()
