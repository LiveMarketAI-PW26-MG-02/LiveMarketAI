"""
  ...
  Folder     : multimodal_pvalue_aggregator
  File       : multimodal_pvalue_aggregator_signal_generator.py
  Purpose    : Validate Results — Pvalue Aggregator
"""
...
MULTIMODAL_MODULE = 'multimodal_pvalue_aggregator_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPvalueAggregatorSignalGeneratorConfig:
    """Multimodal multi-horizon config for pvalue_aggregator."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalPvalueAggregatorEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: validate results — pvalue aggregator.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalPvalueAggregatorSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalPvalueAggregatorSignalGeneratorConfig()
