"""
  ...
  File       : multimodal_pvalue_aggregator_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_pvalue_aggregator_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPvalueAggregatorRiskMetricsConfig:
...
class MultimodalPvalueAggregatorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPvalueAggregatorRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalPvalueAggregatorRiskMetricsConfig()
