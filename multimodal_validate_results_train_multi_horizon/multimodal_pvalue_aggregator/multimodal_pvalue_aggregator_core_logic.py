"""
  ...
  File       : multimodal_pvalue_aggregator_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_pvalue_aggregator_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPvalueAggregatorCoreLogicConfig:
...
class MultimodalPvalueAggregatorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPvalueAggregatorCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalPvalueAggregatorCoreLogicConfig()
