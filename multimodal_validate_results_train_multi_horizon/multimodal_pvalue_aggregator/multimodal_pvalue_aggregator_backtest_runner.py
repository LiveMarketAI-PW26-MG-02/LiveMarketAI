"""
  ...
  File       : multimodal_pvalue_aggregator_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_pvalue_aggregator_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPvalueAggregatorBacktestRunnerConfig:
...
class MultimodalPvalueAggregatorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPvalueAggregatorBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalPvalueAggregatorBacktestRunnerConfig()
