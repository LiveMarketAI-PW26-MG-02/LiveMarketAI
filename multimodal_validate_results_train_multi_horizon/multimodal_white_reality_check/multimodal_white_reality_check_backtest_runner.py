"""
  ...
  File       : multimodal_white_reality_check_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_white_reality_check_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalWhiteRealityCheckBacktestRunnerConfig:
...
class MultimodalWhiteRealityCheckEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalWhiteRealityCheckBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalWhiteRealityCheckBacktestRunnerConfig()
