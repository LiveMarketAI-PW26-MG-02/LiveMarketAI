"""
  ...
  File       : multimodal_white_reality_check_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_white_reality_check_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalWhiteRealityCheckDataPipelineConfig:
...
class MultimodalWhiteRealityCheckEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalWhiteRealityCheckDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalWhiteRealityCheckDataPipelineConfig()
