"""
  ...
  Folder     : multimodal_white_reality_check
  File       : multimodal_white_reality_check_signal_generator.py
  Purpose    : Validate Results — White Reality Check
"""
...
MULTIMODAL_MODULE = 'multimodal_white_reality_check_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalWhiteRealityCheckSignalGeneratorConfig:
    """Multimodal multi-horizon config for white_reality_check."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalWhiteRealityCheckEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: validate results — white reality check.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalWhiteRealityCheckSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalWhiteRealityCheckSignalGeneratorConfig()
