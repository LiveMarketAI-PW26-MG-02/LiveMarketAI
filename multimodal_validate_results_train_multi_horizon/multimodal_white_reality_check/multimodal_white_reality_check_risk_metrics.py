"""
  ...
  File       : multimodal_white_reality_check_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_white_reality_check_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalWhiteRealityCheckRiskMetricsConfig:
...
class MultimodalWhiteRealityCheckEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalWhiteRealityCheckRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalWhiteRealityCheckRiskMetricsConfig()
