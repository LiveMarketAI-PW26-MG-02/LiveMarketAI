"""
  ...
  File       : multimodal_white_reality_check_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_white_reality_check_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalWhiteRealityCheckCoreLogicConfig:
...
class MultimodalWhiteRealityCheckEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalWhiteRealityCheckCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalWhiteRealityCheckCoreLogicConfig()
