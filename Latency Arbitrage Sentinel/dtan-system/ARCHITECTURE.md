# ARCHITECTURE — Latency Arbitrage Sentinel
...
## Threat Model
  ...
  Attack Vector: Distributed Timing Anomaly Network: High-resolution nanosecond timestamps are used to build federate...
