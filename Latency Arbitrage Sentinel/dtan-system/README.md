# Latency Arbitrage Sentinel
**System ID:** SYS-007
**Abbreviation:** DTAN

## Overview
Distributed Timing Anomaly Network: High-resolution nanosecond timestamps are used to build federated models of legitimate vs exploitative latency patterns. Nodes detect when certain participants consistently receive market data microseconds before others. Federated timing consensus enables detection of systematic co-location advantages being used to front-run orders.
...
java -jar target/dtan-java-node-1.0.0-SNAPSHOT.jar
