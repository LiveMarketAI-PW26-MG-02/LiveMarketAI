"""
  ...
  Folder     : multimodal_spread_cap_definer
  File       : multimodal_spread_cap_definer_signal_generator.py
  Purpose    : Define Thresholds — Spread Cap Definer
"""
...
MULTIMODAL_MODULE = 'multimodal_spread_cap_definer_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSpreadCapDefinerSignalGeneratorConfig:
    """Multimodal threshold-sweep config for spread_cap_definer."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalSpreadCapDefinerEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: define thresholds — spread cap definer.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalSpreadCapDefinerSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalSpreadCapDefinerSignalGeneratorConfig()
