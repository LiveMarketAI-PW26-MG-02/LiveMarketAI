"""
  ...
  File       : multimodal_spread_cap_definer_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_spread_cap_definer_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSpreadCapDefinerCoreLogicConfig:
...
class MultimodalSpreadCapDefinerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSpreadCapDefinerCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalSpreadCapDefinerCoreLogicConfig()
