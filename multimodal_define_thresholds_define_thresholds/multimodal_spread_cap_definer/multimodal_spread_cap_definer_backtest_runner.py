"""
  ...
  File       : multimodal_spread_cap_definer_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_spread_cap_definer_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSpreadCapDefinerBacktestRunnerConfig:
...
class MultimodalSpreadCapDefinerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSpreadCapDefinerBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalSpreadCapDefinerBacktestRunnerConfig()
