"""
  ...
  File       : multimodal_spread_cap_definer_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_spread_cap_definer_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSpreadCapDefinerRiskMetricsConfig:
...
class MultimodalSpreadCapDefinerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSpreadCapDefinerRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalSpreadCapDefinerRiskMetricsConfig()
