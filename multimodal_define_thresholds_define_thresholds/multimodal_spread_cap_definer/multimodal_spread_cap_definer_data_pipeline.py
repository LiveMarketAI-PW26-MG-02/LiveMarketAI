"""
  ...
  File       : multimodal_spread_cap_definer_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_spread_cap_definer_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSpreadCapDefinerDataPipelineConfig:
...
class MultimodalSpreadCapDefinerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSpreadCapDefinerDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalSpreadCapDefinerDataPipelineConfig()
