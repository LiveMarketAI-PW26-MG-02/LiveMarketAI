"""
  ...
  Folder     : multimodal_liquidity_floor_spec
  File       : multimodal_liquidity_floor_spec_signal_generator.py
  Purpose    : Define Thresholds — Liquidity Floor Spec
"""
...
MULTIMODAL_MODULE = 'multimodal_liquidity_floor_spec_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalLiquidityFloorSpecSignalGeneratorConfig:
    """Multimodal threshold-sweep config for liquidity_floor_spec."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalLiquidityFloorSpecEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: define thresholds — liquidity floor spec.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalLiquidityFloorSpecSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalLiquidityFloorSpecSignalGeneratorConfig()
