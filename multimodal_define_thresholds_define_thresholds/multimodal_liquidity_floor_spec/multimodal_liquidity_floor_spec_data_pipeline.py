"""
  ...
  File       : multimodal_liquidity_floor_spec_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_liquidity_floor_spec_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalLiquidityFloorSpecDataPipelineConfig:
...
class MultimodalLiquidityFloorSpecEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalLiquidityFloorSpecDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalLiquidityFloorSpecDataPipelineConfig()
