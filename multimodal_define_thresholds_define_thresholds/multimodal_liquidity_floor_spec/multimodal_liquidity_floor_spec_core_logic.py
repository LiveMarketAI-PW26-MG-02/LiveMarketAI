"""
  ...
  File       : multimodal_liquidity_floor_spec_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_liquidity_floor_spec_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalLiquidityFloorSpecCoreLogicConfig:
...
class MultimodalLiquidityFloorSpecEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalLiquidityFloorSpecCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalLiquidityFloorSpecCoreLogicConfig()
