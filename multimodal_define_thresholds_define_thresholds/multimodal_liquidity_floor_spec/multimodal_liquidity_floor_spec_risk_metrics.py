"""
  ...
  File       : multimodal_liquidity_floor_spec_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_liquidity_floor_spec_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalLiquidityFloorSpecRiskMetricsConfig:
...
class MultimodalLiquidityFloorSpecEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalLiquidityFloorSpecRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalLiquidityFloorSpecRiskMetricsConfig()
