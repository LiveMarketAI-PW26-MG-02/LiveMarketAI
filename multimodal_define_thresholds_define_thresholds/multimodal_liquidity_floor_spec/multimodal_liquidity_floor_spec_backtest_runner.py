"""
  ...
  File       : multimodal_liquidity_floor_spec_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_liquidity_floor_spec_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalLiquidityFloorSpecBacktestRunnerConfig:
...
class MultimodalLiquidityFloorSpecEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalLiquidityFloorSpecBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalLiquidityFloorSpecBacktestRunnerConfig()
