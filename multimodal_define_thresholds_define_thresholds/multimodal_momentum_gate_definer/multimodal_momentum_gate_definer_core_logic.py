"""
  ...
  File       : multimodal_momentum_gate_definer_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_momentum_gate_definer_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalMomentumGateDefinerCoreLogicConfig:
...
class MultimodalMomentumGateDefinerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMomentumGateDefinerCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalMomentumGateDefinerCoreLogicConfig()
