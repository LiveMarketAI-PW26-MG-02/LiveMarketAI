"""
  ...
  File       : multimodal_momentum_gate_definer_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_momentum_gate_definer_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalMomentumGateDefinerDataPipelineConfig:
...
class MultimodalMomentumGateDefinerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMomentumGateDefinerDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalMomentumGateDefinerDataPipelineConfig()
