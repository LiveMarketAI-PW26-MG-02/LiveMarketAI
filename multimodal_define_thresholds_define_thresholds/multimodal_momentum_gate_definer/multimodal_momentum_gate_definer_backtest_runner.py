"""
  ...
  File       : multimodal_momentum_gate_definer_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_momentum_gate_definer_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalMomentumGateDefinerBacktestRunnerConfig:
...
class MultimodalMomentumGateDefinerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMomentumGateDefinerBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalMomentumGateDefinerBacktestRunnerConfig()
