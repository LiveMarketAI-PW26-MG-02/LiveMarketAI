"""
  ...
  Folder     : multimodal_momentum_gate_definer
  File       : multimodal_momentum_gate_definer_signal_generator.py
  Purpose    : Define Thresholds — Momentum Gate Definer
"""
...
MULTIMODAL_MODULE = 'multimodal_momentum_gate_definer_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalMomentumGateDefinerSignalGeneratorConfig:
    """Multimodal threshold-sweep config for momentum_gate_definer."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalMomentumGateDefinerEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: define thresholds — momentum gate definer.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalMomentumGateDefinerSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalMomentumGateDefinerSignalGeneratorConfig()
