"""
  ...
  File       : multimodal_momentum_gate_definer_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_momentum_gate_definer_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalMomentumGateDefinerRiskMetricsConfig:
...
class MultimodalMomentumGateDefinerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMomentumGateDefinerRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalMomentumGateDefinerRiskMetricsConfig()
