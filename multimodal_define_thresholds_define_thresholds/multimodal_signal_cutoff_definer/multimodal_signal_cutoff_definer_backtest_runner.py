"""
  ...
  File       : multimodal_signal_cutoff_definer_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_signal_cutoff_definer_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSignalCutoffDefinerBacktestRunnerConfig:
...
class MultimodalSignalCutoffDefinerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSignalCutoffDefinerBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalSignalCutoffDefinerBacktestRunnerConfig()
