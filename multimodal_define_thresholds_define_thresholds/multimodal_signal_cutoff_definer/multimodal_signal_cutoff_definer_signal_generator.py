"""
  ...
  Folder     : multimodal_signal_cutoff_definer
  File       : multimodal_signal_cutoff_definer_signal_generator.py
  Purpose    : Define Thresholds — Signal Cutoff Definer
"""
...
MULTIMODAL_MODULE = 'multimodal_signal_cutoff_definer_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSignalCutoffDefinerSignalGeneratorConfig:
    """Multimodal threshold-sweep config for signal_cutoff_definer."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalSignalCutoffDefinerEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: define thresholds — signal cutoff definer.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalSignalCutoffDefinerSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalSignalCutoffDefinerSignalGeneratorConfig()
