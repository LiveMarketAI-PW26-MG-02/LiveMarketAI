"""
  ...
  File       : multimodal_signal_cutoff_definer_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_signal_cutoff_definer_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSignalCutoffDefinerDataPipelineConfig:
...
class MultimodalSignalCutoffDefinerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSignalCutoffDefinerDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalSignalCutoffDefinerDataPipelineConfig()
