"""
  ...
  File       : multimodal_signal_cutoff_definer_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_signal_cutoff_definer_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSignalCutoffDefinerRiskMetricsConfig:
...
class MultimodalSignalCutoffDefinerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSignalCutoffDefinerRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalSignalCutoffDefinerRiskMetricsConfig()
