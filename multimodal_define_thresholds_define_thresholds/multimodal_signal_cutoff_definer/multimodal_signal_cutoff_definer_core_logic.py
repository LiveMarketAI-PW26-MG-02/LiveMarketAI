"""
  ...
  File       : multimodal_signal_cutoff_definer_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_signal_cutoff_definer_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSignalCutoffDefinerCoreLogicConfig:
...
class MultimodalSignalCutoffDefinerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSignalCutoffDefinerCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalSignalCutoffDefinerCoreLogicConfig()
