"""
  ...
  Folder     : multimodal_entry_threshold_spec
  File       : multimodal_entry_threshold_spec_signal_generator.py
  Purpose    : Define Thresholds — Entry Threshold Spec
"""
...
MULTIMODAL_MODULE = 'multimodal_entry_threshold_spec_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalEntryThresholdSpecSignalGeneratorConfig:
    """Multimodal threshold-sweep config for entry_threshold_spec."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalEntryThresholdSpecEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: define thresholds — entry threshold spec.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalEntryThresholdSpecSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalEntryThresholdSpecSignalGeneratorConfig()
