"""
  ...
  File       : multimodal_entry_threshold_spec_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_entry_threshold_spec_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalEntryThresholdSpecRiskMetricsConfig:
...
class MultimodalEntryThresholdSpecEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalEntryThresholdSpecRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalEntryThresholdSpecRiskMetricsConfig()
