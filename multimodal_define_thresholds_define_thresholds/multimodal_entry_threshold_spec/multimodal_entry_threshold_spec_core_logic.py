"""
  ...
  File       : multimodal_entry_threshold_spec_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_entry_threshold_spec_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalEntryThresholdSpecCoreLogicConfig:
...
class MultimodalEntryThresholdSpecEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalEntryThresholdSpecCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalEntryThresholdSpecCoreLogicConfig()
