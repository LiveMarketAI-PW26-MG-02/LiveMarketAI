"""
  ...
  File       : multimodal_entry_threshold_spec_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_entry_threshold_spec_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalEntryThresholdSpecBacktestRunnerConfig:
...
class MultimodalEntryThresholdSpecEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalEntryThresholdSpecBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalEntryThresholdSpecBacktestRunnerConfig()
