"""
  ...
  File       : multimodal_entry_threshold_spec_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_entry_threshold_spec_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalEntryThresholdSpecDataPipelineConfig:
...
class MultimodalEntryThresholdSpecEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalEntryThresholdSpecDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalEntryThresholdSpecDataPipelineConfig()
