"""
  ...
  File       : multimodal_drawdown_limit_definer_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_drawdown_limit_definer_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalDrawdownLimitDefinerRiskMetricsConfig:
...
class MultimodalDrawdownLimitDefinerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDrawdownLimitDefinerRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalDrawdownLimitDefinerRiskMetricsConfig()
