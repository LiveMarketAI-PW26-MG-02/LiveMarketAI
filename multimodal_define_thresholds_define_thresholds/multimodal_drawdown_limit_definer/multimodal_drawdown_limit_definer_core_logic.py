"""
  ...
  File       : multimodal_drawdown_limit_definer_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_drawdown_limit_definer_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalDrawdownLimitDefinerCoreLogicConfig:
...
class MultimodalDrawdownLimitDefinerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDrawdownLimitDefinerCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalDrawdownLimitDefinerCoreLogicConfig()
