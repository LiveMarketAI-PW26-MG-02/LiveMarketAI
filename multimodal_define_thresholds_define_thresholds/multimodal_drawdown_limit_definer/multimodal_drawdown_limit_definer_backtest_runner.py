"""
  ...
  File       : multimodal_drawdown_limit_definer_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_drawdown_limit_definer_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalDrawdownLimitDefinerBacktestRunnerConfig:
...
class MultimodalDrawdownLimitDefinerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDrawdownLimitDefinerBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalDrawdownLimitDefinerBacktestRunnerConfig()
