"""
  ...
  File       : multimodal_drawdown_limit_definer_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_drawdown_limit_definer_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalDrawdownLimitDefinerDataPipelineConfig:
...
class MultimodalDrawdownLimitDefinerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDrawdownLimitDefinerDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalDrawdownLimitDefinerDataPipelineConfig()
