"""
  ...
  File       : multimodal_risk_limit_framework_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_risk_limit_framework_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRiskLimitFrameworkDataPipelineConfig:
...
class MultimodalRiskLimitFrameworkEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRiskLimitFrameworkDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalRiskLimitFrameworkDataPipelineConfig()
