"""
  ...
  File       : multimodal_risk_limit_framework_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_risk_limit_framework_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRiskLimitFrameworkBacktestRunnerConfig:
...
class MultimodalRiskLimitFrameworkEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRiskLimitFrameworkBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalRiskLimitFrameworkBacktestRunnerConfig()
