"""
  ...
  Folder     : multimodal_risk_limit_framework
  File       : multimodal_risk_limit_framework_signal_generator.py
  Purpose    : Define Thresholds — Risk Limit Framework
"""
...
MULTIMODAL_MODULE = 'multimodal_risk_limit_framework_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRiskLimitFrameworkSignalGeneratorConfig:
    """Multimodal threshold-sweep config for risk_limit_framework."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalRiskLimitFrameworkEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: define thresholds — risk limit framework.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalRiskLimitFrameworkSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalRiskLimitFrameworkSignalGeneratorConfig()
