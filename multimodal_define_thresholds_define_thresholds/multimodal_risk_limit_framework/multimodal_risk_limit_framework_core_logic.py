"""
  ...
  File       : multimodal_risk_limit_framework_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_risk_limit_framework_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRiskLimitFrameworkCoreLogicConfig:
...
class MultimodalRiskLimitFrameworkEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRiskLimitFrameworkCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalRiskLimitFrameworkCoreLogicConfig()
