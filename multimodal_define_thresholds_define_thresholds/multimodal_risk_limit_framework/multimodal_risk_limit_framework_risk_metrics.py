"""
  ...
  File       : multimodal_risk_limit_framework_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_risk_limit_framework_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRiskLimitFrameworkRiskMetricsConfig:
...
class MultimodalRiskLimitFrameworkEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRiskLimitFrameworkRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalRiskLimitFrameworkRiskMetricsConfig()
