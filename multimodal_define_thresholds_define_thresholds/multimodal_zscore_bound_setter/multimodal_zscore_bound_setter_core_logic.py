"""
  ...
  File       : multimodal_zscore_bound_setter_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_zscore_bound_setter_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalZscoreBoundSetterCoreLogicConfig:
...
class MultimodalZscoreBoundSetterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalZscoreBoundSetterCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalZscoreBoundSetterCoreLogicConfig()
