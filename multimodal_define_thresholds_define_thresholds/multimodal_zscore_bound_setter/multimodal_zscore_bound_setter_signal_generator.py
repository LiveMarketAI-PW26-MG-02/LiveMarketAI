"""
  ...
  Folder     : multimodal_zscore_bound_setter
  File       : multimodal_zscore_bound_setter_signal_generator.py
  Purpose    : Define Thresholds — Zscore Bound Setter
"""
...
MULTIMODAL_MODULE = 'multimodal_zscore_bound_setter_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalZscoreBoundSetterSignalGeneratorConfig:
    """Multimodal threshold-sweep config for zscore_bound_setter."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalZscoreBoundSetterEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: define thresholds — zscore bound setter.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalZscoreBoundSetterSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalZscoreBoundSetterSignalGeneratorConfig()
