"""
  ...
  File       : multimodal_zscore_bound_setter_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_zscore_bound_setter_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalZscoreBoundSetterRiskMetricsConfig:
...
class MultimodalZscoreBoundSetterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalZscoreBoundSetterRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalZscoreBoundSetterRiskMetricsConfig()
