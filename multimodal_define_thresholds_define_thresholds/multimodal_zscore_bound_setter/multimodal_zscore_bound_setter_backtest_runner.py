"""
  ...
  File       : multimodal_zscore_bound_setter_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_zscore_bound_setter_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalZscoreBoundSetterBacktestRunnerConfig:
...
class MultimodalZscoreBoundSetterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalZscoreBoundSetterBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalZscoreBoundSetterBacktestRunnerConfig()
