"""
  ...
  File       : multimodal_zscore_bound_setter_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_zscore_bound_setter_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalZscoreBoundSetterDataPipelineConfig:
...
class MultimodalZscoreBoundSetterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalZscoreBoundSetterDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalZscoreBoundSetterDataPipelineConfig()
