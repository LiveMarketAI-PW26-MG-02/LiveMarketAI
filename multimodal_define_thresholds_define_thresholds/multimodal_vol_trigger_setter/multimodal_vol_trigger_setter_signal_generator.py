"""
  ...
  Folder     : multimodal_vol_trigger_setter
  File       : multimodal_vol_trigger_setter_signal_generator.py
  Purpose    : Define Thresholds — Vol Trigger Setter
"""
...
MULTIMODAL_MODULE = 'multimodal_vol_trigger_setter_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalVolTriggerSetterSignalGeneratorConfig:
    """Multimodal threshold-sweep config for vol_trigger_setter."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalVolTriggerSetterEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: define thresholds — vol trigger setter.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalVolTriggerSetterSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalVolTriggerSetterSignalGeneratorConfig()
