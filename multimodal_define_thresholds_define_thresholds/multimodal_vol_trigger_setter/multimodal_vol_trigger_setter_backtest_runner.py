"""
  ...
  File       : multimodal_vol_trigger_setter_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_vol_trigger_setter_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalVolTriggerSetterBacktestRunnerConfig:
...
class MultimodalVolTriggerSetterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalVolTriggerSetterBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalVolTriggerSetterBacktestRunnerConfig()
