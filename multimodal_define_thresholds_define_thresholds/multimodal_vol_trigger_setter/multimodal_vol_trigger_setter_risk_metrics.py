"""
  ...
  File       : multimodal_vol_trigger_setter_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_vol_trigger_setter_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalVolTriggerSetterRiskMetricsConfig:
...
class MultimodalVolTriggerSetterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalVolTriggerSetterRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalVolTriggerSetterRiskMetricsConfig()
