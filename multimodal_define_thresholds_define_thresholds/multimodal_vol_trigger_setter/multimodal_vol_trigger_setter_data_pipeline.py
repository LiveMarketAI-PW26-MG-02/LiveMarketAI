"""
  ...
  File       : multimodal_vol_trigger_setter_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_vol_trigger_setter_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalVolTriggerSetterDataPipelineConfig:
...
class MultimodalVolTriggerSetterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalVolTriggerSetterDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalVolTriggerSetterDataPipelineConfig()
