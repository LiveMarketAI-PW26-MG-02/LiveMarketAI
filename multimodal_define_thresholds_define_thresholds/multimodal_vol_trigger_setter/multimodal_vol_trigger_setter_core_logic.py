"""
  ...
  File       : multimodal_vol_trigger_setter_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_vol_trigger_setter_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalVolTriggerSetterCoreLogicConfig:
...
class MultimodalVolTriggerSetterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalVolTriggerSetterCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalVolTriggerSetterCoreLogicConfig()
