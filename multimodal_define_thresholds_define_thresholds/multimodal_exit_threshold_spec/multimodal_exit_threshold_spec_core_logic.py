"""
  ...
  File       : multimodal_exit_threshold_spec_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_exit_threshold_spec_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalExitThresholdSpecCoreLogicConfig:
...
class MultimodalExitThresholdSpecEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalExitThresholdSpecCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalExitThresholdSpecCoreLogicConfig()
