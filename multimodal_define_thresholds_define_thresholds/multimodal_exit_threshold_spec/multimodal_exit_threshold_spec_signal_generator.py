"""
  ...
  Folder     : multimodal_exit_threshold_spec
  File       : multimodal_exit_threshold_spec_signal_generator.py
  Purpose    : Define Thresholds — Exit Threshold Spec
"""
...
MULTIMODAL_MODULE = 'multimodal_exit_threshold_spec_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalExitThresholdSpecSignalGeneratorConfig:
    """Multimodal threshold-sweep config for exit_threshold_spec."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalExitThresholdSpecEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: define thresholds — exit threshold spec.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalExitThresholdSpecSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalExitThresholdSpecSignalGeneratorConfig()
