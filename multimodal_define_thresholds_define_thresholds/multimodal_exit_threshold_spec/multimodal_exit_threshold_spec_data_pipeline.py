"""
  ...
  File       : multimodal_exit_threshold_spec_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_exit_threshold_spec_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalExitThresholdSpecDataPipelineConfig:
...
class MultimodalExitThresholdSpecEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalExitThresholdSpecDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalExitThresholdSpecDataPipelineConfig()
