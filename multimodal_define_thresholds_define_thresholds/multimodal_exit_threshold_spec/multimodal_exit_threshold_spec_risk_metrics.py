"""
  ...
  File       : multimodal_exit_threshold_spec_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_exit_threshold_spec_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalExitThresholdSpecRiskMetricsConfig:
...
class MultimodalExitThresholdSpecEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalExitThresholdSpecRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalExitThresholdSpecRiskMetricsConfig()
