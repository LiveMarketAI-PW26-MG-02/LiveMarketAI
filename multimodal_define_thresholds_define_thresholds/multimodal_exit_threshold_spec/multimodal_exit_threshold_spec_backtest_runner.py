"""
  ...
  File       : multimodal_exit_threshold_spec_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_exit_threshold_spec_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalExitThresholdSpecBacktestRunnerConfig:
...
class MultimodalExitThresholdSpecEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalExitThresholdSpecBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalExitThresholdSpecBacktestRunnerConfig()
