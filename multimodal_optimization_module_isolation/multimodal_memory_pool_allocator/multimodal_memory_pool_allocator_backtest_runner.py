"""
  ...
  File       : multimodal_memory_pool_allocator_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_memory_pool_allocator_backtest_runner'
TOPIC             = 'optimization'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalMemoryPoolAllocatorBacktestRunnerConfig:
...
class MultimodalMemoryPoolAllocatorEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalMemoryPoolAllocatorBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalMemoryPoolAllocatorBacktestRunnerConfig()
