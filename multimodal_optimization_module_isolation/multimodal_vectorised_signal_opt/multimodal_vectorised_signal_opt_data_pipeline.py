"""
  ...
  File       : multimodal_vectorised_signal_opt_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_vectorised_signal_opt_data_pipeline'
TOPIC             = 'optimization'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalVectorisedSignalOptDataPipelineConfig:
...
class MultimodalVectorisedSignalOptEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalVectorisedSignalOptDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalVectorisedSignalOptDataPipelineConfig()
