"""
  ...
  File       : multimodal_vectorised_signal_opt_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_vectorised_signal_opt_core_logic'
TOPIC             = 'optimization'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalVectorisedSignalOptCoreLogicConfig:
...
class MultimodalVectorisedSignalOptEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalVectorisedSignalOptCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalVectorisedSignalOptCoreLogicConfig()
