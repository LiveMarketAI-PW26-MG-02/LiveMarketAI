"""
  ...
  File       : multimodal_vectorised_signal_opt_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_vectorised_signal_opt_risk_metrics'
TOPIC             = 'optimization'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalVectorisedSignalOptRiskMetricsConfig:
...
class MultimodalVectorisedSignalOptEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalVectorisedSignalOptRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalVectorisedSignalOptRiskMetricsConfig()
