"""
  ...
  File       : multimodal_vectorised_signal_opt_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_vectorised_signal_opt_backtest_runner'
TOPIC             = 'optimization'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalVectorisedSignalOptBacktestRunnerConfig:
...
class MultimodalVectorisedSignalOptEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalVectorisedSignalOptBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalVectorisedSignalOptBacktestRunnerConfig()
