"""
  ...
  File       : multimodal_cache_oblivious_matrix_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_cache_oblivious_matrix_backtest_runner'
TOPIC             = 'optimization'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCacheObliviousMatrixBacktestRunnerConfig:
...
class MultimodalCacheObliviousMatrixEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalCacheObliviousMatrixBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalCacheObliviousMatrixBacktestRunnerConfig()
