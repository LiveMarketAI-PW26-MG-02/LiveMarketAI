"""
  ...
  File       : multimodal_numba_returns_engine_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_numba_returns_engine_backtest_runner'
TOPIC             = 'optimization'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalNumbaReturnsEngineBacktestRunnerConfig:
...
class MultimodalNumbaReturnsEngineEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalNumbaReturnsEngineBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalNumbaReturnsEngineBacktestRunnerConfig()
