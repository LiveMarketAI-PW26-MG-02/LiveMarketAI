"""
  ...
  File       : multimodal_numba_returns_engine_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_numba_returns_engine_core_logic'
TOPIC             = 'optimization'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalNumbaReturnsEngineCoreLogicConfig:
...
class MultimodalNumbaReturnsEngineEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalNumbaReturnsEngineCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalNumbaReturnsEngineCoreLogicConfig()
