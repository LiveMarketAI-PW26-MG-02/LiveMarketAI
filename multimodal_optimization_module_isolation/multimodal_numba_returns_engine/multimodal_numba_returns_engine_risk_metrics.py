"""
  ...
  File       : multimodal_numba_returns_engine_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_numba_returns_engine_risk_metrics'
TOPIC             = 'optimization'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalNumbaReturnsEngineRiskMetricsConfig:
...
class MultimodalNumbaReturnsEngineEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalNumbaReturnsEngineRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalNumbaReturnsEngineRiskMetricsConfig()
