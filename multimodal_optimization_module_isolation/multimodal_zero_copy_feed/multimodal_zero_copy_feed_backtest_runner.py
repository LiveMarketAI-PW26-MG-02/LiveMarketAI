"""
  ...
  File       : multimodal_zero_copy_feed_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_zero_copy_feed_backtest_runner'
TOPIC             = 'optimization'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalZeroCopyFeedBacktestRunnerConfig:
...
class MultimodalZeroCopyFeedEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalZeroCopyFeedBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalZeroCopyFeedBacktestRunnerConfig()
