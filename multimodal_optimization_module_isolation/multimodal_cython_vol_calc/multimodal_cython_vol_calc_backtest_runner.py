"""
  ...
  File       : multimodal_cython_vol_calc_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_cython_vol_calc_backtest_runner'
TOPIC             = 'optimization'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCythonVolCalcBacktestRunnerConfig:
...
class MultimodalCythonVolCalcEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalCythonVolCalcBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalCythonVolCalcBacktestRunnerConfig()
