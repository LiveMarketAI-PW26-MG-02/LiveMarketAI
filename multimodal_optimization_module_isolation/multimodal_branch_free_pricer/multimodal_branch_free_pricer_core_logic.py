"""
  ...
  File       : multimodal_branch_free_pricer_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_branch_free_pricer_core_logic'
TOPIC             = 'optimization'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalBranchFreePricerCoreLogicConfig:
...
class MultimodalBranchFreePricerEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalBranchFreePricerCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalBranchFreePricerCoreLogicConfig()
