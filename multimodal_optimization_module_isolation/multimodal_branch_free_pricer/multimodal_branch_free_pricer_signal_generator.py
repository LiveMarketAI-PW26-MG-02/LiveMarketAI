"""
  ...
  Folder     : multimodal_branch_free_pricer
  File       : multimodal_branch_free_pricer_signal_generator.py
  Purpose    : Optimization — Branch Free Pricer
"""
...
MULTIMODAL_MODULE = 'multimodal_branch_free_pricer_signal_generator'
TOPIC             = 'optimization'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalBranchFreePricerSignalGeneratorConfig:
    """Configuration for multimodal branch_free_pricer module."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalBranchFreePricerEngine(MultimodalBaseModule):
    """
    Multimodal engine: optimization — branch free pricer.
    Supports hot-swap, fault injection, latency SLA tracking.
    """

    def __init__(self, cfg: Optional[MultimodalBranchFreePricerSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalBranchFreePricerSignalGeneratorConfig()
