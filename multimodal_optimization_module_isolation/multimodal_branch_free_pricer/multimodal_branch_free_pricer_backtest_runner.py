"""
  ...
  File       : multimodal_branch_free_pricer_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_branch_free_pricer_backtest_runner'
TOPIC             = 'optimization'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalBranchFreePricerBacktestRunnerConfig:
...
class MultimodalBranchFreePricerEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalBranchFreePricerBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalBranchFreePricerBacktestRunnerConfig()
