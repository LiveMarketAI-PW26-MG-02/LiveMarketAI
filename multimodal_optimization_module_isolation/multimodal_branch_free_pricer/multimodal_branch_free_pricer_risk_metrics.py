"""
  ...
  File       : multimodal_branch_free_pricer_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_branch_free_pricer_risk_metrics'
TOPIC             = 'optimization'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalBranchFreePricerRiskMetricsConfig:
...
class MultimodalBranchFreePricerEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalBranchFreePricerRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalBranchFreePricerRiskMetricsConfig()
