"""
  ...
  File       : multimodal_branch_free_pricer_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_branch_free_pricer_data_pipeline'
TOPIC             = 'optimization'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalBranchFreePricerDataPipelineConfig:
...
class MultimodalBranchFreePricerEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalBranchFreePricerDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalBranchFreePricerDataPipelineConfig()
