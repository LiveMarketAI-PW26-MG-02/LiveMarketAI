"""
  ...
  File       : multimodal_compiler_hint_alpha_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_compiler_hint_alpha_backtest_runner'
TOPIC             = 'optimization'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCompilerHintAlphaBacktestRunnerConfig:
...
class MultimodalCompilerHintAlphaEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalCompilerHintAlphaBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalCompilerHintAlphaBacktestRunnerConfig()
