"""
  ...
  File       : multimodal_async_io_pipeline_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_async_io_pipeline_data_pipeline'
TOPIC             = 'optimization'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalAsyncIoPipelineDataPipelineConfig:
...
class MultimodalAsyncIoPipelineEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalAsyncIoPipelineDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalAsyncIoPipelineDataPipelineConfig()
