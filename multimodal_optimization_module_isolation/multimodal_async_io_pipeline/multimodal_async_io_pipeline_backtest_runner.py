"""
  ...
  File       : multimodal_async_io_pipeline_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_async_io_pipeline_backtest_runner'
TOPIC             = 'optimization'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalAsyncIoPipelineBacktestRunnerConfig:
...
class MultimodalAsyncIoPipelineEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalAsyncIoPipelineBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalAsyncIoPipelineBacktestRunnerConfig()
