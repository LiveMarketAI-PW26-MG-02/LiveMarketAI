"""
  ...
  File       : multimodal_async_io_pipeline_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_async_io_pipeline_core_logic'
TOPIC             = 'optimization'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalAsyncIoPipelineCoreLogicConfig:
...
class MultimodalAsyncIoPipelineEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalAsyncIoPipelineCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalAsyncIoPipelineCoreLogicConfig()
