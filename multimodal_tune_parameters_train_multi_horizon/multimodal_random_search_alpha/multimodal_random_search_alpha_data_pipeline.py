"""
  ...
  File       : multimodal_random_search_alpha_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_random_search_alpha_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRandomSearchAlphaDataPipelineConfig:
...
class MultimodalRandomSearchAlphaEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRandomSearchAlphaDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalRandomSearchAlphaDataPipelineConfig()
