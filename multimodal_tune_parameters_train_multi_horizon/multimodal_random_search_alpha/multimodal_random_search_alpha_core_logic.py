"""
  ...
  File       : multimodal_random_search_alpha_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_random_search_alpha_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRandomSearchAlphaCoreLogicConfig:
...
class MultimodalRandomSearchAlphaEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRandomSearchAlphaCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalRandomSearchAlphaCoreLogicConfig()
