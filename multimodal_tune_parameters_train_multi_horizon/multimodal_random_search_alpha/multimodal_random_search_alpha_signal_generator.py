"""
  ...
  Folder     : multimodal_random_search_alpha
  File       : multimodal_random_search_alpha_signal_generator.py
  Purpose    : Tune Parameters — Random Search Alpha
"""
...
MULTIMODAL_MODULE = 'multimodal_random_search_alpha_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRandomSearchAlphaSignalGeneratorConfig:
    """Multimodal multi-horizon config for random_search_alpha."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalRandomSearchAlphaEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: tune parameters — random search alpha.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalRandomSearchAlphaSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalRandomSearchAlphaSignalGeneratorConfig()
