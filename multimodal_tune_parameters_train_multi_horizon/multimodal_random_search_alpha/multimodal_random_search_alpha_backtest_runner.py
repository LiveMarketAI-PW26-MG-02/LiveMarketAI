"""
  ...
  File       : multimodal_random_search_alpha_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_random_search_alpha_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRandomSearchAlphaBacktestRunnerConfig:
...
class MultimodalRandomSearchAlphaEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRandomSearchAlphaBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalRandomSearchAlphaBacktestRunnerConfig()
