"""
  ...
  File       : multimodal_random_search_alpha_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_random_search_alpha_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRandomSearchAlphaRiskMetricsConfig:
...
class MultimodalRandomSearchAlphaEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRandomSearchAlphaRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalRandomSearchAlphaRiskMetricsConfig()
