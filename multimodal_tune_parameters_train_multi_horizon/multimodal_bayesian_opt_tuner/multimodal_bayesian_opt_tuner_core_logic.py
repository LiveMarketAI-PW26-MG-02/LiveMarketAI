"""
  ...
  File       : multimodal_bayesian_opt_tuner_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_bayesian_opt_tuner_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalBayesianOptTunerCoreLogicConfig:
...
class MultimodalBayesianOptTunerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalBayesianOptTunerCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalBayesianOptTunerCoreLogicConfig()
