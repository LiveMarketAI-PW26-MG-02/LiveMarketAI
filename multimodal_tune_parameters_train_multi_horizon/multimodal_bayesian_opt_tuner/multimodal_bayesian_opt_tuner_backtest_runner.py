"""
  ...
  File       : multimodal_bayesian_opt_tuner_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_bayesian_opt_tuner_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalBayesianOptTunerBacktestRunnerConfig:
...
class MultimodalBayesianOptTunerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalBayesianOptTunerBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalBayesianOptTunerBacktestRunnerConfig()
