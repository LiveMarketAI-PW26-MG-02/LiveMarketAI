"""
  ...
  Folder     : multimodal_bayesian_opt_tuner
  File       : multimodal_bayesian_opt_tuner_signal_generator.py
  Purpose    : Tune Parameters — Bayesian Opt Tuner
"""
...
MULTIMODAL_MODULE = 'multimodal_bayesian_opt_tuner_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalBayesianOptTunerSignalGeneratorConfig:
    """Multimodal multi-horizon config for bayesian_opt_tuner."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalBayesianOptTunerEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: tune parameters — bayesian opt tuner.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalBayesianOptTunerSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalBayesianOptTunerSignalGeneratorConfig()
