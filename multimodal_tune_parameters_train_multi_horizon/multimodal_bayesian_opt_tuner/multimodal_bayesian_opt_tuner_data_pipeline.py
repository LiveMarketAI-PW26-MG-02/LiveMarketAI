"""
  ...
  File       : multimodal_bayesian_opt_tuner_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_bayesian_opt_tuner_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalBayesianOptTunerDataPipelineConfig:
...
class MultimodalBayesianOptTunerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalBayesianOptTunerDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalBayesianOptTunerDataPipelineConfig()
