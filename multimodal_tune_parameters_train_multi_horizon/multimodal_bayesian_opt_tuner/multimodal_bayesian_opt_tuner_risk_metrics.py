"""
  ...
  File       : multimodal_bayesian_opt_tuner_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_bayesian_opt_tuner_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalBayesianOptTunerRiskMetricsConfig:
...
class MultimodalBayesianOptTunerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalBayesianOptTunerRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalBayesianOptTunerRiskMetricsConfig()
