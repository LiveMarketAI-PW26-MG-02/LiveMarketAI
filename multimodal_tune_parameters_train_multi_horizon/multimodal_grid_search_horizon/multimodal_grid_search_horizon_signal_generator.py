"""
  ...
  Folder     : multimodal_grid_search_horizon
  File       : multimodal_grid_search_horizon_signal_generator.py
  Purpose    : Tune Parameters — Grid Search Horizon
"""
...
MULTIMODAL_MODULE = 'multimodal_grid_search_horizon_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalGridSearchHorizonSignalGeneratorConfig:
    """Multimodal multi-horizon config for grid_search_horizon."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalGridSearchHorizonEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: tune parameters — grid search horizon.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalGridSearchHorizonSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalGridSearchHorizonSignalGeneratorConfig()
