"""
  ...
  File       : multimodal_grid_search_horizon_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_grid_search_horizon_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalGridSearchHorizonRiskMetricsConfig:
...
class MultimodalGridSearchHorizonEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalGridSearchHorizonRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalGridSearchHorizonRiskMetricsConfig()
