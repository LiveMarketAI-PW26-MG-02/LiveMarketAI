"""
  ...
  File       : multimodal_grid_search_horizon_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_grid_search_horizon_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalGridSearchHorizonBacktestRunnerConfig:
...
class MultimodalGridSearchHorizonEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalGridSearchHorizonBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalGridSearchHorizonBacktestRunnerConfig()
