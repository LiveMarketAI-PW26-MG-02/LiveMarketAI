"""
  ...
  File       : multimodal_grid_search_horizon_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_grid_search_horizon_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalGridSearchHorizonDataPipelineConfig:
...
class MultimodalGridSearchHorizonEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalGridSearchHorizonDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalGridSearchHorizonDataPipelineConfig()
