"""
  ...
  File       : multimodal_grid_search_horizon_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_grid_search_horizon_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalGridSearchHorizonCoreLogicConfig:
...
class MultimodalGridSearchHorizonEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalGridSearchHorizonCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalGridSearchHorizonCoreLogicConfig()
