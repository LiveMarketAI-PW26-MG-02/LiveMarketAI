"""
  ...
  Folder     : multimodal_ensemble_weight_opt
  File       : multimodal_ensemble_weight_opt_signal_generator.py
  Purpose    : Tune Parameters — Ensemble Weight Opt
"""
...
MULTIMODAL_MODULE = 'multimodal_ensemble_weight_opt_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalEnsembleWeightOptSignalGeneratorConfig:
    """Multimodal multi-horizon config for ensemble_weight_opt."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalEnsembleWeightOptEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: tune parameters — ensemble weight opt.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalEnsembleWeightOptSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalEnsembleWeightOptSignalGeneratorConfig()
