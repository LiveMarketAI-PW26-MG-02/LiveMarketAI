"""
  ...
  File       : multimodal_ensemble_weight_opt_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_ensemble_weight_opt_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalEnsembleWeightOptDataPipelineConfig:
...
class MultimodalEnsembleWeightOptEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalEnsembleWeightOptDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalEnsembleWeightOptDataPipelineConfig()
