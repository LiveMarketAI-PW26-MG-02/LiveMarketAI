"""
  ...
  File       : multimodal_ensemble_weight_opt_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_ensemble_weight_opt_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalEnsembleWeightOptBacktestRunnerConfig:
...
class MultimodalEnsembleWeightOptEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalEnsembleWeightOptBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalEnsembleWeightOptBacktestRunnerConfig()
