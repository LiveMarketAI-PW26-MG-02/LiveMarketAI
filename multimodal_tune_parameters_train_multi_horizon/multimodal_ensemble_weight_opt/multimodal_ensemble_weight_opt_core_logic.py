"""
  ...
  File       : multimodal_ensemble_weight_opt_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_ensemble_weight_opt_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalEnsembleWeightOptCoreLogicConfig:
...
class MultimodalEnsembleWeightOptEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalEnsembleWeightOptCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalEnsembleWeightOptCoreLogicConfig()
