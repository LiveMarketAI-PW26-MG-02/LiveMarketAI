"""
  ...
  File       : multimodal_ensemble_weight_opt_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_ensemble_weight_opt_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalEnsembleWeightOptRiskMetricsConfig:
...
class MultimodalEnsembleWeightOptEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalEnsembleWeightOptRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalEnsembleWeightOptRiskMetricsConfig()
