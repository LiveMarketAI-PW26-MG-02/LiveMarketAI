"""
  ...
  File       : multimodal_regularisation_sweep_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_regularisation_sweep_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegularisationSweepCoreLogicConfig:
...
class MultimodalRegularisationSweepEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegularisationSweepCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalRegularisationSweepCoreLogicConfig()
