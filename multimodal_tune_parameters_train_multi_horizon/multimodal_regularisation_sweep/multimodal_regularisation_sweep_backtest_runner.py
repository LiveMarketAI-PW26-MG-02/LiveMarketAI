"""
  ...
  File       : multimodal_regularisation_sweep_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_regularisation_sweep_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegularisationSweepBacktestRunnerConfig:
...
class MultimodalRegularisationSweepEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegularisationSweepBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalRegularisationSweepBacktestRunnerConfig()
