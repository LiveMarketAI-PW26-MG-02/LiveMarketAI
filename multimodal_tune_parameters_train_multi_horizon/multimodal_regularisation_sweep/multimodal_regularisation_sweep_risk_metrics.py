"""
  ...
  File       : multimodal_regularisation_sweep_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_regularisation_sweep_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegularisationSweepRiskMetricsConfig:
...
class MultimodalRegularisationSweepEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegularisationSweepRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalRegularisationSweepRiskMetricsConfig()
