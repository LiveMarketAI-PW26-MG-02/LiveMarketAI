"""
  ...
  File       : multimodal_regularisation_sweep_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_regularisation_sweep_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegularisationSweepDataPipelineConfig:
...
class MultimodalRegularisationSweepEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegularisationSweepDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalRegularisationSweepDataPipelineConfig()
