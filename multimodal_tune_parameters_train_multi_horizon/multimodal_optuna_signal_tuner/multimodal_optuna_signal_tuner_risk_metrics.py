"""
  ...
  File       : multimodal_optuna_signal_tuner_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_optuna_signal_tuner_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalOptunaSignalTunerRiskMetricsConfig:
...
class MultimodalOptunaSignalTunerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalOptunaSignalTunerRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalOptunaSignalTunerRiskMetricsConfig()
