"""
  ...
  File       : multimodal_optuna_signal_tuner_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_optuna_signal_tuner_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalOptunaSignalTunerCoreLogicConfig:
...
class MultimodalOptunaSignalTunerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalOptunaSignalTunerCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalOptunaSignalTunerCoreLogicConfig()
