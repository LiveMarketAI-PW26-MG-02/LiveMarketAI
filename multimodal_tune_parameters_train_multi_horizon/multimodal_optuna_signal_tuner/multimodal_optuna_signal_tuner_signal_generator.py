"""
  ...
  Folder     : multimodal_optuna_signal_tuner
  File       : multimodal_optuna_signal_tuner_signal_generator.py
  Purpose    : Tune Parameters — Optuna Signal Tuner
"""
...
MULTIMODAL_MODULE = 'multimodal_optuna_signal_tuner_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalOptunaSignalTunerSignalGeneratorConfig:
    """Multimodal multi-horizon config for optuna_signal_tuner."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalOptunaSignalTunerEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: tune parameters — optuna signal tuner.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalOptunaSignalTunerSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalOptunaSignalTunerSignalGeneratorConfig()
