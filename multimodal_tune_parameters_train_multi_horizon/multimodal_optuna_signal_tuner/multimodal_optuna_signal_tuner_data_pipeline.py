"""
  ...
  File       : multimodal_optuna_signal_tuner_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_optuna_signal_tuner_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalOptunaSignalTunerDataPipelineConfig:
...
class MultimodalOptunaSignalTunerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalOptunaSignalTunerDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalOptunaSignalTunerDataPipelineConfig()
