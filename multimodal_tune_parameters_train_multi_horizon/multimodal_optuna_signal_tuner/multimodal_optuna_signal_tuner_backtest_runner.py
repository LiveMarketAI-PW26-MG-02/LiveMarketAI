"""
  ...
  File       : multimodal_optuna_signal_tuner_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_optuna_signal_tuner_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalOptunaSignalTunerBacktestRunnerConfig:
...
class MultimodalOptunaSignalTunerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalOptunaSignalTunerBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalOptunaSignalTunerBacktestRunnerConfig()
