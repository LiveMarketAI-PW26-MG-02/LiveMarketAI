"""
  ...
  File       : multimodal_learning_rate_finder_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_learning_rate_finder_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalLearningRateFinderCoreLogicConfig:
...
class MultimodalLearningRateFinderEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalLearningRateFinderCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalLearningRateFinderCoreLogicConfig()
