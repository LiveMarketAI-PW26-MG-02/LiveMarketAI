"""
  ...
  File       : multimodal_learning_rate_finder_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_learning_rate_finder_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalLearningRateFinderRiskMetricsConfig:
...
class MultimodalLearningRateFinderEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalLearningRateFinderRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalLearningRateFinderRiskMetricsConfig()
