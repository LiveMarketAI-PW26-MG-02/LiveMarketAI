"""
  ...
  File       : multimodal_learning_rate_finder_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_learning_rate_finder_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalLearningRateFinderDataPipelineConfig:
...
class MultimodalLearningRateFinderEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalLearningRateFinderDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalLearningRateFinderDataPipelineConfig()
