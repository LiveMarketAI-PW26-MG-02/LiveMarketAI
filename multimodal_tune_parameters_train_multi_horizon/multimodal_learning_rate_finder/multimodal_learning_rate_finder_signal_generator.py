"""
  ...
  Folder     : multimodal_learning_rate_finder
  File       : multimodal_learning_rate_finder_signal_generator.py
  Purpose    : Tune Parameters — Learning Rate Finder
"""
...
MULTIMODAL_MODULE = 'multimodal_learning_rate_finder_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalLearningRateFinderSignalGeneratorConfig:
    """Multimodal multi-horizon config for learning_rate_finder."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalLearningRateFinderEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: tune parameters — learning rate finder.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalLearningRateFinderSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalLearningRateFinderSignalGeneratorConfig()
