"""
  ...
  File       : multimodal_learning_rate_finder_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_learning_rate_finder_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalLearningRateFinderBacktestRunnerConfig:
...
class MultimodalLearningRateFinderEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalLearningRateFinderBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalLearningRateFinderBacktestRunnerConfig()
