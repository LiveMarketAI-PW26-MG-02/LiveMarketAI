"""
  ...
  Folder     : multimodal_window_length_tuner
  File       : multimodal_window_length_tuner_signal_generator.py
  Purpose    : Tune Parameters — Window Length Tuner
"""
...
MULTIMODAL_MODULE = 'multimodal_window_length_tuner_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalWindowLengthTunerSignalGeneratorConfig:
    """Multimodal multi-horizon config for window_length_tuner."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalWindowLengthTunerEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: tune parameters — window length tuner.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalWindowLengthTunerSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalWindowLengthTunerSignalGeneratorConfig()
