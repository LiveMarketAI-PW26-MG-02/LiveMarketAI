"""
  ...
  File       : multimodal_window_length_tuner_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_window_length_tuner_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalWindowLengthTunerBacktestRunnerConfig:
...
class MultimodalWindowLengthTunerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalWindowLengthTunerBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalWindowLengthTunerBacktestRunnerConfig()
