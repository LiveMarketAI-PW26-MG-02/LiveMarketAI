"""
  ...
  File       : multimodal_window_length_tuner_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_window_length_tuner_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalWindowLengthTunerCoreLogicConfig:
...
class MultimodalWindowLengthTunerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalWindowLengthTunerCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalWindowLengthTunerCoreLogicConfig()
