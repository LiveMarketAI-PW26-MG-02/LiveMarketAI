"""
  ...
  File       : multimodal_window_length_tuner_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_window_length_tuner_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalWindowLengthTunerDataPipelineConfig:
...
class MultimodalWindowLengthTunerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalWindowLengthTunerDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalWindowLengthTunerDataPipelineConfig()
