"""
  ...
  File       : multimodal_window_length_tuner_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_window_length_tuner_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalWindowLengthTunerRiskMetricsConfig:
...
class MultimodalWindowLengthTunerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalWindowLengthTunerRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalWindowLengthTunerRiskMetricsConfig()
