"""
  ...
  File       : multimodal_hyperband_scheduler_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_hyperband_scheduler_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalHyperbandSchedulerBacktestRunnerConfig:
...
class MultimodalHyperbandSchedulerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalHyperbandSchedulerBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalHyperbandSchedulerBacktestRunnerConfig()
