"""
  ...
  File       : multimodal_hyperband_scheduler_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_hyperband_scheduler_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalHyperbandSchedulerCoreLogicConfig:
...
class MultimodalHyperbandSchedulerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalHyperbandSchedulerCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalHyperbandSchedulerCoreLogicConfig()
