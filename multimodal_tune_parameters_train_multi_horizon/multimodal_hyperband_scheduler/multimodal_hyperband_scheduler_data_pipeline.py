"""
  ...
  File       : multimodal_hyperband_scheduler_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_hyperband_scheduler_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalHyperbandSchedulerDataPipelineConfig:
...
class MultimodalHyperbandSchedulerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalHyperbandSchedulerDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalHyperbandSchedulerDataPipelineConfig()
