"""
  ...
  Folder     : multimodal_hyperband_scheduler
  File       : multimodal_hyperband_scheduler_signal_generator.py
  Purpose    : Tune Parameters — Hyperband Scheduler
"""
...
MULTIMODAL_MODULE = 'multimodal_hyperband_scheduler_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalHyperbandSchedulerSignalGeneratorConfig:
    """Multimodal multi-horizon config for hyperband_scheduler."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalHyperbandSchedulerEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: tune parameters — hyperband scheduler.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalHyperbandSchedulerSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalHyperbandSchedulerSignalGeneratorConfig()
