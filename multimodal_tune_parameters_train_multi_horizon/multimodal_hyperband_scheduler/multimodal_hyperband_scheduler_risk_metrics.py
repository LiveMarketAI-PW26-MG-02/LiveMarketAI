"""
  ...
  File       : multimodal_hyperband_scheduler_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_hyperband_scheduler_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalHyperbandSchedulerRiskMetricsConfig:
...
class MultimodalHyperbandSchedulerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalHyperbandSchedulerRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalHyperbandSchedulerRiskMetricsConfig()
