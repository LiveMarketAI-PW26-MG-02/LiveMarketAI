"""
  ...
  File       : multimodal_threshold_calibrator_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_threshold_calibrator_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalThresholdCalibratorCoreLogicConfig:
...
class MultimodalThresholdCalibratorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalThresholdCalibratorCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalThresholdCalibratorCoreLogicConfig()
