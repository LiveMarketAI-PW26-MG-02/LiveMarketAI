"""
  ...
  Folder     : multimodal_threshold_calibrator
  File       : multimodal_threshold_calibrator_signal_generator.py
  Purpose    : Tune Parameters — Threshold Calibrator
"""
...
MULTIMODAL_MODULE = 'multimodal_threshold_calibrator_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalThresholdCalibratorSignalGeneratorConfig:
    """Multimodal multi-horizon config for threshold_calibrator."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalThresholdCalibratorEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: tune parameters — threshold calibrator.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalThresholdCalibratorSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalThresholdCalibratorSignalGeneratorConfig()
