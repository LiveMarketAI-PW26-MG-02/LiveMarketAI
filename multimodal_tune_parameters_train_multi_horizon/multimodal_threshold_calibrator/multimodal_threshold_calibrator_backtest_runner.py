"""
  ...
  File       : multimodal_threshold_calibrator_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_threshold_calibrator_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalThresholdCalibratorBacktestRunnerConfig:
...
class MultimodalThresholdCalibratorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalThresholdCalibratorBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalThresholdCalibratorBacktestRunnerConfig()
