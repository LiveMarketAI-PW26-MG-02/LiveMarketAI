"""
  ...
  File       : multimodal_threshold_calibrator_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_threshold_calibrator_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalThresholdCalibratorDataPipelineConfig:
...
class MultimodalThresholdCalibratorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalThresholdCalibratorDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalThresholdCalibratorDataPipelineConfig()
