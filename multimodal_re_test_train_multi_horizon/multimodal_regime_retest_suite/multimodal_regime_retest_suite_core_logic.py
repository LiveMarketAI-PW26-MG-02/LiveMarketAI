"""
  ...
  File       : multimodal_regime_retest_suite_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_regime_retest_suite_core_logic'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeRetestSuiteCoreLogicConfig:
...
class MultimodalRegimeRetestSuiteEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegimeRetestSuiteCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalRegimeRetestSuiteCoreLogicConfig()
