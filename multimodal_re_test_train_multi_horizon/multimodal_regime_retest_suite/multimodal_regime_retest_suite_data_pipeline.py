"""
  ...
  File       : multimodal_regime_retest_suite_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_regime_retest_suite_data_pipeline'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeRetestSuiteDataPipelineConfig:
...
class MultimodalRegimeRetestSuiteEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegimeRetestSuiteDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalRegimeRetestSuiteDataPipelineConfig()
