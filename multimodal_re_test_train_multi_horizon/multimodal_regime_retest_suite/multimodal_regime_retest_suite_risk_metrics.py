"""
  ...
  File       : multimodal_regime_retest_suite_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_regime_retest_suite_risk_metrics'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeRetestSuiteRiskMetricsConfig:
...
class MultimodalRegimeRetestSuiteEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegimeRetestSuiteRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalRegimeRetestSuiteRiskMetricsConfig()
