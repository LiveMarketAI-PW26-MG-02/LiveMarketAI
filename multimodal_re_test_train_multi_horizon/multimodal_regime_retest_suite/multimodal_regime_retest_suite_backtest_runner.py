"""
  ...
  File       : multimodal_regime_retest_suite_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_regime_retest_suite_backtest_runner'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeRetestSuiteBacktestRunnerConfig:
...
class MultimodalRegimeRetestSuiteEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegimeRetestSuiteBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalRegimeRetestSuiteBacktestRunnerConfig()
