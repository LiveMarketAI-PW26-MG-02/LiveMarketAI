"""
  ...
  ZIP Topic  : ReTest
  Folder     : multimodal_regime_retest_suite
  File       : multimodal_regime_retest_suite_signal_generator.py
  Purpose    : Re Test — Regime Retest Suite
"""
...
MULTIMODAL_MODULE = 'multimodal_regime_retest_suite_signal_generator'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeRetestSuiteSignalGeneratorConfig:
    """Multimodal multi-horizon config for regime_retest_suite."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalRegimeRetestSuiteEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: re test — regime retest suite.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalRegimeRetestSuiteSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalRegimeRetestSuiteSignalGeneratorConfig()
