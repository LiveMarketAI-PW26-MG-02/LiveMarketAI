"""
  ...
  File       : multimodal_oos_retest_harness_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_oos_retest_harness_backtest_runner'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalOosRetestHarnessBacktestRunnerConfig:
...
class MultimodalOosRetestHarnessEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalOosRetestHarnessBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalOosRetestHarnessBacktestRunnerConfig()
