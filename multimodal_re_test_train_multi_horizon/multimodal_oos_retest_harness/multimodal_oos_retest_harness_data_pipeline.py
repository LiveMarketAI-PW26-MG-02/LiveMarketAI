"""
  ...
  File       : multimodal_oos_retest_harness_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_oos_retest_harness_data_pipeline'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalOosRetestHarnessDataPipelineConfig:
...
class MultimodalOosRetestHarnessEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalOosRetestHarnessDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalOosRetestHarnessDataPipelineConfig()
