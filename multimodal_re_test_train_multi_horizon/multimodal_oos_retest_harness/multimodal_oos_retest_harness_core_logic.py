"""
  ...
  File       : multimodal_oos_retest_harness_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_oos_retest_harness_core_logic'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalOosRetestHarnessCoreLogicConfig:
...
class MultimodalOosRetestHarnessEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalOosRetestHarnessCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalOosRetestHarnessCoreLogicConfig()
