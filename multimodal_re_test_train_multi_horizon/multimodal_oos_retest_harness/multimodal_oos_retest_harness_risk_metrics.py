"""
  ...
  File       : multimodal_oos_retest_harness_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_oos_retest_harness_risk_metrics'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalOosRetestHarnessRiskMetricsConfig:
...
class MultimodalOosRetestHarnessEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalOosRetestHarnessRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalOosRetestHarnessRiskMetricsConfig()
