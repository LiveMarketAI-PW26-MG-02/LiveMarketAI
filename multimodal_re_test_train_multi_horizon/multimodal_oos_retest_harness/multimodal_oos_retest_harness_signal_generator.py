"""
  ...
  ZIP Topic  : ReTest
  Folder     : multimodal_oos_retest_harness
  File       : multimodal_oos_retest_harness_signal_generator.py
  Purpose    : Re Test — Oos Retest Harness
"""
...
MULTIMODAL_MODULE = 'multimodal_oos_retest_harness_signal_generator'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalOosRetestHarnessSignalGeneratorConfig:
    """Multimodal multi-horizon config for oos_retest_harness."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalOosRetestHarnessEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: re test — oos retest harness.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalOosRetestHarnessSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalOosRetestHarnessSignalGeneratorConfig()
