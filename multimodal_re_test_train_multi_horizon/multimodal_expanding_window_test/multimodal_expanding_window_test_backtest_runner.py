"""
  ...
  File       : multimodal_expanding_window_test_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_expanding_window_test_backtest_runner'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalExpandingWindowTestBacktestRunnerConfig:
...
class MultimodalExpandingWindowTestEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalExpandingWindowTestBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalExpandingWindowTestBacktestRunnerConfig()
