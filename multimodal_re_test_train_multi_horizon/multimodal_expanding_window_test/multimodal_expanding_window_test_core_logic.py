"""
  ...
  File       : multimodal_expanding_window_test_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_expanding_window_test_core_logic'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalExpandingWindowTestCoreLogicConfig:
...
class MultimodalExpandingWindowTestEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalExpandingWindowTestCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalExpandingWindowTestCoreLogicConfig()
