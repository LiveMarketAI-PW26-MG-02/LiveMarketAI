"""
  ...
  ZIP Topic  : ReTest
  Folder     : multimodal_expanding_window_test
  File       : multimodal_expanding_window_test_signal_generator.py
  Purpose    : Re Test — Expanding Window Test
"""
...
MULTIMODAL_MODULE = 'multimodal_expanding_window_test_signal_generator'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalExpandingWindowTestSignalGeneratorConfig:
    """Multimodal multi-horizon config for expanding_window_test."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalExpandingWindowTestEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: re test — expanding window test.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalExpandingWindowTestSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalExpandingWindowTestSignalGeneratorConfig()
