"""
  ...
  File       : multimodal_expanding_window_test_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_expanding_window_test_risk_metrics'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalExpandingWindowTestRiskMetricsConfig:
...
class MultimodalExpandingWindowTestEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalExpandingWindowTestRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalExpandingWindowTestRiskMetricsConfig()
