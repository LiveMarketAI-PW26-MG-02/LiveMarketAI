"""
  ...
  File       : multimodal_expanding_window_test_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_expanding_window_test_data_pipeline'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalExpandingWindowTestDataPipelineConfig:
...
class MultimodalExpandingWindowTestEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalExpandingWindowTestDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalExpandingWindowTestDataPipelineConfig()
