"""
  ...
  File       : multimodal_live_shadow_retester_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_live_shadow_retester_backtest_runner'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalLiveShadowRetesterBacktestRunnerConfig:
...
class MultimodalLiveShadowRetesterEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalLiveShadowRetesterBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalLiveShadowRetesterBacktestRunnerConfig()
