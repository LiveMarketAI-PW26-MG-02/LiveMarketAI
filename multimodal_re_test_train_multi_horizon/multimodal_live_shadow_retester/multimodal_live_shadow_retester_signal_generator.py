"""
  ...
  ZIP Topic  : ReTest
  Folder     : multimodal_live_shadow_retester
  File       : multimodal_live_shadow_retester_signal_generator.py
  Purpose    : Re Test — Live Shadow Retester
"""
...
MULTIMODAL_MODULE = 'multimodal_live_shadow_retester_signal_generator'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalLiveShadowRetesterSignalGeneratorConfig:
    """Multimodal multi-horizon config for live_shadow_retester."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalLiveShadowRetesterEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: re test — live shadow retester.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalLiveShadowRetesterSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalLiveShadowRetesterSignalGeneratorConfig()
