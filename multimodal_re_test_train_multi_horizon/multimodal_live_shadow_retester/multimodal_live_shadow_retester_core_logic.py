"""
  ...
  File       : multimodal_live_shadow_retester_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_live_shadow_retester_core_logic'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalLiveShadowRetesterCoreLogicConfig:
...
class MultimodalLiveShadowRetesterEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalLiveShadowRetesterCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalLiveShadowRetesterCoreLogicConfig()
