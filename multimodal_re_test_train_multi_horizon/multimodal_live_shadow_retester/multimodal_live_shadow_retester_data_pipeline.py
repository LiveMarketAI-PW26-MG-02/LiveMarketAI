"""
  ...
  File       : multimodal_live_shadow_retester_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_live_shadow_retester_data_pipeline'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalLiveShadowRetesterDataPipelineConfig:
...
class MultimodalLiveShadowRetesterEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalLiveShadowRetesterDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalLiveShadowRetesterDataPipelineConfig()
