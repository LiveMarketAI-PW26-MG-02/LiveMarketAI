"""
  ...
  File       : multimodal_live_shadow_retester_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_live_shadow_retester_risk_metrics'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalLiveShadowRetesterRiskMetricsConfig:
...
class MultimodalLiveShadowRetesterEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalLiveShadowRetesterRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalLiveShadowRetesterRiskMetricsConfig()
