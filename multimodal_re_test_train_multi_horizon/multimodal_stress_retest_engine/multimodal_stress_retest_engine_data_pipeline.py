"""
  ...
  File       : multimodal_stress_retest_engine_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_stress_retest_engine_data_pipeline'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalStressRetestEngineDataPipelineConfig:
...
class MultimodalStressRetestEngineEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalStressRetestEngineDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalStressRetestEngineDataPipelineConfig()
