"""
  ...
  File       : multimodal_stress_retest_engine_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_stress_retest_engine_risk_metrics'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalStressRetestEngineRiskMetricsConfig:
...
class MultimodalStressRetestEngineEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalStressRetestEngineRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalStressRetestEngineRiskMetricsConfig()
