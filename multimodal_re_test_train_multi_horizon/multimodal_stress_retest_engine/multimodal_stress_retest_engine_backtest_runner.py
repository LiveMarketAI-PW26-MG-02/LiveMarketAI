"""
  ...
  File       : multimodal_stress_retest_engine_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_stress_retest_engine_backtest_runner'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalStressRetestEngineBacktestRunnerConfig:
...
class MultimodalStressRetestEngineEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalStressRetestEngineBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalStressRetestEngineBacktestRunnerConfig()
