"""
  ...
  File       : multimodal_purged_kfold_runner_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_purged_kfold_runner_data_pipeline'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPurgedKfoldRunnerDataPipelineConfig:
...
class MultimodalPurgedKfoldRunnerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPurgedKfoldRunnerDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalPurgedKfoldRunnerDataPipelineConfig()
