"""
  ...
  ZIP Topic  : ReTest
  Folder     : multimodal_purged_kfold_runner
  File       : multimodal_purged_kfold_runner_signal_generator.py
  Purpose    : Re Test — Purged Kfold Runner
"""
...
MULTIMODAL_MODULE = 'multimodal_purged_kfold_runner_signal_generator'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPurgedKfoldRunnerSignalGeneratorConfig:
    """Multimodal multi-horizon config for purged_kfold_runner."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalPurgedKfoldRunnerEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: re test — purged kfold runner.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalPurgedKfoldRunnerSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalPurgedKfoldRunnerSignalGeneratorConfig()
