"""
  ...
  File       : multimodal_purged_kfold_runner_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_purged_kfold_runner_core_logic'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPurgedKfoldRunnerCoreLogicConfig:
...
class MultimodalPurgedKfoldRunnerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPurgedKfoldRunnerCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalPurgedKfoldRunnerCoreLogicConfig()
