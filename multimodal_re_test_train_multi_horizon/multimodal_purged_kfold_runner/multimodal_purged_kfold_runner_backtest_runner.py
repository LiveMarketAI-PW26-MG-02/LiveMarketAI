"""
  ...
  File       : multimodal_purged_kfold_runner_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_purged_kfold_runner_backtest_runner'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPurgedKfoldRunnerBacktestRunnerConfig:
...
class MultimodalPurgedKfoldRunnerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPurgedKfoldRunnerBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalPurgedKfoldRunnerBacktestRunnerConfig()
