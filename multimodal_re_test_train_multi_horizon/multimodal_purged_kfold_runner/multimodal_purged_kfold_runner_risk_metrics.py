"""
  ...
  File       : multimodal_purged_kfold_runner_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_purged_kfold_runner_risk_metrics'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPurgedKfoldRunnerRiskMetricsConfig:
...
class MultimodalPurgedKfoldRunnerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPurgedKfoldRunnerRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalPurgedKfoldRunnerRiskMetricsConfig()
