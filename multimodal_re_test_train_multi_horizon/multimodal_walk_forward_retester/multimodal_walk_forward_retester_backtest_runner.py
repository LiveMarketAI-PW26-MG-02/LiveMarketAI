"""
  ...
  File       : multimodal_walk_forward_retester_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_walk_forward_retester_backtest_runner'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalWalkForwardRetesterBacktestRunnerConfig:
...
class MultimodalWalkForwardRetesterEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalWalkForwardRetesterBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalWalkForwardRetesterBacktestRunnerConfig()
