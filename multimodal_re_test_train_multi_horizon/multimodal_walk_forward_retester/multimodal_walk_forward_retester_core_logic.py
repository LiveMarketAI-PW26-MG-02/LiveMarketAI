"""
  ...
  File       : multimodal_walk_forward_retester_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_walk_forward_retester_core_logic'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalWalkForwardRetesterCoreLogicConfig:
...
class MultimodalWalkForwardRetesterEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalWalkForwardRetesterCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalWalkForwardRetesterCoreLogicConfig()
