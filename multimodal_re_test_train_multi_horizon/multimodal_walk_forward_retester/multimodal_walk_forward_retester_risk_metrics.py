"""
  ...
  File       : multimodal_walk_forward_retester_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_walk_forward_retester_risk_metrics'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalWalkForwardRetesterRiskMetricsConfig:
...
class MultimodalWalkForwardRetesterEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalWalkForwardRetesterRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalWalkForwardRetesterRiskMetricsConfig()
