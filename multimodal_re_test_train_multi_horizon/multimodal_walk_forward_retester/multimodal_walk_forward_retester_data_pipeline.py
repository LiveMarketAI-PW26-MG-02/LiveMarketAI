"""
  ...
  File       : multimodal_walk_forward_retester_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_walk_forward_retester_data_pipeline'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalWalkForwardRetesterDataPipelineConfig:
...
class MultimodalWalkForwardRetesterEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalWalkForwardRetesterDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalWalkForwardRetesterDataPipelineConfig()
