"""
  ...
  ZIP Topic  : ReTest
  Folder     : multimodal_walk_forward_retester
  File       : multimodal_walk_forward_retester_signal_generator.py
  Purpose    : Re Test — Walk Forward Retester
"""
...
MULTIMODAL_MODULE = 'multimodal_walk_forward_retester_signal_generator'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalWalkForwardRetesterSignalGeneratorConfig:
    """Multimodal multi-horizon config for walk_forward_retester."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalWalkForwardRetesterEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: re test — walk forward retester.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalWalkForwardRetesterSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalWalkForwardRetesterSignalGeneratorConfig()
