"""
  ...
  File       : multimodal_paper_trade_retester_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_paper_trade_retester_backtest_runner'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPaperTradeRetesterBacktestRunnerConfig:
...
class MultimodalPaperTradeRetesterEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPaperTradeRetesterBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalPaperTradeRetesterBacktestRunnerConfig()
