"""
  ...
  File       : multimodal_paper_trade_retester_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_paper_trade_retester_data_pipeline'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPaperTradeRetesterDataPipelineConfig:
...
class MultimodalPaperTradeRetesterEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPaperTradeRetesterDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalPaperTradeRetesterDataPipelineConfig()
