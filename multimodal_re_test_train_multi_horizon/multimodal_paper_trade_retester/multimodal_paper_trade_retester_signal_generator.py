"""
  ...
  ZIP Topic  : ReTest
  Folder     : multimodal_paper_trade_retester
  File       : multimodal_paper_trade_retester_signal_generator.py
  Purpose    : Re Test — Paper Trade Retester
"""
...
MULTIMODAL_MODULE = 'multimodal_paper_trade_retester_signal_generator'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPaperTradeRetesterSignalGeneratorConfig:
    """Multimodal multi-horizon config for paper_trade_retester."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalPaperTradeRetesterEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: re test — paper trade retester.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalPaperTradeRetesterSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalPaperTradeRetesterSignalGeneratorConfig()
