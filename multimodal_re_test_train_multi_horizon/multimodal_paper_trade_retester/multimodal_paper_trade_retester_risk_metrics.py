"""
  ...
  File       : multimodal_paper_trade_retester_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_paper_trade_retester_risk_metrics'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPaperTradeRetesterRiskMetricsConfig:
...
class MultimodalPaperTradeRetesterEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPaperTradeRetesterRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalPaperTradeRetesterRiskMetricsConfig()
