"""
  ...
  File       : multimodal_paper_trade_retester_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_paper_trade_retester_core_logic'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPaperTradeRetesterCoreLogicConfig:
...
class MultimodalPaperTradeRetesterEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPaperTradeRetesterCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalPaperTradeRetesterCoreLogicConfig()
