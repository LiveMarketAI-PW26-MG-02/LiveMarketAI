"""
  ...
  File       : multimodal_embargo_splitter_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_embargo_splitter_risk_metrics'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalEmbargoSplitterRiskMetricsConfig:
...
class MultimodalEmbargoSplitterEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalEmbargoSplitterRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalEmbargoSplitterRiskMetricsConfig()
