"""
  ...
  ZIP Topic  : ReTest
  Folder     : multimodal_embargo_splitter
  File       : multimodal_embargo_splitter_signal_generator.py
  Purpose    : Re Test — Embargo Splitter
"""
...
MULTIMODAL_MODULE = 'multimodal_embargo_splitter_signal_generator'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalEmbargoSplitterSignalGeneratorConfig:
    """Multimodal multi-horizon config for embargo_splitter."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalEmbargoSplitterEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: re test — embargo splitter.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalEmbargoSplitterSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalEmbargoSplitterSignalGeneratorConfig()
