"""
  ...
  File       : multimodal_embargo_splitter_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_embargo_splitter_data_pipeline'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalEmbargoSplitterDataPipelineConfig:
...
class MultimodalEmbargoSplitterEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalEmbargoSplitterDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalEmbargoSplitterDataPipelineConfig()
