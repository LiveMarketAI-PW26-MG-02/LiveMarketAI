"""
  ...
  File       : multimodal_embargo_splitter_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_embargo_splitter_backtest_runner'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalEmbargoSplitterBacktestRunnerConfig:
...
class MultimodalEmbargoSplitterEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalEmbargoSplitterBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalEmbargoSplitterBacktestRunnerConfig()
