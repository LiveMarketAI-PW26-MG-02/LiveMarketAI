"""
  ...
  File       : multimodal_embargo_splitter_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_embargo_splitter_core_logic'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalEmbargoSplitterCoreLogicConfig:
...
class MultimodalEmbargoSplitterEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalEmbargoSplitterCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalEmbargoSplitterCoreLogicConfig()
