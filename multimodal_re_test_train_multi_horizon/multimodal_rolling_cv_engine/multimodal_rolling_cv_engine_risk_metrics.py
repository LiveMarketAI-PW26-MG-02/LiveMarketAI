"""
  ...
  File       : multimodal_rolling_cv_engine_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_rolling_cv_engine_risk_metrics'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRollingCvEngineRiskMetricsConfig:
...
class MultimodalRollingCvEngineEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRollingCvEngineRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalRollingCvEngineRiskMetricsConfig()
