"""
  ...
  ZIP Topic  : ReTest
  Folder     : multimodal_rolling_cv_engine
  File       : multimodal_rolling_cv_engine_signal_generator.py
  Purpose    : Re Test — Rolling Cv Engine
"""
...
MULTIMODAL_MODULE = 'multimodal_rolling_cv_engine_signal_generator'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRollingCvEngineSignalGeneratorConfig:
    """Multimodal multi-horizon config for rolling_cv_engine."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalRollingCvEngineEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: re test — rolling cv engine.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalRollingCvEngineSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalRollingCvEngineSignalGeneratorConfig()
