"""
  ...
  File       : multimodal_rolling_cv_engine_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_rolling_cv_engine_backtest_runner'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRollingCvEngineBacktestRunnerConfig:
...
class MultimodalRollingCvEngineEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRollingCvEngineBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalRollingCvEngineBacktestRunnerConfig()
