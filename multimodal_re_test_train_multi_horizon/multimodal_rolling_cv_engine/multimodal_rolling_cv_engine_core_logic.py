"""
  ...
  File       : multimodal_rolling_cv_engine_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_rolling_cv_engine_core_logic'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRollingCvEngineCoreLogicConfig:
...
class MultimodalRollingCvEngineEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRollingCvEngineCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalRollingCvEngineCoreLogicConfig()
