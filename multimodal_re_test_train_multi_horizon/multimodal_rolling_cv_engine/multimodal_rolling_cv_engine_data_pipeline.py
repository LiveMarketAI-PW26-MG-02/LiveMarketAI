"""
  ...
  File       : multimodal_rolling_cv_engine_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_rolling_cv_engine_data_pipeline'
TOPIC             = 're_test'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRollingCvEngineDataPipelineConfig:
...
class MultimodalRollingCvEngineEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRollingCvEngineDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalRollingCvEngineDataPipelineConfig()
