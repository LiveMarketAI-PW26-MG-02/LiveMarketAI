"""
  ...
  File       : multimodal_endowment_simulator_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_endowment_simulator_backtest_runner'
TOPIC             = 'longterm_performance'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalEndowmentSimulatorBacktestRunnerConfig:
...
class MultimodalEndowmentSimulatorEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalEndowmentSimulatorBacktestRunnerConfig()
        self.state    : Dict = {}
