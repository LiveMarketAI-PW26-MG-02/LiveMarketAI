"""
  ...
  File       : multimodal_pension_horizon_calc_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_pension_horizon_calc_backtest_runner'
TOPIC             = 'longterm_performance'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalPensionHorizonCalcBacktestRunnerConfig:
...
class MultimodalPensionHorizonCalcEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalPensionHorizonCalcBacktestRunnerConfig()
        self.state    : Dict = {}
