"""
  ...
  File       : multimodal_multi_year_backtest_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_multi_year_backtest_data_pipeline'
TOPIC             = 'longterm_performance'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalMultiYearBacktestDataPipelineConfig:
...
class MultimodalMultiYearBacktestEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalMultiYearBacktestDataPipelineConfig()
        self.state    : Dict = {}
