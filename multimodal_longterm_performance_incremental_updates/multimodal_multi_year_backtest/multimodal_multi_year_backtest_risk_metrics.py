"""
  ...
  File       : multimodal_multi_year_backtest_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_multi_year_backtest_risk_metrics'
TOPIC             = 'longterm_performance'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalMultiYearBacktestRiskMetricsConfig:
...
class MultimodalMultiYearBacktestEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalMultiYearBacktestRiskMetricsConfig()
        self.state    : Dict = {}
