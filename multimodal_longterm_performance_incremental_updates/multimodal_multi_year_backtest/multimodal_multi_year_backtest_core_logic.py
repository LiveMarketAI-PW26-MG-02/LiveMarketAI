"""
  ...
  File       : multimodal_multi_year_backtest_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_multi_year_backtest_core_logic'
TOPIC             = 'longterm_performance'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalMultiYearBacktestCoreLogicConfig:
...
class MultimodalMultiYearBacktestEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalMultiYearBacktestCoreLogicConfig()
        self.state    : Dict = {}
