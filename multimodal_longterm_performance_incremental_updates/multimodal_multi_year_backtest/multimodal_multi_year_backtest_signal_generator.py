"""
  ...
  Folder     : multimodal_multi_year_backtest
  File       : multimodal_multi_year_backtest_signal_generator.py
  Purpose    : Longterm Performance — Multi Year Backtest
"""
...
MULTIMODAL_MODULE = 'multimodal_multi_year_backtest_signal_generator'
TOPIC             = 'longterm_performance'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalMultiYearBacktestSignalGeneratorConfig:
    """Configuration for multimodal multi_year_backtest module."""
...
# ── Core Engine ──────────────────────────────────────────────────────────────
class MultimodalMultiYearBacktestEngine:
    """
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalMultiYearBacktestSignalGeneratorConfig()
        self.state    : Dict = {}
