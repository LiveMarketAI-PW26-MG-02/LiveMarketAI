"""
  ...
  File       : multimodal_multi_year_backtest_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_multi_year_backtest_backtest_runner'
TOPIC             = 'longterm_performance'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalMultiYearBacktestBacktestRunnerConfig:
...
class MultimodalMultiYearBacktestEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalMultiYearBacktestBacktestRunnerConfig()
        self.state    : Dict = {}
