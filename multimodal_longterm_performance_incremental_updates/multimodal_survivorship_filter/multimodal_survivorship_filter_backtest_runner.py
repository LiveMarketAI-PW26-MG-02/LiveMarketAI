"""
  ...
  File       : multimodal_survivorship_filter_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_survivorship_filter_backtest_runner'
TOPIC             = 'longterm_performance'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalSurvivorshipFilterBacktestRunnerConfig:
...
class MultimodalSurvivorshipFilterEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalSurvivorshipFilterBacktestRunnerConfig()
        self.state    : Dict = {}
