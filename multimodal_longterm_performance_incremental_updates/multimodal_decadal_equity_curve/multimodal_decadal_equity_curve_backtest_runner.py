"""
  ...
  File       : multimodal_decadal_equity_curve_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_decadal_equity_curve_backtest_runner'
TOPIC             = 'longterm_performance'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalDecadalEquityCurveBacktestRunnerConfig:
...
class MultimodalDecadalEquityCurveEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalDecadalEquityCurveBacktestRunnerConfig()
        self.state    : Dict = {}
