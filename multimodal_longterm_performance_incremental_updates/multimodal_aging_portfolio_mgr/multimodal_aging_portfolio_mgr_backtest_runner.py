"""
  ...
  File       : multimodal_aging_portfolio_mgr_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_aging_portfolio_mgr_backtest_runner'
TOPIC             = 'longterm_performance'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalAgingPortfolioMgrBacktestRunnerConfig:
...
class MultimodalAgingPortfolioMgrEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalAgingPortfolioMgrBacktestRunnerConfig()
        self.state    : Dict = {}
