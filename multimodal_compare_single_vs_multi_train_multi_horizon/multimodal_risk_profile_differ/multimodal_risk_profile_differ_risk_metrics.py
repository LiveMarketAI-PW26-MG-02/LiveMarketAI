"""
  ...
  File       : multimodal_risk_profile_differ_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_risk_profile_differ_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRiskProfileDifferRiskMetricsConfig:
...
class MultimodalRiskProfileDifferEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRiskProfileDifferRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalRiskProfileDifferRiskMetricsConfig()
