"""
  ...
  File       : multimodal_risk_profile_differ_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_risk_profile_differ_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRiskProfileDifferDataPipelineConfig:
...
class MultimodalRiskProfileDifferEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRiskProfileDifferDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalRiskProfileDifferDataPipelineConfig()
