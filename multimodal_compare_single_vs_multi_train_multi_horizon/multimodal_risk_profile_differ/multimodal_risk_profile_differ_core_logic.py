"""
  ...
  File       : multimodal_risk_profile_differ_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_risk_profile_differ_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRiskProfileDifferCoreLogicConfig:
...
class MultimodalRiskProfileDifferEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRiskProfileDifferCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalRiskProfileDifferCoreLogicConfig()
