"""
  ...
  Folder     : multimodal_risk_profile_differ
  File       : multimodal_risk_profile_differ_signal_generator.py
  Purpose    : Compare Single Vs Multi — Risk Profile Differ
"""
...
MULTIMODAL_MODULE = 'multimodal_risk_profile_differ_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRiskProfileDifferSignalGeneratorConfig:
    """Multimodal multi-horizon config for risk_profile_differ."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalRiskProfileDifferEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: compare single vs multi — risk profile differ.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalRiskProfileDifferSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalRiskProfileDifferSignalGeneratorConfig()
