"""
  ...
  File       : multimodal_risk_profile_differ_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_risk_profile_differ_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRiskProfileDifferBacktestRunnerConfig:
...
class MultimodalRiskProfileDifferEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRiskProfileDifferBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalRiskProfileDifferBacktestRunnerConfig()
