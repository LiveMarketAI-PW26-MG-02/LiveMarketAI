"""
  ...
  Folder     : multimodal_capacity_contrast_tool
  File       : multimodal_capacity_contrast_tool_signal_generator.py
  Purpose    : Compare Single Vs Multi — Capacity Contrast Tool
"""
...
MULTIMODAL_MODULE = 'multimodal_capacity_contrast_tool_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalCapacityContrastToolSignalGeneratorConfig:
    """Multimodal multi-horizon config for capacity_contrast_tool."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalCapacityContrastToolEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: compare single vs multi — capacity contrast tool.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalCapacityContrastToolSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalCapacityContrastToolSignalGeneratorConfig()
