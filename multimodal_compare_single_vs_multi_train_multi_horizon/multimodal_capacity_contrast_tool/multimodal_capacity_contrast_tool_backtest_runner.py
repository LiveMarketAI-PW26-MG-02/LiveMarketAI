"""
  ...
  File       : multimodal_capacity_contrast_tool_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_capacity_contrast_tool_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalCapacityContrastToolBacktestRunnerConfig:
...
class MultimodalCapacityContrastToolEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCapacityContrastToolBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalCapacityContrastToolBacktestRunnerConfig()
