"""
  ...
  File       : multimodal_capacity_contrast_tool_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_capacity_contrast_tool_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalCapacityContrastToolRiskMetricsConfig:
...
class MultimodalCapacityContrastToolEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCapacityContrastToolRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalCapacityContrastToolRiskMetricsConfig()
