"""
  ...
  File       : multimodal_capacity_contrast_tool_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_capacity_contrast_tool_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalCapacityContrastToolDataPipelineConfig:
...
class MultimodalCapacityContrastToolEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCapacityContrastToolDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalCapacityContrastToolDataPipelineConfig()
