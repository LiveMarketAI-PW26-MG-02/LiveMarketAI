"""
  ...
  File       : multimodal_capacity_contrast_tool_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_capacity_contrast_tool_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalCapacityContrastToolCoreLogicConfig:
...
class MultimodalCapacityContrastToolEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCapacityContrastToolCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalCapacityContrastToolCoreLogicConfig()
