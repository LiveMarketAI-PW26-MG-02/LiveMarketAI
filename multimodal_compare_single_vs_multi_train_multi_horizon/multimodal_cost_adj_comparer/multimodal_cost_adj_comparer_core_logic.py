"""
  ...
  File       : multimodal_cost_adj_comparer_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_cost_adj_comparer_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalCostAdjComparerCoreLogicConfig:
...
class MultimodalCostAdjComparerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCostAdjComparerCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalCostAdjComparerCoreLogicConfig()
