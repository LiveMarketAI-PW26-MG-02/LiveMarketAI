"""
  ...
  Folder     : multimodal_cost_adj_comparer
  File       : multimodal_cost_adj_comparer_signal_generator.py
  Purpose    : Compare Single Vs Multi — Cost Adj Comparer
"""
...
MULTIMODAL_MODULE = 'multimodal_cost_adj_comparer_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalCostAdjComparerSignalGeneratorConfig:
    """Multimodal multi-horizon config for cost_adj_comparer."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalCostAdjComparerEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: compare single vs multi — cost adj comparer.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalCostAdjComparerSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalCostAdjComparerSignalGeneratorConfig()
