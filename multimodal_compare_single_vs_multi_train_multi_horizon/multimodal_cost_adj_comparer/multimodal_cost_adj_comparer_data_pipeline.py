"""
  ...
  File       : multimodal_cost_adj_comparer_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_cost_adj_comparer_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalCostAdjComparerDataPipelineConfig:
...
class MultimodalCostAdjComparerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCostAdjComparerDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalCostAdjComparerDataPipelineConfig()
