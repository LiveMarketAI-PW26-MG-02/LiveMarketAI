"""
  ...
  File       : multimodal_cost_adj_comparer_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_cost_adj_comparer_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalCostAdjComparerBacktestRunnerConfig:
...
class MultimodalCostAdjComparerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCostAdjComparerBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalCostAdjComparerBacktestRunnerConfig()
