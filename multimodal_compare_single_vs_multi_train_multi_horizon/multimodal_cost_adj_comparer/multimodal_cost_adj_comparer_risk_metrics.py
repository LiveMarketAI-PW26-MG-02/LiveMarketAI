"""
  ...
  File       : multimodal_cost_adj_comparer_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_cost_adj_comparer_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalCostAdjComparerRiskMetricsConfig:
...
class MultimodalCostAdjComparerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCostAdjComparerRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalCostAdjComparerRiskMetricsConfig()
