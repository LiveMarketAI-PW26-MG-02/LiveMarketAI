"""
  ...
  File       : multimodal_oos_gap_analyser_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_oos_gap_analyser_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalOosGapAnalyserCoreLogicConfig:
...
class MultimodalOosGapAnalyserEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalOosGapAnalyserCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalOosGapAnalyserCoreLogicConfig()
