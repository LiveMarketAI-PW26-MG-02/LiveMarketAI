"""
  ...
  File       : multimodal_oos_gap_analyser_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_oos_gap_analyser_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalOosGapAnalyserDataPipelineConfig:
...
class MultimodalOosGapAnalyserEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalOosGapAnalyserDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalOosGapAnalyserDataPipelineConfig()
