"""
  ...
  File       : multimodal_oos_gap_analyser_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_oos_gap_analyser_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalOosGapAnalyserRiskMetricsConfig:
...
class MultimodalOosGapAnalyserEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalOosGapAnalyserRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalOosGapAnalyserRiskMetricsConfig()
