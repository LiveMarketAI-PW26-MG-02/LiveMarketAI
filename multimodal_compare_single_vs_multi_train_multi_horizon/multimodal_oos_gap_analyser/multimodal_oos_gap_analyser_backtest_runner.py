"""
  ...
  File       : multimodal_oos_gap_analyser_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_oos_gap_analyser_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalOosGapAnalyserBacktestRunnerConfig:
...
class MultimodalOosGapAnalyserEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalOosGapAnalyserBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalOosGapAnalyserBacktestRunnerConfig()
