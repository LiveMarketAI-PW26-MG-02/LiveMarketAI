"""
  ...
  Folder     : multimodal_oos_gap_analyser
  File       : multimodal_oos_gap_analyser_signal_generator.py
  Purpose    : Compare Single Vs Multi — Oos Gap Analyser
"""
...
MULTIMODAL_MODULE = 'multimodal_oos_gap_analyser_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalOosGapAnalyserSignalGeneratorConfig:
    """Multimodal multi-horizon config for oos_gap_analyser."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalOosGapAnalyserEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: compare single vs multi — oos gap analyser.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalOosGapAnalyserSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalOosGapAnalyserSignalGeneratorConfig()
