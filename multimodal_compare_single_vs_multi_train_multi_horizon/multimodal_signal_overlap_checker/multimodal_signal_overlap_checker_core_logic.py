"""
  ...
  File       : multimodal_signal_overlap_checker_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_signal_overlap_checker_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalSignalOverlapCheckerCoreLogicConfig:
...
class MultimodalSignalOverlapCheckerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSignalOverlapCheckerCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalSignalOverlapCheckerCoreLogicConfig()
