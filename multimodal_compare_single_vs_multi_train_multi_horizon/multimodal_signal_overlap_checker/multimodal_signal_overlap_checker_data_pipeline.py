"""
  ...
  File       : multimodal_signal_overlap_checker_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_signal_overlap_checker_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalSignalOverlapCheckerDataPipelineConfig:
...
class MultimodalSignalOverlapCheckerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSignalOverlapCheckerDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalSignalOverlapCheckerDataPipelineConfig()
