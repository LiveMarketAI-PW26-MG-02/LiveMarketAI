"""
  ...
  File       : multimodal_signal_overlap_checker_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_signal_overlap_checker_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalSignalOverlapCheckerRiskMetricsConfig:
...
class MultimodalSignalOverlapCheckerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSignalOverlapCheckerRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalSignalOverlapCheckerRiskMetricsConfig()
