"""
  ...
  Folder     : multimodal_signal_overlap_checker
  File       : multimodal_signal_overlap_checker_signal_generator.py
  Purpose    : Compare Single Vs Multi — Signal Overlap Checker
"""
...
MULTIMODAL_MODULE = 'multimodal_signal_overlap_checker_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalSignalOverlapCheckerSignalGeneratorConfig:
    """Multimodal multi-horizon config for signal_overlap_checker."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalSignalOverlapCheckerEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: compare single vs multi — signal overlap checker.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalSignalOverlapCheckerSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalSignalOverlapCheckerSignalGeneratorConfig()
