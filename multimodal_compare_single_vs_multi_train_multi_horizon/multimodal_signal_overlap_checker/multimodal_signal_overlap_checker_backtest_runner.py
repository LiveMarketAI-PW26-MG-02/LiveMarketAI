"""
  ...
  File       : multimodal_signal_overlap_checker_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_signal_overlap_checker_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalSignalOverlapCheckerBacktestRunnerConfig:
...
class MultimodalSignalOverlapCheckerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSignalOverlapCheckerBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalSignalOverlapCheckerBacktestRunnerConfig()
