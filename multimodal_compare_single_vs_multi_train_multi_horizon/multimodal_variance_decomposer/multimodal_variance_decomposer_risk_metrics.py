"""
  ...
  File       : multimodal_variance_decomposer_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_variance_decomposer_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalVarianceDecomposerRiskMetricsConfig:
...
class MultimodalVarianceDecomposerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalVarianceDecomposerRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalVarianceDecomposerRiskMetricsConfig()
