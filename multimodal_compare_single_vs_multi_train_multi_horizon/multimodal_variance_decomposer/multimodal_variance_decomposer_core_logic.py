"""
  ...
  File       : multimodal_variance_decomposer_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_variance_decomposer_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalVarianceDecomposerCoreLogicConfig:
...
class MultimodalVarianceDecomposerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalVarianceDecomposerCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalVarianceDecomposerCoreLogicConfig()
