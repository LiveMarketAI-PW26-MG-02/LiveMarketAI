"""
  ...
  File       : multimodal_variance_decomposer_signal_generator.py
...
MULTIMODAL_MODULE = 'multimodal_variance_decomposer_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalVarianceDecomposerSignalGeneratorConfig:
...
class MultimodalVarianceDecomposerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalVarianceDecomposerSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalVarianceDecomposerSignalGeneratorConfig()
