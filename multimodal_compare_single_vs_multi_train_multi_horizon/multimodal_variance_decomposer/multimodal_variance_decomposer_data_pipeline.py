"""
  ...
  File       : multimodal_variance_decomposer_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_variance_decomposer_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalVarianceDecomposerDataPipelineConfig:
...
class MultimodalVarianceDecomposerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalVarianceDecomposerDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalVarianceDecomposerDataPipelineConfig()
