"""
  ...
  File       : multimodal_regime_split_comparator_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_regime_split_comparator_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeSplitComparatorCoreLogicConfig:
...
class MultimodalRegimeSplitComparatorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegimeSplitComparatorCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalRegimeSplitComparatorCoreLogicConfig()
