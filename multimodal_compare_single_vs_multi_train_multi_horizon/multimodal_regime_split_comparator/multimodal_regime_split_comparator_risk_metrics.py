"""
  ...
  File       : multimodal_regime_split_comparator_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_regime_split_comparator_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeSplitComparatorRiskMetricsConfig:
...
class MultimodalRegimeSplitComparatorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegimeSplitComparatorRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalRegimeSplitComparatorRiskMetricsConfig()
