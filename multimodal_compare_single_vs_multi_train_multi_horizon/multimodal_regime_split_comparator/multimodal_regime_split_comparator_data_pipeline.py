"""
  ...
  File       : multimodal_regime_split_comparator_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_regime_split_comparator_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeSplitComparatorDataPipelineConfig:
...
class MultimodalRegimeSplitComparatorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegimeSplitComparatorDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalRegimeSplitComparatorDataPipelineConfig()
