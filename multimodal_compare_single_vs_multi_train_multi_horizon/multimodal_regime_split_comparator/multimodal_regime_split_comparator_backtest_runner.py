"""
  ...
  File       : multimodal_regime_split_comparator_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_regime_split_comparator_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeSplitComparatorBacktestRunnerConfig:
...
class MultimodalRegimeSplitComparatorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegimeSplitComparatorBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalRegimeSplitComparatorBacktestRunnerConfig()
