"""
  ...
  Folder     : multimodal_regime_split_comparator
  File       : multimodal_regime_split_comparator_signal_generator.py
  Purpose    : Compare Single Vs Multi — Regime Split Comparator
"""
...
MULTIMODAL_MODULE = 'multimodal_regime_split_comparator_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeSplitComparatorSignalGeneratorConfig:
    """Multimodal multi-horizon config for regime_split_comparator."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalRegimeSplitComparatorEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: compare single vs multi — regime split comparator.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalRegimeSplitComparatorSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalRegimeSplitComparatorSignalGeneratorConfig()
