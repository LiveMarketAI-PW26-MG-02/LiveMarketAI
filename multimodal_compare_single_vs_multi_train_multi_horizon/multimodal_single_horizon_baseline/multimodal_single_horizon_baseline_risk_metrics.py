"""
  ...
  File       : multimodal_single_horizon_baseline_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_single_horizon_baseline_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalSingleHorizonBaselineRiskMetricsConfig:
...
class MultimodalSingleHorizonBaselineEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSingleHorizonBaselineRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalSingleHorizonBaselineRiskMetricsConfig()
