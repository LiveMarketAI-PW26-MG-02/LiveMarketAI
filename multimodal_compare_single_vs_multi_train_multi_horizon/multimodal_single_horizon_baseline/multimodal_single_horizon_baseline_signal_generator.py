"""
  ...
  Folder     : multimodal_single_horizon_baseline
  File       : multimodal_single_horizon_baseline_signal_generator.py
  Purpose    : Compare Single Vs Multi — Single Horizon Baseline
"""
...
MULTIMODAL_MODULE = 'multimodal_single_horizon_baseline_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalSingleHorizonBaselineSignalGeneratorConfig:
    """Multimodal multi-horizon config for single_horizon_baseline."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalSingleHorizonBaselineEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: compare single vs multi — single horizon baseline.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalSingleHorizonBaselineSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalSingleHorizonBaselineSignalGeneratorConfig()
