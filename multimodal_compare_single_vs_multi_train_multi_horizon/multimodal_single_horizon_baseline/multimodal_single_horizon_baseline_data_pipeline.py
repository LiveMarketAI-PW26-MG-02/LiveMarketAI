"""
  ...
  File       : multimodal_single_horizon_baseline_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_single_horizon_baseline_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalSingleHorizonBaselineDataPipelineConfig:
...
class MultimodalSingleHorizonBaselineEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSingleHorizonBaselineDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalSingleHorizonBaselineDataPipelineConfig()
