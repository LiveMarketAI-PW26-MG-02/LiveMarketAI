"""
  ...
  File       : multimodal_single_horizon_baseline_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_single_horizon_baseline_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalSingleHorizonBaselineCoreLogicConfig:
...
class MultimodalSingleHorizonBaselineEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSingleHorizonBaselineCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalSingleHorizonBaselineCoreLogicConfig()
