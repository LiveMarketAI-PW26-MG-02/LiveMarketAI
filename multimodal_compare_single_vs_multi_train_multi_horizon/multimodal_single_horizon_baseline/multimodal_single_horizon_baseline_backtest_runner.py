"""
  ...
  File       : multimodal_single_horizon_baseline_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_single_horizon_baseline_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalSingleHorizonBaselineBacktestRunnerConfig:
...
class MultimodalSingleHorizonBaselineEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSingleHorizonBaselineBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalSingleHorizonBaselineBacktestRunnerConfig()
