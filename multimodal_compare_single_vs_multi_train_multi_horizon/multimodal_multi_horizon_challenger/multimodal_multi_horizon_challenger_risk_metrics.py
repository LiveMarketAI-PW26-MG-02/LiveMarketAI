"""
  ...
  File       : multimodal_multi_horizon_challenger_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_multi_horizon_challenger_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalMultiHorizonChallengerRiskMetricsConfig:
...
class MultimodalMultiHorizonChallengerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMultiHorizonChallengerRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalMultiHorizonChallengerRiskMetricsConfig()
