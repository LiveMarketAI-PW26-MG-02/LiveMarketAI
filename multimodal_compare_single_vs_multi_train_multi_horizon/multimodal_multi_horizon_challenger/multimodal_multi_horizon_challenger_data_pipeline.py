"""
  ...
  File       : multimodal_multi_horizon_challenger_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_multi_horizon_challenger_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalMultiHorizonChallengerDataPipelineConfig:
...
class MultimodalMultiHorizonChallengerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMultiHorizonChallengerDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalMultiHorizonChallengerDataPipelineConfig()
