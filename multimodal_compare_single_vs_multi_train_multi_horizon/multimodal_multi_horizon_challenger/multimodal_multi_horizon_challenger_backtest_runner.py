"""
  ...
  File       : multimodal_multi_horizon_challenger_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_multi_horizon_challenger_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalMultiHorizonChallengerBacktestRunnerConfig:
...
class MultimodalMultiHorizonChallengerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMultiHorizonChallengerBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalMultiHorizonChallengerBacktestRunnerConfig()
