"""
  ...
  File       : multimodal_multi_horizon_challenger_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_multi_horizon_challenger_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalMultiHorizonChallengerCoreLogicConfig:
...
class MultimodalMultiHorizonChallengerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMultiHorizonChallengerCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalMultiHorizonChallengerCoreLogicConfig()
