"""
  ...
  Folder     : multimodal_multi_horizon_challenger
  File       : multimodal_multi_horizon_challenger_signal_generator.py
  Purpose    : Compare Single Vs Multi — Multi Horizon Challenger
"""
...
MULTIMODAL_MODULE = 'multimodal_multi_horizon_challenger_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalMultiHorizonChallengerSignalGeneratorConfig:
    """Multimodal multi-horizon config for multi_horizon_challenger."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalMultiHorizonChallengerEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: compare single vs multi — multi horizon challenger.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalMultiHorizonChallengerSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalMultiHorizonChallengerSignalGeneratorConfig()
