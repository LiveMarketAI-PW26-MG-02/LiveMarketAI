"""
  ...
  File       : multimodal_bias_diff_inspector_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_bias_diff_inspector_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalBiasDiffInspectorCoreLogicConfig:
...
class MultimodalBiasDiffInspectorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalBiasDiffInspectorCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalBiasDiffInspectorCoreLogicConfig()
