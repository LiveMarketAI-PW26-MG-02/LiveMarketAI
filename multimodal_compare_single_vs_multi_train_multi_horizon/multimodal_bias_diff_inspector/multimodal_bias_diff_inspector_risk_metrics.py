"""
  ...
  File       : multimodal_bias_diff_inspector_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_bias_diff_inspector_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalBiasDiffInspectorRiskMetricsConfig:
...
class MultimodalBiasDiffInspectorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalBiasDiffInspectorRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalBiasDiffInspectorRiskMetricsConfig()
