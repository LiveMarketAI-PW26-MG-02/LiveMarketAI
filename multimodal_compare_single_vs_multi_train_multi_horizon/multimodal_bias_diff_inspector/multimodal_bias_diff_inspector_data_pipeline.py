"""
  ...
  File       : multimodal_bias_diff_inspector_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_bias_diff_inspector_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalBiasDiffInspectorDataPipelineConfig:
...
class MultimodalBiasDiffInspectorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalBiasDiffInspectorDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalBiasDiffInspectorDataPipelineConfig()
