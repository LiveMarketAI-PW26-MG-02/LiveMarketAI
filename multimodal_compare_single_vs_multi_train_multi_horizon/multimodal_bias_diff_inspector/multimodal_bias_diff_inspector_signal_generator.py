"""
  ...
  Folder     : multimodal_bias_diff_inspector
  File       : multimodal_bias_diff_inspector_signal_generator.py
  Purpose    : Compare Single Vs Multi — Bias Diff Inspector
"""
...
MULTIMODAL_MODULE = 'multimodal_bias_diff_inspector_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalBiasDiffInspectorSignalGeneratorConfig:
    """Multimodal multi-horizon config for bias_diff_inspector."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalBiasDiffInspectorEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: compare single vs multi — bias diff inspector.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalBiasDiffInspectorSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalBiasDiffInspectorSignalGeneratorConfig()
