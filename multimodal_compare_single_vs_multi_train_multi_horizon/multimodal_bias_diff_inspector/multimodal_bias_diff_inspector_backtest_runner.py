"""
  ...
  File       : multimodal_bias_diff_inspector_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_bias_diff_inspector_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalBiasDiffInspectorBacktestRunnerConfig:
...
class MultimodalBiasDiffInspectorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalBiasDiffInspectorBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalBiasDiffInspectorBacktestRunnerConfig()
