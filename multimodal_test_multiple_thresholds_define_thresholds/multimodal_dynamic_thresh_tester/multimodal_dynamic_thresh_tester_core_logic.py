"""
  ...
  File       : multimodal_dynamic_thresh_tester_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_dynamic_thresh_tester_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalDynamicThreshTesterCoreLogicConfig:
...
class MultimodalDynamicThreshTesterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDynamicThreshTesterCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalDynamicThreshTesterCoreLogicConfig()
