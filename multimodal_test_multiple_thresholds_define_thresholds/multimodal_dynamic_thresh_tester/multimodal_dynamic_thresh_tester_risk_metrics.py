"""
  ...
  File       : multimodal_dynamic_thresh_tester_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_dynamic_thresh_tester_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalDynamicThreshTesterRiskMetricsConfig:
...
class MultimodalDynamicThreshTesterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDynamicThreshTesterRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalDynamicThreshTesterRiskMetricsConfig()
