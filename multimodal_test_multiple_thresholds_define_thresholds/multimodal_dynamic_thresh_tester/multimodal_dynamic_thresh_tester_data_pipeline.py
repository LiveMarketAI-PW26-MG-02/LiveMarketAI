"""
  ...
  File       : multimodal_dynamic_thresh_tester_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_dynamic_thresh_tester_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalDynamicThreshTesterDataPipelineConfig:
...
class MultimodalDynamicThreshTesterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDynamicThreshTesterDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalDynamicThreshTesterDataPipelineConfig()
