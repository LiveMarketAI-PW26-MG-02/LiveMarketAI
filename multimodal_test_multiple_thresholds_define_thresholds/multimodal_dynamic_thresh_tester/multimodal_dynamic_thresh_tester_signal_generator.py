"""
  ...
  Folder     : multimodal_dynamic_thresh_tester
  File       : multimodal_dynamic_thresh_tester_signal_generator.py
  Purpose    : Test Multiple Thresholds — Dynamic Thresh Tester
"""
...
MULTIMODAL_MODULE = 'multimodal_dynamic_thresh_tester_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalDynamicThreshTesterSignalGeneratorConfig:
    """Multimodal threshold-sweep config for dynamic_thresh_tester."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalDynamicThreshTesterEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: test multiple thresholds — dynamic thresh tester.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalDynamicThreshTesterSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalDynamicThreshTesterSignalGeneratorConfig()
