"""
  ...
  File       : multimodal_dynamic_thresh_tester_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_dynamic_thresh_tester_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalDynamicThreshTesterBacktestRunnerConfig:
...
class MultimodalDynamicThreshTesterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDynamicThreshTesterBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalDynamicThreshTesterBacktestRunnerConfig()
