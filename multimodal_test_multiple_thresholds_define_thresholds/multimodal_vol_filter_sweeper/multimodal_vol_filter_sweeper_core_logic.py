"""
  ...
  File       : multimodal_vol_filter_sweeper_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_vol_filter_sweeper_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalVolFilterSweeperCoreLogicConfig:
...
class MultimodalVolFilterSweeperEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalVolFilterSweeperCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalVolFilterSweeperCoreLogicConfig()
