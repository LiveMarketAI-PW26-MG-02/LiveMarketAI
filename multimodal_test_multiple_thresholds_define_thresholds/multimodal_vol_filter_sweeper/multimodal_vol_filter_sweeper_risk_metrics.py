"""
  ...
  File       : multimodal_vol_filter_sweeper_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_vol_filter_sweeper_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalVolFilterSweeperRiskMetricsConfig:
...
class MultimodalVolFilterSweeperEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalVolFilterSweeperRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalVolFilterSweeperRiskMetricsConfig()
