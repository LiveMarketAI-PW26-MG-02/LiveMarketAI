"""
  ...
  File       : multimodal_vol_filter_sweeper_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_vol_filter_sweeper_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalVolFilterSweeperDataPipelineConfig:
...
class MultimodalVolFilterSweeperEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalVolFilterSweeperDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalVolFilterSweeperDataPipelineConfig()
