"""
  ...
  Folder     : multimodal_vol_filter_sweeper
  File       : multimodal_vol_filter_sweeper_signal_generator.py
  Purpose    : Test Multiple Thresholds — Vol Filter Sweeper
"""
...
MULTIMODAL_MODULE = 'multimodal_vol_filter_sweeper_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalVolFilterSweeperSignalGeneratorConfig:
    """Multimodal threshold-sweep config for vol_filter_sweeper."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalVolFilterSweeperEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: test multiple thresholds — vol filter sweeper.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalVolFilterSweeperSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalVolFilterSweeperSignalGeneratorConfig()
