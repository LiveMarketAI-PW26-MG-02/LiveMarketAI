"""
  ...
  File       : multimodal_vol_filter_sweeper_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_vol_filter_sweeper_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalVolFilterSweeperBacktestRunnerConfig:
...
class MultimodalVolFilterSweeperEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalVolFilterSweeperBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalVolFilterSweeperBacktestRunnerConfig()
