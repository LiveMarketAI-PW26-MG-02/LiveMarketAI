"""
  ...
  File       : multimodal_exit_sweep_tester_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_exit_sweep_tester_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalExitSweepTesterCoreLogicConfig:
...
class MultimodalExitSweepTesterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalExitSweepTesterCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalExitSweepTesterCoreLogicConfig()
