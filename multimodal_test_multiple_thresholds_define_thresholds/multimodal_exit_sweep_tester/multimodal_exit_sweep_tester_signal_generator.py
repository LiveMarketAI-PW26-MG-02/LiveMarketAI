"""
  ...
  Folder     : multimodal_exit_sweep_tester
  File       : multimodal_exit_sweep_tester_signal_generator.py
  Purpose    : Test Multiple Thresholds — Exit Sweep Tester
"""
...
MULTIMODAL_MODULE = 'multimodal_exit_sweep_tester_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalExitSweepTesterSignalGeneratorConfig:
    """Multimodal threshold-sweep config for exit_sweep_tester."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalExitSweepTesterEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: test multiple thresholds — exit sweep tester.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalExitSweepTesterSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalExitSweepTesterSignalGeneratorConfig()
