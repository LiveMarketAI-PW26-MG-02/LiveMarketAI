"""
  ...
  File       : multimodal_exit_sweep_tester_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_exit_sweep_tester_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalExitSweepTesterBacktestRunnerConfig:
...
class MultimodalExitSweepTesterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalExitSweepTesterBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalExitSweepTesterBacktestRunnerConfig()
