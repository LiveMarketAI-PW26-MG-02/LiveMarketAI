"""
  ...
  File       : multimodal_exit_sweep_tester_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_exit_sweep_tester_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalExitSweepTesterDataPipelineConfig:
...
class MultimodalExitSweepTesterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalExitSweepTesterDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalExitSweepTesterDataPipelineConfig()
