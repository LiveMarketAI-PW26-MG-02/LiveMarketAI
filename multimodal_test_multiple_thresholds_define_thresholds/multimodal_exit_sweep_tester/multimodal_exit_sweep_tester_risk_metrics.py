"""
  ...
  File       : multimodal_exit_sweep_tester_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_exit_sweep_tester_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalExitSweepTesterRiskMetricsConfig:
...
class MultimodalExitSweepTesterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalExitSweepTesterRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalExitSweepTesterRiskMetricsConfig()
