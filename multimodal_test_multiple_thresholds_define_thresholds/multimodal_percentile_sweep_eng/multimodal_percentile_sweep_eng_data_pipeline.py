"""
  ...
  File       : multimodal_percentile_sweep_eng_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_percentile_sweep_eng_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalPercentileSweepEngDataPipelineConfig:
...
class MultimodalPercentileSweepEngEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPercentileSweepEngDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalPercentileSweepEngDataPipelineConfig()
