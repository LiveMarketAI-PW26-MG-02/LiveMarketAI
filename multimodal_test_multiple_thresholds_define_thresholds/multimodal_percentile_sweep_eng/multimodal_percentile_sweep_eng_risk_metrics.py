"""
  ...
  File       : multimodal_percentile_sweep_eng_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_percentile_sweep_eng_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalPercentileSweepEngRiskMetricsConfig:
...
class MultimodalPercentileSweepEngEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPercentileSweepEngRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalPercentileSweepEngRiskMetricsConfig()
