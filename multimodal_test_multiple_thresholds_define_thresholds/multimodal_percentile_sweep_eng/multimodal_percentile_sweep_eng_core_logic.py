"""
  ...
  File       : multimodal_percentile_sweep_eng_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_percentile_sweep_eng_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalPercentileSweepEngCoreLogicConfig:
...
class MultimodalPercentileSweepEngEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPercentileSweepEngCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalPercentileSweepEngCoreLogicConfig()
