"""
  ...
  File       : multimodal_percentile_sweep_eng_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_percentile_sweep_eng_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalPercentileSweepEngBacktestRunnerConfig:
...
class MultimodalPercentileSweepEngEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPercentileSweepEngBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalPercentileSweepEngBacktestRunnerConfig()
