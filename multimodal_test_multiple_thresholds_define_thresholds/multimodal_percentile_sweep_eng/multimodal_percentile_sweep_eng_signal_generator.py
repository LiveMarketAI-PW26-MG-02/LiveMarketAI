"""
  ...
  Folder     : multimodal_percentile_sweep_eng
  File       : multimodal_percentile_sweep_eng_signal_generator.py
  Purpose    : Test Multiple Thresholds — Percentile Sweep Eng
"""
...
MULTIMODAL_MODULE = 'multimodal_percentile_sweep_eng_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalPercentileSweepEngSignalGeneratorConfig:
    """Multimodal threshold-sweep config for percentile_sweep_eng."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalPercentileSweepEngEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: test multiple thresholds — percentile sweep eng.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalPercentileSweepEngSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalPercentileSweepEngSignalGeneratorConfig()
