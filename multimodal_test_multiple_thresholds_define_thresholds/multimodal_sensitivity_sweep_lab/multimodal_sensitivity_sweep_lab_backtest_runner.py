"""
  ...
  File       : multimodal_sensitivity_sweep_lab_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_sensitivity_sweep_lab_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSensitivitySweepLabBacktestRunnerConfig:
...
class MultimodalSensitivitySweepLabEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSensitivitySweepLabBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalSensitivitySweepLabBacktestRunnerConfig()
