"""
  ...
  File       : multimodal_sensitivity_sweep_lab_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_sensitivity_sweep_lab_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSensitivitySweepLabRiskMetricsConfig:
...
class MultimodalSensitivitySweepLabEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSensitivitySweepLabRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalSensitivitySweepLabRiskMetricsConfig()
