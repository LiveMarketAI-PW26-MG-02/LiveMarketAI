"""
  ...
  File       : multimodal_sensitivity_sweep_lab_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_sensitivity_sweep_lab_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSensitivitySweepLabDataPipelineConfig:
...
class MultimodalSensitivitySweepLabEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSensitivitySweepLabDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalSensitivitySweepLabDataPipelineConfig()
