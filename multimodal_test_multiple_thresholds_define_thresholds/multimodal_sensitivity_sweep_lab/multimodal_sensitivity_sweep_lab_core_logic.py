"""
  ...
  File       : multimodal_sensitivity_sweep_lab_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_sensitivity_sweep_lab_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSensitivitySweepLabCoreLogicConfig:
...
class MultimodalSensitivitySweepLabEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSensitivitySweepLabCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalSensitivitySweepLabCoreLogicConfig()
