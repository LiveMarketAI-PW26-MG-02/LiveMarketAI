"""
  ...
  File       : multimodal_threshold_grid_runner_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_threshold_grid_runner_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalThresholdGridRunnerDataPipelineConfig:
...
class MultimodalThresholdGridRunnerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalThresholdGridRunnerDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalThresholdGridRunnerDataPipelineConfig()
