"""
  ...
  File       : multimodal_threshold_grid_runner_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_threshold_grid_runner_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalThresholdGridRunnerCoreLogicConfig:
...
class MultimodalThresholdGridRunnerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalThresholdGridRunnerCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalThresholdGridRunnerCoreLogicConfig()
