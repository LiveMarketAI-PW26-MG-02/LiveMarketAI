"""
  ...
  Folder     : multimodal_threshold_grid_runner
  File       : multimodal_threshold_grid_runner_signal_generator.py
  Purpose    : Test Multiple Thresholds — Threshold Grid Runner
"""
...
MULTIMODAL_MODULE = 'multimodal_threshold_grid_runner_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalThresholdGridRunnerSignalGeneratorConfig:
    """Multimodal threshold-sweep config for threshold_grid_runner."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalThresholdGridRunnerEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: test multiple thresholds — threshold grid runner.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalThresholdGridRunnerSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalThresholdGridRunnerSignalGeneratorConfig()
