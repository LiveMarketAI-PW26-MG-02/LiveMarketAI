"""
  ...
  File       : multimodal_threshold_grid_runner_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_threshold_grid_runner_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalThresholdGridRunnerBacktestRunnerConfig:
...
class MultimodalThresholdGridRunnerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalThresholdGridRunnerBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalThresholdGridRunnerBacktestRunnerConfig()
