"""
  ...
  File       : multimodal_threshold_grid_runner_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_threshold_grid_runner_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalThresholdGridRunnerRiskMetricsConfig:
...
class MultimodalThresholdGridRunnerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalThresholdGridRunnerRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalThresholdGridRunnerRiskMetricsConfig()
