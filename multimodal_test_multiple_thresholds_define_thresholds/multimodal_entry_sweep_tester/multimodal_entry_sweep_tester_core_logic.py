"""
  ...
  File       : multimodal_entry_sweep_tester_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_entry_sweep_tester_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalEntrySweepTesterCoreLogicConfig:
...
class MultimodalEntrySweepTesterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalEntrySweepTesterCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalEntrySweepTesterCoreLogicConfig()
