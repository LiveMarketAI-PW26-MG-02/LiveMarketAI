"""
  ...
  File       : multimodal_entry_sweep_tester_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_entry_sweep_tester_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalEntrySweepTesterDataPipelineConfig:
...
class MultimodalEntrySweepTesterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalEntrySweepTesterDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalEntrySweepTesterDataPipelineConfig()
