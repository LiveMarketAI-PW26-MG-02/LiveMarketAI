"""
  ...
  File       : multimodal_entry_sweep_tester_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_entry_sweep_tester_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalEntrySweepTesterRiskMetricsConfig:
...
class MultimodalEntrySweepTesterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalEntrySweepTesterRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalEntrySweepTesterRiskMetricsConfig()
