"""
  ...
  Folder     : multimodal_entry_sweep_tester
  File       : multimodal_entry_sweep_tester_signal_generator.py
  Purpose    : Test Multiple Thresholds — Entry Sweep Tester
"""
...
MULTIMODAL_MODULE = 'multimodal_entry_sweep_tester_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalEntrySweepTesterSignalGeneratorConfig:
    """Multimodal threshold-sweep config for entry_sweep_tester."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalEntrySweepTesterEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: test multiple thresholds — entry sweep tester.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalEntrySweepTesterSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalEntrySweepTesterSignalGeneratorConfig()
