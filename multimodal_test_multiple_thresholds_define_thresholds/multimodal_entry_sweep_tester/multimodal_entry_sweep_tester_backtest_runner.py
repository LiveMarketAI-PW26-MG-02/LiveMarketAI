"""
  ...
  File       : multimodal_entry_sweep_tester_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_entry_sweep_tester_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalEntrySweepTesterBacktestRunnerConfig:
...
class MultimodalEntrySweepTesterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalEntrySweepTesterBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalEntrySweepTesterBacktestRunnerConfig()
