"""
  ...
  Folder     : multimodal_adaptive_cut_runner
  File       : multimodal_adaptive_cut_runner_signal_generator.py
  Purpose    : Test Multiple Thresholds — Adaptive Cut Runner
"""
...
MULTIMODAL_MODULE = 'multimodal_adaptive_cut_runner_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalAdaptiveCutRunnerSignalGeneratorConfig:
    """Multimodal threshold-sweep config for adaptive_cut_runner."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalAdaptiveCutRunnerEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: test multiple thresholds — adaptive cut runner.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalAdaptiveCutRunnerSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalAdaptiveCutRunnerSignalGeneratorConfig()
