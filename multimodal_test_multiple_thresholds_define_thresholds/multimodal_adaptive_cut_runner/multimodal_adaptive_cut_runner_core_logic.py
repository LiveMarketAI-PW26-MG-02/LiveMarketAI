"""
  ...
  File       : multimodal_adaptive_cut_runner_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_adaptive_cut_runner_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalAdaptiveCutRunnerCoreLogicConfig:
...
class MultimodalAdaptiveCutRunnerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalAdaptiveCutRunnerCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalAdaptiveCutRunnerCoreLogicConfig()
