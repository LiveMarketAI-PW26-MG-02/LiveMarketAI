"""
  ...
  File       : multimodal_adaptive_cut_runner_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_adaptive_cut_runner_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalAdaptiveCutRunnerBacktestRunnerConfig:
...
class MultimodalAdaptiveCutRunnerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalAdaptiveCutRunnerBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalAdaptiveCutRunnerBacktestRunnerConfig()
