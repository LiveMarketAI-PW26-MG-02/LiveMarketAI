"""
  ...
  File       : multimodal_adaptive_cut_runner_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_adaptive_cut_runner_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalAdaptiveCutRunnerRiskMetricsConfig:
...
class MultimodalAdaptiveCutRunnerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalAdaptiveCutRunnerRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalAdaptiveCutRunnerRiskMetricsConfig()
