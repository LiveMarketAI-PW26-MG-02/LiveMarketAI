"""
  ...
  File       : multimodal_adaptive_cut_runner_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_adaptive_cut_runner_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalAdaptiveCutRunnerDataPipelineConfig:
...
class MultimodalAdaptiveCutRunnerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalAdaptiveCutRunnerDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalAdaptiveCutRunnerDataPipelineConfig()
