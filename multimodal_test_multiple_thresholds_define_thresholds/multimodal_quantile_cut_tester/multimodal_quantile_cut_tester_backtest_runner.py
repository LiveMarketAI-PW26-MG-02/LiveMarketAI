"""
  ...
  File       : multimodal_quantile_cut_tester_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_quantile_cut_tester_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalQuantileCutTesterBacktestRunnerConfig:
...
class MultimodalQuantileCutTesterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalQuantileCutTesterBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalQuantileCutTesterBacktestRunnerConfig()
