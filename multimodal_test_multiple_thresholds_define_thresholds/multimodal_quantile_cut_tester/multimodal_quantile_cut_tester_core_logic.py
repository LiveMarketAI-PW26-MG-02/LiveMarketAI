"""
  ...
  File       : multimodal_quantile_cut_tester_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_quantile_cut_tester_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalQuantileCutTesterCoreLogicConfig:
...
class MultimodalQuantileCutTesterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalQuantileCutTesterCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalQuantileCutTesterCoreLogicConfig()
