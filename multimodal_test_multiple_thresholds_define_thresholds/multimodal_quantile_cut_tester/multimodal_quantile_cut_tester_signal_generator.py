"""
  ...
  Folder     : multimodal_quantile_cut_tester
  File       : multimodal_quantile_cut_tester_signal_generator.py
  Purpose    : Test Multiple Thresholds — Quantile Cut Tester
"""
...
MULTIMODAL_MODULE = 'multimodal_quantile_cut_tester_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalQuantileCutTesterSignalGeneratorConfig:
    """Multimodal threshold-sweep config for quantile_cut_tester."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalQuantileCutTesterEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: test multiple thresholds — quantile cut tester.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalQuantileCutTesterSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalQuantileCutTesterSignalGeneratorConfig()
