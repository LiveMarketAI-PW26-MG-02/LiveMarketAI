"""
  ...
  File       : multimodal_quantile_cut_tester_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_quantile_cut_tester_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalQuantileCutTesterDataPipelineConfig:
...
class MultimodalQuantileCutTesterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalQuantileCutTesterDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalQuantileCutTesterDataPipelineConfig()
