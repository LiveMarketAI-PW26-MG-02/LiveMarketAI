"""
  ...
  File       : multimodal_quantile_cut_tester_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_quantile_cut_tester_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalQuantileCutTesterRiskMetricsConfig:
...
class MultimodalQuantileCutTesterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalQuantileCutTesterRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalQuantileCutTesterRiskMetricsConfig()
