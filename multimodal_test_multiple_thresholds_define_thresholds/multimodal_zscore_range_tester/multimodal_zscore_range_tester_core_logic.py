"""
  ...
  File       : multimodal_zscore_range_tester_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_zscore_range_tester_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalZscoreRangeTesterCoreLogicConfig:
...
class MultimodalZscoreRangeTesterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalZscoreRangeTesterCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalZscoreRangeTesterCoreLogicConfig()
