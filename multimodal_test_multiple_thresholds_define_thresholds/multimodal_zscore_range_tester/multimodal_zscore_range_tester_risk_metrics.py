"""
  ...
  File       : multimodal_zscore_range_tester_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_zscore_range_tester_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalZscoreRangeTesterRiskMetricsConfig:
...
class MultimodalZscoreRangeTesterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalZscoreRangeTesterRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalZscoreRangeTesterRiskMetricsConfig()
