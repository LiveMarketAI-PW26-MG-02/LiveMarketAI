"""
  ...
  File       : multimodal_zscore_range_tester_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_zscore_range_tester_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalZscoreRangeTesterBacktestRunnerConfig:
...
class MultimodalZscoreRangeTesterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalZscoreRangeTesterBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalZscoreRangeTesterBacktestRunnerConfig()
