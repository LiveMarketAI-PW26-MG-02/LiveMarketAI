"""
  ...
  Folder     : multimodal_zscore_range_tester
  File       : multimodal_zscore_range_tester_signal_generator.py
  Purpose    : Test Multiple Thresholds — Zscore Range Tester
"""
...
MULTIMODAL_MODULE = 'multimodal_zscore_range_tester_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalZscoreRangeTesterSignalGeneratorConfig:
    """Multimodal threshold-sweep config for zscore_range_tester."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalZscoreRangeTesterEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: test multiple thresholds — zscore range tester.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalZscoreRangeTesterSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalZscoreRangeTesterSignalGeneratorConfig()
