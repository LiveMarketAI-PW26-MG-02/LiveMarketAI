"""
  ...
  File       : multimodal_zscore_range_tester_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_zscore_range_tester_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalZscoreRangeTesterDataPipelineConfig:
...
class MultimodalZscoreRangeTesterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalZscoreRangeTesterDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalZscoreRangeTesterDataPipelineConfig()
