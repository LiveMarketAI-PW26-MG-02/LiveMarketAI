...
from ...schemas.pattern import PatternCreate, PatternRead
...
@router.get("/{item_id}", response_model=PatternRead)
...
def create_item(payload: PatternCreate, db: Session = Depends(get_db)):
