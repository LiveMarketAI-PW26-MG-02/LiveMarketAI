# Flash Crash Cascade Shield
**System ID:** SYS-004
**Abbreviation:** DCBM

## Overview
Distributed Circuit Breaker Mesh: Federated nodes monitor cross-asset correlation breakdown, velocity of price change, and order book imbalance. Local models learn normal cascade propagation patterns. When the federated consensus detects simultaneous anomalies across multiple asset classes, a distributed circuit breaker signal is generated without central authority.
...
java -jar target/dcbm-java-node-1.0.0-SNAPSHOT.jar
