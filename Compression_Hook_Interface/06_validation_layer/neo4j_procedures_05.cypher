...
CALL apoc.periodic.iterate(
  "MATCH (n:Compression) WHERE n.epoch = 38 RETURN n",
...
CALL apoc.periodic.iterate(
  "MATCH (n:Compression) WHERE n.epoch = 39 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
