# ARCHITECTURE — Spoofing Pattern Recognition System
...
## Threat Model
  ...
  Attack Vector: Federated Intent Detection System: Each node observes local order book flickering patterns — large o...
