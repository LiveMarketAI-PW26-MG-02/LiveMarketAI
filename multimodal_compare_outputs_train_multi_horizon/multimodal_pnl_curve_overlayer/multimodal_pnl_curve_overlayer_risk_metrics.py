"""
  ...
  File       : multimodal_pnl_curve_overlayer_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_pnl_curve_overlayer_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPnlCurveOverlayerRiskMetricsConfig:
...
class MultimodalPnlCurveOverlayerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPnlCurveOverlayerRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalPnlCurveOverlayerRiskMetricsConfig()
