"""
  ...
  File       : multimodal_pnl_curve_overlayer_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_pnl_curve_overlayer_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPnlCurveOverlayerDataPipelineConfig:
...
class MultimodalPnlCurveOverlayerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPnlCurveOverlayerDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalPnlCurveOverlayerDataPipelineConfig()
