"""
  ...
  File       : multimodal_pnl_curve_overlayer_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_pnl_curve_overlayer_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPnlCurveOverlayerCoreLogicConfig:
...
class MultimodalPnlCurveOverlayerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPnlCurveOverlayerCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalPnlCurveOverlayerCoreLogicConfig()
