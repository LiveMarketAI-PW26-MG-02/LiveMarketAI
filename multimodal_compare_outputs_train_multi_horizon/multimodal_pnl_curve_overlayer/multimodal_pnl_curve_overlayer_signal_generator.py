"""
  ...
  Folder     : multimodal_pnl_curve_overlayer
  File       : multimodal_pnl_curve_overlayer_signal_generator.py
  Purpose    : Compare Outputs — Pnl Curve Overlayer
"""
...
MULTIMODAL_MODULE = 'multimodal_pnl_curve_overlayer_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPnlCurveOverlayerSignalGeneratorConfig:
    """Multimodal multi-horizon config for pnl_curve_overlayer."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalPnlCurveOverlayerEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: compare outputs — pnl curve overlayer.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalPnlCurveOverlayerSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalPnlCurveOverlayerSignalGeneratorConfig()
