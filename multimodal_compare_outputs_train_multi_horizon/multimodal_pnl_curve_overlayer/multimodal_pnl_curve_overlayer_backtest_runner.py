"""
  ...
  File       : multimodal_pnl_curve_overlayer_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_pnl_curve_overlayer_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPnlCurveOverlayerBacktestRunnerConfig:
...
class MultimodalPnlCurveOverlayerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPnlCurveOverlayerBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalPnlCurveOverlayerBacktestRunnerConfig()
