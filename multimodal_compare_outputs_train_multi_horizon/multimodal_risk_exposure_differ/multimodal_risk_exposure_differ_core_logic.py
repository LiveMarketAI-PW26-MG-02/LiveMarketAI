"""
  ...
  File       : multimodal_risk_exposure_differ_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_risk_exposure_differ_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRiskExposureDifferCoreLogicConfig:
...
class MultimodalRiskExposureDifferEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRiskExposureDifferCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalRiskExposureDifferCoreLogicConfig()
