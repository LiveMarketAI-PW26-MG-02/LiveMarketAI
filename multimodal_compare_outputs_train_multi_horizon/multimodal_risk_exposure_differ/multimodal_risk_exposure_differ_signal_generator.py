"""
  ...
  Folder     : multimodal_risk_exposure_differ
  File       : multimodal_risk_exposure_differ_signal_generator.py
  Purpose    : Compare Outputs — Risk Exposure Differ
"""
...
MULTIMODAL_MODULE = 'multimodal_risk_exposure_differ_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRiskExposureDifferSignalGeneratorConfig:
    """Multimodal multi-horizon config for risk_exposure_differ."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalRiskExposureDifferEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: compare outputs — risk exposure differ.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalRiskExposureDifferSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalRiskExposureDifferSignalGeneratorConfig()
