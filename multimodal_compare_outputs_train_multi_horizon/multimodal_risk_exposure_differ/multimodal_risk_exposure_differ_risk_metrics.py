"""
  ...
  File       : multimodal_risk_exposure_differ_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_risk_exposure_differ_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRiskExposureDifferRiskMetricsConfig:
...
class MultimodalRiskExposureDifferEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRiskExposureDifferRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalRiskExposureDifferRiskMetricsConfig()
