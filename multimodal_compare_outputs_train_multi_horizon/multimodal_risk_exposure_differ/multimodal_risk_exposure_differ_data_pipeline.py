"""
  ...
  File       : multimodal_risk_exposure_differ_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_risk_exposure_differ_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRiskExposureDifferDataPipelineConfig:
...
class MultimodalRiskExposureDifferEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRiskExposureDifferDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalRiskExposureDifferDataPipelineConfig()
