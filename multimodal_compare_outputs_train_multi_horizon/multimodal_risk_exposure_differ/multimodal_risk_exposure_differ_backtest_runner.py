"""
  ...
  File       : multimodal_risk_exposure_differ_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_risk_exposure_differ_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRiskExposureDifferBacktestRunnerConfig:
...
class MultimodalRiskExposureDifferEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRiskExposureDifferBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalRiskExposureDifferBacktestRunnerConfig()
