"""
  ...
  File       : multimodal_portfolio_overlap_diff_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_portfolio_overlap_diff_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPortfolioOverlapDiffCoreLogicConfig:
...
class MultimodalPortfolioOverlapDiffEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPortfolioOverlapDiffCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalPortfolioOverlapDiffCoreLogicConfig()
