"""
  ...
  Folder     : multimodal_portfolio_overlap_diff
  File       : multimodal_portfolio_overlap_diff_signal_generator.py
  Purpose    : Compare Outputs — Portfolio Overlap Diff
"""
...
MULTIMODAL_MODULE = 'multimodal_portfolio_overlap_diff_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPortfolioOverlapDiffSignalGeneratorConfig:
    """Multimodal multi-horizon config for portfolio_overlap_diff."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalPortfolioOverlapDiffEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: compare outputs — portfolio overlap diff.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalPortfolioOverlapDiffSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalPortfolioOverlapDiffSignalGeneratorConfig()
