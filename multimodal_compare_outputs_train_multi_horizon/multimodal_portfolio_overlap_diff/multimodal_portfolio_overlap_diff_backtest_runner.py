"""
  ...
  File       : multimodal_portfolio_overlap_diff_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_portfolio_overlap_diff_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPortfolioOverlapDiffBacktestRunnerConfig:
...
class MultimodalPortfolioOverlapDiffEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPortfolioOverlapDiffBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalPortfolioOverlapDiffBacktestRunnerConfig()
