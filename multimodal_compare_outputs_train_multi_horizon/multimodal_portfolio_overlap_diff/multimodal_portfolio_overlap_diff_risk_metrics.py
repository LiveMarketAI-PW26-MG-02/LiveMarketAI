"""
  ...
  File       : multimodal_portfolio_overlap_diff_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_portfolio_overlap_diff_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPortfolioOverlapDiffRiskMetricsConfig:
...
class MultimodalPortfolioOverlapDiffEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPortfolioOverlapDiffRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalPortfolioOverlapDiffRiskMetricsConfig()
