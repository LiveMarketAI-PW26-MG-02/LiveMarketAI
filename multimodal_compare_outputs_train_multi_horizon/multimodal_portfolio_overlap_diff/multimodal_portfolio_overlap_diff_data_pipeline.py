"""
  ...
  File       : multimodal_portfolio_overlap_diff_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_portfolio_overlap_diff_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPortfolioOverlapDiffDataPipelineConfig:
...
class MultimodalPortfolioOverlapDiffEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPortfolioOverlapDiffDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalPortfolioOverlapDiffDataPipelineConfig()
