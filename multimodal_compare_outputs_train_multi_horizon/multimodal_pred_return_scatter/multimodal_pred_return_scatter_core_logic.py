"""
  ...
  File       : multimodal_pred_return_scatter_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_pred_return_scatter_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPredReturnScatterCoreLogicConfig:
...
class MultimodalPredReturnScatterEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPredReturnScatterCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalPredReturnScatterCoreLogicConfig()
