"""
  ...
  Folder     : multimodal_pred_return_scatter
  File       : multimodal_pred_return_scatter_signal_generator.py
  Purpose    : Compare Outputs — Pred Return Scatter
"""
...
MULTIMODAL_MODULE = 'multimodal_pred_return_scatter_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPredReturnScatterSignalGeneratorConfig:
    """Multimodal multi-horizon config for pred_return_scatter."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalPredReturnScatterEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: compare outputs — pred return scatter.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalPredReturnScatterSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalPredReturnScatterSignalGeneratorConfig()
