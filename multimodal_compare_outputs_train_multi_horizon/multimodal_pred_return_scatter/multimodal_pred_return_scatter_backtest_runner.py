"""
  ...
  File       : multimodal_pred_return_scatter_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_pred_return_scatter_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPredReturnScatterBacktestRunnerConfig:
...
class MultimodalPredReturnScatterEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPredReturnScatterBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalPredReturnScatterBacktestRunnerConfig()
