"""
  ...
  File       : multimodal_pred_return_scatter_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_pred_return_scatter_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPredReturnScatterRiskMetricsConfig:
...
class MultimodalPredReturnScatterEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPredReturnScatterRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalPredReturnScatterRiskMetricsConfig()
