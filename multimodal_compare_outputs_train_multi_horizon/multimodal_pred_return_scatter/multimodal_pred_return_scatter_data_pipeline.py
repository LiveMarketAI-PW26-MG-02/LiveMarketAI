"""
  ...
  File       : multimodal_pred_return_scatter_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_pred_return_scatter_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPredReturnScatterDataPipelineConfig:
...
class MultimodalPredReturnScatterEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPredReturnScatterDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalPredReturnScatterDataPipelineConfig()
