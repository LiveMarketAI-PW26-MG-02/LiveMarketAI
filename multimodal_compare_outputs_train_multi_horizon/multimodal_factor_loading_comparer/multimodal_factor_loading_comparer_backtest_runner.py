"""
  ...
  File       : multimodal_factor_loading_comparer_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_factor_loading_comparer_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalFactorLoadingComparerBacktestRunnerConfig:
...
class MultimodalFactorLoadingComparerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalFactorLoadingComparerBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalFactorLoadingComparerBacktestRunnerConfig()
