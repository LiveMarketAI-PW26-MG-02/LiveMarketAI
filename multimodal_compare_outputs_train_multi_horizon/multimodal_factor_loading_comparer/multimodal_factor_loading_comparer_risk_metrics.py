"""
  ...
  File       : multimodal_factor_loading_comparer_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_factor_loading_comparer_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalFactorLoadingComparerRiskMetricsConfig:
...
class MultimodalFactorLoadingComparerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalFactorLoadingComparerRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalFactorLoadingComparerRiskMetricsConfig()
