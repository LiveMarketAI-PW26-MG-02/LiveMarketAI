"""
  ...
  File       : multimodal_factor_loading_comparer_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_factor_loading_comparer_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalFactorLoadingComparerDataPipelineConfig:
...
class MultimodalFactorLoadingComparerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalFactorLoadingComparerDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalFactorLoadingComparerDataPipelineConfig()
