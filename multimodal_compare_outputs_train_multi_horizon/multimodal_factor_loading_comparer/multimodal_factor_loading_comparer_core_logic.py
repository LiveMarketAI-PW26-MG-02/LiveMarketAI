"""
  ...
  File       : multimodal_factor_loading_comparer_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_factor_loading_comparer_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalFactorLoadingComparerCoreLogicConfig:
...
class MultimodalFactorLoadingComparerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalFactorLoadingComparerCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalFactorLoadingComparerCoreLogicConfig()
