"""
  ...
  File       : multimodal_execution_path_differ_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_execution_path_differ_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalExecutionPathDifferDataPipelineConfig:
...
class MultimodalExecutionPathDifferEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalExecutionPathDifferDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalExecutionPathDifferDataPipelineConfig()
