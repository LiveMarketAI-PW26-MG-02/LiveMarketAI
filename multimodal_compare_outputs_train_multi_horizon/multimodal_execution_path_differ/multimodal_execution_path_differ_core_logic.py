"""
  ...
  File       : multimodal_execution_path_differ_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_execution_path_differ_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalExecutionPathDifferCoreLogicConfig:
...
class MultimodalExecutionPathDifferEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalExecutionPathDifferCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalExecutionPathDifferCoreLogicConfig()
