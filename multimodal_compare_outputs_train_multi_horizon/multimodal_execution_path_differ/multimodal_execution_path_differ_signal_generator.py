"""
  ...
  Folder     : multimodal_execution_path_differ
  File       : multimodal_execution_path_differ_signal_generator.py
  Purpose    : Compare Outputs — Execution Path Differ
"""
...
MULTIMODAL_MODULE = 'multimodal_execution_path_differ_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalExecutionPathDifferSignalGeneratorConfig:
    """Multimodal multi-horizon config for execution_path_differ."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalExecutionPathDifferEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: compare outputs — execution path differ.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalExecutionPathDifferSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalExecutionPathDifferSignalGeneratorConfig()
