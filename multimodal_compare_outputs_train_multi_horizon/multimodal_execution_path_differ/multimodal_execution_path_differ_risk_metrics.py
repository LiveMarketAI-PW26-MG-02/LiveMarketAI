"""
  ...
  File       : multimodal_execution_path_differ_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_execution_path_differ_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalExecutionPathDifferRiskMetricsConfig:
...
class MultimodalExecutionPathDifferEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalExecutionPathDifferRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalExecutionPathDifferRiskMetricsConfig()
