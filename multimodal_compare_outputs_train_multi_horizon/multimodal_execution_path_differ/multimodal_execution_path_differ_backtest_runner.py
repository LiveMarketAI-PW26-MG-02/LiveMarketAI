"""
  ...
  File       : multimodal_execution_path_differ_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_execution_path_differ_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalExecutionPathDifferBacktestRunnerConfig:
...
class MultimodalExecutionPathDifferEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalExecutionPathDifferBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalExecutionPathDifferBacktestRunnerConfig()
