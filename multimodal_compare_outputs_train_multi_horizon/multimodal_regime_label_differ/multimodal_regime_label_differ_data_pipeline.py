"""
  ...
  File       : multimodal_regime_label_differ_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_regime_label_differ_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeLabelDifferDataPipelineConfig:
...
class MultimodalRegimeLabelDifferEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegimeLabelDifferDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalRegimeLabelDifferDataPipelineConfig()
