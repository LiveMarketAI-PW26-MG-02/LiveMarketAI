"""
  ...
  File       : multimodal_regime_label_differ_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_regime_label_differ_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeLabelDifferRiskMetricsConfig:
...
class MultimodalRegimeLabelDifferEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegimeLabelDifferRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalRegimeLabelDifferRiskMetricsConfig()
