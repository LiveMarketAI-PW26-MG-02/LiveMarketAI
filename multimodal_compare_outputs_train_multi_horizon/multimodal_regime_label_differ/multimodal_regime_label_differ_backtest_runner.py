"""
  ...
  File       : multimodal_regime_label_differ_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_regime_label_differ_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeLabelDifferBacktestRunnerConfig:
...
class MultimodalRegimeLabelDifferEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegimeLabelDifferBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalRegimeLabelDifferBacktestRunnerConfig()
