"""
  ...
  File       : multimodal_regime_label_differ_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_regime_label_differ_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeLabelDifferCoreLogicConfig:
...
class MultimodalRegimeLabelDifferEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegimeLabelDifferCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalRegimeLabelDifferCoreLogicConfig()
