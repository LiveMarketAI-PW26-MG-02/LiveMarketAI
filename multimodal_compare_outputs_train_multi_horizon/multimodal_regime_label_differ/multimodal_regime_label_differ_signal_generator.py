"""
  ...
  Folder     : multimodal_regime_label_differ
  File       : multimodal_regime_label_differ_signal_generator.py
  Purpose    : Compare Outputs — Regime Label Differ
"""
...
MULTIMODAL_MODULE = 'multimodal_regime_label_differ_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeLabelDifferSignalGeneratorConfig:
    """Multimodal multi-horizon config for regime_label_differ."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalRegimeLabelDifferEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: compare outputs — regime label differ.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalRegimeLabelDifferSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalRegimeLabelDifferSignalGeneratorConfig()
