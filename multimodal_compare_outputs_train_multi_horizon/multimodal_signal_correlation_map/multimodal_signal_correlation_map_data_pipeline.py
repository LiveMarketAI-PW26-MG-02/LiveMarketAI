"""
  ...
  File       : multimodal_signal_correlation_map_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_signal_correlation_map_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalSignalCorrelationMapDataPipelineConfig:
...
class MultimodalSignalCorrelationMapEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSignalCorrelationMapDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalSignalCorrelationMapDataPipelineConfig()
