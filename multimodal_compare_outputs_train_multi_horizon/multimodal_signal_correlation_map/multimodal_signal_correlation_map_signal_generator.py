"""
  ...
  Folder     : multimodal_signal_correlation_map
  File       : multimodal_signal_correlation_map_signal_generator.py
  Purpose    : Compare Outputs — Signal Correlation Map
"""
...
MULTIMODAL_MODULE = 'multimodal_signal_correlation_map_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalSignalCorrelationMapSignalGeneratorConfig:
    """Multimodal multi-horizon config for signal_correlation_map."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalSignalCorrelationMapEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: compare outputs — signal correlation map.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalSignalCorrelationMapSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalSignalCorrelationMapSignalGeneratorConfig()
