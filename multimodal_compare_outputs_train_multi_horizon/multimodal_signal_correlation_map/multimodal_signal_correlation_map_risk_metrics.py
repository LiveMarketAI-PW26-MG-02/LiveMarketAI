"""
  ...
  File       : multimodal_signal_correlation_map_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_signal_correlation_map_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalSignalCorrelationMapRiskMetricsConfig:
...
class MultimodalSignalCorrelationMapEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSignalCorrelationMapRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalSignalCorrelationMapRiskMetricsConfig()
