"""
  ...
  File       : multimodal_signal_correlation_map_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_signal_correlation_map_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalSignalCorrelationMapCoreLogicConfig:
...
class MultimodalSignalCorrelationMapEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSignalCorrelationMapCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalSignalCorrelationMapCoreLogicConfig()
