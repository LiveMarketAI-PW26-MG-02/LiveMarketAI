"""
  ...
  File       : multimodal_signal_correlation_map_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_signal_correlation_map_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalSignalCorrelationMapBacktestRunnerConfig:
...
class MultimodalSignalCorrelationMapEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSignalCorrelationMapBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalSignalCorrelationMapBacktestRunnerConfig()
