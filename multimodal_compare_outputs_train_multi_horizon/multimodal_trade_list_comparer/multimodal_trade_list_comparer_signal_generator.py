"""
  ...
  Folder     : multimodal_trade_list_comparer
  File       : multimodal_trade_list_comparer_signal_generator.py
  Purpose    : Compare Outputs — Trade List Comparer
"""
...
MULTIMODAL_MODULE = 'multimodal_trade_list_comparer_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalTradeListComparerSignalGeneratorConfig:
    """Multimodal multi-horizon config for trade_list_comparer."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalTradeListComparerEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: compare outputs — trade list comparer.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalTradeListComparerSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalTradeListComparerSignalGeneratorConfig()
