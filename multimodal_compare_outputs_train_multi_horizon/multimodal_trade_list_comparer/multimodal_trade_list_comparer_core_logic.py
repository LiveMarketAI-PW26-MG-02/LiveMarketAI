"""
  ...
  File       : multimodal_trade_list_comparer_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_trade_list_comparer_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalTradeListComparerCoreLogicConfig:
...
class MultimodalTradeListComparerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalTradeListComparerCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalTradeListComparerCoreLogicConfig()
