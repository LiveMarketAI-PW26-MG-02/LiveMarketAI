"""
  ...
  File       : multimodal_trade_list_comparer_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_trade_list_comparer_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalTradeListComparerRiskMetricsConfig:
...
class MultimodalTradeListComparerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalTradeListComparerRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalTradeListComparerRiskMetricsConfig()
