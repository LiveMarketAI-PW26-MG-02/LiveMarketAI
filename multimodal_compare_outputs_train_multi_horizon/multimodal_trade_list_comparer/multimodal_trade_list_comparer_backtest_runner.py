"""
  ...
  File       : multimodal_trade_list_comparer_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_trade_list_comparer_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalTradeListComparerBacktestRunnerConfig:
...
class MultimodalTradeListComparerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalTradeListComparerBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalTradeListComparerBacktestRunnerConfig()
