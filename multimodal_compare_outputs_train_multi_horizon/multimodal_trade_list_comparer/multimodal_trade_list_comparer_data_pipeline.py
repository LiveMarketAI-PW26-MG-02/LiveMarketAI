"""
  ...
  File       : multimodal_trade_list_comparer_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_trade_list_comparer_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalTradeListComparerDataPipelineConfig:
...
class MultimodalTradeListComparerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalTradeListComparerDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalTradeListComparerDataPipelineConfig()
