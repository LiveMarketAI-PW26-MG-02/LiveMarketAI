"""
  ...
  File       : multimodal_drawdown_path_comparer_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_drawdown_path_comparer_risk_metrics'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalDrawdownPathComparerRiskMetricsConfig:
...
class MultimodalDrawdownPathComparerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDrawdownPathComparerRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalDrawdownPathComparerRiskMetricsConfig()
