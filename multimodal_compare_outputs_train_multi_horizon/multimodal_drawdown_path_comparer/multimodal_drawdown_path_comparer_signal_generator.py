"""
  ...
  Folder     : multimodal_drawdown_path_comparer
  File       : multimodal_drawdown_path_comparer_signal_generator.py
  Purpose    : Compare Outputs — Drawdown Path Comparer
"""
...
MULTIMODAL_MODULE = 'multimodal_drawdown_path_comparer_signal_generator'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalDrawdownPathComparerSignalGeneratorConfig:
    """Multimodal multi-horizon config for drawdown_path_comparer."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalDrawdownPathComparerEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: compare outputs — drawdown path comparer.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalDrawdownPathComparerSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalDrawdownPathComparerSignalGeneratorConfig()
