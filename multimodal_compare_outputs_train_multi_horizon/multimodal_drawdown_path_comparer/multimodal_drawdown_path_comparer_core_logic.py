"""
  ...
  File       : multimodal_drawdown_path_comparer_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_drawdown_path_comparer_core_logic'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalDrawdownPathComparerCoreLogicConfig:
...
class MultimodalDrawdownPathComparerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDrawdownPathComparerCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalDrawdownPathComparerCoreLogicConfig()
