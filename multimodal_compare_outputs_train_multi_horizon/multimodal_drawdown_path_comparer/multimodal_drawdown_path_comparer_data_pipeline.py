"""
  ...
  File       : multimodal_drawdown_path_comparer_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_drawdown_path_comparer_data_pipeline'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalDrawdownPathComparerDataPipelineConfig:
...
class MultimodalDrawdownPathComparerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDrawdownPathComparerDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalDrawdownPathComparerDataPipelineConfig()
