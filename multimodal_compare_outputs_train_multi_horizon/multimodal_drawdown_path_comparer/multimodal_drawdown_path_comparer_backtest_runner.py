"""
  ...
  File       : multimodal_drawdown_path_comparer_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_drawdown_path_comparer_backtest_runner'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalDrawdownPathComparerBacktestRunnerConfig:
...
class MultimodalDrawdownPathComparerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDrawdownPathComparerBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalDrawdownPathComparerBacktestRunnerConfig()
