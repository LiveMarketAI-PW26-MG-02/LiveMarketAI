"""
  ...
  File       : multimodal_fix_protocol_validator_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_fix_protocol_validator_backtest_runner'
TOPIC             = 'interface_validation'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalFixProtocolValidatorBacktestRunnerConfig:
...
class MultimodalFixProtocolValidatorEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalFixProtocolValidatorBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalFixProtocolValidatorBacktestRunnerConfig()
