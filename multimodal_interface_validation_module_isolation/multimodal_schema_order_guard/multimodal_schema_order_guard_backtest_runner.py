"""
  ...
  File       : multimodal_schema_order_guard_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_schema_order_guard_backtest_runner'
TOPIC             = 'interface_validation'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSchemaOrderGuardBacktestRunnerConfig:
...
class MultimodalSchemaOrderGuardEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalSchemaOrderGuardBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalSchemaOrderGuardBacktestRunnerConfig()
