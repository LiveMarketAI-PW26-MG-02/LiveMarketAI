"""
  ...
  File       : multimodal_endpoint_health_probe_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_endpoint_health_probe_core_logic'
TOPIC             = 'interface_validation'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalEndpointHealthProbeCoreLogicConfig:
...
class MultimodalEndpointHealthProbeEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalEndpointHealthProbeCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalEndpointHealthProbeCoreLogicConfig()
