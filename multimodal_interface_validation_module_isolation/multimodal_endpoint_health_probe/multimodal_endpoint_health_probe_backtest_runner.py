"""
  ...
  File       : multimodal_endpoint_health_probe_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_endpoint_health_probe_backtest_runner'
TOPIC             = 'interface_validation'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalEndpointHealthProbeBacktestRunnerConfig:
...
class MultimodalEndpointHealthProbeEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalEndpointHealthProbeBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalEndpointHealthProbeBacktestRunnerConfig()
