"""
  ...
  File       : multimodal_grpc_market_checker_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_grpc_market_checker_backtest_runner'
TOPIC             = 'interface_validation'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalGrpcMarketCheckerBacktestRunnerConfig:
...
class MultimodalGrpcMarketCheckerEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalGrpcMarketCheckerBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalGrpcMarketCheckerBacktestRunnerConfig()
