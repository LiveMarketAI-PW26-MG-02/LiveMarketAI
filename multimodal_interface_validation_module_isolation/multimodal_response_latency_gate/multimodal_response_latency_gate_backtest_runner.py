"""
  ...
  File       : multimodal_response_latency_gate_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_response_latency_gate_backtest_runner'
TOPIC             = 'interface_validation'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalResponseLatencyGateBacktestRunnerConfig:
...
class MultimodalResponseLatencyGateEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalResponseLatencyGateBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalResponseLatencyGateBacktestRunnerConfig()
