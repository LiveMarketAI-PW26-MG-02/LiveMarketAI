"""
  ...
  File       : multimodal_message_seq_verifier_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_message_seq_verifier_backtest_runner'
TOPIC             = 'interface_validation'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalMessageSeqVerifierBacktestRunnerConfig:
...
class MultimodalMessageSeqVerifierEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalMessageSeqVerifierBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalMessageSeqVerifierBacktestRunnerConfig()
