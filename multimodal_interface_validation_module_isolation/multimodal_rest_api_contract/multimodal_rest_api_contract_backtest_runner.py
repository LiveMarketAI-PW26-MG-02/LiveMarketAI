"""
  ...
  File       : multimodal_rest_api_contract_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_rest_api_contract_backtest_runner'
TOPIC             = 'interface_validation'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRestApiContractBacktestRunnerConfig:
...
class MultimodalRestApiContractEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalRestApiContractBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalRestApiContractBacktestRunnerConfig()
