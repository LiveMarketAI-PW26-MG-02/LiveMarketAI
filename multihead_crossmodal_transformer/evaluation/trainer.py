"""
Trainer for Cross-modal alignment scores and regime-conditioned evaluation
Module: evaluation.trainer
"""
import torch
...
class CrossModalTransformerEvaluatorTrainer(nn.Module):
    """
    Trainer for Cross-modal alignment scores and regime-conditioned evaluation
    """
