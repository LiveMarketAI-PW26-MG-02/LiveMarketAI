"""
Trainer for Learnable spectral positional encoding for frequency-aware attention
Module: spectral_positional_encoding.trainer
"""
import torch
...
class SpectralPositionalEncodingTrainer(nn.Module):
    """
    Trainer for Learnable spectral positional encoding for frequency-aware attention
    """
