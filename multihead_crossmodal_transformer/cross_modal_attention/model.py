"""
Multi-head cross-modal attention: audio × price × text
Module: cross_modal_attention.model
"""
import torch
...
def cross_attend(query_mod, key_mod, value_mod, scale):
    scores = (query_mod @ key_mod.transpose(-2,-1)) * scale
    return F.softmax(scores, -1) @ value_mod
