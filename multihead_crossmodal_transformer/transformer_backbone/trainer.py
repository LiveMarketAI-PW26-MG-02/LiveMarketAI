"""
Trainer for Full transformer with cross-modal and self-attention layers
Module: transformer_backbone.trainer
"""
import torch
...
class CrossModalTransformerBackboneTrainer(nn.Module):
    """
    Trainer for Full transformer with cross-modal and self-attention layers
    """
