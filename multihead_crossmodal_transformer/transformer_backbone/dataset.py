"""
Dataset for Full transformer with cross-modal and self-attention layers
Module: transformer_backbone.dataset
"""
import torch
...
class CrossModalTransformerBackboneDataset(nn.Module):
    """
    Dataset for Full transformer with cross-modal and self-attention layers
    """
