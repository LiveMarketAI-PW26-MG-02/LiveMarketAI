#!/usr/bin/env python3
"""
Counterfactual Graph Neural Network (CGNN-XAI) - Data Generation Module
...
REGIME_TYPES      = ['factual', 'counterfactual_low', 'counterfactual_high', 'minimal_edit']
OUTPUT_DIR        = "outputs/cgnn_xai_data"
...
class SyntheticMarketDataGenerator:
    """
    Generates synthetic OHLCV + microstructure + sentiment data for CGNN-XAI.
    ...
    def generate_price_series(self, asset_id: str, regime: str = "bull") -> pd.DataFrame:
        ...
        Regimes: ['factual', 'counterfactual_low', 'counterfactual_high', 'minimal_edit']
        """
        regime_params = {
...
class SentimentDataGenerator:
    ...
    price manipulation events for CGNN-XAI.
    """
...
class OrderBookGenerator:
    ...
    Critical for CGNN-XAI microstructure-based manipulation detection.
    """
...
class GraphDataBuilder:
    ...
    and GNN propagation in CGNN-XAI.
    """
...
def main():
    print(f"\n============================================================")
    print(f"  CGNN-XAI - Data Generation Pipeline")
    ...
    # Summary
    print(f"\n============================================================")
    print(f"  Data Generation Complete for CGNN-XAI")
