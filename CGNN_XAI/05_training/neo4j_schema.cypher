// ═══════════════════════════════════════════════════════════════════════════
// Counterfactual Graph Neural Network (CGNN-XAI) — Neo4j Graph Schema
// Module: cgnn_xai
// ═══════════════════════════════════════════════════════════════════════════
...
// ── NODE PROPERTIES (sample MERGE for CGNN-XAI) ─────────────────────────────
...
ON CREATE SET
  ...
  al.description    = 'Pump-and-dump pattern detected by CGNN-XAI',
