#!/usr/bin/env python3
"""
CGNN-XAI - Shared Utility Functions
Common helpers used across all subfolders of the CGNN-XAI module.
"""
...
def get_logger(name: str = "CGNN-XAI", level: str = "INFO") -> logging.Logger:
    """Configure and return a logger for CGNN-XAI module."""
