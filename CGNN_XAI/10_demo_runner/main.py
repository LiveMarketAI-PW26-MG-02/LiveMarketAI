#!/usr/bin/env python3
"""
Counterfactual Graph Neural Network (CGNN-XAI) - Demo Runner — End-to-End Pipeline
...
OUTPUT_DIR = "outputs/cgnn_xai_inference"
...
class InferenceFeatureExtractor:
    ...
    for CGNN-XAI inference. Handles normalization using training statistics.
    """
...
class AlertGenerator:
    ...
    def __init__(self, module_name: str = "CGNN-XAI"):
    ...
    def save_alerts(self, alerts: List[dict], filename: str = "alerts.json") -> str:
        ...
        with open(path, "w") as f:
            json.dump({"module": "CGNN-XAI", "alerts": alerts,
                        "total": len(alerts),
...
class InferencePipeline:
    """
    End-to-end CGNN-XAI inference pipeline:
    ...
    def __init__(self, model, n_assets: int = 20, threshold: float = 0.5):
        ...
        self.alert_generator = AlertGenerator("CGNN-XAI")
    ...
    def run_streaming(self, n_windows: int = 50,
        ...
        print(f"  Running CGNN-XAI streaming inference: {n_windows} windows...")
        results = []
...
def main():
    print(f"\n{'='*60}")
    print(f"  CGNN-XAI - Demo Runner — End-to-End Pipeline")
    ...
    print(f"\nCGNN-XAI Demo Runner — End-to-End Pipeline Complete.\n")
...
7 + np.random.rand(n) * 0.3, 0, 1),
        ...
        explanation_text = f"""
MANIPULATION DETECTION EXPLANATION - CGNN-XAI
============================================================
