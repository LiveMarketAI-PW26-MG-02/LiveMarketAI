#!/usr/bin/env python3
"""
Counterfactual Graph Neural Network (CGNN-XAI) - Evaluation Engine (Alt Entry)
...
OUTPUT_DIR = "outputs/cgnn_xai_eval"
os.makedirs(OUTPUT_DIR, exist_ok=True)
np.random.seed(42)

class BinaryClassificationEvaluator:
    """Full binary classification metric suite for CGNN-XAI."""
...
class RegimeEvaluator:
    """Regime-stratified evaluation for CGNN-XAI."""
...
class CalibrationEvaluator:
    """ECE and reliability diagram for CGNN-XAI probability calibration."""
...
class GraphEvaluator:
    """Graph-aware metrics for CGNN-XAI GNN evaluation."""
...
def main():
    print(f"\n{'='*60}\n  CGNN-XAI Evaluation Engine (Alt Entry)\n{'='*60}")
    n=200
    ...
    report={"module":"CGNN-XAI","full_name":"Counterfactual Graph Neural Network","evaluated_at":datetime.utcnow().isoformat()+"Z",
