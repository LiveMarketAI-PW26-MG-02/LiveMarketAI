"""
  ...
  Folder     : multimodal_yield_curve_adapter
  File       : multimodal_yield_curve_adapter_signal_generator.py
  Purpose    : Drift Adaptation — Yield Curve Adapter
"""
...
MULTIMODAL_MODULE = 'multimodal_yield_curve_adapter_signal_generator'
TOPIC             = 'drift_adaptation'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalYieldCurveAdapterSignalGeneratorConfig:
    """Configuration for multimodal yield_curve_adapter module."""
...
# ── Core Engine ──────────────────────────────────────────────────────────────
class MultimodalYieldCurveAdapterEngine:
    """
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalYieldCurveAdapterSignalGeneratorConfig()
        self.state    : Dict = {}
