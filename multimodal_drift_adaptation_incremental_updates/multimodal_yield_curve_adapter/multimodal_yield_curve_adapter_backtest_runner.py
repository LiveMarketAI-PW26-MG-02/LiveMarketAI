"""
  ...
  File       : multimodal_yield_curve_adapter_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_yield_curve_adapter_backtest_runner'
TOPIC             = 'drift_adaptation'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalYieldCurveAdapterBacktestRunnerConfig:
...
class MultimodalYieldCurveAdapterEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalYieldCurveAdapterBacktestRunnerConfig()
        self.state    : Dict = {}
