"""
  ...
  File       : multimodal_yield_curve_adapter_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_yield_curve_adapter_core_logic'
TOPIC             = 'drift_adaptation'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalYieldCurveAdapterCoreLogicConfig:
...
class MultimodalYieldCurveAdapterEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalYieldCurveAdapterCoreLogicConfig()
        self.state    : Dict = {}
