"""
  ...
  File       : multimodal_price_impact_adjuster_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_price_impact_adjuster_backtest_runner'
TOPIC             = 'drift_adaptation'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalPriceImpactAdjusterBacktestRunnerConfig:
...
class MultimodalPriceImpactAdjusterEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalPriceImpactAdjusterBacktestRunnerConfig()
        self.state    : Dict = {}
