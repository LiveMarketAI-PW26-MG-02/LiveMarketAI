...
from ...schemas.claim import ClaimCreate, ClaimRead
...
@router.get("/{item_id}", response_model=ClaimRead)
...
def create_item(payload: ClaimCreate, db: Session = Depends(get_db)):
