...
Classifies financial claims, attributes likely origin narratives and explains the linguistic evidence behind each verdict.
...
- **10 self-created APIs (routers)**: /health, /auth, /audit, /ingest, /explain, /claims, /sources, /attribution_results, /narratives, /evidences
- **AI primitive**: `nlp` — see `financial_misinformation_attribution_framework/ai/engine.py`. Exposed at `POST /explain`.
...
## Run
    ...
    uvicorn financial_misinformation_attribution_framework.main:app --reload     # SQLite tables auto-created on boot
...
## Layout
    ...
    financial_misinformation_attribution_framework/
