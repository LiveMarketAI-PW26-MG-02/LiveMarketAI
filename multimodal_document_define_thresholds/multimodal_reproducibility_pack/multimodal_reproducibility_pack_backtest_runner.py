"""
  ...
  File       : multimodal_reproducibility_pack_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_reproducibility_pack_backtest_runner'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalReproducibilityPackBacktestRunnerConfig:
...
class MultimodalReproducibilityPackEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalReproducibilityPackBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalReproducibilityPackBacktestRunnerConfig()
