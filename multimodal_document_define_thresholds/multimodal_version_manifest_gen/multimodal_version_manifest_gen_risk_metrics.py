"""
  ...
  File       : multimodal_version_manifest_gen_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_version_manifest_gen_risk_metrics'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalVersionManifestGenRiskMetricsConfig:
...
class MultimodalVersionManifestGenEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalVersionManifestGenRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalVersionManifestGenRiskMetricsConfig()
