"""
  ...
  File       : multimodal_version_manifest_gen_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_version_manifest_gen_data_pipeline'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalVersionManifestGenDataPipelineConfig:
...
class MultimodalVersionManifestGenEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalVersionManifestGenDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalVersionManifestGenDataPipelineConfig()
