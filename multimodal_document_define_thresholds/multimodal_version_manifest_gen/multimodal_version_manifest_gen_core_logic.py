"""
  ...
  File       : multimodal_version_manifest_gen_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_version_manifest_gen_core_logic'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalVersionManifestGenCoreLogicConfig:
...
class MultimodalVersionManifestGenEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalVersionManifestGenCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalVersionManifestGenCoreLogicConfig()
