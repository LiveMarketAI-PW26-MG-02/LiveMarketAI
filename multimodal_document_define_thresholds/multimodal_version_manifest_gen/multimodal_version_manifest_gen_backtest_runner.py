"""
  ...
  File       : multimodal_version_manifest_gen_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_version_manifest_gen_backtest_runner'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalVersionManifestGenBacktestRunnerConfig:
...
class MultimodalVersionManifestGenEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalVersionManifestGenBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalVersionManifestGenBacktestRunnerConfig()
