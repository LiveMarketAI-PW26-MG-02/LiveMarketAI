"""
  ...
  File       : multimodal_data_lineage_thresh_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_data_lineage_thresh_data_pipeline'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalDataLineageThreshDataPipelineConfig:
...
class MultimodalDataLineageThreshEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDataLineageThreshDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalDataLineageThreshDataPipelineConfig()
