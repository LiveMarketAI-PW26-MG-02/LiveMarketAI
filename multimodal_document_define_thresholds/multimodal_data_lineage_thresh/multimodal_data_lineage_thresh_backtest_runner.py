"""
  ...
  File       : multimodal_data_lineage_thresh_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_data_lineage_thresh_backtest_runner'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalDataLineageThreshBacktestRunnerConfig:
...
class MultimodalDataLineageThreshEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDataLineageThreshBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalDataLineageThreshBacktestRunnerConfig()
