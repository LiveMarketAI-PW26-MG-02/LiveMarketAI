"""
  ...
  File       : multimodal_threshold_model_card_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_threshold_model_card_data_pipeline'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalThresholdModelCardDataPipelineConfig:
...
class MultimodalThresholdModelCardEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalThresholdModelCardDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalThresholdModelCardDataPipelineConfig()
