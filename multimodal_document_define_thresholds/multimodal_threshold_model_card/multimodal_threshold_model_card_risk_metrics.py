"""
  ...
  File       : multimodal_threshold_model_card_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_threshold_model_card_risk_metrics'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalThresholdModelCardRiskMetricsConfig:
...
class MultimodalThresholdModelCardEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalThresholdModelCardRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalThresholdModelCardRiskMetricsConfig()
