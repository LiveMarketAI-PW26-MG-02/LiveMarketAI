"""
  ...
  File       : multimodal_threshold_model_card_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_threshold_model_card_backtest_runner'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalThresholdModelCardBacktestRunnerConfig:
...
class MultimodalThresholdModelCardEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalThresholdModelCardBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalThresholdModelCardBacktestRunnerConfig()
