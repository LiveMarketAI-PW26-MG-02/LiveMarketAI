"""
  ...
  File       : multimodal_threshold_model_card_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_threshold_model_card_core_logic'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalThresholdModelCardCoreLogicConfig:
...
class MultimodalThresholdModelCardEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalThresholdModelCardCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalThresholdModelCardCoreLogicConfig()
