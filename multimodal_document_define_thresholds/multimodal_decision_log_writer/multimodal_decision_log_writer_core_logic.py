"""
  ...
  File       : multimodal_decision_log_writer_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_decision_log_writer_core_logic'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalDecisionLogWriterCoreLogicConfig:
...
class MultimodalDecisionLogWriterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDecisionLogWriterCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalDecisionLogWriterCoreLogicConfig()
