"""
  ...
  File       : multimodal_decision_log_writer_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_decision_log_writer_data_pipeline'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalDecisionLogWriterDataPipelineConfig:
...
class MultimodalDecisionLogWriterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDecisionLogWriterDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalDecisionLogWriterDataPipelineConfig()
