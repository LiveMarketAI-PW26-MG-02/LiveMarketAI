"""
  ...
  File       : multimodal_decision_log_writer_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_decision_log_writer_risk_metrics'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalDecisionLogWriterRiskMetricsConfig:
...
class MultimodalDecisionLogWriterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDecisionLogWriterRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalDecisionLogWriterRiskMetricsConfig()
