"""
  ...
  File       : multimodal_decision_log_writer_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_decision_log_writer_backtest_runner'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalDecisionLogWriterBacktestRunnerConfig:
...
class MultimodalDecisionLogWriterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDecisionLogWriterBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalDecisionLogWriterBacktestRunnerConfig()
