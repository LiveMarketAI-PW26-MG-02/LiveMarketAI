"""
  ...
  File       : multimodal_methodology_doc_eng_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_methodology_doc_eng_backtest_runner'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalMethodologyDocEngBacktestRunnerConfig:
...
class MultimodalMethodologyDocEngEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMethodologyDocEngBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalMethodologyDocEngBacktestRunnerConfig()
