"""
  ...
  File       : multimodal_methodology_doc_eng_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_methodology_doc_eng_core_logic'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalMethodologyDocEngCoreLogicConfig:
...
class MultimodalMethodologyDocEngEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMethodologyDocEngCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalMethodologyDocEngCoreLogicConfig()
