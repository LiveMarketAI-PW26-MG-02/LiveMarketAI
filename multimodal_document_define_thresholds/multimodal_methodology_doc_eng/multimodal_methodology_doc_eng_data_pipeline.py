"""
  ...
  File       : multimodal_methodology_doc_eng_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_methodology_doc_eng_data_pipeline'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalMethodologyDocEngDataPipelineConfig:
...
class MultimodalMethodologyDocEngEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMethodologyDocEngDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalMethodologyDocEngDataPipelineConfig()
