"""
  ...
  File       : multimodal_changelog_threshold_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_changelog_threshold_backtest_runner'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalChangelogThresholdBacktestRunnerConfig:
...
class MultimodalChangelogThresholdEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalChangelogThresholdBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalChangelogThresholdBacktestRunnerConfig()
