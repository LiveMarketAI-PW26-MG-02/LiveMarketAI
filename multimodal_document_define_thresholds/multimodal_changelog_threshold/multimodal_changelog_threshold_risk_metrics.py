"""
  ...
  File       : multimodal_changelog_threshold_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_changelog_threshold_risk_metrics'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalChangelogThresholdRiskMetricsConfig:
...
class MultimodalChangelogThresholdEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalChangelogThresholdRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalChangelogThresholdRiskMetricsConfig()
