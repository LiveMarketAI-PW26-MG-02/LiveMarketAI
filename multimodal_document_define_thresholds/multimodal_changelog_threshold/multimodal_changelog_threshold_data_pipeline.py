"""
  ...
  File       : multimodal_changelog_threshold_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_changelog_threshold_data_pipeline'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalChangelogThresholdDataPipelineConfig:
...
class MultimodalChangelogThresholdEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalChangelogThresholdDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalChangelogThresholdDataPipelineConfig()
