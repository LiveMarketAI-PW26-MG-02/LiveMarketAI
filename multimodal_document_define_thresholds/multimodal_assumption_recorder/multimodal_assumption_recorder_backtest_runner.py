"""
  ...
  File       : multimodal_assumption_recorder_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_assumption_recorder_backtest_runner'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalAssumptionRecorderBacktestRunnerConfig:
...
class MultimodalAssumptionRecorderEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalAssumptionRecorderBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalAssumptionRecorderBacktestRunnerConfig()
