"""
  ...
  File       : multimodal_api_spec_thresh_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_api_spec_thresh_risk_metrics'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalApiSpecThreshRiskMetricsConfig:
...
class MultimodalApiSpecThreshEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalApiSpecThreshRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalApiSpecThreshRiskMetricsConfig()
