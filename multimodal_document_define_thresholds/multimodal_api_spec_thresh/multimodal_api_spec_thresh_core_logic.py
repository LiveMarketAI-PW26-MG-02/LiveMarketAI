"""
  ...
  File       : multimodal_api_spec_thresh_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_api_spec_thresh_core_logic'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalApiSpecThreshCoreLogicConfig:
...
class MultimodalApiSpecThreshEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalApiSpecThreshCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalApiSpecThreshCoreLogicConfig()
