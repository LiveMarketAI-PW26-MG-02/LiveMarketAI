"""
  ...
  File       : multimodal_api_spec_thresh_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_api_spec_thresh_data_pipeline'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalApiSpecThreshDataPipelineConfig:
...
class MultimodalApiSpecThreshEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalApiSpecThreshDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalApiSpecThreshDataPipelineConfig()
