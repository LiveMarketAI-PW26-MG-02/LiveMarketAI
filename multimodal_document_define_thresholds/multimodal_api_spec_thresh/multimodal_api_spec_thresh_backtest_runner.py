"""
  ...
  File       : multimodal_api_spec_thresh_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_api_spec_thresh_backtest_runner'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalApiSpecThreshBacktestRunnerConfig:
...
class MultimodalApiSpecThreshEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalApiSpecThreshBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalApiSpecThreshBacktestRunnerConfig()
