"""
  ...
  File       : multimodal_audit_trail_thresh_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_audit_trail_thresh_backtest_runner'
TOPIC             = 'document'
VERSION           = '1.0.0'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalAuditTrailThreshBacktestRunnerConfig:
...
class MultimodalAuditTrailThreshEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalAuditTrailThreshBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalAuditTrailThreshBacktestRunnerConfig()
