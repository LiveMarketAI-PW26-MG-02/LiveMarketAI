"""
Trainer for Wavelet-based signal preprocessing for NSRAS regime classification
Module: wavelet_preprocessing.trainer
"""
import torch
...
class WaveletPreprocessorTrainer(nn.Module):
    """
    Trainer for Wavelet-based signal preprocessing for NSRAS regime classification
    """
