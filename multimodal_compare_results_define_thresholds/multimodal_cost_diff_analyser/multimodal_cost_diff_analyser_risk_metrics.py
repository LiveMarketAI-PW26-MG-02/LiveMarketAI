"""
  ...
  File       : multimodal_cost_diff_analyser_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_cost_diff_analyser_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCostDiffAnalyserRiskMetricsConfig:
...
class MultimodalCostDiffAnalyserEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCostDiffAnalyserRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalCostDiffAnalyserRiskMetricsConfig()
