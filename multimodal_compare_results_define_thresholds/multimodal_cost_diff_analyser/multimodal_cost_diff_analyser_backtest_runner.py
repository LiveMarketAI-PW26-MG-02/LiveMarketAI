"""
  ...
  File       : multimodal_cost_diff_analyser_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_cost_diff_analyser_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCostDiffAnalyserBacktestRunnerConfig:
...
class MultimodalCostDiffAnalyserEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCostDiffAnalyserBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalCostDiffAnalyserBacktestRunnerConfig()
