"""
  ...
  File       : multimodal_cost_diff_analyser_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_cost_diff_analyser_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCostDiffAnalyserDataPipelineConfig:
...
class MultimodalCostDiffAnalyserEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCostDiffAnalyserDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalCostDiffAnalyserDataPipelineConfig()
