"""
  ...
  File       : multimodal_cost_diff_analyser_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_cost_diff_analyser_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCostDiffAnalyserCoreLogicConfig:
...
class MultimodalCostDiffAnalyserEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCostDiffAnalyserCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalCostDiffAnalyserCoreLogicConfig()
