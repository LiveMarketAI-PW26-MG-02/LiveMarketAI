"""
  ...
  Folder     : multimodal_cost_diff_analyser
  File       : multimodal_cost_diff_analyser_signal_generator.py
  Purpose    : Compare Results — Cost Diff Analyser
"""
...
MULTIMODAL_MODULE = 'multimodal_cost_diff_analyser_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCostDiffAnalyserSignalGeneratorConfig:
    """Multimodal threshold-sweep config for cost_diff_analyser."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalCostDiffAnalyserEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: compare results — cost diff analyser.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalCostDiffAnalyserSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalCostDiffAnalyserSignalGeneratorConfig()
