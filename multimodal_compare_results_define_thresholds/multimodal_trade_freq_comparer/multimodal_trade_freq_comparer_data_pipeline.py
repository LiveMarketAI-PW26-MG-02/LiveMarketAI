"""
  ...
  File       : multimodal_trade_freq_comparer_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_trade_freq_comparer_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalTradeFreqComparerDataPipelineConfig:
...
class MultimodalTradeFreqComparerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalTradeFreqComparerDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalTradeFreqComparerDataPipelineConfig()
