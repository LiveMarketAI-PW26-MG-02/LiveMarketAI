"""
  ...
  File       : multimodal_trade_freq_comparer_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_trade_freq_comparer_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalTradeFreqComparerRiskMetricsConfig:
...
class MultimodalTradeFreqComparerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalTradeFreqComparerRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalTradeFreqComparerRiskMetricsConfig()
