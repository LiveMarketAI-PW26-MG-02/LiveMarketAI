"""
  ...
  File       : multimodal_trade_freq_comparer_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_trade_freq_comparer_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalTradeFreqComparerCoreLogicConfig:
...
class MultimodalTradeFreqComparerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalTradeFreqComparerCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalTradeFreqComparerCoreLogicConfig()
