"""
  ...
  File       : multimodal_trade_freq_comparer_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_trade_freq_comparer_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalTradeFreqComparerBacktestRunnerConfig:
...
class MultimodalTradeFreqComparerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalTradeFreqComparerBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalTradeFreqComparerBacktestRunnerConfig()
