"""
  ...
  Folder     : multimodal_trade_freq_comparer
  File       : multimodal_trade_freq_comparer_signal_generator.py
  Purpose    : Compare Results — Trade Freq Comparer
"""
...
MULTIMODAL_MODULE = 'multimodal_trade_freq_comparer_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalTradeFreqComparerSignalGeneratorConfig:
    """Multimodal threshold-sweep config for trade_freq_comparer."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalTradeFreqComparerEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: compare results — trade freq comparer.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalTradeFreqComparerSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalTradeFreqComparerSignalGeneratorConfig()
