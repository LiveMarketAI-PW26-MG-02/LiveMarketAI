"""
  ...
  File       : multimodal_risk_profile_comparer_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_risk_profile_comparer_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRiskProfileComparerCoreLogicConfig:
...
class MultimodalRiskProfileComparerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRiskProfileComparerCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalRiskProfileComparerCoreLogicConfig()
