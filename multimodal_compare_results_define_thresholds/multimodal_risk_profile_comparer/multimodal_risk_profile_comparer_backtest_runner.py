"""
  ...
  File       : multimodal_risk_profile_comparer_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_risk_profile_comparer_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRiskProfileComparerBacktestRunnerConfig:
...
class MultimodalRiskProfileComparerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRiskProfileComparerBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalRiskProfileComparerBacktestRunnerConfig()
