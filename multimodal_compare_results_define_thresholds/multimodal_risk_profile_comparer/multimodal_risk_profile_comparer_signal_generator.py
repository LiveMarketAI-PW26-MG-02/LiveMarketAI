"""
  ...
  Folder     : multimodal_risk_profile_comparer
  File       : multimodal_risk_profile_comparer_signal_generator.py
  Purpose    : Compare Results — Risk Profile Comparer
"""
...
MULTIMODAL_MODULE = 'multimodal_risk_profile_comparer_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRiskProfileComparerSignalGeneratorConfig:
    """Multimodal threshold-sweep config for risk_profile_comparer."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalRiskProfileComparerEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: compare results — risk profile comparer.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalRiskProfileComparerSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalRiskProfileComparerSignalGeneratorConfig()
