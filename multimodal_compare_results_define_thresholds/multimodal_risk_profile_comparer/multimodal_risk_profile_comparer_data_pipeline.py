"""
  ...
  File       : multimodal_risk_profile_comparer_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_risk_profile_comparer_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRiskProfileComparerDataPipelineConfig:
...
class MultimodalRiskProfileComparerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRiskProfileComparerDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalRiskProfileComparerDataPipelineConfig()
