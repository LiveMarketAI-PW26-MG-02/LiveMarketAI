"""
  ...
  File       : multimodal_risk_profile_comparer_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_risk_profile_comparer_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRiskProfileComparerRiskMetricsConfig:
...
class MultimodalRiskProfileComparerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRiskProfileComparerRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalRiskProfileComparerRiskMetricsConfig()
