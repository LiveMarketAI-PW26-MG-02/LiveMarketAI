"""
  ...
  File       : multimodal_signal_overlap_differ_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_signal_overlap_differ_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSignalOverlapDifferRiskMetricsConfig:
...
class MultimodalSignalOverlapDifferEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSignalOverlapDifferRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalSignalOverlapDifferRiskMetricsConfig()
