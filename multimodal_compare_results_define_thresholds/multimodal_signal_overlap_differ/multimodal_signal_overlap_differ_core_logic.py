"""
  ...
  File       : multimodal_signal_overlap_differ_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_signal_overlap_differ_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSignalOverlapDifferCoreLogicConfig:
...
class MultimodalSignalOverlapDifferEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSignalOverlapDifferCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalSignalOverlapDifferCoreLogicConfig()
