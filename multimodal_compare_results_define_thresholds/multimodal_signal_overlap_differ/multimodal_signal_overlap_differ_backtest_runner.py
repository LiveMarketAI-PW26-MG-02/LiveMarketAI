"""
  ...
  File       : multimodal_signal_overlap_differ_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_signal_overlap_differ_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSignalOverlapDifferBacktestRunnerConfig:
...
class MultimodalSignalOverlapDifferEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSignalOverlapDifferBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalSignalOverlapDifferBacktestRunnerConfig()
