"""
  ...
  File       : multimodal_signal_overlap_differ_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_signal_overlap_differ_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSignalOverlapDifferDataPipelineConfig:
...
class MultimodalSignalOverlapDifferEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSignalOverlapDifferDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalSignalOverlapDifferDataPipelineConfig()
