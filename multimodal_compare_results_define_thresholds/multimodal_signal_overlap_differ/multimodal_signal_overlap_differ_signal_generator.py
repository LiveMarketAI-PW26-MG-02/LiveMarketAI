"""
  ...
  Folder     : multimodal_signal_overlap_differ
  File       : multimodal_signal_overlap_differ_signal_generator.py
  Purpose    : Compare Results — Signal Overlap Differ
"""
...
MULTIMODAL_MODULE = 'multimodal_signal_overlap_differ_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSignalOverlapDifferSignalGeneratorConfig:
    """Multimodal threshold-sweep config for signal_overlap_differ."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalSignalOverlapDifferEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: compare results — signal overlap differ.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalSignalOverlapDifferSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalSignalOverlapDifferSignalGeneratorConfig()
