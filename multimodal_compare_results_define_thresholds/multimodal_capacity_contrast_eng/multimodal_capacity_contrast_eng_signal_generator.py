"""
  ...
  Folder     : multimodal_capacity_contrast_eng
  File       : multimodal_capacity_contrast_eng_signal_generator.py
  Purpose    : Compare Results — Capacity Contrast Eng
"""
...
MULTIMODAL_MODULE = 'multimodal_capacity_contrast_eng_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCapacityContrastEngSignalGeneratorConfig:
    """Multimodal threshold-sweep config for capacity_contrast_eng."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalCapacityContrastEngEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: compare results — capacity contrast eng.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalCapacityContrastEngSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalCapacityContrastEngSignalGeneratorConfig()
