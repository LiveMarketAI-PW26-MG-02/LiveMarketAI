"""
  ...
  File       : multimodal_capacity_contrast_eng_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_capacity_contrast_eng_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCapacityContrastEngDataPipelineConfig:
...
class MultimodalCapacityContrastEngEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCapacityContrastEngDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalCapacityContrastEngDataPipelineConfig()
