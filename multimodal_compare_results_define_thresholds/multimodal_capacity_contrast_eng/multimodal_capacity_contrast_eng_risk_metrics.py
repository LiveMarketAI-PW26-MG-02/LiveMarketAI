"""
  ...
  File       : multimodal_capacity_contrast_eng_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_capacity_contrast_eng_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCapacityContrastEngRiskMetricsConfig:
...
class MultimodalCapacityContrastEngEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCapacityContrastEngRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalCapacityContrastEngRiskMetricsConfig()
