"""
  ...
  File       : multimodal_capacity_contrast_eng_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_capacity_contrast_eng_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCapacityContrastEngBacktestRunnerConfig:
...
class MultimodalCapacityContrastEngEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCapacityContrastEngBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalCapacityContrastEngBacktestRunnerConfig()
