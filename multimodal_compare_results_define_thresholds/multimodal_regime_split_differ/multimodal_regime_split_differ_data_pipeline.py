"""
  ...
  File       : multimodal_regime_split_differ_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_regime_split_differ_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeSplitDifferDataPipelineConfig:
...
class MultimodalRegimeSplitDifferEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegimeSplitDifferDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalRegimeSplitDifferDataPipelineConfig()
