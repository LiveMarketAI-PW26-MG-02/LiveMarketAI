"""
  ...
  Folder     : multimodal_regime_split_differ
  File       : multimodal_regime_split_differ_signal_generator.py
  Purpose    : Compare Results — Regime Split Differ
"""
...
MULTIMODAL_MODULE = 'multimodal_regime_split_differ_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeSplitDifferSignalGeneratorConfig:
    """Multimodal threshold-sweep config for regime_split_differ."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalRegimeSplitDifferEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: compare results — regime split differ.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalRegimeSplitDifferSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalRegimeSplitDifferSignalGeneratorConfig()
