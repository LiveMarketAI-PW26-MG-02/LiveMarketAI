"""
  ...
  File       : multimodal_regime_split_differ_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_regime_split_differ_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeSplitDifferRiskMetricsConfig:
...
class MultimodalRegimeSplitDifferEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegimeSplitDifferRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalRegimeSplitDifferRiskMetricsConfig()
