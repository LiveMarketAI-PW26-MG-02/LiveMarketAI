"""
  ...
  File       : multimodal_regime_split_differ_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_regime_split_differ_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeSplitDifferBacktestRunnerConfig:
...
class MultimodalRegimeSplitDifferEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegimeSplitDifferBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalRegimeSplitDifferBacktestRunnerConfig()
