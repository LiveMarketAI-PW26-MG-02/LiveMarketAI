"""
  ...
  File       : multimodal_regime_split_differ_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_regime_split_differ_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeSplitDifferCoreLogicConfig:
...
class MultimodalRegimeSplitDifferEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegimeSplitDifferCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalRegimeSplitDifferCoreLogicConfig()
