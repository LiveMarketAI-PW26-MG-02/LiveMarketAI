"""
  ...
  File       : multimodal_oos_gap_comparer_signal_generator.py
...
MULTIMODAL_MODULE = 'multimodal_oos_gap_comparer_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalOosGapComparerSignalGeneratorConfig:
...
class MultimodalOosGapComparerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalOosGapComparerSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalOosGapComparerSignalGeneratorConfig()
