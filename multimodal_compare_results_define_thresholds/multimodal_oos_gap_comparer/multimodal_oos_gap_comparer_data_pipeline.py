"""
  ...
  File       : multimodal_oos_gap_comparer_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_oos_gap_comparer_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalOosGapComparerDataPipelineConfig:
...
class MultimodalOosGapComparerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalOosGapComparerDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalOosGapComparerDataPipelineConfig()
