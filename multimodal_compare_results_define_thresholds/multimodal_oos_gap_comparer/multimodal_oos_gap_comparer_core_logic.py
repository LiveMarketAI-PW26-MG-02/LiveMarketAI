"""
  ...
  File       : multimodal_oos_gap_comparer_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_oos_gap_comparer_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalOosGapComparerCoreLogicConfig:
...
class MultimodalOosGapComparerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalOosGapComparerCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalOosGapComparerCoreLogicConfig()
