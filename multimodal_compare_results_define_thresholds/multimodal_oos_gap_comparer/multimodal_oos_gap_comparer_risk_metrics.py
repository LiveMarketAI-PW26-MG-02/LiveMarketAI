"""
  ...
  File       : multimodal_oos_gap_comparer_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_oos_gap_comparer_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalOosGapComparerRiskMetricsConfig:
...
class MultimodalOosGapComparerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalOosGapComparerRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalOosGapComparerRiskMetricsConfig()
