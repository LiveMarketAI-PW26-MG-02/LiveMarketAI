"""
  ...
  File       : multimodal_factor_load_comparer_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_factor_load_comparer_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalFactorLoadComparerRiskMetricsConfig:
...
class MultimodalFactorLoadComparerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalFactorLoadComparerRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalFactorLoadComparerRiskMetricsConfig()
