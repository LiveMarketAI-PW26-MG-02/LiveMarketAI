"""
  ...
  Folder     : multimodal_factor_load_comparer
  File       : multimodal_factor_load_comparer_signal_generator.py
  Purpose    : Compare Results — Factor Load Comparer
"""
...
MULTIMODAL_MODULE = 'multimodal_factor_load_comparer_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalFactorLoadComparerSignalGeneratorConfig:
    """Multimodal threshold-sweep config for factor_load_comparer."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalFactorLoadComparerEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: compare results — factor load comparer.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalFactorLoadComparerSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalFactorLoadComparerSignalGeneratorConfig()
