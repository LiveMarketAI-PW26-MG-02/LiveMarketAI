"""
  ...
  File       : multimodal_factor_load_comparer_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_factor_load_comparer_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalFactorLoadComparerBacktestRunnerConfig:
...
class MultimodalFactorLoadComparerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalFactorLoadComparerBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalFactorLoadComparerBacktestRunnerConfig()
