"""
  ...
  File       : multimodal_factor_load_comparer_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_factor_load_comparer_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalFactorLoadComparerDataPipelineConfig:
...
class MultimodalFactorLoadComparerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalFactorLoadComparerDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalFactorLoadComparerDataPipelineConfig()
