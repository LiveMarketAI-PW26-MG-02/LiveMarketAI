"""
  ...
  File       : multimodal_factor_load_comparer_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_factor_load_comparer_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalFactorLoadComparerCoreLogicConfig:
...
class MultimodalFactorLoadComparerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalFactorLoadComparerCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalFactorLoadComparerCoreLogicConfig()
