"""
  ...
  File       : multimodal_threshold_pnl_comparer_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_threshold_pnl_comparer_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalThresholdPnlComparerBacktestRunnerConfig:
...
class MultimodalThresholdPnlComparerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalThresholdPnlComparerBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalThresholdPnlComparerBacktestRunnerConfig()
