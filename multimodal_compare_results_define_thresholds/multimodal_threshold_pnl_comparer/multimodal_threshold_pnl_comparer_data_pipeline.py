"""
  ...
  File       : multimodal_threshold_pnl_comparer_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_threshold_pnl_comparer_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalThresholdPnlComparerDataPipelineConfig:
...
class MultimodalThresholdPnlComparerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalThresholdPnlComparerDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalThresholdPnlComparerDataPipelineConfig()
