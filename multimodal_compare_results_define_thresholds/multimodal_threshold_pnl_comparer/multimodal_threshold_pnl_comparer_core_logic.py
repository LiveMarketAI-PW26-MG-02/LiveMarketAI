"""
  ...
  File       : multimodal_threshold_pnl_comparer_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_threshold_pnl_comparer_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalThresholdPnlComparerCoreLogicConfig:
...
class MultimodalThresholdPnlComparerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalThresholdPnlComparerCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalThresholdPnlComparerCoreLogicConfig()
