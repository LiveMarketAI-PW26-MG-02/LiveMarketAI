"""
  ...
  File       : multimodal_threshold_pnl_comparer_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_threshold_pnl_comparer_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalThresholdPnlComparerRiskMetricsConfig:
...
class MultimodalThresholdPnlComparerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalThresholdPnlComparerRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalThresholdPnlComparerRiskMetricsConfig()
