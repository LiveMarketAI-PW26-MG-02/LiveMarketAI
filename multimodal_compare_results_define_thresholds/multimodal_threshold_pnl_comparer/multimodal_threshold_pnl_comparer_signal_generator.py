"""
  ...
  Folder     : multimodal_threshold_pnl_comparer
  File       : multimodal_threshold_pnl_comparer_signal_generator.py
  Purpose    : Compare Results — Threshold Pnl Comparer
"""
...
MULTIMODAL_MODULE = 'multimodal_threshold_pnl_comparer_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalThresholdPnlComparerSignalGeneratorConfig:
    """Multimodal threshold-sweep config for threshold_pnl_comparer."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalThresholdPnlComparerEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: compare results — threshold pnl comparer.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalThresholdPnlComparerSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalThresholdPnlComparerSignalGeneratorConfig()
