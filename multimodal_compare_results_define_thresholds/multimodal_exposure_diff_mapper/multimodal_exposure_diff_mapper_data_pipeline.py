"""
  ...
  File       : multimodal_exposure_diff_mapper_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_exposure_diff_mapper_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalExposureDiffMapperDataPipelineConfig:
...
class MultimodalExposureDiffMapperEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalExposureDiffMapperDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalExposureDiffMapperDataPipelineConfig()
