"""
  ...
  Folder     : multimodal_exposure_diff_mapper
  File       : multimodal_exposure_diff_mapper_signal_generator.py
  Purpose    : Compare Results — Exposure Diff Mapper
"""
...
MULTIMODAL_MODULE = 'multimodal_exposure_diff_mapper_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalExposureDiffMapperSignalGeneratorConfig:
    """Multimodal threshold-sweep config for exposure_diff_mapper."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalExposureDiffMapperEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: compare results — exposure diff mapper.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalExposureDiffMapperSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalExposureDiffMapperSignalGeneratorConfig()
