"""
  ...
  File       : multimodal_exposure_diff_mapper_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_exposure_diff_mapper_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalExposureDiffMapperRiskMetricsConfig:
...
class MultimodalExposureDiffMapperEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalExposureDiffMapperRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalExposureDiffMapperRiskMetricsConfig()
