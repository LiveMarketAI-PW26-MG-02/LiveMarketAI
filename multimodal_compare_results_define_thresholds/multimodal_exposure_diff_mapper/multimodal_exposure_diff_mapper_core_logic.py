"""
  ...
  File       : multimodal_exposure_diff_mapper_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_exposure_diff_mapper_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalExposureDiffMapperCoreLogicConfig:
...
class MultimodalExposureDiffMapperEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalExposureDiffMapperCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalExposureDiffMapperCoreLogicConfig()
