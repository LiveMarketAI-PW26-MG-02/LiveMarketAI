"""
  ...
  File       : multimodal_exposure_diff_mapper_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_exposure_diff_mapper_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalExposureDiffMapperBacktestRunnerConfig:
...
class MultimodalExposureDiffMapperEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalExposureDiffMapperBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalExposureDiffMapperBacktestRunnerConfig()
