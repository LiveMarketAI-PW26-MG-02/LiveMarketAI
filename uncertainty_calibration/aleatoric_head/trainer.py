"""
Trainer for Aleatoric (data) uncertainty estimation via learned noise variance
Module: aleatoric_head.trainer
"""
import torch
...
class AleatoricUncertaintyHeadTrainer(nn.Module):
    """
    Trainer for Aleatoric (data) uncertainty estimation via learned noise variance
    """
