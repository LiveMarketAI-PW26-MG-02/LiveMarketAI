"""
Dataset for Aleatoric (data) uncertainty estimation via learned noise variance
Module: aleatoric_head.dataset
"""
import torch
...
class AleatoricUncertaintyHeadDataset(nn.Module):
    """
    Dataset for Aleatoric (data) uncertainty estimation via learned noise variance
    """
