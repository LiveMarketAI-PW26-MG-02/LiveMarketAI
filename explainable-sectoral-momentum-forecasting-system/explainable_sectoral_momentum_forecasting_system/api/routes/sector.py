...
from ...schemas.sector import SectorCreate, SectorRead

router = APIRouter(prefix="/sectors", tags=["Sector"])
...
@router.get("/{item_id}", response_model=SectorRead)
...
def create_item(payload: SectorCreate, db: Session = Depends(get_db)):
