"""
  ...
  File       : multimodal_signal_noise_analyser_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_signal_noise_analyser_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSignalNoiseAnalyserDataPipelineConfig:
...
class MultimodalSignalNoiseAnalyserEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSignalNoiseAnalyserDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalSignalNoiseAnalyserDataPipelineConfig()
