"""
  ...
  File       : multimodal_signal_noise_analyser_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_signal_noise_analyser_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSignalNoiseAnalyserBacktestRunnerConfig:
...
class MultimodalSignalNoiseAnalyserEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSignalNoiseAnalyserBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalSignalNoiseAnalyserBacktestRunnerConfig()
