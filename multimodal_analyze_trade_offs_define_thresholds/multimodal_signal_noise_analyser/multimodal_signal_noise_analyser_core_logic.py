"""
  ...
  File       : multimodal_signal_noise_analyser_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_signal_noise_analyser_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSignalNoiseAnalyserCoreLogicConfig:
...
class MultimodalSignalNoiseAnalyserEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSignalNoiseAnalyserCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalSignalNoiseAnalyserCoreLogicConfig()
