"""
  ...
  Folder     : multimodal_signal_noise_analyser
  File       : multimodal_signal_noise_analyser_signal_generator.py
  Purpose    : Analyze Trade Offs — Signal Noise Analyser
"""
...
MULTIMODAL_MODULE = 'multimodal_signal_noise_analyser_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSignalNoiseAnalyserSignalGeneratorConfig:
    """Multimodal threshold-sweep config for signal_noise_analyser."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalSignalNoiseAnalyserEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: analyze trade offs — signal noise analyser.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalSignalNoiseAnalyserSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalSignalNoiseAnalyserSignalGeneratorConfig()
