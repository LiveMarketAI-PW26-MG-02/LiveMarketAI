"""
  ...
  File       : multimodal_signal_noise_analyser_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_signal_noise_analyser_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSignalNoiseAnalyserRiskMetricsConfig:
...
class MultimodalSignalNoiseAnalyserEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSignalNoiseAnalyserRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalSignalNoiseAnalyserRiskMetricsConfig()
