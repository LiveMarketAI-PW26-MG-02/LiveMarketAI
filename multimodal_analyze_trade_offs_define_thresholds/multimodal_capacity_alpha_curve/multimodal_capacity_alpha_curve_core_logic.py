"""
  ...
  File       : multimodal_capacity_alpha_curve_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_capacity_alpha_curve_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCapacityAlphaCurveCoreLogicConfig:
...
class MultimodalCapacityAlphaCurveEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCapacityAlphaCurveCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalCapacityAlphaCurveCoreLogicConfig()
