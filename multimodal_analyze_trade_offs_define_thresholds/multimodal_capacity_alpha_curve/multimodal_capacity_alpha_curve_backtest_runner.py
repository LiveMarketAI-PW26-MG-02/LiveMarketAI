"""
  ...
  File       : multimodal_capacity_alpha_curve_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_capacity_alpha_curve_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCapacityAlphaCurveBacktestRunnerConfig:
...
class MultimodalCapacityAlphaCurveEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCapacityAlphaCurveBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalCapacityAlphaCurveBacktestRunnerConfig()
