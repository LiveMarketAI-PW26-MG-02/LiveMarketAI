"""
  ...
  File       : multimodal_capacity_alpha_curve_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_capacity_alpha_curve_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCapacityAlphaCurveRiskMetricsConfig:
...
class MultimodalCapacityAlphaCurveEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCapacityAlphaCurveRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalCapacityAlphaCurveRiskMetricsConfig()
