"""
  ...
  Folder     : multimodal_capacity_alpha_curve
  File       : multimodal_capacity_alpha_curve_signal_generator.py
  Purpose    : Analyze Trade Offs — Capacity Alpha Curve
"""
...
MULTIMODAL_MODULE = 'multimodal_capacity_alpha_curve_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCapacityAlphaCurveSignalGeneratorConfig:
    """Multimodal threshold-sweep config for capacity_alpha_curve."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalCapacityAlphaCurveEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: analyze trade offs — capacity alpha curve.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalCapacityAlphaCurveSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalCapacityAlphaCurveSignalGeneratorConfig()
