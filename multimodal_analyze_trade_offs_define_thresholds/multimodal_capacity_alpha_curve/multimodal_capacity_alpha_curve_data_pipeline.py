"""
  ...
  File       : multimodal_capacity_alpha_curve_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_capacity_alpha_curve_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCapacityAlphaCurveDataPipelineConfig:
...
class MultimodalCapacityAlphaCurveEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCapacityAlphaCurveDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalCapacityAlphaCurveDataPipelineConfig()
