"""
  ...
  File       : multimodal_bias_variance_thresh_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_bias_variance_thresh_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalBiasVarianceThreshDataPipelineConfig:
...
class MultimodalBiasVarianceThreshEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalBiasVarianceThreshDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalBiasVarianceThreshDataPipelineConfig()
