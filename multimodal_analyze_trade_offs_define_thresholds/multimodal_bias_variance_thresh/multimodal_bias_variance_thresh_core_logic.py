"""
  ...
  File       : multimodal_bias_variance_thresh_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_bias_variance_thresh_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalBiasVarianceThreshCoreLogicConfig:
...
class MultimodalBiasVarianceThreshEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalBiasVarianceThreshCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalBiasVarianceThreshCoreLogicConfig()
