"""
  ...
  File       : multimodal_bias_variance_thresh_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_bias_variance_thresh_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalBiasVarianceThreshRiskMetricsConfig:
...
class MultimodalBiasVarianceThreshEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalBiasVarianceThreshRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalBiasVarianceThreshRiskMetricsConfig()
