"""
  ...
  Folder     : multimodal_bias_variance_thresh
  File       : multimodal_bias_variance_thresh_signal_generator.py
  Purpose    : Analyze Trade Offs — Bias Variance Thresh
"""
...
MULTIMODAL_MODULE = 'multimodal_bias_variance_thresh_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalBiasVarianceThreshSignalGeneratorConfig:
    """Multimodal threshold-sweep config for bias_variance_thresh."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalBiasVarianceThreshEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: analyze trade offs — bias variance thresh.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalBiasVarianceThreshSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalBiasVarianceThreshSignalGeneratorConfig()
