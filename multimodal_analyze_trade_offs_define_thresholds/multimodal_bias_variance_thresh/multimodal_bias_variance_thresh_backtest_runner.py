"""
  ...
  File       : multimodal_bias_variance_thresh_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_bias_variance_thresh_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalBiasVarianceThreshBacktestRunnerConfig:
...
class MultimodalBiasVarianceThreshEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalBiasVarianceThreshBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalBiasVarianceThreshBacktestRunnerConfig()
