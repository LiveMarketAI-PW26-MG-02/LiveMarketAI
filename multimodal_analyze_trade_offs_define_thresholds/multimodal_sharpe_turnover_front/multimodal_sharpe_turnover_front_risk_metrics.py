"""
  ...
  File       : multimodal_sharpe_turnover_front_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_sharpe_turnover_front_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSharpeTurnoverFrontRiskMetricsConfig:
...
class MultimodalSharpeTurnoverFrontEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSharpeTurnoverFrontRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalSharpeTurnoverFrontRiskMetricsConfig()
