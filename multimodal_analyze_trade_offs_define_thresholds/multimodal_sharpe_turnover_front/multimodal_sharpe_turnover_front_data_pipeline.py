"""
  ...
  File       : multimodal_sharpe_turnover_front_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_sharpe_turnover_front_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSharpeTurnoverFrontDataPipelineConfig:
...
class MultimodalSharpeTurnoverFrontEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSharpeTurnoverFrontDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalSharpeTurnoverFrontDataPipelineConfig()
