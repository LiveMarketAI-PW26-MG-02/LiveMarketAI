"""
  ...
  Folder     : multimodal_sharpe_turnover_front
  File       : multimodal_sharpe_turnover_front_signal_generator.py
  Purpose    : Analyze Trade Offs — Sharpe Turnover Front
"""
...
MULTIMODAL_MODULE = 'multimodal_sharpe_turnover_front_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSharpeTurnoverFrontSignalGeneratorConfig:
    """Multimodal threshold-sweep config for sharpe_turnover_front."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalSharpeTurnoverFrontEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: analyze trade offs — sharpe turnover front.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalSharpeTurnoverFrontSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalSharpeTurnoverFrontSignalGeneratorConfig()
