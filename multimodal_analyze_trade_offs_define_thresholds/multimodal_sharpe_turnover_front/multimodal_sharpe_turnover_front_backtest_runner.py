"""
  ...
  File       : multimodal_sharpe_turnover_front_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_sharpe_turnover_front_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSharpeTurnoverFrontBacktestRunnerConfig:
...
class MultimodalSharpeTurnoverFrontEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSharpeTurnoverFrontBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalSharpeTurnoverFrontBacktestRunnerConfig()
