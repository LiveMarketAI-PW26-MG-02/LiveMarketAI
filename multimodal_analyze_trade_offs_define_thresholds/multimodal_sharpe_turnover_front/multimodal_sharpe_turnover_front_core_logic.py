"""
  ...
  File       : multimodal_sharpe_turnover_front_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_sharpe_turnover_front_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSharpeTurnoverFrontCoreLogicConfig:
...
class MultimodalSharpeTurnoverFrontEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSharpeTurnoverFrontCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalSharpeTurnoverFrontCoreLogicConfig()
