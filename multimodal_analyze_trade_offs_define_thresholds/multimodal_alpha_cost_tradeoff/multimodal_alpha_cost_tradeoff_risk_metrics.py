"""
  ...
  File       : multimodal_alpha_cost_tradeoff_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_alpha_cost_tradeoff_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalAlphaCostTradeoffRiskMetricsConfig:
...
class MultimodalAlphaCostTradeoffEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalAlphaCostTradeoffRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalAlphaCostTradeoffRiskMetricsConfig()
