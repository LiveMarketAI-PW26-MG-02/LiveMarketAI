"""
  ...
  File       : multimodal_alpha_cost_tradeoff_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_alpha_cost_tradeoff_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalAlphaCostTradeoffCoreLogicConfig:
...
class MultimodalAlphaCostTradeoffEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalAlphaCostTradeoffCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalAlphaCostTradeoffCoreLogicConfig()
