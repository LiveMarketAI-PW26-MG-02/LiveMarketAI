"""
  ...
  File       : multimodal_alpha_cost_tradeoff_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_alpha_cost_tradeoff_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalAlphaCostTradeoffBacktestRunnerConfig:
...
class MultimodalAlphaCostTradeoffEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalAlphaCostTradeoffBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalAlphaCostTradeoffBacktestRunnerConfig()
