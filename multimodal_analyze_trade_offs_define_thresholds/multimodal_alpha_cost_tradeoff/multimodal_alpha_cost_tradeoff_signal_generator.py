"""
  ...
  Folder     : multimodal_alpha_cost_tradeoff
  File       : multimodal_alpha_cost_tradeoff_signal_generator.py
  Purpose    : Analyze Trade Offs — Alpha Cost Tradeoff
"""
...
MULTIMODAL_MODULE = 'multimodal_alpha_cost_tradeoff_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalAlphaCostTradeoffSignalGeneratorConfig:
    """Multimodal threshold-sweep config for alpha_cost_tradeoff."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalAlphaCostTradeoffEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: analyze trade offs — alpha cost tradeoff.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalAlphaCostTradeoffSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalAlphaCostTradeoffSignalGeneratorConfig()
