"""
  ...
  File       : multimodal_precision_recall_curve_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_precision_recall_curve_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalPrecisionRecallCurveRiskMetricsConfig:
...
class MultimodalPrecisionRecallCurveEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPrecisionRecallCurveRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalPrecisionRecallCurveRiskMetricsConfig()
