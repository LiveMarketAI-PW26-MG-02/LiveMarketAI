"""
  ...
  Folder     : multimodal_precision_recall_curve
  File       : multimodal_precision_recall_curve_signal_generator.py
  Purpose    : Analyze Trade Offs — Precision Recall Curve
"""
...
MULTIMODAL_MODULE = 'multimodal_precision_recall_curve_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalPrecisionRecallCurveSignalGeneratorConfig:
    """Multimodal threshold-sweep config for precision_recall_curve."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalPrecisionRecallCurveEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: analyze trade offs — precision recall curve.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalPrecisionRecallCurveSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalPrecisionRecallCurveSignalGeneratorConfig()
