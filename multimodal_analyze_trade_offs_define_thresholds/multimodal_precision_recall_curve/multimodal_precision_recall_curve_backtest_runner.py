"""
  ...
  File       : multimodal_precision_recall_curve_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_precision_recall_curve_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalPrecisionRecallCurveBacktestRunnerConfig:
...
class MultimodalPrecisionRecallCurveEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPrecisionRecallCurveBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalPrecisionRecallCurveBacktestRunnerConfig()
