"""
  ...
  File       : multimodal_precision_recall_curve_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_precision_recall_curve_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalPrecisionRecallCurveCoreLogicConfig:
...
class MultimodalPrecisionRecallCurveEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPrecisionRecallCurveCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalPrecisionRecallCurveCoreLogicConfig()
