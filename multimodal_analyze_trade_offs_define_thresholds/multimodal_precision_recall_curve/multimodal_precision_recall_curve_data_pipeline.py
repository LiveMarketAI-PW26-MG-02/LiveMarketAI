"""
  ...
  File       : multimodal_precision_recall_curve_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_precision_recall_curve_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalPrecisionRecallCurveDataPipelineConfig:
...
class MultimodalPrecisionRecallCurveEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPrecisionRecallCurveDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalPrecisionRecallCurveDataPipelineConfig()
