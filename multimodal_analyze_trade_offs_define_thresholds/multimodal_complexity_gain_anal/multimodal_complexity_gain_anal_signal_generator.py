"""
  ...
  Folder     : multimodal_complexity_gain_anal
  File       : multimodal_complexity_gain_anal_signal_generator.py
  Purpose    : Analyze Trade Offs — Complexity Gain Anal
"""
...
MULTIMODAL_MODULE = 'multimodal_complexity_gain_anal_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalComplexityGainAnalSignalGeneratorConfig:
    """Multimodal threshold-sweep config for complexity_gain_anal."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalComplexityGainAnalEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: analyze trade offs — complexity gain anal.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalComplexityGainAnalSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalComplexityGainAnalSignalGeneratorConfig()
