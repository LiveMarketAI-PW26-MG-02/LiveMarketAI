"""
  ...
  File       : multimodal_complexity_gain_anal_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_complexity_gain_anal_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalComplexityGainAnalBacktestRunnerConfig:
...
class MultimodalComplexityGainAnalEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalComplexityGainAnalBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalComplexityGainAnalBacktestRunnerConfig()
