"""
  ...
  File       : multimodal_complexity_gain_anal_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_complexity_gain_anal_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalComplexityGainAnalCoreLogicConfig:
...
class MultimodalComplexityGainAnalEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalComplexityGainAnalCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalComplexityGainAnalCoreLogicConfig()
