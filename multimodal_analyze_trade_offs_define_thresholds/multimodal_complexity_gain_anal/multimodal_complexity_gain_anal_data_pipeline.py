"""
  ...
  File       : multimodal_complexity_gain_anal_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_complexity_gain_anal_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalComplexityGainAnalDataPipelineConfig:
...
class MultimodalComplexityGainAnalEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalComplexityGainAnalDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalComplexityGainAnalDataPipelineConfig()
