"""
  ...
  File       : multimodal_complexity_gain_anal_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_complexity_gain_anal_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalComplexityGainAnalRiskMetricsConfig:
...
class MultimodalComplexityGainAnalEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalComplexityGainAnalRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalComplexityGainAnalRiskMetricsConfig()
