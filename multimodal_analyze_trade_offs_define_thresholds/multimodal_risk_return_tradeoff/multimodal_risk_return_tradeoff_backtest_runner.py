"""
  ...
  File       : multimodal_risk_return_tradeoff_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_risk_return_tradeoff_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRiskReturnTradeoffBacktestRunnerConfig:
...
class MultimodalRiskReturnTradeoffEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRiskReturnTradeoffBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalRiskReturnTradeoffBacktestRunnerConfig()
