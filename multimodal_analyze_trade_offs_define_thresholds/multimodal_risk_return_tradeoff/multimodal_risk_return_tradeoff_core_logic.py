"""
  ...
  File       : multimodal_risk_return_tradeoff_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_risk_return_tradeoff_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRiskReturnTradeoffCoreLogicConfig:
...
class MultimodalRiskReturnTradeoffEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRiskReturnTradeoffCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalRiskReturnTradeoffCoreLogicConfig()
