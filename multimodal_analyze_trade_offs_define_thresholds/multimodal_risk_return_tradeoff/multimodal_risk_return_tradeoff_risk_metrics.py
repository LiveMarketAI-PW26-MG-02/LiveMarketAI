"""
  ...
  File       : multimodal_risk_return_tradeoff_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_risk_return_tradeoff_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRiskReturnTradeoffRiskMetricsConfig:
...
class MultimodalRiskReturnTradeoffEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRiskReturnTradeoffRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalRiskReturnTradeoffRiskMetricsConfig()
