"""
  ...
  File       : multimodal_latency_accuracy_curve_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_latency_accuracy_curve_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalLatencyAccuracyCurveBacktestRunnerConfig:
...
class MultimodalLatencyAccuracyCurveEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalLatencyAccuracyCurveBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalLatencyAccuracyCurveBacktestRunnerConfig()
