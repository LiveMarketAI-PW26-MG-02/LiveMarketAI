"""
  ...
  File       : multimodal_latency_accuracy_curve_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_latency_accuracy_curve_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalLatencyAccuracyCurveDataPipelineConfig:
...
class MultimodalLatencyAccuracyCurveEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalLatencyAccuracyCurveDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalLatencyAccuracyCurveDataPipelineConfig()
