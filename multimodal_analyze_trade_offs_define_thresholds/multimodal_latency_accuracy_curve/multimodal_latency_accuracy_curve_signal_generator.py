"""
  ...
  Folder     : multimodal_latency_accuracy_curve
  File       : multimodal_latency_accuracy_curve_signal_generator.py
  Purpose    : Analyze Trade Offs — Latency Accuracy Curve
"""
...
MULTIMODAL_MODULE = 'multimodal_latency_accuracy_curve_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalLatencyAccuracyCurveSignalGeneratorConfig:
    """Multimodal threshold-sweep config for latency_accuracy_curve."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalLatencyAccuracyCurveEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: analyze trade offs — latency accuracy curve.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalLatencyAccuracyCurveSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalLatencyAccuracyCurveSignalGeneratorConfig()
