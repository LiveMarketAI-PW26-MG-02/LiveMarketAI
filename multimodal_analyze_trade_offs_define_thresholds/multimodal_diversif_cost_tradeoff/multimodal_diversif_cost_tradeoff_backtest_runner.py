"""
  ...
  File       : multimodal_diversif_cost_tradeoff_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_diversif_cost_tradeoff_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalDiversifCostTradeoffBacktestRunnerConfig:
...
class MultimodalDiversifCostTradeoffEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDiversifCostTradeoffBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalDiversifCostTradeoffBacktestRunnerConfig()
