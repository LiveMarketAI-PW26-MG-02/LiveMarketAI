"""
  ...
  File       : multimodal_diversif_cost_tradeoff_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_diversif_cost_tradeoff_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalDiversifCostTradeoffCoreLogicConfig:
...
class MultimodalDiversifCostTradeoffEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDiversifCostTradeoffCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalDiversifCostTradeoffCoreLogicConfig()
