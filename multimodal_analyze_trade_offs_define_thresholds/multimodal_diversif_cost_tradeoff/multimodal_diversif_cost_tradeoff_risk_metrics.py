"""
  ...
  File       : multimodal_diversif_cost_tradeoff_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_diversif_cost_tradeoff_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalDiversifCostTradeoffRiskMetricsConfig:
...
class MultimodalDiversifCostTradeoffEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDiversifCostTradeoffRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalDiversifCostTradeoffRiskMetricsConfig()
