"""
Trainer for L2, spectral, and adaptive temporal attention drift regularizers
Module: drift_regularizers.trainer
"""
import torch
...
class TemporalDriftRegularizerTrainer(nn.Module):
    """
    Trainer for L2, spectral, and adaptive temporal attention drift regularizers
    """
