"""
Dataset for L2, spectral, and adaptive temporal attention drift regularizers
Module: drift_regularizers.dataset
"""
import torch
...
class TemporalDriftRegularizerDataset(nn.Module):
    """
    Dataset for L2, spectral, and adaptive temporal attention drift regularizers
    """
