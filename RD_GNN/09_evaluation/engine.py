#!/usr/bin/env python3
"""
Risk Diffusion Graph Network (RD-GNN) - Evaluation Engine (Alt Entry)
...
OUTPUT_DIR = "outputs/rd_gnn_eval"
os.makedirs(OUTPUT_DIR, exist_ok=True)
np.random.seed(42)

class BinaryClassificationEvaluator:
    """Full binary classification metric suite for RD-GNN."""
...
class RegimeEvaluator:
    """Regime-stratified evaluation for RD-GNN."""
...
class CalibrationEvaluator:
    """ECE and reliability diagram for RD-GNN probability calibration."""
...
class GraphEvaluator:
    """Graph-aware metrics for RD-GNN GNN evaluation."""
...
def main():
    print(f"\n{'='*60}\n  RD-GNN Evaluation Engine (Alt Entry)\n{'='*60}")
    n=200
    ...
    report={"module":"RD-GNN","full_name":"Risk Diffusion Graph Network","evaluated_at":datetime.utcnow().isoformat()+"Z",
