#!/usr/bin/env python3
"""
Risk Diffusion Graph Network (RD-GNN) - Data Generation Module
...
REGIME_TYPES      = ['stable', 'stress', 'contagion', 'cascade', 'recovery']
OUTPUT_DIR        = "outputs/rd_gnn_data"
...
class SyntheticMarketDataGenerator:
    """
    Generates synthetic OHLCV + microstructure + sentiment data for RD-GNN.
    ...
    def generate_price_series(self, asset_id: str, regime: str = "bull") -> pd.DataFrame:
        ...
        Regimes: ['stable', 'stress', 'contagion', 'cascade', 'recovery']
        """
        regime_params = {
...
class SentimentDataGenerator:
    ...
    price manipulation events for RD-GNN.
    """
...
class OrderBookGenerator:
    ...
    Critical for RD-GNN microstructure-based manipulation detection.
    """
...
def main():
    print(f"\n============================================================")
    print(f"  RD-GNN - Data Generation Pipeline")
    ...
    # Summary
    print(f"\n============================================================")
    print(f"  Data Generation Complete for RD-GNN")
