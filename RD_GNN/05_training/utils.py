#!/usr/bin/env python3
"""
RD-GNN - Shared Utility Functions
Common helpers used across all subfolders of the RD-GNN module.
"""
...
def get_logger(name: str = "RD-GNN", level: str = "INFO") -> logging.Logger:
    """Configure and return a logger for RD-GNN module."""
