"""
  ...
  File       : multimodal_ic_peak_identifier_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_ic_peak_identifier_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalIcPeakIdentifierRiskMetricsConfig:
...
class MultimodalIcPeakIdentifierEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalIcPeakIdentifierRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalIcPeakIdentifierRiskMetricsConfig()
