"""
  ...
  File       : multimodal_ic_peak_identifier_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_ic_peak_identifier_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalIcPeakIdentifierCoreLogicConfig:
...
class MultimodalIcPeakIdentifierEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalIcPeakIdentifierCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalIcPeakIdentifierCoreLogicConfig()
