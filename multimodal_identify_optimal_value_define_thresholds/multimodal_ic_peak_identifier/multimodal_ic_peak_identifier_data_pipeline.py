"""
  ...
  File       : multimodal_ic_peak_identifier_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_ic_peak_identifier_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalIcPeakIdentifierDataPipelineConfig:
...
class MultimodalIcPeakIdentifierEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalIcPeakIdentifierDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalIcPeakIdentifierDataPipelineConfig()
