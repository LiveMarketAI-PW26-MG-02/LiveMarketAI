"""
  ...
  Folder     : multimodal_ic_peak_identifier
  File       : multimodal_ic_peak_identifier_signal_generator.py
  Purpose    : Identify Optimal Value — Ic Peak Identifier
"""
...
MULTIMODAL_MODULE = 'multimodal_ic_peak_identifier_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalIcPeakIdentifierSignalGeneratorConfig:
    """Multimodal threshold-sweep config for ic_peak_identifier."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalIcPeakIdentifierEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: identify optimal value — ic peak identifier.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalIcPeakIdentifierSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalIcPeakIdentifierSignalGeneratorConfig()
