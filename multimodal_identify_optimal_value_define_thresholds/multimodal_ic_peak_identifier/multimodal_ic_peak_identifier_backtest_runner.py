"""
  ...
  File       : multimodal_ic_peak_identifier_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_ic_peak_identifier_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalIcPeakIdentifierBacktestRunnerConfig:
...
class MultimodalIcPeakIdentifierEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalIcPeakIdentifierBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalIcPeakIdentifierBacktestRunnerConfig()
