"""
  ...
  File       : multimodal_max_sharpe_locator_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_max_sharpe_locator_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalMaxSharpeLocatorDataPipelineConfig:
...
class MultimodalMaxSharpeLocatorEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMaxSharpeLocatorDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalMaxSharpeLocatorDataPipelineConfig()
