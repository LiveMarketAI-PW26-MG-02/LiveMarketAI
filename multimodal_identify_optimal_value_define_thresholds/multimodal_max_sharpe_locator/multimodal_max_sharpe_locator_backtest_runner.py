"""
  ...
  File       : multimodal_max_sharpe_locator_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_max_sharpe_locator_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalMaxSharpeLocatorBacktestRunnerConfig:
...
class MultimodalMaxSharpeLocatorEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMaxSharpeLocatorBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalMaxSharpeLocatorBacktestRunnerConfig()
