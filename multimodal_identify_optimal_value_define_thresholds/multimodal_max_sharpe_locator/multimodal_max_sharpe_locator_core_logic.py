"""
  ...
  File       : multimodal_max_sharpe_locator_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_max_sharpe_locator_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalMaxSharpeLocatorCoreLogicConfig:
...
class MultimodalMaxSharpeLocatorEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMaxSharpeLocatorCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalMaxSharpeLocatorCoreLogicConfig()
