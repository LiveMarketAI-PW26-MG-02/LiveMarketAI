"""
  ...
  Folder     : multimodal_max_sharpe_locator
  File       : multimodal_max_sharpe_locator_signal_generator.py
  Purpose    : Identify Optimal Value — Max Sharpe Locator
"""
...
MULTIMODAL_MODULE = 'multimodal_max_sharpe_locator_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalMaxSharpeLocatorSignalGeneratorConfig:
    """Multimodal threshold-sweep config for max_sharpe_locator."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalMaxSharpeLocatorEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: identify optimal value — max sharpe locator.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalMaxSharpeLocatorSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalMaxSharpeLocatorSignalGeneratorConfig()
