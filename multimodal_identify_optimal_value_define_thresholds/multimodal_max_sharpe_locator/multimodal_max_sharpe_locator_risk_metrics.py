"""
  ...
  File       : multimodal_max_sharpe_locator_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_max_sharpe_locator_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalMaxSharpeLocatorRiskMetricsConfig:
...
class MultimodalMaxSharpeLocatorEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMaxSharpeLocatorRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalMaxSharpeLocatorRiskMetricsConfig()
