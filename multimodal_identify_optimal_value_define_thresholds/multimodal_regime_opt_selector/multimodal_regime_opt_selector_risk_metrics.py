"""
  ...
  File       : multimodal_regime_opt_selector_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_regime_opt_selector_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeOptSelectorRiskMetricsConfig:
...
class MultimodalRegimeOptSelectorEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegimeOptSelectorRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalRegimeOptSelectorRiskMetricsConfig()
