"""
  ...
  File       : multimodal_regime_opt_selector_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_regime_opt_selector_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeOptSelectorBacktestRunnerConfig:
...
class MultimodalRegimeOptSelectorEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegimeOptSelectorBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalRegimeOptSelectorBacktestRunnerConfig()
