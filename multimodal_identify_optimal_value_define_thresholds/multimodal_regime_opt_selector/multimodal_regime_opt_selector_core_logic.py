"""
  ...
  File       : multimodal_regime_opt_selector_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_regime_opt_selector_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeOptSelectorCoreLogicConfig:
...
class MultimodalRegimeOptSelectorEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegimeOptSelectorCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalRegimeOptSelectorCoreLogicConfig()
