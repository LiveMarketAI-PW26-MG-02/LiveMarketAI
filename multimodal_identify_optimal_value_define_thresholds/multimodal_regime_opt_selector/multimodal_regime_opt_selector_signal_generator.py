"""
  ...
  Folder     : multimodal_regime_opt_selector
  File       : multimodal_regime_opt_selector_signal_generator.py
  Purpose    : Identify Optimal Value — Regime Opt Selector
"""
...
MULTIMODAL_MODULE = 'multimodal_regime_opt_selector_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeOptSelectorSignalGeneratorConfig:
    """Multimodal threshold-sweep config for regime_opt_selector."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalRegimeOptSelectorEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: identify optimal value — regime opt selector.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalRegimeOptSelectorSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalRegimeOptSelectorSignalGeneratorConfig()
