"""
  ...
  File       : multimodal_regime_opt_selector_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_regime_opt_selector_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeOptSelectorDataPipelineConfig:
...
class MultimodalRegimeOptSelectorEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegimeOptSelectorDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalRegimeOptSelectorDataPipelineConfig()
