"""
  ...
  File       : multimodal_pareto_frontier_picker_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_pareto_frontier_picker_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalParetoFrontierPickerCoreLogicConfig:
...
class MultimodalParetoFrontierPickerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalParetoFrontierPickerCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalParetoFrontierPickerCoreLogicConfig()
