"""
  ...
  File       : multimodal_pareto_frontier_picker_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_pareto_frontier_picker_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalParetoFrontierPickerBacktestRunnerConfig:
...
class MultimodalParetoFrontierPickerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalParetoFrontierPickerBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalParetoFrontierPickerBacktestRunnerConfig()
