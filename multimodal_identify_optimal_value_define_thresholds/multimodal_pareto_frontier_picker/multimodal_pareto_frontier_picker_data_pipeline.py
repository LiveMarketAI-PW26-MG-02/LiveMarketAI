"""
  ...
  File       : multimodal_pareto_frontier_picker_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_pareto_frontier_picker_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalParetoFrontierPickerDataPipelineConfig:
...
class MultimodalParetoFrontierPickerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalParetoFrontierPickerDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalParetoFrontierPickerDataPipelineConfig()
