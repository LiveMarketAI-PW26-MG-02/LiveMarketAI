"""
  ...
  File       : multimodal_pareto_frontier_picker_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_pareto_frontier_picker_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalParetoFrontierPickerRiskMetricsConfig:
...
class MultimodalParetoFrontierPickerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalParetoFrontierPickerRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalParetoFrontierPickerRiskMetricsConfig()
