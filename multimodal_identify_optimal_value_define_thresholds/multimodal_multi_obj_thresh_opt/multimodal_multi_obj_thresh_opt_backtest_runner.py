"""
  ...
  File       : multimodal_multi_obj_thresh_opt_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_multi_obj_thresh_opt_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalMultiObjThreshOptBacktestRunnerConfig:
...
class MultimodalMultiObjThreshOptEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMultiObjThreshOptBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalMultiObjThreshOptBacktestRunnerConfig()
