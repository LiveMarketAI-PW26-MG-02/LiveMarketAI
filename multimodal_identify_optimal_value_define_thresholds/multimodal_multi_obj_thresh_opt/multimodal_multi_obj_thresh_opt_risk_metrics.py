"""
  ...
  File       : multimodal_multi_obj_thresh_opt_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_multi_obj_thresh_opt_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalMultiObjThreshOptRiskMetricsConfig:
...
class MultimodalMultiObjThreshOptEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMultiObjThreshOptRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalMultiObjThreshOptRiskMetricsConfig()
