"""
  ...
  Folder     : multimodal_multi_obj_thresh_opt
  File       : multimodal_multi_obj_thresh_opt_signal_generator.py
  Purpose    : Identify Optimal Value — Multi Obj Thresh Opt
"""
...
MULTIMODAL_MODULE = 'multimodal_multi_obj_thresh_opt_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalMultiObjThreshOptSignalGeneratorConfig:
    """Multimodal threshold-sweep config for multi_obj_thresh_opt."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalMultiObjThreshOptEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: identify optimal value — multi obj thresh opt.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalMultiObjThreshOptSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalMultiObjThreshOptSignalGeneratorConfig()
