"""
  ...
  File       : multimodal_multi_obj_thresh_opt_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_multi_obj_thresh_opt_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalMultiObjThreshOptDataPipelineConfig:
...
class MultimodalMultiObjThreshOptEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMultiObjThreshOptDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalMultiObjThreshOptDataPipelineConfig()
