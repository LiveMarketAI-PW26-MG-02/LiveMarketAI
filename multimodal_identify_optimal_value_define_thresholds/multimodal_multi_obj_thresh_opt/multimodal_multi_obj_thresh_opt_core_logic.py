"""
  ...
  File       : multimodal_multi_obj_thresh_opt_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_multi_obj_thresh_opt_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalMultiObjThreshOptCoreLogicConfig:
...
class MultimodalMultiObjThreshOptEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMultiObjThreshOptCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalMultiObjThreshOptCoreLogicConfig()
