"""
  ...
  File       : multimodal_golden_threshold_finder_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_golden_threshold_finder_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalGoldenThresholdFinderBacktestRunnerConfig:
...
class MultimodalGoldenThresholdFinderEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalGoldenThresholdFinderBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalGoldenThresholdFinderBacktestRunnerConfig()
