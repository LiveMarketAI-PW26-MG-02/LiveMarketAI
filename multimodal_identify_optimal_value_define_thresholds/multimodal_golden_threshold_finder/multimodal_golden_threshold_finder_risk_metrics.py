"""
  ...
  File       : multimodal_golden_threshold_finder_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_golden_threshold_finder_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalGoldenThresholdFinderRiskMetricsConfig:
...
class MultimodalGoldenThresholdFinderEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalGoldenThresholdFinderRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalGoldenThresholdFinderRiskMetricsConfig()
