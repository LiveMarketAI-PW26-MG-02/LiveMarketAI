"""
  ...
  File       : multimodal_golden_threshold_finder_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_golden_threshold_finder_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalGoldenThresholdFinderDataPipelineConfig:
...
class MultimodalGoldenThresholdFinderEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalGoldenThresholdFinderDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalGoldenThresholdFinderDataPipelineConfig()
