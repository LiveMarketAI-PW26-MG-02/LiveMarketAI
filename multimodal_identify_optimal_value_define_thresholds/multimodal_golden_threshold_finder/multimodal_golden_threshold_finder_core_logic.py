"""
  ...
  File       : multimodal_golden_threshold_finder_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_golden_threshold_finder_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalGoldenThresholdFinderCoreLogicConfig:
...
class MultimodalGoldenThresholdFinderEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalGoldenThresholdFinderCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalGoldenThresholdFinderCoreLogicConfig()
