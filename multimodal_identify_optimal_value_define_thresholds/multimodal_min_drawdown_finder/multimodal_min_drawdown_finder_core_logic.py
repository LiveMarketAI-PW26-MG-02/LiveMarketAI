"""
  ...
  File       : multimodal_min_drawdown_finder_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_min_drawdown_finder_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalMinDrawdownFinderCoreLogicConfig:
...
class MultimodalMinDrawdownFinderEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMinDrawdownFinderCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalMinDrawdownFinderCoreLogicConfig()
