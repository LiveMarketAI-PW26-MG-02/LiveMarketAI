"""
  ...
  File       : multimodal_min_drawdown_finder_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_min_drawdown_finder_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalMinDrawdownFinderRiskMetricsConfig:
...
class MultimodalMinDrawdownFinderEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMinDrawdownFinderRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalMinDrawdownFinderRiskMetricsConfig()
