"""
  ...
  Folder     : multimodal_min_drawdown_finder
  File       : multimodal_min_drawdown_finder_signal_generator.py
  Purpose    : Identify Optimal Value — Min Drawdown Finder
"""
...
MULTIMODAL_MODULE = 'multimodal_min_drawdown_finder_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalMinDrawdownFinderSignalGeneratorConfig:
    """Multimodal threshold-sweep config for min_drawdown_finder."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalMinDrawdownFinderEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: identify optimal value — min drawdown finder.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalMinDrawdownFinderSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalMinDrawdownFinderSignalGeneratorConfig()
