"""
  ...
  File       : multimodal_min_drawdown_finder_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_min_drawdown_finder_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalMinDrawdownFinderDataPipelineConfig:
...
class MultimodalMinDrawdownFinderEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMinDrawdownFinderDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalMinDrawdownFinderDataPipelineConfig()
