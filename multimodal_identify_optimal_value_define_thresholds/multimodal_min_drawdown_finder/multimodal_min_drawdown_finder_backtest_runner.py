"""
  ...
  File       : multimodal_min_drawdown_finder_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_min_drawdown_finder_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalMinDrawdownFinderBacktestRunnerConfig:
...
class MultimodalMinDrawdownFinderEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMinDrawdownFinderBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalMinDrawdownFinderBacktestRunnerConfig()
