"""
  ...
  File       : multimodal_cost_aware_optimizer_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_cost_aware_optimizer_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCostAwareOptimizerCoreLogicConfig:
...
class MultimodalCostAwareOptimizerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCostAwareOptimizerCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalCostAwareOptimizerCoreLogicConfig()
