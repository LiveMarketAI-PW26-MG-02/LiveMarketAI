"""
  ...
  File       : multimodal_cost_aware_optimizer_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_cost_aware_optimizer_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCostAwareOptimizerRiskMetricsConfig:
...
class MultimodalCostAwareOptimizerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCostAwareOptimizerRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalCostAwareOptimizerRiskMetricsConfig()
