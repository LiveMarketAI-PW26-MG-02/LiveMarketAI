"""
  ...
  File       : multimodal_cost_aware_optimizer_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_cost_aware_optimizer_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCostAwareOptimizerDataPipelineConfig:
...
class MultimodalCostAwareOptimizerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCostAwareOptimizerDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalCostAwareOptimizerDataPipelineConfig()
