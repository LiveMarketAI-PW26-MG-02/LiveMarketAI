"""
  ...
  File       : multimodal_cost_aware_optimizer_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_cost_aware_optimizer_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCostAwareOptimizerBacktestRunnerConfig:
...
class MultimodalCostAwareOptimizerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCostAwareOptimizerBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalCostAwareOptimizerBacktestRunnerConfig()
