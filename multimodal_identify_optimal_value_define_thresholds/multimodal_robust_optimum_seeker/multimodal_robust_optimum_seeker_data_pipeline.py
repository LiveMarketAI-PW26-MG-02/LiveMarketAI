"""
  ...
  File       : multimodal_robust_optimum_seeker_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_robust_optimum_seeker_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRobustOptimumSeekerDataPipelineConfig:
...
class MultimodalRobustOptimumSeekerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRobustOptimumSeekerDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalRobustOptimumSeekerDataPipelineConfig()
