"""
  ...
  File       : multimodal_robust_optimum_seeker_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_robust_optimum_seeker_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRobustOptimumSeekerRiskMetricsConfig:
...
class MultimodalRobustOptimumSeekerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRobustOptimumSeekerRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalRobustOptimumSeekerRiskMetricsConfig()
