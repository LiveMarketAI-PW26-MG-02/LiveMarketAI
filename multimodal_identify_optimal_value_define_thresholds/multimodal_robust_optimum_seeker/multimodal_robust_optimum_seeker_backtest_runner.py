"""
  ...
  File       : multimodal_robust_optimum_seeker_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_robust_optimum_seeker_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRobustOptimumSeekerBacktestRunnerConfig:
...
class MultimodalRobustOptimumSeekerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRobustOptimumSeekerBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalRobustOptimumSeekerBacktestRunnerConfig()
