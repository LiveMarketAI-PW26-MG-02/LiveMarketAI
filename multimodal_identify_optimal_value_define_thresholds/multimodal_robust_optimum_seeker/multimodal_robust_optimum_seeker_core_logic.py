"""
  ...
  File       : multimodal_robust_optimum_seeker_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_robust_optimum_seeker_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRobustOptimumSeekerCoreLogicConfig:
...
class MultimodalRobustOptimumSeekerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRobustOptimumSeekerCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalRobustOptimumSeekerCoreLogicConfig()
