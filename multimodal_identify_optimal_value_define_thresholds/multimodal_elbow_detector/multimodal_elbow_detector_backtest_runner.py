"""
  ...
  File       : multimodal_elbow_detector_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_elbow_detector_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalElbowDetectorBacktestRunnerConfig:
...
class MultimodalElbowDetectorEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalElbowDetectorBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalElbowDetectorBacktestRunnerConfig()
