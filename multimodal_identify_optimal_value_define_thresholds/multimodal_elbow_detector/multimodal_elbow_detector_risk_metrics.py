"""
  ...
  File       : multimodal_elbow_detector_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_elbow_detector_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalElbowDetectorRiskMetricsConfig:
...
class MultimodalElbowDetectorEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalElbowDetectorRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalElbowDetectorRiskMetricsConfig()
