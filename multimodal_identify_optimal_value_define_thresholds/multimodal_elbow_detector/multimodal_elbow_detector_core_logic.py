"""
  ...
  File       : multimodal_elbow_detector_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_elbow_detector_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalElbowDetectorCoreLogicConfig:
...
class MultimodalElbowDetectorEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalElbowDetectorCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalElbowDetectorCoreLogicConfig()
