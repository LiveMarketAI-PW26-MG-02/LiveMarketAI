"""
  ...
  File       : multimodal_elbow_detector_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_elbow_detector_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalElbowDetectorDataPipelineConfig:
...
class MultimodalElbowDetectorEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalElbowDetectorDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalElbowDetectorDataPipelineConfig()
