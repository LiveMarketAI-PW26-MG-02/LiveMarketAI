"""
  ...
  Folder     : multimodal_elbow_detector
  File       : multimodal_elbow_detector_signal_generator.py
  Purpose    : Identify Optimal Value — Elbow Detector
"""
...
MULTIMODAL_MODULE = 'multimodal_elbow_detector_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalElbowDetectorSignalGeneratorConfig:
    """Multimodal threshold-sweep config for elbow_detector."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalElbowDetectorEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: identify optimal value — elbow detector.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalElbowDetectorSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalElbowDetectorSignalGeneratorConfig()
