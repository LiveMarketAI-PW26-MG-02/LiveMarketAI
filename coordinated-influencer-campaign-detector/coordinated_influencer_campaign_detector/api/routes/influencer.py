...
from ...schemas.influencer import InfluencerCreate, InfluencerRead
...
@router.get("/{item_id}", response_model=InfluencerRead)
...
def create_item(payload: InfluencerCreate, db: Session = Depends(get_db)):
