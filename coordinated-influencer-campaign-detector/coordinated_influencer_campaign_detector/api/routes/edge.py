...
from ...schemas.edge import EdgeCreate, EdgeRead

router = APIRouter(prefix="/edges", tags=["Edge"])
...
@router.get("/{item_id}", response_model=EdgeRead)
...
def create_item(payload: EdgeCreate, db: Session = Depends(get_db)):
