...
from ...schemas.option import OptionCreate, OptionRead
...
@router.get("/{item_id}", response_model=OptionRead)
...
def create_item(payload: OptionCreate, db: Session = Depends(get_db)):
