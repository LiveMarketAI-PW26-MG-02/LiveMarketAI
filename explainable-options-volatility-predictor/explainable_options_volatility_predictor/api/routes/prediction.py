...
from ...schemas.prediction import PredictionCreate, PredictionRead
...
@router.get("/{item_id}", response_model=PredictionRead)
...
def create_item(payload: PredictionCreate, db: Session = Depends(get_db)):
