...
Analyses dark-pool prints and block trades to surface and explain manipulative routing and information leakage.
...
- **10 self-created APIs (routers)**: /health, /auth, /audit, /ingest, /explain, /dark_pool_prints, /blocks, /manipulation_signals, /venues, /explanations
- **AI primitive**: `anomaly` — see `dark_pool_manipulation_intelligence_engine/ai/engine.py`. Exposed at `POST /explain`.
...
## Run
    ...
    uvicorn dark_pool_manipulation_intelligence_engine.main:app --reload     # SQLite tables auto-created on boot
...
## Layout
    ...
    dark_pool_manipulation_intelligence_engine/
