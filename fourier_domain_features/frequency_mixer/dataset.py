"""
Dataset for Mix frequency-domain and time-domain features for regime awareness
Module: frequency_mixer.dataset
"""
import torch
...
class FrequencyDomainMixerDataset(nn.Module):
    """
    Dataset for Mix frequency-domain and time-domain features for regime awareness
    """
