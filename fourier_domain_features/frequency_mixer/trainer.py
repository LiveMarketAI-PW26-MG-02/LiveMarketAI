"""
Trainer for Mix frequency-domain and time-domain features for regime awareness
Module: frequency_mixer.trainer
"""
import torch
...
class FrequencyDomainMixerTrainer(nn.Module):
    """
    Trainer for Mix frequency-domain and time-domain features for regime awareness
    """
