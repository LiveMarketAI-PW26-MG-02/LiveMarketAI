"""
Trainer for Attention computed in Fourier domain for long-range temporal dependencies
Module: spectral_attention.trainer
"""
import torch
...
class SpectralDomainAttentionTrainer(nn.Module):
    """
    Trainer for Attention computed in Fourier domain for long-range temporal dependencies
    """
