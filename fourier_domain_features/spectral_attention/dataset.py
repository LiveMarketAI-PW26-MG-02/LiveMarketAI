"""
Dataset for Attention computed in Fourier domain for long-range temporal dependencies
Module: spectral_attention.dataset
"""
import torch
...
class SpectralDomainAttentionDataset(nn.Module):
    """
    Dataset for Attention computed in Fourier domain for long-range temporal dependencies
    """
