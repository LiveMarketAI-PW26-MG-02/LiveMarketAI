"""
Trainer for Full transformer with Fourier attention for regime-conditioned processing
Module: fourier_transformer.trainer
"""
import torch
...
class FourierDomainTransformerTrainer(nn.Module):
    """
    Trainer for Full transformer with Fourier attention for regime-conditioned processing
    """
