"""
Dataset for Full transformer with Fourier attention for regime-conditioned processing
Module: fourier_transformer.dataset
"""
import torch
...
class FourierDomainTransformerDataset(nn.Module):
    """
    Dataset for Full transformer with Fourier attention for regime-conditioned processing
    """
