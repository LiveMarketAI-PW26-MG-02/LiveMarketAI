...
from ...schemas.transcript import TranscriptCreate, TranscriptRead
...
@router.get("/{item_id}", response_model=TranscriptRead)
...
def create_item(payload: TranscriptCreate, db: Session = Depends(get_db)):
