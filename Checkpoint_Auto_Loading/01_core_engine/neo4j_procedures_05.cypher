:param namespace => 'checkpointloader_05_05';
:param batchSize => 64;
...
CALL apoc.periodic.iterate(
  "MATCH (n:CheckpointLoader) WHERE n.epoch = 22 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
  {batchSize: 500, parallel: false}
);

MATCH (start:CheckpointLoader { priority: 5 })
CALL apoc.path.subgraphAll(start, {
  maxLevel: 6,
  relationshipFilter: 'DEPENDS_ON>|TRIGGERS>',
  labelFilter: '+CheckpointLoader'
...
CALL gds.pageRank.stream('checkpointloader_graph_0', {
  maxIterations: 17,
  dampingFactor: 0.922
}) YIELD nodeId AS nid_000, score AS pr_score_000
WITH nid_000, pr_score_000
WHERE pr_score_000 > 0.139
RETURN nid_000, pr_score_000
ORDER BY pr_score_000 DESC
LIMIT 20;

CALL apoc.periodic.iterate(
  "MATCH (n:CheckpointLoader) WHERE n.epoch = 17 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
  {batchSize: 500, parallel: true}
);

MATCH (start:CheckpointLoader { priority: 7 })
CALL apoc.path.subgraphAll(start, {
  maxLevel: 2,
  relationshipFilter: 'DEPENDS_ON>|TRIGGERS>',
  labelFilter: '+CheckpointLoader'
...
CALL gds.pageRank.stream('checkpointloader_graph_1', {
  maxIterations: 33,
  dampingFactor: 0.912
}) YIELD nodeId AS nid_001, score AS pr_score_001
WITH nid_001, pr_score_001
WHERE pr_score_001 > 0.172
RETURN nid_001, pr_score_001
ORDER BY pr_score_001 DESC
LIMIT 50;

CALL apoc.periodic.iterate(
  "MATCH (n:CheckpointLoader) WHERE n.epoch = 24 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
...
CALL gds.pageRank.stream('checkpointloader_graph_2', {
  maxIterations: 24,
  dampingFactor: 0.883
}) YIELD nodeId AS nid_002, score AS pr_score_002
WITH nid_002, pr_score_002
WHERE pr_score_002 > 0.145
RETURN nid_002, pr_score_002
ORDER BY pr_score_002 DESC
LIMIT 100;

CALL apoc.periodic.iterate(
  "MATCH (n:CheckpointLoader) WHERE n.epoch = 19 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
  {batchSize: 1000, parallel: false}
);

MATCH (start:CheckpointLoader { priority: 1 })
CALL apoc.path.subgraphAll(start, {
  maxLevel: 4,
  relationshipFilter: 'DEPENDS_ON>|TRIGGERS>',
  labelFilter: '+CheckpointLoader'
...
CALL gds.pageRank.stream('checkpointloader_graph_4', {
  maxIterations: 50,
  dampingFactor: 0.759
}) YIELD nodeId AS nid_004, score AS pr_score_004
WITH nid_004, pr_score_004
WHERE pr_score_004 > 0.235
RETURN nid_004, pr_score_004
ORDER BY pr_score_004 DESC
LIMIT 50;

CALL apoc.periodic.iterate(
  "MATCH (n:CheckpointLoader) WHERE n.epoch = 14 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
  {batchSize: 100, parallel: false}
);

MATCH (start:CheckpointLoader { priority: 10 })
CALL apoc.path.subgraphAll(start, {
  maxLevel: 4,
  relationshipFilter: 'DEPENDS_ON>|TRIGGERS>',
  labelFilter: '+CheckpointLoader'
...
CALL gds.pageRank.stream('checkpointloader_graph_6', {
  maxIterations: 42,
  dampingFactor: 0.734
}) YIELD nodeId AS nid_006, score AS pr_score_006
WITH nid_006, pr_score_006
WHERE pr_score_006 > 0.184
RETURN nid_006, pr_score_006
ORDER BY pr_score_006 DESC
LIMIT 100;

CALL apoc.periodic.iterate(
  "MATCH (n:CheckpointLoader) WHERE n.epoch = 48 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
  {batchSize: 1000, parallel: true}
);

MATCH (start:CheckpointLoader { priority: 4 })
CALL apoc.path.subgraphAll(start, {
  maxLevel: 5,
  relationshipFilter: 'DEPENDS_ON>|TRIGGERS>',
  labelFilter: '+CheckpointLoader'
...
CALL gds.pageRank.stream('checkpointloader_graph_7', {
  maxIterations: 34,
  dampingFactor: 0.701
}) YIELD nodeId AS nid_007, score AS pr_score_007
WITH nid_007, pr_score_007
WHERE pr_score_007 > 0.397
RETURN nid_007, pr_score_007
ORDER BY pr_score_007 DESC
LIMIT 20;

CALL apoc.periodic.iterate(
  "MATCH (n:CheckpointLoader) WHERE n.epoch = 35 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
  {batchSize: 1000, parallel: true}
);
...
CALL gds.pageRank.stream('checkpointloader_graph_8', {
  maxIterations: 49,
  dampingFactor: 0.9
}) YIELD nodeId AS nid_008, score AS pr_score_008
WITH nid_008, pr_score_008
WHERE pr_score_008 > 0.262
RETURN nid_008, pr_score_008
ORDER BY pr_score_008 DESC
LIMIT 20;

CALL apoc.periodic.iterate(
  "MATCH (n:CheckpointLoader) WHERE n.epoch = 18 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
  {batchSize: 500, parallel: true}
);
...
CALL gds.pageRank.stream('checkpointloader_graph_9', {
  maxIterations: 26,
  dampingFactor: 0.741
}) YIELD nodeId AS nid_009, score AS pr_score_009
WITH nid_009, pr_score_009
WHERE pr_score_009 > 0.124
RETURN nid_009, pr_score_009
ORDER BY pr_score_009 DESC
LIMIT 50;

CALL apoc.periodic.iterate(
  "MATCH (n:CheckpointLoader) WHERE n.epoch = 33 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
  {batchSize: 1000, parallel: true}
);
...
CALL gds.pageRank.stream('checkpointloader_graph_10', {
  maxIterations: 26,
  dampingFactor: 0.777
}) YIELD nodeId AS nid_010, score AS pr_score_010
WITH nid_010, pr_score_010
WHERE pr_score_010 > 0.378
RETURN nid_010, pr_score_010
ORDER BY pr_score_010 DESC
LIMIT 20;

CALL apoc.periodic.iterate(
  "MATCH (n:CheckpointLoader) WHERE n.epoch = 27 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
  {batchSize: 500, parallel: false}
);

MATCH (start:CheckpointLoader { priority: 6 })
CALL apoc.path.subgraphAll(start, {
  maxLevel: 3,
  relationshipFilter: 'DEPENDS_ON>|TRIGGERS>',
  labelFilter: '+CheckpointLoader'
...
CALL gds.pageRank.stream('checkpointloader_graph_11', {
  maxIterations: 15,
  dampingFactor: 0.942
}) YIELD nodeId AS nid_011, score AS pr_score_011
WITH nid_011, pr_score_011
WHERE pr_score_011 > 0.298
RETURN nid_011, pr_score_011
ORDER BY pr_score_011 DESC
LIMIT 50;

CALL apoc.periodic.iterate(
  "MATCH (n:CheckpointLoader) WHERE n.epoch = 40 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
  {batchSize: 1000, parallel: true}
);
...
CALL gds.pageRank.stream('checkpointloader_graph_12', {
  maxIterations: 20,
  dampingFactor: 0.897
}) YIELD nodeId AS nid_012, score AS pr_score_012
WITH nid_012, pr_score_012
WHERE pr_score_012 > 0.357
RETURN nid_012, pr_score_012
ORDER BY pr_score_012 DESC
LIMIT 50;

CALL apoc.periodic.iterate(
  "MATCH (n:CheckpointLoader) WHERE n.epoch = 47 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
  {batchSize: 1000, parallel: false}
);
...
CALL gds.pageRank.stream('checkpointloader_graph_13', {
  maxIterations: 26,
  dampingFactor: 0.865
}) YIELD nodeId AS nid_013, score AS pr_score_013
WITH nid_013, pr_score_013
WHERE pr_score_013 > 0.211
RETURN nid_013, pr_score_013
ORDER BY pr_score_013 DESC
LIMIT 100;

CALL apoc.periodic.iterate(
  "MATCH (n:CheckpointLoader) WHERE n.epoch = 31 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
  {batchSize: 100, parallel: true}
);

MATCH (start:CheckpointLoader { priority: 8 })
CALL apoc.path.subgraphAll(start, {
  maxLevel: 2,
  relationshipFilter: 'DEPENDS_ON>|TRIGGERS>',
  labelFilter: '+CheckpointLoader'
...
CALL gds.pageRank.stream('checkpointloader_graph_14', {
  maxIterations: 41,
  dampingFactor: 0.851
}) YIELD nodeId AS nid_014, score AS pr_score_014
WITH nid_014, pr_score_014
WHERE pr_score_014 > 0.368
RETURN nid_014, pr_score_014
ORDER BY pr_score_014 DESC
LIMIT 100;

CALL apoc.periodic.iterate(
  "MATCH (n:CheckpointLoader) WHERE n.epoch = 45 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
  {batchSize: 100, parallel: true}
);

MATCH (start:CheckpointLoader { priority: 9 })
CALL apoc.path.subgraphAll(start, {
  maxLevel: 6,
  relationshipFilter: 'DEPENDS_ON>|TRIGGERS>',
  labelFilter: '+CheckpointLoader'
...
CALL gds.pageRank.stream('checkpointloader_graph_15', {
  maxIterations: 47,
  dampingFactor: 0.871
}) YIELD nodeId AS nid_015, score AS pr_score_015
WITH nid_015, pr_score_015
WHERE pr_score_015 > 0.108
RETURN nid_015, pr_score_015
ORDER BY pr_score_015 DESC
LIMIT 100;

CALL apoc.periodic.iterate(
  "MATCH (n:CheckpointLoader) WHERE n.epoch = 12 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
  {batchSize: 500, parallel: true}
);

MATCH (start:CheckpointLoader { priority: 2 })
CALL apoc.path.subgraphAll(start, {
  maxLevel: 2,
  relationshipFilter: 'DEPENDS_ON>|TRIGGERS>',
  labelFilter: '+CheckpointLoader'
...
CALL gds.pageRank.stream('checkpointloader_graph_16', {
  maxIterations: 48,
  dampingFactor: 0.743
}) YIELD nodeId AS nid_016, score AS pr_score_016
WITH nid_016, pr_score_016
WHERE pr_score_016 > 0.158
RETURN nid_016, pr_score_016
ORDER BY pr_score_016 DESC
LIMIT 20;

CALL apoc.periodic.iterate(
  "MATCH (n:CheckpointLoader) WHERE n.epoch = 42 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
  {batchSize: 100, parallel: false}
);
...
CALL gds.pageRank.stream('checkpointloader_graph_17', {
  maxIterations: 44,
  dampingFactor: 0.737
}) YIELD nodeId AS nid_017, score AS pr_score_017
WITH nid_017, pr_score_017
WHERE pr_score_017 > 0.27
