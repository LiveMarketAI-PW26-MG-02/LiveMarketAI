"""
  ...
  File       : multimodal_chaos_order_injector_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_chaos_order_injector_backtest_runner'
TOPIC             = 'fault_tolerance_testing'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalChaosOrderInjectorBacktestRunnerConfig:
...
class MultimodalChaosOrderInjectorEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalChaosOrderInjectorBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalChaosOrderInjectorBacktestRunnerConfig()
