"""
  ...
  File       : multimodal_bulkhead_portfolio_test_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_bulkhead_portfolio_test_backtest_runner'
TOPIC             = 'fault_tolerance_testing'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalBulkheadPortfolioTestBacktestRunnerConfig:
...
class MultimodalBulkheadPortfolioTestEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalBulkheadPortfolioTestBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalBulkheadPortfolioTestBacktestRunnerConfig()
