"""
  ...
  File       : multimodal_disaster_recovery_sim_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_disaster_recovery_sim_backtest_runner'
TOPIC             = 'fault_tolerance_testing'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalDisasterRecoverySimBacktestRunnerConfig:
...
class MultimodalDisasterRecoverySimEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalDisasterRecoverySimBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalDisasterRecoverySimBacktestRunnerConfig()
