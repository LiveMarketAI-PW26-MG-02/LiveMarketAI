"""
  ...
  File       : multimodal_retry_feed_handler_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_retry_feed_handler_backtest_runner'
TOPIC             = 'fault_tolerance_testing'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRetryFeedHandlerBacktestRunnerConfig:
...
class MultimodalRetryFeedHandlerEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalRetryFeedHandlerBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalRetryFeedHandlerBacktestRunnerConfig()
