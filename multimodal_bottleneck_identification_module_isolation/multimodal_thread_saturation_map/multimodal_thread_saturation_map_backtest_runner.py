"""
  ...
  File       : multimodal_thread_saturation_map_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_thread_saturation_map_backtest_runner'
TOPIC             = 'bottleneck_identification'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalThreadSaturationMapBacktestRunnerConfig:
...
class MultimodalThreadSaturationMapEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalThreadSaturationMapBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalThreadSaturationMapBacktestRunnerConfig()
