"""
  ...
  File       : multimodal_serialisation_bottleneck_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_serialisation_bottleneck_risk_metrics'
TOPIC             = 'bottleneck_identification'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSerialisationBottleneckRiskMetricsConfig:
...
class MultimodalSerialisationBottleneckEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalSerialisationBottleneckRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalSerialisationBottleneckRiskMetricsConfig()
