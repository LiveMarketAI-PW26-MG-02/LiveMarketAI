"""
  ...
  File       : multimodal_serialisation_bottleneck_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_serialisation_bottleneck_data_pipeline'
TOPIC             = 'bottleneck_identification'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSerialisationBottleneckDataPipelineConfig:
...
class MultimodalSerialisationBottleneckEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalSerialisationBottleneckDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalSerialisationBottleneckDataPipelineConfig()
