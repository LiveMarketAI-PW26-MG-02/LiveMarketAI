"""
  ...
  File       : multimodal_serialisation_bottleneck_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_serialisation_bottleneck_backtest_runner'
TOPIC             = 'bottleneck_identification'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSerialisationBottleneckBacktestRunnerConfig:
...
class MultimodalSerialisationBottleneckEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalSerialisationBottleneckBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalSerialisationBottleneckBacktestRunnerConfig()
