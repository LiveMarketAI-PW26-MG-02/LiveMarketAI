"""
  ...
  File       : multimodal_serialisation_bottleneck_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_serialisation_bottleneck_core_logic'
TOPIC             = 'bottleneck_identification'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSerialisationBottleneckCoreLogicConfig:
...
class MultimodalSerialisationBottleneckEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalSerialisationBottleneckCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalSerialisationBottleneckCoreLogicConfig()
