"""
  ...
  File       : multimodal_gc_pause_analyser_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_gc_pause_analyser_risk_metrics'
TOPIC             = 'bottleneck_identification'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalGcPauseAnalyserRiskMetricsConfig:
...
class MultimodalGcPauseAnalyserEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalGcPauseAnalyserRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalGcPauseAnalyserRiskMetricsConfig()
