"""
  ...
  File       : multimodal_gc_pause_analyser_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_gc_pause_analyser_core_logic'
TOPIC             = 'bottleneck_identification'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalGcPauseAnalyserCoreLogicConfig:
...
class MultimodalGcPauseAnalyserEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalGcPauseAnalyserCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalGcPauseAnalyserCoreLogicConfig()
