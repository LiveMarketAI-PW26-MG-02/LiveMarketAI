"""
  ...
  File       : multimodal_gc_pause_analyser_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_gc_pause_analyser_data_pipeline'
TOPIC             = 'bottleneck_identification'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalGcPauseAnalyserDataPipelineConfig:
...
class MultimodalGcPauseAnalyserEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalGcPauseAnalyserDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalGcPauseAnalyserDataPipelineConfig()
