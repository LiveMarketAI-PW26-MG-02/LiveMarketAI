"""
  ...
  File       : multimodal_gc_pause_analyser_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_gc_pause_analyser_backtest_runner'
TOPIC             = 'bottleneck_identification'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalGcPauseAnalyserBacktestRunnerConfig:
...
class MultimodalGcPauseAnalyserEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalGcPauseAnalyserBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalGcPauseAnalyserBacktestRunnerConfig()
