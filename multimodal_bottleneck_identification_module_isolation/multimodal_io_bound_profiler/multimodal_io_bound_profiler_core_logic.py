"""
  ...
  File       : multimodal_io_bound_profiler_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_io_bound_profiler_core_logic'
TOPIC             = 'bottleneck_identification'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalIoBoundProfilerCoreLogicConfig:
...
class MultimodalIoBoundProfilerEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalIoBoundProfilerCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalIoBoundProfilerCoreLogicConfig()
