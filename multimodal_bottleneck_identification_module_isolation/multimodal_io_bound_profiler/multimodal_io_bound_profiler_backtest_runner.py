"""
  ...
  File       : multimodal_io_bound_profiler_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_io_bound_profiler_backtest_runner'
TOPIC             = 'bottleneck_identification'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalIoBoundProfilerBacktestRunnerConfig:
...
class MultimodalIoBoundProfilerEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalIoBoundProfilerBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalIoBoundProfilerBacktestRunnerConfig()
