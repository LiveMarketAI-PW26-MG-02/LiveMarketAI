"""
  ...
  File       : multimodal_io_bound_profiler_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_io_bound_profiler_data_pipeline'
TOPIC             = 'bottleneck_identification'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalIoBoundProfilerDataPipelineConfig:
...
class MultimodalIoBoundProfilerEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalIoBoundProfilerDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalIoBoundProfilerDataPipelineConfig()
