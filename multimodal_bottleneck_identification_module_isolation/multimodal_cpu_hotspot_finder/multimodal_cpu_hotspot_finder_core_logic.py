"""
  ...
  File       : multimodal_cpu_hotspot_finder_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_cpu_hotspot_finder_core_logic'
TOPIC             = 'bottleneck_identification'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCpuHotspotFinderCoreLogicConfig:
...
class MultimodalCpuHotspotFinderEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalCpuHotspotFinderCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalCpuHotspotFinderCoreLogicConfig()
