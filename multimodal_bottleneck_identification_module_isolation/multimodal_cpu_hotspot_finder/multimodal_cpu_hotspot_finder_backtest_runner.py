"""
  ...
  File       : multimodal_cpu_hotspot_finder_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_cpu_hotspot_finder_backtest_runner'
TOPIC             = 'bottleneck_identification'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCpuHotspotFinderBacktestRunnerConfig:
...
class MultimodalCpuHotspotFinderEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalCpuHotspotFinderBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalCpuHotspotFinderBacktestRunnerConfig()
