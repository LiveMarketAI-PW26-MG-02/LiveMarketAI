"""
  ...
  File       : multimodal_cpu_hotspot_finder_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_cpu_hotspot_finder_data_pipeline'
TOPIC             = 'bottleneck_identification'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCpuHotspotFinderDataPipelineConfig:
...
class MultimodalCpuHotspotFinderEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalCpuHotspotFinderDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalCpuHotspotFinderDataPipelineConfig()
