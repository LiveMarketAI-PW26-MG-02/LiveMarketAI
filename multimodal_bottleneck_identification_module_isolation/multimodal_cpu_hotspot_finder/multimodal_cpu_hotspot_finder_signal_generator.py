"""
  ...
  File       : multimodal_cpu_hotspot_finder_signal_generator.py
...
MULTIMODAL_MODULE = 'multimodal_cpu_hotspot_finder_signal_generator'
TOPIC             = 'bottleneck_identification'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCpuHotspotFinderSignalGeneratorConfig:
...
class MultimodalCpuHotspotFinderEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalCpuHotspotFinderSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalCpuHotspotFinderSignalGeneratorConfig()
