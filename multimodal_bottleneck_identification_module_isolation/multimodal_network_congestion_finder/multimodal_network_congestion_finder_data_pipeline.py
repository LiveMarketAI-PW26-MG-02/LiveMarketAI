"""
  ...
  File       : multimodal_network_congestion_finder_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_network_congestion_finder_data_pipeline'
TOPIC             = 'bottleneck_identification'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalNetworkCongestionFinderDataPipelineConfig:
...
class MultimodalNetworkCongestionFinderEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalNetworkCongestionFinderDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalNetworkCongestionFinderDataPipelineConfig()
