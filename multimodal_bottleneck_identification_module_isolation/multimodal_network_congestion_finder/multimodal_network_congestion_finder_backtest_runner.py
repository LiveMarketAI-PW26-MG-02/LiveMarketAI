"""
  ...
  File       : multimodal_network_congestion_finder_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_network_congestion_finder_backtest_runner'
TOPIC             = 'bottleneck_identification'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalNetworkCongestionFinderBacktestRunnerConfig:
...
class MultimodalNetworkCongestionFinderEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalNetworkCongestionFinderBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalNetworkCongestionFinderBacktestRunnerConfig()
