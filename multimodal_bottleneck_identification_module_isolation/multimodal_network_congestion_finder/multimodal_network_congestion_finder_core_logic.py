"""
  ...
  File       : multimodal_network_congestion_finder_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_network_congestion_finder_core_logic'
TOPIC             = 'bottleneck_identification'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalNetworkCongestionFinderCoreLogicConfig:
...
class MultimodalNetworkCongestionFinderEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalNetworkCongestionFinderCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalNetworkCongestionFinderCoreLogicConfig()
