"""
  ...
  File       : multimodal_p99_latency_tracker_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_p99_latency_tracker_core_logic'
TOPIC             = 'pipeline_latency_analysis'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalP99LatencyTrackerCoreLogicConfig:
...
class MultimodalP99LatencyTrackerEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalP99LatencyTrackerCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalP99LatencyTrackerCoreLogicConfig()
