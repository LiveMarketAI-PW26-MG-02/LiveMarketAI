"""
  ...
  File       : multimodal_stage_latency_profiler_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_stage_latency_profiler_core_logic'
TOPIC             = 'pipeline_latency_analysis'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalStageLatencyProfilerCoreLogicConfig:
...
class MultimodalStageLatencyProfilerEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalStageLatencyProfilerCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalStageLatencyProfilerCoreLogicConfig()
