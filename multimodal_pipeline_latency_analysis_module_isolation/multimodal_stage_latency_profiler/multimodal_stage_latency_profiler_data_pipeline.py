"""
  ...
  File       : multimodal_stage_latency_profiler_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_stage_latency_profiler_data_pipeline'
TOPIC             = 'pipeline_latency_analysis'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalStageLatencyProfilerDataPipelineConfig:
...
class MultimodalStageLatencyProfilerEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalStageLatencyProfilerDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalStageLatencyProfilerDataPipelineConfig()
