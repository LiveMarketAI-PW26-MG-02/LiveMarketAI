"""
  ...
  File       : multimodal_colocation_bench_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_colocation_bench_backtest_runner'
TOPIC             = 'pipeline_latency_analysis'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalColocationBenchBacktestRunnerConfig:
...
class MultimodalColocationBenchEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalColocationBenchBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalColocationBenchBacktestRunnerConfig()
