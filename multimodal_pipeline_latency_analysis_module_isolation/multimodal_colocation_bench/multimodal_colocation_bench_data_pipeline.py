"""
  ...
  File       : multimodal_colocation_bench_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_colocation_bench_data_pipeline'
TOPIC             = 'pipeline_latency_analysis'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalColocationBenchDataPipelineConfig:
...
class MultimodalColocationBenchEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalColocationBenchDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalColocationBenchDataPipelineConfig()
