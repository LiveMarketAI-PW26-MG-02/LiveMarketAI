"""
  ...
  File       : multimodal_fpga_path_analyser_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_fpga_path_analyser_data_pipeline'
TOPIC             = 'pipeline_latency_analysis'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalFpgaPathAnalyserDataPipelineConfig:
...
class MultimodalFpgaPathAnalyserEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalFpgaPathAnalyserDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalFpgaPathAnalyserDataPipelineConfig()
