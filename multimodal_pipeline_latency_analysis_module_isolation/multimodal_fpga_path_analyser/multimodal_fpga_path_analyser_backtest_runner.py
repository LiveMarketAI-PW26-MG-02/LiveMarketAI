"""
  ...
  File       : multimodal_fpga_path_analyser_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_fpga_path_analyser_backtest_runner'
TOPIC             = 'pipeline_latency_analysis'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalFpgaPathAnalyserBacktestRunnerConfig:
...
class MultimodalFpgaPathAnalyserEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalFpgaPathAnalyserBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalFpgaPathAnalyserBacktestRunnerConfig()
