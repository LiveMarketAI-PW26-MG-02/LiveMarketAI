"""
  ...
  Folder     : multimodal_fpga_path_analyser
  File       : multimodal_fpga_path_analyser_signal_generator.py
  Purpose    : Pipeline Latency Analysis — Fpga Path Analyser
"""
...
MULTIMODAL_MODULE = 'multimodal_fpga_path_analyser_signal_generator'
TOPIC             = 'pipeline_latency_analysis'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalFpgaPathAnalyserSignalGeneratorConfig:
    """Configuration for multimodal fpga_path_analyser module."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalFpgaPathAnalyserEngine(MultimodalBaseModule):
    """
    Multimodal engine: pipeline latency analysis — fpga path analyser.
    Supports hot-swap, fault injection, latency SLA tracking.
    """

    def __init__(self, cfg: Optional[MultimodalFpgaPathAnalyserSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalFpgaPathAnalyserSignalGeneratorConfig()
