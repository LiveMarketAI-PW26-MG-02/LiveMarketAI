"""
  ...
  File       : multimodal_fpga_path_analyser_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_fpga_path_analyser_core_logic'
TOPIC             = 'pipeline_latency_analysis'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalFpgaPathAnalyserCoreLogicConfig:
...
class MultimodalFpgaPathAnalyserEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalFpgaPathAnalyserCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalFpgaPathAnalyserCoreLogicConfig()
