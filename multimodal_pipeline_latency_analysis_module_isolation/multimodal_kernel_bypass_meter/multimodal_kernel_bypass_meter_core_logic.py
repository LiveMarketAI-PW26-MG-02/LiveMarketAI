"""
  ...
  File       : multimodal_kernel_bypass_meter_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_kernel_bypass_meter_core_logic'
TOPIC             = 'pipeline_latency_analysis'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalKernelBypassMeterCoreLogicConfig:
...
class MultimodalKernelBypassMeterEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalKernelBypassMeterCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalKernelBypassMeterCoreLogicConfig()
