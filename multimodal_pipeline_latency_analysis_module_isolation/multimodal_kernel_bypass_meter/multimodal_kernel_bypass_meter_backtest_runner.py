"""
  ...
  File       : multimodal_kernel_bypass_meter_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_kernel_bypass_meter_backtest_runner'
TOPIC             = 'pipeline_latency_analysis'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalKernelBypassMeterBacktestRunnerConfig:
...
class MultimodalKernelBypassMeterEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalKernelBypassMeterBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalKernelBypassMeterBacktestRunnerConfig()
