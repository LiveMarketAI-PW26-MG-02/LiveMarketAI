"""
  ...
  File       : multimodal_tick_to_trade_timer_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_tick_to_trade_timer_backtest_runner'
TOPIC             = 'pipeline_latency_analysis'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalTickToTradeTimerBacktestRunnerConfig:
...
class MultimodalTickToTradeTimerEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalTickToTradeTimerBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalTickToTradeTimerBacktestRunnerConfig()
