"""
  ...
  File       : multimodal_jitter_detector_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_jitter_detector_core_logic'
TOPIC             = 'pipeline_latency_analysis'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalJitterDetectorCoreLogicConfig:
...
class MultimodalJitterDetectorEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalJitterDetectorCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalJitterDetectorCoreLogicConfig()
