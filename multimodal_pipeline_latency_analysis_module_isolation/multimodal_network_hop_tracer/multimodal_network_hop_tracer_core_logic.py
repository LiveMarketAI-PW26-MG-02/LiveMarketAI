"""
  ...
  File       : multimodal_network_hop_tracer_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_network_hop_tracer_core_logic'
TOPIC             = 'pipeline_latency_analysis'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalNetworkHopTracerCoreLogicConfig:
...
class MultimodalNetworkHopTracerEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalNetworkHopTracerCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalNetworkHopTracerCoreLogicConfig()
