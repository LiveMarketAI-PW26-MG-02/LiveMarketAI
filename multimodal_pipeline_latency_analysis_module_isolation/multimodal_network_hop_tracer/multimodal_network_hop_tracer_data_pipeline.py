"""
  ...
  File       : multimodal_network_hop_tracer_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_network_hop_tracer_data_pipeline'
TOPIC             = 'pipeline_latency_analysis'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalNetworkHopTracerDataPipelineConfig:
...
class MultimodalNetworkHopTracerEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalNetworkHopTracerDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalNetworkHopTracerDataPipelineConfig()
