"""
  ...
  File       : multimodal_kpi_summary_builder_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_kpi_summary_builder_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalKpiSummaryBuilderDataPipelineConfig:
...
class MultimodalKpiSummaryBuilderEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalKpiSummaryBuilderDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalKpiSummaryBuilderDataPipelineConfig()
