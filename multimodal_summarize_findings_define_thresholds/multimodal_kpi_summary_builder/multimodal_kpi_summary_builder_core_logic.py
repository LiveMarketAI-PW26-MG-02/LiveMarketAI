"""
  ...
  File       : multimodal_kpi_summary_builder_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_kpi_summary_builder_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalKpiSummaryBuilderCoreLogicConfig:
...
class MultimodalKpiSummaryBuilderEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalKpiSummaryBuilderCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalKpiSummaryBuilderCoreLogicConfig()
