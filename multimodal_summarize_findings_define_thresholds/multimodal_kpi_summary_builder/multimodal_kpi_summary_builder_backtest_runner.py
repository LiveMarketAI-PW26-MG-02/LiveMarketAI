"""
  ...
  File       : multimodal_kpi_summary_builder_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_kpi_summary_builder_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalKpiSummaryBuilderBacktestRunnerConfig:
...
class MultimodalKpiSummaryBuilderEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalKpiSummaryBuilderBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalKpiSummaryBuilderBacktestRunnerConfig()
