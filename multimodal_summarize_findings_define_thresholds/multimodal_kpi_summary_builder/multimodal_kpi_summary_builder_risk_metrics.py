"""
  ...
  File       : multimodal_kpi_summary_builder_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_kpi_summary_builder_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalKpiSummaryBuilderRiskMetricsConfig:
...
class MultimodalKpiSummaryBuilderEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalKpiSummaryBuilderRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalKpiSummaryBuilderRiskMetricsConfig()
