"""
  ...
  Folder     : multimodal_kpi_summary_builder
  File       : multimodal_kpi_summary_builder_signal_generator.py
  Purpose    : Summarize Findings — Kpi Summary Builder
"""
...
MULTIMODAL_MODULE = 'multimodal_kpi_summary_builder_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalKpiSummaryBuilderSignalGeneratorConfig:
    """Multimodal threshold-sweep config for kpi_summary_builder."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalKpiSummaryBuilderEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: summarize findings — kpi summary builder.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalKpiSummaryBuilderSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalKpiSummaryBuilderSignalGeneratorConfig()
