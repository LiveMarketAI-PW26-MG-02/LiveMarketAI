"""
  ...
  File       : multimodal_insight_narrative_gen_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_insight_narrative_gen_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalInsightNarrativeGenCoreLogicConfig:
...
class MultimodalInsightNarrativeGenEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalInsightNarrativeGenCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalInsightNarrativeGenCoreLogicConfig()
