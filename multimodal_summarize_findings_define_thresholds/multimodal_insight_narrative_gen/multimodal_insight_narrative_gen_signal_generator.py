"""
  ...
  Folder     : multimodal_insight_narrative_gen
  File       : multimodal_insight_narrative_gen_signal_generator.py
  Purpose    : Summarize Findings — Insight Narrative Gen
"""
...
MULTIMODAL_MODULE = 'multimodal_insight_narrative_gen_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalInsightNarrativeGenSignalGeneratorConfig:
    """Multimodal threshold-sweep config for insight_narrative_gen."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalInsightNarrativeGenEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: summarize findings — insight narrative gen.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalInsightNarrativeGenSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalInsightNarrativeGenSignalGeneratorConfig()
