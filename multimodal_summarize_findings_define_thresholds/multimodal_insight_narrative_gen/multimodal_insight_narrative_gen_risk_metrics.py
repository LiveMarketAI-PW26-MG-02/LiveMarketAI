"""
  ...
  File       : multimodal_insight_narrative_gen_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_insight_narrative_gen_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalInsightNarrativeGenRiskMetricsConfig:
...
class MultimodalInsightNarrativeGenEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalInsightNarrativeGenRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalInsightNarrativeGenRiskMetricsConfig()
