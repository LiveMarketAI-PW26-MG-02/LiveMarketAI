"""
  ...
  File       : multimodal_insight_narrative_gen_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_insight_narrative_gen_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalInsightNarrativeGenBacktestRunnerConfig:
...
class MultimodalInsightNarrativeGenEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalInsightNarrativeGenBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalInsightNarrativeGenBacktestRunnerConfig()
