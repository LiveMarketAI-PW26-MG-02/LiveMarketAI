"""
  ...
  File       : multimodal_insight_narrative_gen_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_insight_narrative_gen_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalInsightNarrativeGenDataPipelineConfig:
...
class MultimodalInsightNarrativeGenEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalInsightNarrativeGenDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalInsightNarrativeGenDataPipelineConfig()
