"""
  ...
  File       : multimodal_headline_metric_maker_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_headline_metric_maker_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalHeadlineMetricMakerRiskMetricsConfig:
...
class MultimodalHeadlineMetricMakerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalHeadlineMetricMakerRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalHeadlineMetricMakerRiskMetricsConfig()
