"""
  ...
  File       : multimodal_headline_metric_maker_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_headline_metric_maker_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalHeadlineMetricMakerDataPipelineConfig:
...
class MultimodalHeadlineMetricMakerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalHeadlineMetricMakerDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalHeadlineMetricMakerDataPipelineConfig()
