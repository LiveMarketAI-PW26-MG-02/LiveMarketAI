"""
  ...
  File       : multimodal_headline_metric_maker_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_headline_metric_maker_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalHeadlineMetricMakerCoreLogicConfig:
...
class MultimodalHeadlineMetricMakerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalHeadlineMetricMakerCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalHeadlineMetricMakerCoreLogicConfig()
