"""
  ...
  Folder     : multimodal_headline_metric_maker
  File       : multimodal_headline_metric_maker_signal_generator.py
  Purpose    : Summarize Findings — Headline Metric Maker
"""
...
MULTIMODAL_MODULE = 'multimodal_headline_metric_maker_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalHeadlineMetricMakerSignalGeneratorConfig:
    """Multimodal threshold-sweep config for headline_metric_maker."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalHeadlineMetricMakerEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: summarize findings — headline metric maker.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalHeadlineMetricMakerSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalHeadlineMetricMakerSignalGeneratorConfig()
