"""
  ...
  File       : multimodal_headline_metric_maker_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_headline_metric_maker_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalHeadlineMetricMakerBacktestRunnerConfig:
...
class MultimodalHeadlineMetricMakerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalHeadlineMetricMakerBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalHeadlineMetricMakerBacktestRunnerConfig()
