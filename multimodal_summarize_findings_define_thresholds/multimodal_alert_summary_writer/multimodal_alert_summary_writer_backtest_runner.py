"""
  ...
  File       : multimodal_alert_summary_writer_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_alert_summary_writer_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalAlertSummaryWriterBacktestRunnerConfig:
...
class MultimodalAlertSummaryWriterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalAlertSummaryWriterBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalAlertSummaryWriterBacktestRunnerConfig()
