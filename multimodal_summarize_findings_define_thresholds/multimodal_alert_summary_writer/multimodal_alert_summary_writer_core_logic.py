"""
  ...
  File       : multimodal_alert_summary_writer_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_alert_summary_writer_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalAlertSummaryWriterCoreLogicConfig:
...
class MultimodalAlertSummaryWriterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalAlertSummaryWriterCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalAlertSummaryWriterCoreLogicConfig()
