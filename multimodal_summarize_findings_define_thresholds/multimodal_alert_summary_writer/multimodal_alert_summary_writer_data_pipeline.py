"""
  ...
  File       : multimodal_alert_summary_writer_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_alert_summary_writer_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalAlertSummaryWriterDataPipelineConfig:
...
class MultimodalAlertSummaryWriterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalAlertSummaryWriterDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalAlertSummaryWriterDataPipelineConfig()
