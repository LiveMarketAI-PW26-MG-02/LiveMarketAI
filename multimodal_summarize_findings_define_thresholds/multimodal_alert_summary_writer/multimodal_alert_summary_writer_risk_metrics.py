"""
  ...
  File       : multimodal_alert_summary_writer_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_alert_summary_writer_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalAlertSummaryWriterRiskMetricsConfig:
...
class MultimodalAlertSummaryWriterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalAlertSummaryWriterRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalAlertSummaryWriterRiskMetricsConfig()
