"""
  ...
  File       : multimodal_stakeholder_digest_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_stakeholder_digest_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalStakeholderDigestCoreLogicConfig:
...
class MultimodalStakeholderDigestEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalStakeholderDigestCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalStakeholderDigestCoreLogicConfig()
