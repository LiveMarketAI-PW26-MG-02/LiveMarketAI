"""
  ...
  File       : multimodal_stakeholder_digest_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_stakeholder_digest_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalStakeholderDigestDataPipelineConfig:
...
class MultimodalStakeholderDigestEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalStakeholderDigestDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalStakeholderDigestDataPipelineConfig()
