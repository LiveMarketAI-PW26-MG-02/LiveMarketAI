"""
  ...
  Folder     : multimodal_stakeholder_digest
  File       : multimodal_stakeholder_digest_signal_generator.py
  Purpose    : Summarize Findings — Stakeholder Digest
"""
...
MULTIMODAL_MODULE = 'multimodal_stakeholder_digest_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalStakeholderDigestSignalGeneratorConfig:
    """Multimodal threshold-sweep config for stakeholder_digest."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalStakeholderDigestEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: summarize findings — stakeholder digest.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalStakeholderDigestSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalStakeholderDigestSignalGeneratorConfig()
