"""
  ...
  File       : multimodal_stakeholder_digest_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_stakeholder_digest_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalStakeholderDigestBacktestRunnerConfig:
...
class MultimodalStakeholderDigestEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalStakeholderDigestBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalStakeholderDigestBacktestRunnerConfig()
