"""
  ...
  File       : multimodal_stakeholder_digest_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_stakeholder_digest_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalStakeholderDigestRiskMetricsConfig:
...
class MultimodalStakeholderDigestEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalStakeholderDigestRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalStakeholderDigestRiskMetricsConfig()
