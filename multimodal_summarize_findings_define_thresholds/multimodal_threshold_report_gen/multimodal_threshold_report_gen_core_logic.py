"""
  ...
  File       : multimodal_threshold_report_gen_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_threshold_report_gen_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalThresholdReportGenCoreLogicConfig:
...
class MultimodalThresholdReportGenEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalThresholdReportGenCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalThresholdReportGenCoreLogicConfig()
