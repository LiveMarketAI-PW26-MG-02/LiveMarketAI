"""
  ...
  File       : multimodal_threshold_report_gen_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_threshold_report_gen_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalThresholdReportGenDataPipelineConfig:
...
class MultimodalThresholdReportGenEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalThresholdReportGenDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalThresholdReportGenDataPipelineConfig()
