"""
  ...
  File       : multimodal_threshold_report_gen_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_threshold_report_gen_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalThresholdReportGenRiskMetricsConfig:
...
class MultimodalThresholdReportGenEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalThresholdReportGenRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalThresholdReportGenRiskMetricsConfig()
