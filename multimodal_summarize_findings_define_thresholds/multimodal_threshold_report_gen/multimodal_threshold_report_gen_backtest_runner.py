"""
  ...
  File       : multimodal_threshold_report_gen_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_threshold_report_gen_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalThresholdReportGenBacktestRunnerConfig:
...
class MultimodalThresholdReportGenEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalThresholdReportGenBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalThresholdReportGenBacktestRunnerConfig()
