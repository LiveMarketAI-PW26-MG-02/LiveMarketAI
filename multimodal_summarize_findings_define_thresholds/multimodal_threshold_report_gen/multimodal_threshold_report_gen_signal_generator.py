"""
  ...
  Folder     : multimodal_threshold_report_gen
  File       : multimodal_threshold_report_gen_signal_generator.py
  Purpose    : Summarize Findings — Threshold Report Gen
"""
...
MULTIMODAL_MODULE = 'multimodal_threshold_report_gen_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalThresholdReportGenSignalGeneratorConfig:
    """Multimodal threshold-sweep config for threshold_report_gen."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalThresholdReportGenEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: summarize findings — threshold report gen.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalThresholdReportGenSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalThresholdReportGenSignalGeneratorConfig()
