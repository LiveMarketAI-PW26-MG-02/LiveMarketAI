"""
  ...
  File       : multimodal_exec_brief_compiler_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_exec_brief_compiler_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalExecBriefCompilerCoreLogicConfig:
...
class MultimodalExecBriefCompilerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalExecBriefCompilerCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalExecBriefCompilerCoreLogicConfig()
