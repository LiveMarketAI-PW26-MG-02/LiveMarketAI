"""
  ...
  File       : multimodal_exec_brief_compiler_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_exec_brief_compiler_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalExecBriefCompilerBacktestRunnerConfig:
...
class MultimodalExecBriefCompilerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalExecBriefCompilerBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalExecBriefCompilerBacktestRunnerConfig()
