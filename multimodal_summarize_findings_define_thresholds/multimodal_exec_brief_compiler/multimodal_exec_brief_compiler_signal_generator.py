"""
  ...
  Folder     : multimodal_exec_brief_compiler
  File       : multimodal_exec_brief_compiler_signal_generator.py
  Purpose    : Summarize Findings — Exec Brief Compiler
"""
...
MULTIMODAL_MODULE = 'multimodal_exec_brief_compiler_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalExecBriefCompilerSignalGeneratorConfig:
    """Multimodal threshold-sweep config for exec_brief_compiler."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalExecBriefCompilerEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: summarize findings — exec brief compiler.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalExecBriefCompilerSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalExecBriefCompilerSignalGeneratorConfig()
