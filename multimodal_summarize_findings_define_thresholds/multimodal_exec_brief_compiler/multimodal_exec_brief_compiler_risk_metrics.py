"""
  ...
  File       : multimodal_exec_brief_compiler_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_exec_brief_compiler_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalExecBriefCompilerRiskMetricsConfig:
...
class MultimodalExecBriefCompilerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalExecBriefCompilerRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalExecBriefCompilerRiskMetricsConfig()
