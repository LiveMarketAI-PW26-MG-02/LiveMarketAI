"""
  ...
  File       : multimodal_exec_brief_compiler_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_exec_brief_compiler_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalExecBriefCompilerDataPipelineConfig:
...
class MultimodalExecBriefCompilerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalExecBriefCompilerDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalExecBriefCompilerDataPipelineConfig()
