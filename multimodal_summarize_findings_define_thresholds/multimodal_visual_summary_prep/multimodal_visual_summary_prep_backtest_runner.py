"""
  ...
  File       : multimodal_visual_summary_prep_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_visual_summary_prep_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalVisualSummaryPrepBacktestRunnerConfig:
...
class MultimodalVisualSummaryPrepEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalVisualSummaryPrepBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalVisualSummaryPrepBacktestRunnerConfig()
