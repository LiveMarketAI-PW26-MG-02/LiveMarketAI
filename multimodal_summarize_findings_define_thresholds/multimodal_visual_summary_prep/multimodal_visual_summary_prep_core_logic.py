"""
  ...
  File       : multimodal_visual_summary_prep_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_visual_summary_prep_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalVisualSummaryPrepCoreLogicConfig:
...
class MultimodalVisualSummaryPrepEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalVisualSummaryPrepCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalVisualSummaryPrepCoreLogicConfig()
