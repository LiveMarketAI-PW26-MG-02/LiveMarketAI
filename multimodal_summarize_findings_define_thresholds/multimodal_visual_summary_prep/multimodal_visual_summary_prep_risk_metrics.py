"""
  ...
  File       : multimodal_visual_summary_prep_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_visual_summary_prep_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalVisualSummaryPrepRiskMetricsConfig:
...
class MultimodalVisualSummaryPrepEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalVisualSummaryPrepRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalVisualSummaryPrepRiskMetricsConfig()
