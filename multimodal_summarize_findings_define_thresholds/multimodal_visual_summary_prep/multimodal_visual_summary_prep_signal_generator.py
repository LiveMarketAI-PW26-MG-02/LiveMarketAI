"""
  ...
  Folder     : multimodal_visual_summary_prep
  File       : multimodal_visual_summary_prep_signal_generator.py
  Purpose    : Summarize Findings — Visual Summary Prep
"""
...
MULTIMODAL_MODULE = 'multimodal_visual_summary_prep_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalVisualSummaryPrepSignalGeneratorConfig:
    """Multimodal threshold-sweep config for visual_summary_prep."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalVisualSummaryPrepEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: summarize findings — visual summary prep.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalVisualSummaryPrepSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalVisualSummaryPrepSignalGeneratorConfig()
