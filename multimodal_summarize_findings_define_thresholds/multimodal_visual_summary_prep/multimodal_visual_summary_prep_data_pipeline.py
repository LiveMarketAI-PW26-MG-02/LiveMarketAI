"""
  ...
  File       : multimodal_visual_summary_prep_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_visual_summary_prep_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalVisualSummaryPrepDataPipelineConfig:
...
class MultimodalVisualSummaryPrepEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalVisualSummaryPrepDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalVisualSummaryPrepDataPipelineConfig()
