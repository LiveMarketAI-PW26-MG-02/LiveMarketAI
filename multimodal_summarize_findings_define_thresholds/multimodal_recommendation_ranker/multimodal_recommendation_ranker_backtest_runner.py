"""
  ...
  File       : multimodal_recommendation_ranker_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_recommendation_ranker_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRecommendationRankerBacktestRunnerConfig:
...
class MultimodalRecommendationRankerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRecommendationRankerBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalRecommendationRankerBacktestRunnerConfig()
