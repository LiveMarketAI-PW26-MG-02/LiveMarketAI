"""
  ...
  File       : multimodal_recommendation_ranker_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_recommendation_ranker_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRecommendationRankerRiskMetricsConfig:
...
class MultimodalRecommendationRankerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRecommendationRankerRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalRecommendationRankerRiskMetricsConfig()
