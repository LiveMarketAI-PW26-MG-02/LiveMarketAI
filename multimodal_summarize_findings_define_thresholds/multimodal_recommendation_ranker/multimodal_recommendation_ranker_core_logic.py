"""
  ...
  File       : multimodal_recommendation_ranker_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_recommendation_ranker_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRecommendationRankerCoreLogicConfig:
...
class MultimodalRecommendationRankerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRecommendationRankerCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalRecommendationRankerCoreLogicConfig()
