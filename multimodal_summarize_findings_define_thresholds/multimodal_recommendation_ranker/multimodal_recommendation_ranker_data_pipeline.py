"""
  ...
  File       : multimodal_recommendation_ranker_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_recommendation_ranker_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRecommendationRankerDataPipelineConfig:
...
class MultimodalRecommendationRankerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRecommendationRankerDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalRecommendationRankerDataPipelineConfig()
