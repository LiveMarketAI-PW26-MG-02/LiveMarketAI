"""
  ...
  File       : multimodal_findings_digest_eng_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_findings_digest_eng_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalFindingsDigestEngRiskMetricsConfig:
...
class MultimodalFindingsDigestEngEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalFindingsDigestEngRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalFindingsDigestEngRiskMetricsConfig()
