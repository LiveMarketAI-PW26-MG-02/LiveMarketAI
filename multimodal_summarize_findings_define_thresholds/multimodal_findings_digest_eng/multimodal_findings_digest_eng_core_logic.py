"""
  ...
  File       : multimodal_findings_digest_eng_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_findings_digest_eng_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalFindingsDigestEngCoreLogicConfig:
...
class MultimodalFindingsDigestEngEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalFindingsDigestEngCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalFindingsDigestEngCoreLogicConfig()
