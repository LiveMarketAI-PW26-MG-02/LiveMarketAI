"""
  ...
  Folder     : multimodal_findings_digest_eng
  File       : multimodal_findings_digest_eng_signal_generator.py
  Purpose    : Summarize Findings — Findings Digest Eng
"""
...
MULTIMODAL_MODULE = 'multimodal_findings_digest_eng_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalFindingsDigestEngSignalGeneratorConfig:
    """Multimodal threshold-sweep config for findings_digest_eng."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalFindingsDigestEngEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: summarize findings — findings digest eng.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalFindingsDigestEngSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalFindingsDigestEngSignalGeneratorConfig()
