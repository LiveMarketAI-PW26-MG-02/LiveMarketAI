"""
  ...
  File       : multimodal_findings_digest_eng_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_findings_digest_eng_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalFindingsDigestEngBacktestRunnerConfig:
...
class MultimodalFindingsDigestEngEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalFindingsDigestEngBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalFindingsDigestEngBacktestRunnerConfig()
