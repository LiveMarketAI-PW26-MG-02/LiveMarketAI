"""
  ...
  File       : multimodal_findings_digest_eng_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_findings_digest_eng_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalFindingsDigestEngDataPipelineConfig:
...
class MultimodalFindingsDigestEngEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalFindingsDigestEngDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalFindingsDigestEngDataPipelineConfig()
