"""
  ...
  File       : multimodal_bond_duration_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_bond_duration_backtest_runner'
TOPIC             = 'stability_analysis'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalBondDurationBacktestRunnerConfig:
...
class MultimodalBondDurationEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalBondDurationBacktestRunnerConfig()
        self.state    : Dict = {}
