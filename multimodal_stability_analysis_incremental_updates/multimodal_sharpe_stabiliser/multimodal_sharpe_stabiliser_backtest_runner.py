"""
  ...
  File       : multimodal_sharpe_stabiliser_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_sharpe_stabiliser_backtest_runner'
TOPIC             = 'stability_analysis'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalSharpeStabiliserBacktestRunnerConfig:
...
class MultimodalSharpeStabiliserEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalSharpeStabiliserBacktestRunnerConfig()
        self.state    : Dict = {}
