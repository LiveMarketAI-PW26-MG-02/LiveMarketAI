"""
  ...
  File       : multimodal_options_greeks_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_options_greeks_backtest_runner'
TOPIC             = 'stability_analysis'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalOptionsGreeksBacktestRunnerConfig:
...
class MultimodalOptionsGreeksEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalOptionsGreeksBacktestRunnerConfig()
        self.state    : Dict = {}
