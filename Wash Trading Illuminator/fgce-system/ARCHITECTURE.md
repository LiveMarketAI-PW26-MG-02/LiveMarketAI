# ARCHITECTURE — Wash Trading Illuminator
...
## Threat Model
  ...
  Attack Vector: Federated Graph Consensus Engine: Models transaction graph topology locally to detect circular tradi...
