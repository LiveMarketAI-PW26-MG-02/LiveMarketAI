# Explainable Liquidity-Crisis Forecasting Engine

Forecasts systemic liquidity stress and explains the contributing institutions and channels.
...
- **10 self-created APIs (routers)**: /health, /auth, /audit, /ingest, /explain, /liquidity_metrics, /crisis_signals, /institutions, /forecasts, /explanations
- **AI primitive**: `forecast` — see `explainable_liquidity_crisis_forecasting_engine/ai/engine.py`. Exposed at `POST /explain`.
...
## Run
    ...
    uvicorn explainable_liquidity_crisis_forecasting_engine.main:app --reload     # SQLite tables auto-created on boot
...
## Layout
    ...
    explainable_liquidity_crisis_forecasting_engine/
