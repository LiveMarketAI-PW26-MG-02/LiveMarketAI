...
from ...schemas.institution import InstitutionCreate, InstitutionRead
...
@router.get("/{item_id}", response_model=InstitutionRead)
...
def create_item(payload: InstitutionCreate, db: Session = Depends(get_db)):
