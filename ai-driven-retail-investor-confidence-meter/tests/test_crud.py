...
from ai_driven_retail_investor_confidence_meter.main import app


def test_create_and_list_sentiment_signal():
    with TestClient(app) as c:
        created = c.post("/sentiment_signals", json={})
        assert created.status_code == 201
        listed = c.get("/sentiment_signals")
