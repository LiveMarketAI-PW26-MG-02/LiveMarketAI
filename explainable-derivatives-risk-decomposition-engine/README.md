# Explainable Derivatives Risk-Decomposition Engine

Decomposes portfolio derivatives risk into interpretable Greeks and factor buckets with stress-scenario attributions.
...
- **10 self-created APIs (routers)**: /health, /auth, /audit, /ingest, /explain, /derivatives, /risk_factors, /decompositions, /greekss, /stress_scenarios
- **AI primitive**: `attention` — see `explainable_derivatives_risk_decomposition_engine/ai/engine.py`. Exposed at `POST /explain`.
...
## Run
    ...
    uvicorn explainable_derivatives_risk_decomposition_engine.main:app --reload     # SQLite tables auto-created on boot
...
## Layout
    ...
    explainable_derivatives_risk_decomposition_engine/
