"""
  ...
  Folder     : multimodal_turnover_thresh_audit
  File       : multimodal_turnover_thresh_audit_signal_generator.py
  Purpose    : Evaluate Performance — Turnover Thresh Audit
"""
...
MULTIMODAL_MODULE = 'multimodal_turnover_thresh_audit_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalTurnoverThreshAuditSignalGeneratorConfig:
    """Multimodal threshold-sweep config for turnover_thresh_audit."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalTurnoverThreshAuditEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: evaluate performance — turnover thresh audit.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalTurnoverThreshAuditSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalTurnoverThreshAuditSignalGeneratorConfig()
