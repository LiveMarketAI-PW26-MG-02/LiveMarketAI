"""
  ...
  File       : multimodal_turnover_thresh_audit_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_turnover_thresh_audit_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalTurnoverThreshAuditBacktestRunnerConfig:
...
class MultimodalTurnoverThreshAuditEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalTurnoverThreshAuditBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalTurnoverThreshAuditBacktestRunnerConfig()
