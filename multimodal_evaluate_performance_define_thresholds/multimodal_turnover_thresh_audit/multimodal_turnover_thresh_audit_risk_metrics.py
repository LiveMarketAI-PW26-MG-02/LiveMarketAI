"""
  ...
  File       : multimodal_turnover_thresh_audit_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_turnover_thresh_audit_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalTurnoverThreshAuditRiskMetricsConfig:
...
class MultimodalTurnoverThreshAuditEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalTurnoverThreshAuditRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalTurnoverThreshAuditRiskMetricsConfig()
