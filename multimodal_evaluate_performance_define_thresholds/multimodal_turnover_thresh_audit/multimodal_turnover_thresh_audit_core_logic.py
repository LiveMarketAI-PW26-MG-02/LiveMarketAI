"""
  ...
  File       : multimodal_turnover_thresh_audit_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_turnover_thresh_audit_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalTurnoverThreshAuditCoreLogicConfig:
...
class MultimodalTurnoverThreshAuditEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalTurnoverThreshAuditCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalTurnoverThreshAuditCoreLogicConfig()
