"""
  ...
  File       : multimodal_turnover_thresh_audit_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_turnover_thresh_audit_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalTurnoverThreshAuditDataPipelineConfig:
...
class MultimodalTurnoverThreshAuditEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalTurnoverThreshAuditDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalTurnoverThreshAuditDataPipelineConfig()
