"""
  ...
  File       : multimodal_sharpe_thresh_eval_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_sharpe_thresh_eval_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSharpeThreshEvalRiskMetricsConfig:
...
class MultimodalSharpeThreshEvalEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSharpeThreshEvalRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalSharpeThreshEvalRiskMetricsConfig()
