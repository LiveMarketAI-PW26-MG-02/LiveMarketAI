"""
  ...
  File       : multimodal_sharpe_thresh_eval_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_sharpe_thresh_eval_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSharpeThreshEvalDataPipelineConfig:
...
class MultimodalSharpeThreshEvalEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSharpeThreshEvalDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalSharpeThreshEvalDataPipelineConfig()
