"""
  ...
  Folder     : multimodal_sharpe_thresh_eval
  File       : multimodal_sharpe_thresh_eval_signal_generator.py
  Purpose    : Evaluate Performance — Sharpe Thresh Eval
"""
...
MULTIMODAL_MODULE = 'multimodal_sharpe_thresh_eval_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSharpeThreshEvalSignalGeneratorConfig:
    """Multimodal threshold-sweep config for sharpe_thresh_eval."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalSharpeThreshEvalEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: evaluate performance — sharpe thresh eval.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalSharpeThreshEvalSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalSharpeThreshEvalSignalGeneratorConfig()
