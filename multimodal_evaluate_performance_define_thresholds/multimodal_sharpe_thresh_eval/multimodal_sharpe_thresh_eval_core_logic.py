"""
  ...
  File       : multimodal_sharpe_thresh_eval_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_sharpe_thresh_eval_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSharpeThreshEvalCoreLogicConfig:
...
class MultimodalSharpeThreshEvalEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSharpeThreshEvalCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalSharpeThreshEvalCoreLogicConfig()
