"""
  ...
  File       : multimodal_sharpe_thresh_eval_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_sharpe_thresh_eval_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSharpeThreshEvalBacktestRunnerConfig:
...
class MultimodalSharpeThreshEvalEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSharpeThreshEvalBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalSharpeThreshEvalBacktestRunnerConfig()
