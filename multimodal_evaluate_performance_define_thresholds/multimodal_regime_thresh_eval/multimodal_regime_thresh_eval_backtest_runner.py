"""
  ...
  File       : multimodal_regime_thresh_eval_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_regime_thresh_eval_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeThreshEvalBacktestRunnerConfig:
...
class MultimodalRegimeThreshEvalEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegimeThreshEvalBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalRegimeThreshEvalBacktestRunnerConfig()
