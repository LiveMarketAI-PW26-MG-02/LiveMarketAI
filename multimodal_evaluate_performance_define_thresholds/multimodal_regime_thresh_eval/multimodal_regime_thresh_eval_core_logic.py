"""
  ...
  File       : multimodal_regime_thresh_eval_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_regime_thresh_eval_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeThreshEvalCoreLogicConfig:
...
class MultimodalRegimeThreshEvalEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegimeThreshEvalCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalRegimeThreshEvalCoreLogicConfig()
