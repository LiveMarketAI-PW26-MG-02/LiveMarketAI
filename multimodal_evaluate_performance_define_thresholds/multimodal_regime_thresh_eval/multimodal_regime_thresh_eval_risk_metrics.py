"""
  ...
  File       : multimodal_regime_thresh_eval_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_regime_thresh_eval_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeThreshEvalRiskMetricsConfig:
...
class MultimodalRegimeThreshEvalEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegimeThreshEvalRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalRegimeThreshEvalRiskMetricsConfig()
