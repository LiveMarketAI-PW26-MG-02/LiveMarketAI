"""
  ...
  File       : multimodal_regime_thresh_eval_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_regime_thresh_eval_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeThreshEvalDataPipelineConfig:
...
class MultimodalRegimeThreshEvalEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegimeThreshEvalDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalRegimeThreshEvalDataPipelineConfig()
