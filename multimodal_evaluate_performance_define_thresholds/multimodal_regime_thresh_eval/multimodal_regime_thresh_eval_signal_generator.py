"""
  ...
  Folder     : multimodal_regime_thresh_eval
  File       : multimodal_regime_thresh_eval_signal_generator.py
  Purpose    : Evaluate Performance — Regime Thresh Eval
"""
...
MULTIMODAL_MODULE = 'multimodal_regime_thresh_eval_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeThreshEvalSignalGeneratorConfig:
    """Multimodal threshold-sweep config for regime_thresh_eval."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalRegimeThreshEvalEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: evaluate performance — regime thresh eval.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalRegimeThreshEvalSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalRegimeThreshEvalSignalGeneratorConfig()
