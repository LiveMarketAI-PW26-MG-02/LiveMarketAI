"""
  ...
  File       : multimodal_cost_adj_thresh_eval_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_cost_adj_thresh_eval_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCostAdjThreshEvalDataPipelineConfig:
...
class MultimodalCostAdjThreshEvalEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCostAdjThreshEvalDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalCostAdjThreshEvalDataPipelineConfig()
