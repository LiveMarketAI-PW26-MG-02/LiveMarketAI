"""
  ...
  File       : multimodal_cost_adj_thresh_eval_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_cost_adj_thresh_eval_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCostAdjThreshEvalRiskMetricsConfig:
...
class MultimodalCostAdjThreshEvalEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCostAdjThreshEvalRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalCostAdjThreshEvalRiskMetricsConfig()
