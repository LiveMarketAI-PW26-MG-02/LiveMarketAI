"""
  ...
  File       : multimodal_cost_adj_thresh_eval_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_cost_adj_thresh_eval_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCostAdjThreshEvalBacktestRunnerConfig:
...
class MultimodalCostAdjThreshEvalEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCostAdjThreshEvalBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalCostAdjThreshEvalBacktestRunnerConfig()
