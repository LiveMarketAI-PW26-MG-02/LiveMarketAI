"""
  ...
  File       : multimodal_cost_adj_thresh_eval_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_cost_adj_thresh_eval_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCostAdjThreshEvalCoreLogicConfig:
...
class MultimodalCostAdjThreshEvalEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCostAdjThreshEvalCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalCostAdjThreshEvalCoreLogicConfig()
