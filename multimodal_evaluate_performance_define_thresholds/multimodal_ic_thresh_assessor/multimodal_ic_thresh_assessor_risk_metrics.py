"""
  ...
  File       : multimodal_ic_thresh_assessor_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_ic_thresh_assessor_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalIcThreshAssessorRiskMetricsConfig:
...
class MultimodalIcThreshAssessorEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalIcThreshAssessorRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalIcThreshAssessorRiskMetricsConfig()
