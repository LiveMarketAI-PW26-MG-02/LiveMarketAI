"""
  ...
  File       : multimodal_ic_thresh_assessor_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_ic_thresh_assessor_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalIcThreshAssessorBacktestRunnerConfig:
...
class MultimodalIcThreshAssessorEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalIcThreshAssessorBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalIcThreshAssessorBacktestRunnerConfig()
