"""
  ...
  File       : multimodal_ic_thresh_assessor_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_ic_thresh_assessor_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalIcThreshAssessorCoreLogicConfig:
...
class MultimodalIcThreshAssessorEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalIcThreshAssessorCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalIcThreshAssessorCoreLogicConfig()
