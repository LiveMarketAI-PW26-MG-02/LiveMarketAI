"""
  ...
  File       : multimodal_ic_thresh_assessor_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_ic_thresh_assessor_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalIcThreshAssessorDataPipelineConfig:
...
class MultimodalIcThreshAssessorEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalIcThreshAssessorDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalIcThreshAssessorDataPipelineConfig()
