"""
  ...
  Folder     : multimodal_ic_thresh_assessor
  File       : multimodal_ic_thresh_assessor_signal_generator.py
  Purpose    : Evaluate Performance — Ic Thresh Assessor
"""
...
MULTIMODAL_MODULE = 'multimodal_ic_thresh_assessor_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalIcThreshAssessorSignalGeneratorConfig:
    """Multimodal threshold-sweep config for ic_thresh_assessor."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalIcThreshAssessorEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: evaluate performance — ic thresh assessor.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalIcThreshAssessorSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalIcThreshAssessorSignalGeneratorConfig()
