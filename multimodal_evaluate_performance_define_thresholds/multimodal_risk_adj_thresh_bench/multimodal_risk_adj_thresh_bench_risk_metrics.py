"""
  ...
  File       : multimodal_risk_adj_thresh_bench_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_risk_adj_thresh_bench_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRiskAdjThreshBenchRiskMetricsConfig:
...
class MultimodalRiskAdjThreshBenchEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRiskAdjThreshBenchRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalRiskAdjThreshBenchRiskMetricsConfig()
