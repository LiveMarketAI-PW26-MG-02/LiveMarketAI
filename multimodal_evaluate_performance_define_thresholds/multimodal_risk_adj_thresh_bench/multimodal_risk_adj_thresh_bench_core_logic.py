"""
  ...
  File       : multimodal_risk_adj_thresh_bench_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_risk_adj_thresh_bench_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRiskAdjThreshBenchCoreLogicConfig:
...
class MultimodalRiskAdjThreshBenchEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRiskAdjThreshBenchCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalRiskAdjThreshBenchCoreLogicConfig()
