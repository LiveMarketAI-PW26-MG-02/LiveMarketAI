"""
  ...
  File       : multimodal_risk_adj_thresh_bench_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_risk_adj_thresh_bench_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRiskAdjThreshBenchBacktestRunnerConfig:
...
class MultimodalRiskAdjThreshBenchEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRiskAdjThreshBenchBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalRiskAdjThreshBenchBacktestRunnerConfig()
