"""
  ...
  File       : multimodal_risk_adj_thresh_bench_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_risk_adj_thresh_bench_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRiskAdjThreshBenchDataPipelineConfig:
...
class MultimodalRiskAdjThreshBenchEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRiskAdjThreshBenchDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalRiskAdjThreshBenchDataPipelineConfig()
