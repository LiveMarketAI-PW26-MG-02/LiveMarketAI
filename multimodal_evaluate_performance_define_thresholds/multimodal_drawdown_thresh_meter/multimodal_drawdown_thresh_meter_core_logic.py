"""
  ...
  File       : multimodal_drawdown_thresh_meter_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_drawdown_thresh_meter_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalDrawdownThreshMeterCoreLogicConfig:
...
class MultimodalDrawdownThreshMeterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDrawdownThreshMeterCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalDrawdownThreshMeterCoreLogicConfig()
