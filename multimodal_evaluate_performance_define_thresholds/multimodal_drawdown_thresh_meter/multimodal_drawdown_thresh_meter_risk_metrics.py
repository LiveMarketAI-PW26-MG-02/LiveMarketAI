"""
  ...
  File       : multimodal_drawdown_thresh_meter_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_drawdown_thresh_meter_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalDrawdownThreshMeterRiskMetricsConfig:
...
class MultimodalDrawdownThreshMeterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDrawdownThreshMeterRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalDrawdownThreshMeterRiskMetricsConfig()
