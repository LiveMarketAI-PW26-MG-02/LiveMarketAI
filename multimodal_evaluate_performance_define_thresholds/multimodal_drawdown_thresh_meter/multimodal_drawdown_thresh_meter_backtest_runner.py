"""
  ...
  File       : multimodal_drawdown_thresh_meter_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_drawdown_thresh_meter_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalDrawdownThreshMeterBacktestRunnerConfig:
...
class MultimodalDrawdownThreshMeterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDrawdownThreshMeterBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalDrawdownThreshMeterBacktestRunnerConfig()
