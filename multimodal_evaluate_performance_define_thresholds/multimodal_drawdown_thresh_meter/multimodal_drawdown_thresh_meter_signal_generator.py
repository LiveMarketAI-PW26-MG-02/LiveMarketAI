"""
  ...
  Folder     : multimodal_drawdown_thresh_meter
  File       : multimodal_drawdown_thresh_meter_signal_generator.py
  Purpose    : Evaluate Performance — Drawdown Thresh Meter
"""
...
MULTIMODAL_MODULE = 'multimodal_drawdown_thresh_meter_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalDrawdownThreshMeterSignalGeneratorConfig:
    """Multimodal threshold-sweep config for drawdown_thresh_meter."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalDrawdownThreshMeterEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: evaluate performance — drawdown thresh meter.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalDrawdownThreshMeterSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalDrawdownThreshMeterSignalGeneratorConfig()
