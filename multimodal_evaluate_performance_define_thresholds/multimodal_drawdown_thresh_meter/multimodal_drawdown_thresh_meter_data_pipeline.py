"""
  ...
  File       : multimodal_drawdown_thresh_meter_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_drawdown_thresh_meter_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalDrawdownThreshMeterDataPipelineConfig:
...
class MultimodalDrawdownThreshMeterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDrawdownThreshMeterDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalDrawdownThreshMeterDataPipelineConfig()
