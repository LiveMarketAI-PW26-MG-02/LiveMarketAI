"""
  ...
  File       : multimodal_alpha_decay_thresh_log_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_alpha_decay_thresh_log_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalAlphaDecayThreshLogBacktestRunnerConfig:
...
class MultimodalAlphaDecayThreshLogEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalAlphaDecayThreshLogBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalAlphaDecayThreshLogBacktestRunnerConfig()
