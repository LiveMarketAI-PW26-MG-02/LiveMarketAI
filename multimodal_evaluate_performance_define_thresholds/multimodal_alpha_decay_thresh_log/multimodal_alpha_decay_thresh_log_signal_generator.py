"""
  ...
  Folder     : multimodal_alpha_decay_thresh_log
  File       : multimodal_alpha_decay_thresh_log_signal_generator.py
  Purpose    : Evaluate Performance — Alpha Decay Thresh Log
"""
...
MULTIMODAL_MODULE = 'multimodal_alpha_decay_thresh_log_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalAlphaDecayThreshLogSignalGeneratorConfig:
    """Multimodal threshold-sweep config for alpha_decay_thresh_log."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalAlphaDecayThreshLogEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: evaluate performance — alpha decay thresh log.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalAlphaDecayThreshLogSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalAlphaDecayThreshLogSignalGeneratorConfig()
