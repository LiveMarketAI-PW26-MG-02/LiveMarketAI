"""
  ...
  File       : multimodal_alpha_decay_thresh_log_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_alpha_decay_thresh_log_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalAlphaDecayThreshLogRiskMetricsConfig:
...
class MultimodalAlphaDecayThreshLogEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalAlphaDecayThreshLogRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalAlphaDecayThreshLogRiskMetricsConfig()
