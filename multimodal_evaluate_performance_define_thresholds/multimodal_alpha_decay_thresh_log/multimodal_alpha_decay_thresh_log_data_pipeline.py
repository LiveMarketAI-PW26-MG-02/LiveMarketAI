"""
  ...
  File       : multimodal_alpha_decay_thresh_log_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_alpha_decay_thresh_log_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalAlphaDecayThreshLogDataPipelineConfig:
...
class MultimodalAlphaDecayThreshLogEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalAlphaDecayThreshLogDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalAlphaDecayThreshLogDataPipelineConfig()
