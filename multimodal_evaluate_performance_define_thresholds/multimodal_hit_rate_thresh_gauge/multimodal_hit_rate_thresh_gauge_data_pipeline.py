"""
  ...
  File       : multimodal_hit_rate_thresh_gauge_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_hit_rate_thresh_gauge_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalHitRateThreshGaugeDataPipelineConfig:
...
class MultimodalHitRateThreshGaugeEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalHitRateThreshGaugeDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalHitRateThreshGaugeDataPipelineConfig()
