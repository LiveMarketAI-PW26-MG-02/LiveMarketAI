"""
  ...
  Folder     : multimodal_hit_rate_thresh_gauge
  File       : multimodal_hit_rate_thresh_gauge_signal_generator.py
  Purpose    : Evaluate Performance — Hit Rate Thresh Gauge
"""
...
MULTIMODAL_MODULE = 'multimodal_hit_rate_thresh_gauge_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalHitRateThreshGaugeSignalGeneratorConfig:
    """Multimodal threshold-sweep config for hit_rate_thresh_gauge."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalHitRateThreshGaugeEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: evaluate performance — hit rate thresh gauge.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalHitRateThreshGaugeSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalHitRateThreshGaugeSignalGeneratorConfig()
