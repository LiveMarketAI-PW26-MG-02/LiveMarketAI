"""
  ...
  File       : multimodal_hit_rate_thresh_gauge_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_hit_rate_thresh_gauge_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalHitRateThreshGaugeBacktestRunnerConfig:
...
class MultimodalHitRateThreshGaugeEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalHitRateThreshGaugeBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalHitRateThreshGaugeBacktestRunnerConfig()
