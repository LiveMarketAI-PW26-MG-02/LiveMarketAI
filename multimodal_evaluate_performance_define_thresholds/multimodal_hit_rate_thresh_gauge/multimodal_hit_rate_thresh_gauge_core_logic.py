"""
  ...
  File       : multimodal_hit_rate_thresh_gauge_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_hit_rate_thresh_gauge_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalHitRateThreshGaugeCoreLogicConfig:
...
class MultimodalHitRateThreshGaugeEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalHitRateThreshGaugeCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalHitRateThreshGaugeCoreLogicConfig()
