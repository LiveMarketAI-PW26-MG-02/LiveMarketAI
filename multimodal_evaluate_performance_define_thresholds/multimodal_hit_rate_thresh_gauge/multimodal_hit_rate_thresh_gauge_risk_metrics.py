"""
  ...
  File       : multimodal_hit_rate_thresh_gauge_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_hit_rate_thresh_gauge_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalHitRateThreshGaugeRiskMetricsConfig:
...
class MultimodalHitRateThreshGaugeEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalHitRateThreshGaugeRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalHitRateThreshGaugeRiskMetricsConfig()
