"""
  ...
  File       : multimodal_calmar_thresh_scorer_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_calmar_thresh_scorer_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCalmarThreshScorerBacktestRunnerConfig:
...
class MultimodalCalmarThreshScorerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCalmarThreshScorerBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalCalmarThreshScorerBacktestRunnerConfig()
