"""
  ...
  File       : multimodal_calmar_thresh_scorer_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_calmar_thresh_scorer_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCalmarThreshScorerRiskMetricsConfig:
...
class MultimodalCalmarThreshScorerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCalmarThreshScorerRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalCalmarThreshScorerRiskMetricsConfig()
