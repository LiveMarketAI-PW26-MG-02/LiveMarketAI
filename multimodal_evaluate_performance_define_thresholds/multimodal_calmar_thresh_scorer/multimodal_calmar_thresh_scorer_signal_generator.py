"""
  ...
  Folder     : multimodal_calmar_thresh_scorer
  File       : multimodal_calmar_thresh_scorer_signal_generator.py
  Purpose    : Evaluate Performance — Calmar Thresh Scorer
"""
...
MULTIMODAL_MODULE = 'multimodal_calmar_thresh_scorer_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCalmarThreshScorerSignalGeneratorConfig:
    """Multimodal threshold-sweep config for calmar_thresh_scorer."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalCalmarThreshScorerEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: evaluate performance — calmar thresh scorer.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalCalmarThreshScorerSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalCalmarThreshScorerSignalGeneratorConfig()
