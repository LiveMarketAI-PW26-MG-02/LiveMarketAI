"""
  ...
  File       : multimodal_calmar_thresh_scorer_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_calmar_thresh_scorer_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCalmarThreshScorerCoreLogicConfig:
...
class MultimodalCalmarThreshScorerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCalmarThreshScorerCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalCalmarThreshScorerCoreLogicConfig()
