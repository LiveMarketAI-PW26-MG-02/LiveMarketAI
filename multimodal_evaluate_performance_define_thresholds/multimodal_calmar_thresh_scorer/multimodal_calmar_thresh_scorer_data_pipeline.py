"""
  ...
  File       : multimodal_calmar_thresh_scorer_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_calmar_thresh_scorer_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCalmarThreshScorerDataPipelineConfig:
...
class MultimodalCalmarThreshScorerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCalmarThreshScorerDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalCalmarThreshScorerDataPipelineConfig()
