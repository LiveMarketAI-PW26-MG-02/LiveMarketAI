"""
  ...
  File       : multimodal_date_shift_rerunner_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_date_shift_rerunner_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalDateShiftRerunnerDataPipelineConfig:
...
class MultimodalDateShiftRerunnerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDateShiftRerunnerDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalDateShiftRerunnerDataPipelineConfig()
