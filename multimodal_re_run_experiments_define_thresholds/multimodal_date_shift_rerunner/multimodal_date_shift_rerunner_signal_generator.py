"""
  ...
  Folder     : multimodal_date_shift_rerunner
  File       : multimodal_date_shift_rerunner_signal_generator.py
  Purpose    : Re Run Experiments — Date Shift Rerunner
"""
...
MULTIMODAL_MODULE = 'multimodal_date_shift_rerunner_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalDateShiftRerunnerSignalGeneratorConfig:
    """Multimodal threshold-sweep config for date_shift_rerunner."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalDateShiftRerunnerEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: re run experiments — date shift rerunner.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalDateShiftRerunnerSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalDateShiftRerunnerSignalGeneratorConfig()
