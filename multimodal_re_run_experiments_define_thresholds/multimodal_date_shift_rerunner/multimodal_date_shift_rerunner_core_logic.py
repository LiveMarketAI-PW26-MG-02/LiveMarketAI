"""
  ...
  File       : multimodal_date_shift_rerunner_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_date_shift_rerunner_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalDateShiftRerunnerCoreLogicConfig:
...
class MultimodalDateShiftRerunnerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDateShiftRerunnerCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalDateShiftRerunnerCoreLogicConfig()
