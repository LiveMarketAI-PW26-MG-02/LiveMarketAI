"""
  ...
  File       : multimodal_date_shift_rerunner_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_date_shift_rerunner_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalDateShiftRerunnerRiskMetricsConfig:
...
class MultimodalDateShiftRerunnerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDateShiftRerunnerRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalDateShiftRerunnerRiskMetricsConfig()
