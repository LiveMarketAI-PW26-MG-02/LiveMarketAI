"""
  ...
  File       : multimodal_date_shift_rerunner_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_date_shift_rerunner_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalDateShiftRerunnerBacktestRunnerConfig:
...
class MultimodalDateShiftRerunnerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDateShiftRerunnerBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalDateShiftRerunnerBacktestRunnerConfig()
