"""
  ...
  Folder     : multimodal_regime_replay_engine
  File       : multimodal_regime_replay_engine_signal_generator.py
  Purpose    : Re Run Experiments — Regime Replay Engine
"""
...
MULTIMODAL_MODULE = 'multimodal_regime_replay_engine_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeReplayEngineSignalGeneratorConfig:
    """Multimodal threshold-sweep config for regime_replay_engine."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalRegimeReplayEngineEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: re run experiments — regime replay engine.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalRegimeReplayEngineSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalRegimeReplayEngineSignalGeneratorConfig()
