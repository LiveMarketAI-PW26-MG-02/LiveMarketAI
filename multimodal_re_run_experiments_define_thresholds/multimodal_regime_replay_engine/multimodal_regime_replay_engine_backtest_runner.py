"""
  ...
  File       : multimodal_regime_replay_engine_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_regime_replay_engine_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeReplayEngineBacktestRunnerConfig:
...
class MultimodalRegimeReplayEngineEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegimeReplayEngineBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalRegimeReplayEngineBacktestRunnerConfig()
