"""
  ...
  File       : multimodal_regime_replay_engine_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_regime_replay_engine_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeReplayEngineCoreLogicConfig:
...
class MultimodalRegimeReplayEngineEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegimeReplayEngineCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalRegimeReplayEngineCoreLogicConfig()
