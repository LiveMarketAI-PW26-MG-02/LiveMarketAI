"""
  ...
  File       : multimodal_regime_replay_engine_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_regime_replay_engine_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeReplayEngineDataPipelineConfig:
...
class MultimodalRegimeReplayEngineEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegimeReplayEngineDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalRegimeReplayEngineDataPipelineConfig()
