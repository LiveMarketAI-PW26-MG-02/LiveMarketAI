"""
  ...
  File       : multimodal_regime_replay_engine_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_regime_replay_engine_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeReplayEngineRiskMetricsConfig:
...
class MultimodalRegimeReplayEngineEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegimeReplayEngineRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalRegimeReplayEngineRiskMetricsConfig()
