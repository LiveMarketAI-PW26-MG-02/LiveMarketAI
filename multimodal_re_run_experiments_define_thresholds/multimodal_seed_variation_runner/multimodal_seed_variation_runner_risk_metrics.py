"""
  ...
  File       : multimodal_seed_variation_runner_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_seed_variation_runner_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSeedVariationRunnerRiskMetricsConfig:
...
class MultimodalSeedVariationRunnerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSeedVariationRunnerRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalSeedVariationRunnerRiskMetricsConfig()
