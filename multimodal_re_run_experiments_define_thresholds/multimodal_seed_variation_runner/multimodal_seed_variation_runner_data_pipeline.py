"""
  ...
  File       : multimodal_seed_variation_runner_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_seed_variation_runner_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSeedVariationRunnerDataPipelineConfig:
...
class MultimodalSeedVariationRunnerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSeedVariationRunnerDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalSeedVariationRunnerDataPipelineConfig()
