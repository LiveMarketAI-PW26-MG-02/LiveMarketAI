"""
  ...
  Folder     : multimodal_seed_variation_runner
  File       : multimodal_seed_variation_runner_signal_generator.py
  Purpose    : Re Run Experiments — Seed Variation Runner
"""
...
MULTIMODAL_MODULE = 'multimodal_seed_variation_runner_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSeedVariationRunnerSignalGeneratorConfig:
    """Multimodal threshold-sweep config for seed_variation_runner."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalSeedVariationRunnerEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: re run experiments — seed variation runner.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalSeedVariationRunnerSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalSeedVariationRunnerSignalGeneratorConfig()
