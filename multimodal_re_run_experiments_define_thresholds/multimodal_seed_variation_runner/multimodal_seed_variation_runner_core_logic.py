"""
  ...
  File       : multimodal_seed_variation_runner_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_seed_variation_runner_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSeedVariationRunnerCoreLogicConfig:
...
class MultimodalSeedVariationRunnerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSeedVariationRunnerCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalSeedVariationRunnerCoreLogicConfig()
