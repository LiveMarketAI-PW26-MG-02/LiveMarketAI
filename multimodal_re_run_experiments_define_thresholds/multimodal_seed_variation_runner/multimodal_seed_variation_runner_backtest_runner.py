"""
  ...
  File       : multimodal_seed_variation_runner_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_seed_variation_runner_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSeedVariationRunnerBacktestRunnerConfig:
...
class MultimodalSeedVariationRunnerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSeedVariationRunnerBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalSeedVariationRunnerBacktestRunnerConfig()
