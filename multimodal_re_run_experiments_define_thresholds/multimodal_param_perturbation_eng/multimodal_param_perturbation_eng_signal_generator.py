"""
  ...
  Folder     : multimodal_param_perturbation_eng
  File       : multimodal_param_perturbation_eng_signal_generator.py
  Purpose    : Re Run Experiments — Param Perturbation Eng
"""
...
MULTIMODAL_MODULE = 'multimodal_param_perturbation_eng_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalParamPerturbationEngSignalGeneratorConfig:
    """Multimodal threshold-sweep config for param_perturbation_eng."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalParamPerturbationEngEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: re run experiments — param perturbation eng.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalParamPerturbationEngSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalParamPerturbationEngSignalGeneratorConfig()
