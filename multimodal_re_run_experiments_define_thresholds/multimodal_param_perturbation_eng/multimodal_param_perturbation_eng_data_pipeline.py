"""
  ...
  File       : multimodal_param_perturbation_eng_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_param_perturbation_eng_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalParamPerturbationEngDataPipelineConfig:
...
class MultimodalParamPerturbationEngEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalParamPerturbationEngDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalParamPerturbationEngDataPipelineConfig()
