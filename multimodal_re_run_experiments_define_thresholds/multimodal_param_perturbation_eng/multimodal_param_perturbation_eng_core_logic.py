"""
  ...
  File       : multimodal_param_perturbation_eng_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_param_perturbation_eng_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalParamPerturbationEngCoreLogicConfig:
...
class MultimodalParamPerturbationEngEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalParamPerturbationEngCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalParamPerturbationEngCoreLogicConfig()
