"""
  ...
  File       : multimodal_param_perturbation_eng_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_param_perturbation_eng_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalParamPerturbationEngBacktestRunnerConfig:
...
class MultimodalParamPerturbationEngEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalParamPerturbationEngBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalParamPerturbationEngBacktestRunnerConfig()
