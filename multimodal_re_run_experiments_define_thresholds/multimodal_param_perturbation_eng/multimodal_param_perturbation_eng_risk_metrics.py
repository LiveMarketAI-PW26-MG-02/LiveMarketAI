"""
  ...
  File       : multimodal_param_perturbation_eng_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_param_perturbation_eng_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalParamPerturbationEngRiskMetricsConfig:
...
class MultimodalParamPerturbationEngEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalParamPerturbationEngRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalParamPerturbationEngRiskMetricsConfig()
