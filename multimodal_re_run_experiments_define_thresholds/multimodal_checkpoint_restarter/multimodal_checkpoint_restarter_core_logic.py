"""
  ...
  File       : multimodal_checkpoint_restarter_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_checkpoint_restarter_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCheckpointRestarterCoreLogicConfig:
...
class MultimodalCheckpointRestarterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCheckpointRestarterCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalCheckpointRestarterCoreLogicConfig()
