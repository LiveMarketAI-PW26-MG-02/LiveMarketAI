"""
  ...
  File       : multimodal_checkpoint_restarter_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_checkpoint_restarter_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCheckpointRestarterRiskMetricsConfig:
...
class MultimodalCheckpointRestarterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCheckpointRestarterRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalCheckpointRestarterRiskMetricsConfig()
