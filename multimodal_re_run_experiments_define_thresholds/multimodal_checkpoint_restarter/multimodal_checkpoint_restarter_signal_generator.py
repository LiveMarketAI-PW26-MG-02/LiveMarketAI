"""
  ...
  Folder     : multimodal_checkpoint_restarter
  File       : multimodal_checkpoint_restarter_signal_generator.py
  Purpose    : Re Run Experiments — Checkpoint Restarter
"""
...
MULTIMODAL_MODULE = 'multimodal_checkpoint_restarter_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCheckpointRestarterSignalGeneratorConfig:
    """Multimodal threshold-sweep config for checkpoint_restarter."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalCheckpointRestarterEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: re run experiments — checkpoint restarter.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalCheckpointRestarterSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalCheckpointRestarterSignalGeneratorConfig()
