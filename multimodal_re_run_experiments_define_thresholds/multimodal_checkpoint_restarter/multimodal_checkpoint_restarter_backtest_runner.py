"""
  ...
  File       : multimodal_checkpoint_restarter_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_checkpoint_restarter_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCheckpointRestarterBacktestRunnerConfig:
...
class MultimodalCheckpointRestarterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCheckpointRestarterBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalCheckpointRestarterBacktestRunnerConfig()
