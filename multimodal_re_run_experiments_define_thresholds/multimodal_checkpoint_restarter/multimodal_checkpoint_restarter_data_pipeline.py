"""
  ...
  File       : multimodal_checkpoint_restarter_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_checkpoint_restarter_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCheckpointRestarterDataPipelineConfig:
...
class MultimodalCheckpointRestarterEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCheckpointRestarterDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalCheckpointRestarterDataPipelineConfig()
