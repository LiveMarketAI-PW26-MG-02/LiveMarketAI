"""
  ...
  File       : multimodal_universe_reshuffle_test_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_universe_reshuffle_test_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalUniverseReshuffleTestBacktestRunnerConfig:
...
class MultimodalUniverseReshuffleTestEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalUniverseReshuffleTestBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalUniverseReshuffleTestBacktestRunnerConfig()
