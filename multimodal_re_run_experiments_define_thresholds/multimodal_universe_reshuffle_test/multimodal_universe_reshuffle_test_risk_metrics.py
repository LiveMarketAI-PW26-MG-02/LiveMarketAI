"""
  ...
  File       : multimodal_universe_reshuffle_test_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_universe_reshuffle_test_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalUniverseReshuffleTestRiskMetricsConfig:
...
class MultimodalUniverseReshuffleTestEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalUniverseReshuffleTestRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalUniverseReshuffleTestRiskMetricsConfig()
