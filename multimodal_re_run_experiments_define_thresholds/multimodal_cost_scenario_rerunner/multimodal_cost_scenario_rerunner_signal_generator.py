"""
  ...
  Folder     : multimodal_cost_scenario_rerunner
  File       : multimodal_cost_scenario_rerunner_signal_generator.py
  Purpose    : Re Run Experiments — Cost Scenario Rerunner
"""
...
MULTIMODAL_MODULE = 'multimodal_cost_scenario_rerunner_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCostScenarioRerunnerSignalGeneratorConfig:
    """Multimodal threshold-sweep config for cost_scenario_rerunner."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalCostScenarioRerunnerEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: re run experiments — cost scenario rerunner.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalCostScenarioRerunnerSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalCostScenarioRerunnerSignalGeneratorConfig()
