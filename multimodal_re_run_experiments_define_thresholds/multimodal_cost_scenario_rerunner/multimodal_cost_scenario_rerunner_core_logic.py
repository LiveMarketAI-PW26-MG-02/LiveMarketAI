"""
  ...
  File       : multimodal_cost_scenario_rerunner_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_cost_scenario_rerunner_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCostScenarioRerunnerCoreLogicConfig:
...
class MultimodalCostScenarioRerunnerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCostScenarioRerunnerCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalCostScenarioRerunnerCoreLogicConfig()
