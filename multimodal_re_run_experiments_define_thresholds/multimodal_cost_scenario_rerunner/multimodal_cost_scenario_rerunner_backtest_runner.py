"""
  ...
  File       : multimodal_cost_scenario_rerunner_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_cost_scenario_rerunner_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCostScenarioRerunnerBacktestRunnerConfig:
...
class MultimodalCostScenarioRerunnerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCostScenarioRerunnerBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalCostScenarioRerunnerBacktestRunnerConfig()
