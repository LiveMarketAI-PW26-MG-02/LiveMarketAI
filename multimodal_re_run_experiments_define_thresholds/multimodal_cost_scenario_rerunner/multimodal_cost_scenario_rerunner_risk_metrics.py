"""
  ...
  File       : multimodal_cost_scenario_rerunner_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_cost_scenario_rerunner_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCostScenarioRerunnerRiskMetricsConfig:
...
class MultimodalCostScenarioRerunnerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCostScenarioRerunnerRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalCostScenarioRerunnerRiskMetricsConfig()
