"""
  ...
  File       : multimodal_cost_scenario_rerunner_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_cost_scenario_rerunner_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCostScenarioRerunnerDataPipelineConfig:
...
class MultimodalCostScenarioRerunnerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCostScenarioRerunnerDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalCostScenarioRerunnerDataPipelineConfig()
