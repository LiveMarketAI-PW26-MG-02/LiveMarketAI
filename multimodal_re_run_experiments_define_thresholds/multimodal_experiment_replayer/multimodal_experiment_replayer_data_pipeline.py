"""
  ...
  File       : multimodal_experiment_replayer_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_experiment_replayer_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalExperimentReplayerDataPipelineConfig:
...
class MultimodalExperimentReplayerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalExperimentReplayerDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalExperimentReplayerDataPipelineConfig()
