"""
  ...
  File       : multimodal_experiment_replayer_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_experiment_replayer_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalExperimentReplayerBacktestRunnerConfig:
...
class MultimodalExperimentReplayerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalExperimentReplayerBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalExperimentReplayerBacktestRunnerConfig()
