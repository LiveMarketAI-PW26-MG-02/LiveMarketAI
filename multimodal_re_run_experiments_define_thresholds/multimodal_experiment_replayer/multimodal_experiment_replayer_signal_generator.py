"""
  ...
  Folder     : multimodal_experiment_replayer
  File       : multimodal_experiment_replayer_signal_generator.py
  Purpose    : Re Run Experiments — Experiment Replayer
"""
...
MULTIMODAL_MODULE = 'multimodal_experiment_replayer_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalExperimentReplayerSignalGeneratorConfig:
    """Multimodal threshold-sweep config for experiment_replayer."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalExperimentReplayerEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: re run experiments — experiment replayer.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalExperimentReplayerSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalExperimentReplayerSignalGeneratorConfig()
