"""
  ...
  File       : multimodal_experiment_replayer_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_experiment_replayer_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalExperimentReplayerRiskMetricsConfig:
...
class MultimodalExperimentReplayerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalExperimentReplayerRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalExperimentReplayerRiskMetricsConfig()
