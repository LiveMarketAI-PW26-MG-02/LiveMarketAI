"""
  ...
  File       : multimodal_experiment_replayer_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_experiment_replayer_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalExperimentReplayerCoreLogicConfig:
...
class MultimodalExperimentReplayerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalExperimentReplayerCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalExperimentReplayerCoreLogicConfig()
