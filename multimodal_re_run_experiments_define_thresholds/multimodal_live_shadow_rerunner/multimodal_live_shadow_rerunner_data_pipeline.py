"""
  ...
  File       : multimodal_live_shadow_rerunner_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_live_shadow_rerunner_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalLiveShadowRerunnerDataPipelineConfig:
...
class MultimodalLiveShadowRerunnerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalLiveShadowRerunnerDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalLiveShadowRerunnerDataPipelineConfig()
