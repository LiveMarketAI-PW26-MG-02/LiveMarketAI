"""
  ...
  File       : multimodal_live_shadow_rerunner_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_live_shadow_rerunner_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalLiveShadowRerunnerCoreLogicConfig:
...
class MultimodalLiveShadowRerunnerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalLiveShadowRerunnerCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalLiveShadowRerunnerCoreLogicConfig()
