"""
  ...
  Folder     : multimodal_live_shadow_rerunner
  File       : multimodal_live_shadow_rerunner_signal_generator.py
  Purpose    : Re Run Experiments — Live Shadow Rerunner
"""
...
MULTIMODAL_MODULE = 'multimodal_live_shadow_rerunner_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalLiveShadowRerunnerSignalGeneratorConfig:
    """Multimodal threshold-sweep config for live_shadow_rerunner."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalLiveShadowRerunnerEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: re run experiments — live shadow rerunner.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalLiveShadowRerunnerSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalLiveShadowRerunnerSignalGeneratorConfig()
