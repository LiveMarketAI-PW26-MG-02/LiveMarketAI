"""
  ...
  File       : multimodal_live_shadow_rerunner_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_live_shadow_rerunner_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalLiveShadowRerunnerRiskMetricsConfig:
...
class MultimodalLiveShadowRerunnerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalLiveShadowRerunnerRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalLiveShadowRerunnerRiskMetricsConfig()
