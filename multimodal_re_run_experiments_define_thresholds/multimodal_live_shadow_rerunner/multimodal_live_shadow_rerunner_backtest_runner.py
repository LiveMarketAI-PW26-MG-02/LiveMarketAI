"""
  ...
  File       : multimodal_live_shadow_rerunner_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_live_shadow_rerunner_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalLiveShadowRerunnerBacktestRunnerConfig:
...
class MultimodalLiveShadowRerunnerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalLiveShadowRerunnerBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalLiveShadowRerunnerBacktestRunnerConfig()
