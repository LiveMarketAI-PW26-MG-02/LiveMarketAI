"""
  ...
  File       : multimodal_data_resample_rerunner_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_data_resample_rerunner_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalDataResampleRerunnerRiskMetricsConfig:
...
class MultimodalDataResampleRerunnerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDataResampleRerunnerRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalDataResampleRerunnerRiskMetricsConfig()
