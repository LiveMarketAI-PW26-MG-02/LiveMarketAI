"""
  ...
  File       : multimodal_data_resample_rerunner_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_data_resample_rerunner_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalDataResampleRerunnerDataPipelineConfig:
...
class MultimodalDataResampleRerunnerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDataResampleRerunnerDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalDataResampleRerunnerDataPipelineConfig()
