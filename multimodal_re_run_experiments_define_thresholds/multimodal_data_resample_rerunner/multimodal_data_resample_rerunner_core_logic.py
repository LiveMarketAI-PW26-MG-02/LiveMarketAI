"""
  ...
  File       : multimodal_data_resample_rerunner_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_data_resample_rerunner_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalDataResampleRerunnerCoreLogicConfig:
...
class MultimodalDataResampleRerunnerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDataResampleRerunnerCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalDataResampleRerunnerCoreLogicConfig()
