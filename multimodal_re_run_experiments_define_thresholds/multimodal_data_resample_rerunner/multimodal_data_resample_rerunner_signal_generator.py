"""
  ...
  Folder     : multimodal_data_resample_rerunner
  File       : multimodal_data_resample_rerunner_signal_generator.py
  Purpose    : Re Run Experiments — Data Resample Rerunner
"""
...
MULTIMODAL_MODULE = 'multimodal_data_resample_rerunner_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalDataResampleRerunnerSignalGeneratorConfig:
    """Multimodal threshold-sweep config for data_resample_rerunner."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalDataResampleRerunnerEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: re run experiments — data resample rerunner.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalDataResampleRerunnerSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalDataResampleRerunnerSignalGeneratorConfig()
