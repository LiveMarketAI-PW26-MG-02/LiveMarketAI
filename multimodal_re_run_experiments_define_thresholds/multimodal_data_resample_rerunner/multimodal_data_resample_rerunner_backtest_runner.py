"""
  ...
  File       : multimodal_data_resample_rerunner_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_data_resample_rerunner_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalDataResampleRerunnerBacktestRunnerConfig:
...
class MultimodalDataResampleRerunnerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalDataResampleRerunnerBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalDataResampleRerunnerBacktestRunnerConfig()
