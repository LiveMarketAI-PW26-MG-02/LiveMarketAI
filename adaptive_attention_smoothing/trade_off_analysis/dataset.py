"""
Dataset for Analyse smoothness-responsiveness trade-off across regime transition speeds
Module: trade_off_analysis.dataset
"""
import torch
...
class SmoothingTradeOffAnalyzerDataset(nn.Module):
    """
    Dataset for Analyse smoothness-responsiveness trade-off across regime transition speeds
    """
