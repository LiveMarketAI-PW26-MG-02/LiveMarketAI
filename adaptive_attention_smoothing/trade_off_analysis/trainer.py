"""
Trainer for Analyse smoothness-responsiveness trade-off across regime transition speeds
Module: trade_off_analysis.trainer
"""
import torch
...
class SmoothingTradeOffAnalyzerTrainer(nn.Module):
    """
    Trainer for Analyse smoothness-responsiveness trade-off across regime transition speeds
    """
