"""
Dataset for Detect regime transitions to switch between smooth and sharp attention
Module: transition_detector.dataset
"""
import torch
...
class RegimeTransitionDetectorDataset(nn.Module):
    """
    Dataset for Detect regime transitions to switch between smooth and sharp attention
    """
