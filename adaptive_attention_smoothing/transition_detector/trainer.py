"""
Trainer for Detect regime transitions to switch between smooth and sharp attention
Module: transition_detector.trainer
"""
import torch
...
class RegimeTransitionDetectorTrainer(nn.Module):
    """
    Trainer for Detect regime transitions to switch between smooth and sharp attention
    """
