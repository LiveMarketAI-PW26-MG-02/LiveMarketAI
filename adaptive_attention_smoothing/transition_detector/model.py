"""
Detect regime transitions to switch between smooth and sharp attention
Module: transition_detector.model
"""
import torch
...
def detect_transition_probability(alpha_seq, threshold=0.15):
    drift = (alpha_seq[1:] - alpha_seq[:-1]).norm(dim=-1)
    transition_prob = torch.sigmoid((drift - threshold) * 10)
