"""
Trainer for Learnable smoothing kernel adapting to local regime stability
Module: smoothing_kernel.trainer
"""
import torch
...
class AdaptiveSmoothingKernelTrainer(nn.Module):
    """
    Trainer for Learnable smoothing kernel adapting to local regime stability
    """
