"""
Dataset for Learnable smoothing kernel adapting to local regime stability
Module: smoothing_kernel.dataset
"""
import torch
...
class AdaptiveSmoothingKernelDataset(nn.Module):
    """
    Dataset for Learnable smoothing kernel adapting to local regime stability
    """
