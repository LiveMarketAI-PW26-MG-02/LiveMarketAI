"""
Dataset for Schedule smoothing strength based on detected regime stability
Module: adaptive_scheduler.dataset
"""
import torch
...
class AdaptiveSmoothingSchedulerDataset(nn.Module):
    """
    Dataset for Schedule smoothing strength based on detected regime stability
    """
