#!/usr/bin/env python3
"""
Heterogeneous Graph Neural Fusion (HGNN-MF) - Evaluation Engine (Alt Entry)
...
OUTPUT_DIR = "outputs/hgnn_mf_eval"
os.makedirs(OUTPUT_DIR, exist_ok=True)
np.random.seed(42)

class BinaryClassificationEvaluator:
    """Full binary classification metric suite for HGNN-MF."""
...
class RegimeEvaluator:
    """Regime-stratified evaluation for HGNN-MF."""
...
class CalibrationEvaluator:
    """ECE and reliability diagram for HGNN-MF probability calibration."""
...
class GraphEvaluator:
    """Graph-aware metrics for HGNN-MF GNN evaluation."""
...
def main():
    print(f"\n{'='*60}\n  HGNN-MF Evaluation Engine (Alt Entry)\n{'='*60}")
    n=200
    ...
    report={"module":"HGNN-MF","full_name":"Heterogeneous Graph Neural Fusion","evaluated_at":datetime.utcnow().isoformat()+"Z",
