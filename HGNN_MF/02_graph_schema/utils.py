#!/usr/bin/env python3
"""
HGNN-MF - Shared Utility Functions
Common helpers used across all subfolders of the HGNN-MF module.
"""
...
def get_logger(name: str = "HGNN-MF", level: str = "INFO") -> logging.Logger:
    """Configure and return a logger for HGNN-MF module."""
