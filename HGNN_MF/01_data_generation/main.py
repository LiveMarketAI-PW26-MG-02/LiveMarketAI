#!/usr/bin/env python3
"""
Heterogeneous Graph Neural Fusion (HGNN-MF) - Data Generation Module
...
REGIME_TYPES      = ['news_driven', 'order_flow', 'social_pump', 'fundamental']
OUTPUT_DIR        = "outputs/hgnn_mf_data"
...
class SyntheticMarketDataGenerator:
    """
    Generates synthetic OHLCV + microstructure + sentiment data for HGNN-MF.
    ...
    def generate_price_series(self, asset_id: str, regime: str = "bull") -> pd.DataFrame:
        ...
        Regimes: ['news_driven', 'order_flow', 'social_pump', 'fundamental']
        """
        regime_params = {
...
class SentimentDataGenerator:
    ...
    price manipulation events for HGNN-MF.
    """
...
class OrderBookGenerator:
    ...
    Critical for HGNN-MF microstructure-based manipulation detection.
    """
...
class GraphDataBuilder:
    ...
    and GNN propagation in HGNN-MF.
    """
...
def main():
    print(f"\n============================================================")
    print(f"  HGNN-MF - Data Generation Pipeline")
    ...
    # Summary
    print(f"\n============================================================")
    print(f"  Data Generation Complete for HGNN-MF")
