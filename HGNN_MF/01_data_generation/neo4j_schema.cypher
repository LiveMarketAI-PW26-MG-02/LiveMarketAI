// ═══════════════════════════════════════════════════════════════════════════
// Heterogeneous Graph Neural Fusion (HGNN-MF) — Neo4j Graph Schema
// Module: hgnn_mf
// ═══════════════════════════════════════════════════════════════════════════
...
// ── NODE PROPERTIES (sample MERGE for HGNN-MF) ─────────────────────────────
...
ON CREATE SET
  ...
  al.description    = 'Pump-and-dump pattern detected by HGNN-MF',
