#!/usr/bin/env python3
"""
Heterogeneous Graph Neural Fusion (HGNN-MF) - Demo Runner — End-to-End Pipeline
...
OUTPUT_DIR = "outputs/hgnn_mf_inference"
...
class InferenceFeatureExtractor:
    ...
    for HGNN-MF inference. Handles normalization using training statistics.
    """
...
class AlertGenerator:
    ...
    def __init__(self, module_name: str = "HGNN-MF"):
    ...
    def save_alerts(self, alerts: List[dict], filename: str = "alerts.json") -> str:
        ...
        with open(path, "w") as f:
            json.dump({"module": "HGNN-MF", "alerts": alerts,
                        "total": len(alerts),
...
class InferencePipeline:
    """
    End-to-end HGNN-MF inference pipeline:
    ...
    def __init__(self, model, n_assets: int = 20, threshold: float = 0.5):
        ...
        self.alert_generator = AlertGenerator("HGNN-MF")
    ...
    def run_streaming(self, n_windows: int = 50,
        ...
        print(f"  Running HGNN-MF streaming inference: {n_windows} windows...")
        results = []
...
def main():
    print(f"\n{'='*60}")
    print(f"  HGNN-MF - Demo Runner — End-to-End Pipeline")
    print(f"  Heterogeneous Graph Neural Fusion")
    print(f"{'='*60}\n")
    ...
    print(f"\nHGNN-MF Demo Runner — End-to-End Pipeline Complete.\n")
...
7 + np.random.rand(n) * 0.3, 0, 1),
        ...
        explanation_text = f"""
MANIPULATION DETECTION EXPLANATION - HGNN-MF
============================================================
...
"""
        ...
        report  = {
            "module":          "HGNN-MF",
            "full_name":       "Heterogeneous Graph Neural Fusion",
