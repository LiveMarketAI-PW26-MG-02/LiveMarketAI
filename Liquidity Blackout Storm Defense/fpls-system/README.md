# Liquidity Blackout Storm Defense
**System ID:** SYS-002
**Abbreviation:** FPLS

## Overview
Federated Predictive Load Shield: Distributed ML nodes model liquidity surface topology across trading venues. Local nodes learn normal order book depth profiles and inter-venue correlation matrices. Federated aggregation creates a global liquidity baseline. Sudden multi-venue depth collapses are detected as deviations from the federated baseline, triggering protective routing.
...
java -jar target/fpls-java-node-1.0.0-SNAPSHOT.jar
