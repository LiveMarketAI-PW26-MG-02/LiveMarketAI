# GRL-Fusion — 04 Gnn Model

## Module: Graph Reinforcement Learning Fusion

### Overview
Core GNN architecture with module-specific innovations

This subfolder implements **GRL-Fusion** capabilities for:
> *Graph-structured action space for adaptive module weight selection*
...
financial market manipulation detection. This subfolder (04_gnn_model)
