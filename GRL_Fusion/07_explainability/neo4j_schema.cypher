// ═══════════════════════════════════════════════════════════════════════════
// Graph Reinforcement Learning Fusion (GRL-Fusion) — Neo4j Graph Schema
// Module: grl_fusion
// ═══════════════════════════════════════════════════════════════════════════
...
// ── NODE PROPERTIES (sample MERGE for GRL-Fusion) ─────────────────────────────
...
ON CREATE SET
  ...
  sig.strength     = 0.82,
  sig.confidence   = 0.79,
  sig.source       = 'GRL-Fusion',
  sig.isValidated  = true,
  sig.module       = 'GRL-Fusion',
