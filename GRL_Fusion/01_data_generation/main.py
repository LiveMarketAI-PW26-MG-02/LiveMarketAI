#!/usr/bin/env python3
"""
Graph Reinforcement Learning Fusion (GRL-Fusion) - Data Generation Module
...
REGIME_TYPES      = ['exploration', 'exploitation', 'fusion_stable', 'fusion_update', 'policy_shift']
OUTPUT_DIR        = "outputs/grl_fusion_data"
...
class SyntheticMarketDataGenerator:
    """
    Generates synthetic OHLCV + microstructure + sentiment data for GRL-Fusion.
    ...
    def generate_price_series(self, asset_id: str, regime: str = "bull") -> pd.DataFrame:
        ...
        Regimes: ['exploration', 'exploitation', 'fusion_stable', 'fusion_update', 'policy_shift']
        """
        regime_params = {
...
class SentimentDataGenerator:
    ...
    price manipulation events for GRL-Fusion.
    """
...
class OrderBookGenerator:
    ...
    Critical for GRL-Fusion microstructure-based manipulation detection.
    """
...
class GraphDataBuilder:
    ...
    and GNN propagation in GRL-Fusion.
    """
...
def main():
    print(f"\n============================================================")
    print(f"  GRL-Fusion - Data Generation Pipeline")
    ...
    # Summary
    print(f"\n============================================================")
    print(f"  Data Generation Complete for GRL-Fusion")
