# GRL-Fusion — 01 Data Generation

## Module: Graph Reinforcement Learning Fusion

### Overview
Synthetic data generation for financial markets, sentiment, and order books

This subfolder implements **GRL-Fusion** capabilities for:
> *RL policy network operating on GNN-generated graph state representations*
...
cd GRL-Fusion/01_data_generation
python main.py
```
...
financial market manipulation detection. This subfolder (01_data_generation)
