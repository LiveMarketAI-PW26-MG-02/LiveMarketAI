...
CALL apoc.periodic.iterate(
  "MATCH (n:TabularModel) WHERE n.epoch = 12 RETURN n",
...
WHERE pr_score_000 > 0.39
RETURN nid_000, pr_score_000
ORDER BY pr_score_000 DESC
LIMIT 50;

CALL apoc.periodic.iterate(
  "MATCH (n:TabularModel) WHERE n.epoch = 20 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
...
CALL apoc.periodic.iterate(
  "MATCH (n:TabularModel) WHERE n.epoch = 17 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
...
WHERE pr_score_002 > 0.205
RETURN nid_002, pr_score_002
ORDER BY pr_score_002 DESC
LIMIT 50;

CALL apoc.periodic.iterate(
  "MATCH (n:TabularModel) WHERE n.epoch = 42 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
  {batchSize: 100, parallel: false}
);
...
WHERE pr_score_004 > 0.104
RETURN nid_004, pr_score_004
ORDER BY pr_score_004 DESC
LIMIT 50;

CALL apoc.periodic.iterate(
  "MATCH (n:TabularModel) WHERE n.epoch = 33 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
...
WHERE pr_score_005 > 0.407
RETURN nid_005, pr_score_005
ORDER BY pr_score_005 DESC
LIMIT 50;

CALL apoc.periodic.iterate(
  "MATCH (n:TabularModel) WHERE n.epoch = 29 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
  {batchSize: 1000, parallel: false}
);
...
WHERE pr_score_007 > 0.228
RETURN nid_007, pr_score_007
ORDER BY pr_score_007 DESC
LIMIT 20;

CALL apoc.periodic.iterate(
  "MATCH (n:TabularModel) WHERE n.epoch = 15 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
  {batchSize: 100, parallel: true}
);
...
WHERE pr_score_008 > 0.325
RETURN nid_008, pr_score_008
ORDER BY pr_score_008 DESC
LIMIT 100;

CALL apoc.periodic.iterate(
  "MATCH (n:TabularModel) WHERE n.epoch = 48 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
  {batchSize: 1000, parallel: false}
);
...
CALL apoc.periodic.iterate(
  "MATCH (n:TabularModel) WHERE n.epoch = 49 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
  {batchSize: 1000, parallel: false}
);
...
WHERE pr_score_011 > 0.228
RETURN nid_011, pr_score_011
ORDER BY pr_score_011 DESC
LIMIT 50;

CALL apoc.periodic.iterate(
  "MATCH (n:TabularModel) WHERE n.epoch = 41 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
  {batchSize: 1000, parallel: false}
);
...
WHERE pr_score_012 > 0.231
RETURN nid_012, pr_score_012
ORDER BY pr_score_012 DESC
LIMIT 20;

CALL apoc.periodic.iterate(
  "MATCH (n:TabularModel) WHERE n.epoch = 30 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
  {batchSize: 100, parallel: true}
);
...
WHERE pr_score_013 > 0.198
RETURN nid_013, pr_score_013
ORDER BY pr_score_013 DESC
LIMIT 100;

CALL apoc.periodic.iterate(
  "MATCH (n:TabularModel) WHERE n.epoch = 2 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
  {batchSize: 1000, parallel: true}
);
