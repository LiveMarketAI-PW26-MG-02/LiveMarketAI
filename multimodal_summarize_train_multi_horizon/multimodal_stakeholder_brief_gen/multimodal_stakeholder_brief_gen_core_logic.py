"""
  ...
  File       : multimodal_stakeholder_brief_gen_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_stakeholder_brief_gen_core_logic'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalStakeholderBriefGenCoreLogicConfig:
...
class MultimodalStakeholderBriefGenEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalStakeholderBriefGenCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalStakeholderBriefGenCoreLogicConfig()
