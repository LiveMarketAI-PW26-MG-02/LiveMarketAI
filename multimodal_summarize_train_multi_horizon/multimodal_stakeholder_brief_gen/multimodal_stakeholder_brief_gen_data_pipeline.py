"""
  ...
  File       : multimodal_stakeholder_brief_gen_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_stakeholder_brief_gen_data_pipeline'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalStakeholderBriefGenDataPipelineConfig:
...
class MultimodalStakeholderBriefGenEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalStakeholderBriefGenDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalStakeholderBriefGenDataPipelineConfig()
