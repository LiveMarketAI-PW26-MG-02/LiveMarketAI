"""
  ...
  File       : multimodal_stakeholder_brief_gen_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_stakeholder_brief_gen_backtest_runner'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalStakeholderBriefGenBacktestRunnerConfig:
...
class MultimodalStakeholderBriefGenEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalStakeholderBriefGenBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalStakeholderBriefGenBacktestRunnerConfig()
