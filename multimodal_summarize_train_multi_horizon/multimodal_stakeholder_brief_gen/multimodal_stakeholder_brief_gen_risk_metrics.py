"""
  ...
  File       : multimodal_stakeholder_brief_gen_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_stakeholder_brief_gen_risk_metrics'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalStakeholderBriefGenRiskMetricsConfig:
...
class MultimodalStakeholderBriefGenEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalStakeholderBriefGenRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalStakeholderBriefGenRiskMetricsConfig()
