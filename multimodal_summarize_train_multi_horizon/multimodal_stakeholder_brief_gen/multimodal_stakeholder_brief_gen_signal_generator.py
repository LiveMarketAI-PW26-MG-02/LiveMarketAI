"""
  ...
  ZIP Topic  : Summarize
  Folder     : multimodal_stakeholder_brief_gen
  File       : multimodal_stakeholder_brief_gen_signal_generator.py
  Purpose    : Summarize — Stakeholder Brief Gen
"""
...
MULTIMODAL_MODULE = 'multimodal_stakeholder_brief_gen_signal_generator'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalStakeholderBriefGenSignalGeneratorConfig:
    """Multimodal multi-horizon config for stakeholder_brief_gen."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalStakeholderBriefGenEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: summarize — stakeholder brief gen.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalStakeholderBriefGenSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalStakeholderBriefGenSignalGeneratorConfig()
