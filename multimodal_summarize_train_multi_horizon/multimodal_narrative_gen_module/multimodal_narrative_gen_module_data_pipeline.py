"""
  ...
  File       : multimodal_narrative_gen_module_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_narrative_gen_module_data_pipeline'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalNarrativeGenModuleDataPipelineConfig:
...
class MultimodalNarrativeGenModuleEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalNarrativeGenModuleDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalNarrativeGenModuleDataPipelineConfig()
