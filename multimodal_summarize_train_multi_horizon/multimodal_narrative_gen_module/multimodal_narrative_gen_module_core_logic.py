"""
  ...
  File       : multimodal_narrative_gen_module_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_narrative_gen_module_core_logic'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalNarrativeGenModuleCoreLogicConfig:
...
class MultimodalNarrativeGenModuleEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalNarrativeGenModuleCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalNarrativeGenModuleCoreLogicConfig()
