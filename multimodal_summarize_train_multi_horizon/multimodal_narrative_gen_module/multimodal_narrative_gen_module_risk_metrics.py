"""
  ...
  File       : multimodal_narrative_gen_module_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_narrative_gen_module_risk_metrics'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalNarrativeGenModuleRiskMetricsConfig:
...
class MultimodalNarrativeGenModuleEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalNarrativeGenModuleRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalNarrativeGenModuleRiskMetricsConfig()
