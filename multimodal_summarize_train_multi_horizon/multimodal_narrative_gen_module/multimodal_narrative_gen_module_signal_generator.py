"""
  ...
  ZIP Topic  : Summarize
  Folder     : multimodal_narrative_gen_module
  File       : multimodal_narrative_gen_module_signal_generator.py
  Purpose    : Summarize — Narrative Gen Module
"""
...
MULTIMODAL_MODULE = 'multimodal_narrative_gen_module_signal_generator'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalNarrativeGenModuleSignalGeneratorConfig:
    """Multimodal multi-horizon config for narrative_gen_module."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalNarrativeGenModuleEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: summarize — narrative gen module.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalNarrativeGenModuleSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalNarrativeGenModuleSignalGeneratorConfig()
