"""
  ...
  File       : multimodal_narrative_gen_module_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_narrative_gen_module_backtest_runner'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalNarrativeGenModuleBacktestRunnerConfig:
...
class MultimodalNarrativeGenModuleEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalNarrativeGenModuleBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalNarrativeGenModuleBacktestRunnerConfig()
