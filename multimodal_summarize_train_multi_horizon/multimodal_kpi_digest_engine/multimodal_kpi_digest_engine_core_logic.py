"""
  ...
  File       : multimodal_kpi_digest_engine_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_kpi_digest_engine_core_logic'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalKpiDigestEngineCoreLogicConfig:
...
class MultimodalKpiDigestEngineEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalKpiDigestEngineCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalKpiDigestEngineCoreLogicConfig()
