"""
  ...
  File       : multimodal_kpi_digest_engine_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_kpi_digest_engine_backtest_runner'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalKpiDigestEngineBacktestRunnerConfig:
...
class MultimodalKpiDigestEngineEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalKpiDigestEngineBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalKpiDigestEngineBacktestRunnerConfig()
