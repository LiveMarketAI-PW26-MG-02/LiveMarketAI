"""
  ...
  File       : multimodal_kpi_digest_engine_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_kpi_digest_engine_risk_metrics'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalKpiDigestEngineRiskMetricsConfig:
...
class MultimodalKpiDigestEngineEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalKpiDigestEngineRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalKpiDigestEngineRiskMetricsConfig()
