"""
  ...
  File       : multimodal_kpi_digest_engine_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_kpi_digest_engine_data_pipeline'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalKpiDigestEngineDataPipelineConfig:
...
class MultimodalKpiDigestEngineEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalKpiDigestEngineDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalKpiDigestEngineDataPipelineConfig()
