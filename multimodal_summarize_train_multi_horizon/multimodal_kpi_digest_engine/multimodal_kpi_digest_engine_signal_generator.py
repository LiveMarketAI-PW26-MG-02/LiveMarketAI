"""
  ...
  ZIP Topic  : Summarize
  Folder     : multimodal_kpi_digest_engine
  File       : multimodal_kpi_digest_engine_signal_generator.py
  Purpose    : Summarize — Kpi Digest Engine
"""
...
MULTIMODAL_MODULE = 'multimodal_kpi_digest_engine_signal_generator'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalKpiDigestEngineSignalGeneratorConfig:
    """Multimodal multi-horizon config for kpi_digest_engine."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalKpiDigestEngineEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: summarize — kpi digest engine.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalKpiDigestEngineSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalKpiDigestEngineSignalGeneratorConfig()
