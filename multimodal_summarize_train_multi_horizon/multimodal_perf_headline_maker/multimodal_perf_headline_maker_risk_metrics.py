"""
  ...
  File       : multimodal_perf_headline_maker_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_perf_headline_maker_risk_metrics'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPerfHeadlineMakerRiskMetricsConfig:
...
class MultimodalPerfHeadlineMakerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPerfHeadlineMakerRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalPerfHeadlineMakerRiskMetricsConfig()
