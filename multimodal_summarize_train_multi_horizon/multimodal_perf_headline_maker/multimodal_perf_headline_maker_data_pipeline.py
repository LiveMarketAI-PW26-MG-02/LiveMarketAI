"""
  ...
  File       : multimodal_perf_headline_maker_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_perf_headline_maker_data_pipeline'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPerfHeadlineMakerDataPipelineConfig:
...
class MultimodalPerfHeadlineMakerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPerfHeadlineMakerDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalPerfHeadlineMakerDataPipelineConfig()
