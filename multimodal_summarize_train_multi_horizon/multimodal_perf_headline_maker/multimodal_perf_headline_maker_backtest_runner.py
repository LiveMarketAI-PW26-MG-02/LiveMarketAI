"""
  ...
  File       : multimodal_perf_headline_maker_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_perf_headline_maker_backtest_runner'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPerfHeadlineMakerBacktestRunnerConfig:
...
class MultimodalPerfHeadlineMakerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPerfHeadlineMakerBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalPerfHeadlineMakerBacktestRunnerConfig()
