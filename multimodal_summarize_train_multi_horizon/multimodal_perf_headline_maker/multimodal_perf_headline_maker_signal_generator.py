"""
  ...
  ZIP Topic  : Summarize
  Folder     : multimodal_perf_headline_maker
  File       : multimodal_perf_headline_maker_signal_generator.py
  Purpose    : Summarize — Perf Headline Maker
"""
...
MULTIMODAL_MODULE = 'multimodal_perf_headline_maker_signal_generator'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPerfHeadlineMakerSignalGeneratorConfig:
    """Multimodal multi-horizon config for perf_headline_maker."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalPerfHeadlineMakerEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: summarize — perf headline maker.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalPerfHeadlineMakerSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalPerfHeadlineMakerSignalGeneratorConfig()
