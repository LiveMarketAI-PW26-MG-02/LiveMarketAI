"""
  ...
  File       : multimodal_perf_headline_maker_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_perf_headline_maker_core_logic'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalPerfHeadlineMakerCoreLogicConfig:
...
class MultimodalPerfHeadlineMakerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPerfHeadlineMakerCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalPerfHeadlineMakerCoreLogicConfig()
