"""
  ...
  File       : multimodal_risk_summary_writer_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_risk_summary_writer_core_logic'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRiskSummaryWriterCoreLogicConfig:
...
class MultimodalRiskSummaryWriterEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRiskSummaryWriterCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalRiskSummaryWriterCoreLogicConfig()
