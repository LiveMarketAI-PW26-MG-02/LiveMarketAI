"""
  ...
  File       : multimodal_risk_summary_writer_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_risk_summary_writer_backtest_runner'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRiskSummaryWriterBacktestRunnerConfig:
...
class MultimodalRiskSummaryWriterEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRiskSummaryWriterBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalRiskSummaryWriterBacktestRunnerConfig()
