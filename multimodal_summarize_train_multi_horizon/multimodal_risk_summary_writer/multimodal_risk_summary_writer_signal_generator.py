"""
  ...
  ZIP Topic  : Summarize
  Folder     : multimodal_risk_summary_writer
  File       : multimodal_risk_summary_writer_signal_generator.py
  Purpose    : Summarize — Risk Summary Writer
"""
...
MULTIMODAL_MODULE = 'multimodal_risk_summary_writer_signal_generator'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRiskSummaryWriterSignalGeneratorConfig:
    """Multimodal multi-horizon config for risk_summary_writer."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalRiskSummaryWriterEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: summarize — risk summary writer.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalRiskSummaryWriterSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalRiskSummaryWriterSignalGeneratorConfig()
