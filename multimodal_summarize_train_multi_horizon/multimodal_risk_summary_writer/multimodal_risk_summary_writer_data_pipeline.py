"""
  ...
  File       : multimodal_risk_summary_writer_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_risk_summary_writer_data_pipeline'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRiskSummaryWriterDataPipelineConfig:
...
class MultimodalRiskSummaryWriterEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRiskSummaryWriterDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalRiskSummaryWriterDataPipelineConfig()
