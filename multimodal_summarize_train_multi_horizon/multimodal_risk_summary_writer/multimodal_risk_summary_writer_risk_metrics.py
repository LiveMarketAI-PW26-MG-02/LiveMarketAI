"""
  ...
  File       : multimodal_risk_summary_writer_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_risk_summary_writer_risk_metrics'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalRiskSummaryWriterRiskMetricsConfig:
...
class MultimodalRiskSummaryWriterEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRiskSummaryWriterRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalRiskSummaryWriterRiskMetricsConfig()
