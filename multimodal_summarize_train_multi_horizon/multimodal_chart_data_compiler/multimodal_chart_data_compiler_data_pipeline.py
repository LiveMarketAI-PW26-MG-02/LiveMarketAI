"""
  ...
  File       : multimodal_chart_data_compiler_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_chart_data_compiler_data_pipeline'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalChartDataCompilerDataPipelineConfig:
...
class MultimodalChartDataCompilerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalChartDataCompilerDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalChartDataCompilerDataPipelineConfig()
