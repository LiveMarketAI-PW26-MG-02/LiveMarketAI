"""
  ...
  File       : multimodal_chart_data_compiler_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_chart_data_compiler_backtest_runner'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalChartDataCompilerBacktestRunnerConfig:
...
class MultimodalChartDataCompilerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalChartDataCompilerBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalChartDataCompilerBacktestRunnerConfig()
