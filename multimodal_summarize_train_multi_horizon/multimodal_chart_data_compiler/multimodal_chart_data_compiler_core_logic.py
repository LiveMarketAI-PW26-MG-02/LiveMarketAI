"""
  ...
  File       : multimodal_chart_data_compiler_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_chart_data_compiler_core_logic'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalChartDataCompilerCoreLogicConfig:
...
class MultimodalChartDataCompilerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalChartDataCompilerCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalChartDataCompilerCoreLogicConfig()
