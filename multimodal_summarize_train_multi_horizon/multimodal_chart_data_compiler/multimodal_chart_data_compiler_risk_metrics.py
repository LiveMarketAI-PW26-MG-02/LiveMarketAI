"""
  ...
  File       : multimodal_chart_data_compiler_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_chart_data_compiler_risk_metrics'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalChartDataCompilerRiskMetricsConfig:
...
class MultimodalChartDataCompilerEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalChartDataCompilerRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalChartDataCompilerRiskMetricsConfig()
