"""
  ...
  File       : multimodal_insight_extractor_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_insight_extractor_backtest_runner'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalInsightExtractorBacktestRunnerConfig:
...
class MultimodalInsightExtractorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalInsightExtractorBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalInsightExtractorBacktestRunnerConfig()
