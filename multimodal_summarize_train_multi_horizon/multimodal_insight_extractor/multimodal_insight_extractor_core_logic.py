"""
  ...
  File       : multimodal_insight_extractor_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_insight_extractor_core_logic'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalInsightExtractorCoreLogicConfig:
...
class MultimodalInsightExtractorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalInsightExtractorCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalInsightExtractorCoreLogicConfig()
