"""
  ...
  File       : multimodal_insight_extractor_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_insight_extractor_data_pipeline'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalInsightExtractorDataPipelineConfig:
...
class MultimodalInsightExtractorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalInsightExtractorDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalInsightExtractorDataPipelineConfig()
