"""
  ...
  ZIP Topic  : Summarize
  Folder     : multimodal_insight_extractor
  File       : multimodal_insight_extractor_signal_generator.py
  Purpose    : Summarize — Insight Extractor
"""
...
MULTIMODAL_MODULE = 'multimodal_insight_extractor_signal_generator'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalInsightExtractorSignalGeneratorConfig:
    """Multimodal multi-horizon config for insight_extractor."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalInsightExtractorEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: summarize — insight extractor.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalInsightExtractorSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalInsightExtractorSignalGeneratorConfig()
