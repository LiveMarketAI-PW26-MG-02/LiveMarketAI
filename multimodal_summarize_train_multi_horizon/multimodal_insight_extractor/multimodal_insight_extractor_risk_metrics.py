"""
  ...
  File       : multimodal_insight_extractor_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_insight_extractor_risk_metrics'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalInsightExtractorRiskMetricsConfig:
...
class MultimodalInsightExtractorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalInsightExtractorRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalInsightExtractorRiskMetricsConfig()
