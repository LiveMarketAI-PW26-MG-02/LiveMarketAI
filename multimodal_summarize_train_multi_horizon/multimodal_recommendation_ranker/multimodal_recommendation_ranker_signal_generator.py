"""
  ...
  Purpose    : Summarize — Recommendation Ranker
"""
...
class MultimodalRecommendationRankerSignalGeneratorConfig:
    """Multimodal multi-horizon config for recommendation_ranker."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalRecommendationRankerEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: summarize — recommendation ranker.
