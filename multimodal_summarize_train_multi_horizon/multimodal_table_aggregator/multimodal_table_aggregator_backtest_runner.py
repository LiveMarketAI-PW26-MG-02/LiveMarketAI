"""
  ...
  File       : multimodal_table_aggregator_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_table_aggregator_backtest_runner'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalTableAggregatorBacktestRunnerConfig:
...
class MultimodalTableAggregatorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalTableAggregatorBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalTableAggregatorBacktestRunnerConfig()
