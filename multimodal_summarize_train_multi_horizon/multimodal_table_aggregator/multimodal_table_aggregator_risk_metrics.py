"""
  ...
  File       : multimodal_table_aggregator_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_table_aggregator_risk_metrics'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalTableAggregatorRiskMetricsConfig:
...
class MultimodalTableAggregatorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalTableAggregatorRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalTableAggregatorRiskMetricsConfig()
