"""
  ...
  File       : multimodal_table_aggregator_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_table_aggregator_data_pipeline'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalTableAggregatorDataPipelineConfig:
...
class MultimodalTableAggregatorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalTableAggregatorDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalTableAggregatorDataPipelineConfig()
