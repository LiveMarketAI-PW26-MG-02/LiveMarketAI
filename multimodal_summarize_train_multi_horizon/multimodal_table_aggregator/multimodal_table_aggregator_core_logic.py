"""
  ...
  File       : multimodal_table_aggregator_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_table_aggregator_core_logic'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalTableAggregatorCoreLogicConfig:
...
class MultimodalTableAggregatorEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalTableAggregatorCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalTableAggregatorCoreLogicConfig()
