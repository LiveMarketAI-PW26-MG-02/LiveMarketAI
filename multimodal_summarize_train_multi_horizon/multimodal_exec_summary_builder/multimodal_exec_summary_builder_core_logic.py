"""
  ...
  File       : multimodal_exec_summary_builder_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_exec_summary_builder_core_logic'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalExecSummaryBuilderCoreLogicConfig:
...
class MultimodalExecSummaryBuilderEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalExecSummaryBuilderCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalExecSummaryBuilderCoreLogicConfig()
