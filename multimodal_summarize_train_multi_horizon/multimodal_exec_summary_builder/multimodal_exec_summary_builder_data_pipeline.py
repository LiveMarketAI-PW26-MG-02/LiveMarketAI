"""
  ...
  File       : multimodal_exec_summary_builder_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_exec_summary_builder_data_pipeline'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalExecSummaryBuilderDataPipelineConfig:
...
class MultimodalExecSummaryBuilderEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalExecSummaryBuilderDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalExecSummaryBuilderDataPipelineConfig()
