"""
  ...
  File       : multimodal_exec_summary_builder_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_exec_summary_builder_risk_metrics'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalExecSummaryBuilderRiskMetricsConfig:
...
class MultimodalExecSummaryBuilderEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalExecSummaryBuilderRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalExecSummaryBuilderRiskMetricsConfig()
