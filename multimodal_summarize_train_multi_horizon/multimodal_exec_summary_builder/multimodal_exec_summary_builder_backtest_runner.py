"""
  ...
  File       : multimodal_exec_summary_builder_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_exec_summary_builder_backtest_runner'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalExecSummaryBuilderBacktestRunnerConfig:
...
class MultimodalExecSummaryBuilderEngine(MultimodalBaseHorizon):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalExecSummaryBuilderBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalExecSummaryBuilderBacktestRunnerConfig()
