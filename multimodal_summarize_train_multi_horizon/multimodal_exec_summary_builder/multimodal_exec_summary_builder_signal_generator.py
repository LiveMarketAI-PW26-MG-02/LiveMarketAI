"""
  ...
  ZIP Topic  : Summarize
  Folder     : multimodal_exec_summary_builder
  File       : multimodal_exec_summary_builder_signal_generator.py
  Purpose    : Summarize — Exec Summary Builder
"""
...
MULTIMODAL_MODULE = 'multimodal_exec_summary_builder_signal_generator'
TOPIC             = 'summarize'
VERSION           = '1.0.0'
...
# ── Config ────────────────────────────────────────────────────────────────────
@dataclass
class MultimodalExecSummaryBuilderSignalGeneratorConfig:
    """Multimodal multi-horizon config for exec_summary_builder."""
...
# ── Core engine ───────────────────────────────────────────────────────────────
class MultimodalExecSummaryBuilderEngine(MultimodalBaseHorizon):
    """
    Multimodal engine: summarize — exec summary builder.
    Trains, evaluates, tunes and documents multi-horizon stock signals.
    """
    def __init__(self, cfg: Optional[MultimodalExecSummaryBuilderSignalGeneratorConfig] = None):
        self.cfg     = cfg or MultimodalExecSummaryBuilderSignalGeneratorConfig()
