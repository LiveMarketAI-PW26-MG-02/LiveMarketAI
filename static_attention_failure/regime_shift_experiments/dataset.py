"""
Dataset for Empirical experiments measuring static attention degradation across regimes
Module: regime_shift_experiments.dataset
"""
import torch
...
class RegimeShiftExperimentDataset(nn.Module):
    """
    Dataset for Empirical experiments measuring static attention degradation across regimes
    """
