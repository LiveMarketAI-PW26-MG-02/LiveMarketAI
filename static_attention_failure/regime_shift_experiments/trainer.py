"""
Trainer for Empirical experiments measuring static attention degradation across regimes
Module: regime_shift_experiments.trainer
"""
import torch
...
class RegimeShiftExperimentTrainer(nn.Module):
    """
    Trainer for Empirical experiments measuring static attention degradation across regimes
    """
