"""
Trainer for KL divergence, MMD, and Wasserstein distance for regime shift quantification
Module: distribution_shift_metrics.trainer
"""
import torch
...
class DistributionShiftMetricsTrainer(nn.Module):
    """
    Trainer for KL divergence, MMD, and Wasserstein distance for regime shift quantification
    """
