"""
KL divergence, MMD, and Wasserstein distance for regime shift quantification
Module: distribution_shift_metrics.model
"""
import torch
...
class DistributionShiftMetrics(nn.Module):
    """
    KL divergence, MMD, and Wasserstein distance for regime shift quantification
    """
