"""
Dataset for KL divergence, MMD, and Wasserstein distance for regime shift quantification
Module: distribution_shift_metrics.dataset
"""
import torch
...
class DistributionShiftMetricsDataset(nn.Module):
    """
    Dataset for KL divergence, MMD, and Wasserstein distance for regime shift quantification
    """
