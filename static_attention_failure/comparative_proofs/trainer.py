"""
Trainer for Theoretical + empirical comparison: dynamic vs static attention performance
Module: comparative_proofs.trainer
"""
import torch
...
class DynamicVsStaticProofSuiteTrainer(nn.Module):
    """
    Trainer for Theoretical + empirical comparison: dynamic vs static attention performance
    """
