"""
Dataset for Theoretical + empirical comparison: dynamic vs static attention performance
Module: comparative_proofs.dataset
"""
import torch
...
class DynamicVsStaticProofSuiteDataset(nn.Module):
    """
    Dataset for Theoretical + empirical comparison: dynamic vs static attention performance
    """
