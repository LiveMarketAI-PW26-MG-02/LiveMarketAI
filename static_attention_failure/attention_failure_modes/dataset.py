"""
Dataset for Identify and categorize failure modes of static attention under regime shift
Module: attention_failure_modes.dataset
"""
import torch
...
class AttentionFailureModeAnalyzerDataset(nn.Module):
    """
    Dataset for Identify and categorize failure modes of static attention under regime shift
    """
