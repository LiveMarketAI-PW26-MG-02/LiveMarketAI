"""
Dataset for Mathematical proof: static attention fails under distribution shift
Module: theoretical_analysis.dataset
"""
import torch
...
class TheoreticalRegimeShiftAnalysisDataset(nn.Module):
    """
    Dataset for Mathematical proof: static attention fails under distribution shift
    """
