"""
Trainer for Mathematical proof: static attention fails under distribution shift
Module: theoretical_analysis.trainer
"""
import torch
...
class TheoreticalRegimeShiftAnalysisTrainer(nn.Module):
    """
    Trainer for Mathematical proof: static attention fails under distribution shift
    """
