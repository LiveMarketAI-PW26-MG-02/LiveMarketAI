"""
  ...
  File       : multimodal_property_vol_test_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_property_vol_test_data_pipeline'
TOPIC             = 'independent_testing'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalPropertyVolTestDataPipelineConfig:
...
class MultimodalPropertyVolTestEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalPropertyVolTestDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalPropertyVolTestDataPipelineConfig()
