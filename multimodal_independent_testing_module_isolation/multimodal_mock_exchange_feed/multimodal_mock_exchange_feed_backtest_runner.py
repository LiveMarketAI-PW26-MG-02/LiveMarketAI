"""
  ...
  File       : multimodal_mock_exchange_feed_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_mock_exchange_feed_backtest_runner'
TOPIC             = 'independent_testing'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalMockExchangeFeedBacktestRunnerConfig:
...
class MultimodalMockExchangeFeedEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalMockExchangeFeedBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalMockExchangeFeedBacktestRunnerConfig()
