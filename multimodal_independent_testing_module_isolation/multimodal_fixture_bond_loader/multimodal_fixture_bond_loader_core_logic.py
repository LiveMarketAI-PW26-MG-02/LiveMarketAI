"""
  ...
  File       : multimodal_fixture_bond_loader_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_fixture_bond_loader_core_logic'
TOPIC             = 'independent_testing'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalFixtureBondLoaderCoreLogicConfig:
...
class MultimodalFixtureBondLoaderEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalFixtureBondLoaderCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalFixtureBondLoaderCoreLogicConfig()
