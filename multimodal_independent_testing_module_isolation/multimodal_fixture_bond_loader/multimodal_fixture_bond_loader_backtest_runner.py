"""
  ...
  File       : multimodal_fixture_bond_loader_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_fixture_bond_loader_backtest_runner'
TOPIC             = 'independent_testing'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalFixtureBondLoaderBacktestRunnerConfig:
...
class MultimodalFixtureBondLoaderEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalFixtureBondLoaderBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalFixtureBondLoaderBacktestRunnerConfig()
