"""
  ...
  File       : multimodal_fixture_bond_loader_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_fixture_bond_loader_data_pipeline'
TOPIC             = 'independent_testing'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalFixtureBondLoaderDataPipelineConfig:
...
class MultimodalFixtureBondLoaderEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalFixtureBondLoaderDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalFixtureBondLoaderDataPipelineConfig()
