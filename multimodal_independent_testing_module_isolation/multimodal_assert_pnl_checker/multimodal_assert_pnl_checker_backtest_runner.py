"""
  ...
  File       : multimodal_assert_pnl_checker_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_assert_pnl_checker_backtest_runner'
TOPIC             = 'independent_testing'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalAssertPnlCheckerBacktestRunnerConfig:
...
class MultimodalAssertPnlCheckerEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalAssertPnlCheckerBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalAssertPnlCheckerBacktestRunnerConfig()
