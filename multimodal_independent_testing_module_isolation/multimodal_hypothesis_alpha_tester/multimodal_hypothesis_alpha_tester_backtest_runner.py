"""
  ...
  File       : multimodal_hypothesis_alpha_tester_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_hypothesis_alpha_tester_backtest_runner'
TOPIC             = 'independent_testing'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalHypothesisAlphaTesterBacktestRunnerConfig:
...
class MultimodalHypothesisAlphaTesterEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalHypothesisAlphaTesterBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalHypothesisAlphaTesterBacktestRunnerConfig()
