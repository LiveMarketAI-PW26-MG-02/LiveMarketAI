"""
  ...
  File       : multimodal_spy_order_router_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_spy_order_router_backtest_runner'
TOPIC             = 'independent_testing'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSpyOrderRouterBacktestRunnerConfig:
...
class MultimodalSpyOrderRouterEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalSpyOrderRouterBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalSpyOrderRouterBacktestRunnerConfig()
