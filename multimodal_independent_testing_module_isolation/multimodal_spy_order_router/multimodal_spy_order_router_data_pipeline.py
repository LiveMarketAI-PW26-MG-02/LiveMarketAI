"""
  ...
  File       : multimodal_spy_order_router_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_spy_order_router_data_pipeline'
TOPIC             = 'independent_testing'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSpyOrderRouterDataPipelineConfig:
...
class MultimodalSpyOrderRouterEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalSpyOrderRouterDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalSpyOrderRouterDataPipelineConfig()
