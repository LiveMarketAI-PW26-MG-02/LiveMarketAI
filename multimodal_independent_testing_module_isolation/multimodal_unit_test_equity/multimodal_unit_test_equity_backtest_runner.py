"""
  ...
  File       : multimodal_unit_test_equity_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_unit_test_equity_backtest_runner'
TOPIC             = 'independent_testing'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalUnitTestEquityBacktestRunnerConfig:
...
class MultimodalUnitTestEquityEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalUnitTestEquityBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalUnitTestEquityBacktestRunnerConfig()
