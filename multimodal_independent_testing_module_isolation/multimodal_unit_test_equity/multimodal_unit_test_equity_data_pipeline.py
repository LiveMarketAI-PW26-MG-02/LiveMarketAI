"""
  ...
  File       : multimodal_unit_test_equity_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_unit_test_equity_data_pipeline'
TOPIC             = 'independent_testing'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalUnitTestEquityDataPipelineConfig:
...
class MultimodalUnitTestEquityEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalUnitTestEquityDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalUnitTestEquityDataPipelineConfig()
