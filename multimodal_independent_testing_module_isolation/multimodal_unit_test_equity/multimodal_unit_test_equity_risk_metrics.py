"""
  ...
  File       : multimodal_unit_test_equity_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_unit_test_equity_risk_metrics'
TOPIC             = 'independent_testing'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalUnitTestEquityRiskMetricsConfig:
...
class MultimodalUnitTestEquityEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalUnitTestEquityRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalUnitTestEquityRiskMetricsConfig()
