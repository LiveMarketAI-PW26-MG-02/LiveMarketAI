...
from ...schemas.advisor import AdvisorCreate, AdvisorRead
...
@router.get("/{item_id}", response_model=AdvisorRead)
...
def create_item(payload: AdvisorCreate, db: Session = Depends(get_db)):
