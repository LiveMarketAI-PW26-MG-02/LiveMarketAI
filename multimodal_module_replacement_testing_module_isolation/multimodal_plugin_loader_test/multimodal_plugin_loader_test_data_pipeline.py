"""
  ...
  File       : multimodal_plugin_loader_test_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_plugin_loader_test_data_pipeline'
TOPIC             = 'module_replacement_testing'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalPluginLoaderTestDataPipelineConfig:
...
class MultimodalPluginLoaderTestEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalPluginLoaderTestDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalPluginLoaderTestDataPipelineConfig()
