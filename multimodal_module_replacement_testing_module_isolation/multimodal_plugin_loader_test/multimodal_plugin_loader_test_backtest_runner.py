"""
  ...
  File       : multimodal_plugin_loader_test_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_plugin_loader_test_backtest_runner'
TOPIC             = 'module_replacement_testing'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalPluginLoaderTestBacktestRunnerConfig:
...
class MultimodalPluginLoaderTestEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalPluginLoaderTestBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalPluginLoaderTestBacktestRunnerConfig()
