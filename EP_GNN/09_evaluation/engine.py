#!/usr/bin/env python3
"""
Emotion Propagation Graph Neural Network (EP-GNN) - Evaluation Engine (Alt Entry)
...
OUTPUT_DIR = "outputs/ep_gnn_eval"
os.makedirs(OUTPUT_DIR, exist_ok=True)
np.random.seed(42)

class BinaryClassificationEvaluator:
    """Full binary classification metric suite for EP-GNN."""
...
class RegimeEvaluator:
    """Regime-stratified evaluation for EP-GNN."""
...
class CalibrationEvaluator:
    """ECE and reliability diagram for EP-GNN probability calibration."""
...
class GraphEvaluator:
    """Graph-aware metrics for EP-GNN GNN evaluation."""
...
def main():
    print(f"\n{'='*60}\n  EP-GNN Evaluation Engine (Alt Entry)\n{'='*60}")
    n=200
    ...
    report={"module":"EP-GNN","full_name":"Emotion Propagation Graph Neural Network","evaluated_at":datetime.utcnow().isoformat()+"Z",
