#!/usr/bin/env python3
"""
EP-GNN - Shared Utility Functions
Common helpers used across all subfolders of the EP-GNN module.
"""
...
def get_logger(name: str = "EP-GNN", level: str = "INFO") -> logging.Logger:
    """Configure and return a logger for EP-GNN module."""
