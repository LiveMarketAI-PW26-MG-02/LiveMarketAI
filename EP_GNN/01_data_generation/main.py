#!/usr/bin/env python3
"""
Emotion Propagation Graph Neural Network (EP-GNN) - Data Generation Module
...
REGIME_TYPES      = ['organic_sentiment', 'coordinated_pump', 'fud_campaign', 'neutral', 'mixed']
OUTPUT_DIR        = "outputs/ep_gnn_data"
...
class SyntheticMarketDataGenerator:
    """
    Generates synthetic OHLCV + microstructure + sentiment data for EP-GNN.
    ...
    def generate_price_series(self, asset_id: str, regime: str = "bull") -> pd.DataFrame:
        ...
        Regimes: ['organic_sentiment', 'coordinated_pump', 'fud_campaign', 'neutral', 'mixed']
        """
        regime_params = {
...
class SentimentDataGenerator:
    ...
    price manipulation events for EP-GNN.
    """
...
class OrderBookGenerator:
    ...
    Critical for EP-GNN microstructure-based manipulation detection.
    """
...
def main():
    print(f"\n============================================================")
    print(f"  EP-GNN - Data Generation Pipeline")
    ...
    # Summary
    print(f"\n============================================================")
    print(f"  Data Generation Complete for EP-GNN")
