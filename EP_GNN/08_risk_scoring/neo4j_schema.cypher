// ═══════════════════════════════════════════════════════════════════════════
// Emotion Propagation Graph Neural Network (EP-GNN) — Neo4j Graph Schema
// Module: ep_gnn
// ═══════════════════════════════════════════════════════════════════════════
...
// ── NODE PROPERTIES (sample MERGE for EP-GNN) ─────────────────────────────
...
ON CREATE SET
  ...
  al.description    = 'Pump-and-dump pattern detected by EP-GNN',
