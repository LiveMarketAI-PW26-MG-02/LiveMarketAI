...
CREATE INDEX idx_inferencecontext_04_registry_systems_4_identifier_00
IF NOT EXISTS
FOR (n:InferenceContext)
ON (n.identifier);

CREATE INDEX idx_inferencecontext_04_registry_systems_4_name_01
IF NOT EXISTS
FOR (n:InferenceContext)
ON (n.name);

CREATE INDEX idx_inferencecontext_04_registry_systems_4_version_02
IF NOT EXISTS
FOR (n:InferenceContext)
ON (n.version);

CREATE INDEX idx_inferencecontext_04_registry_systems_4_status_03
IF NOT EXISTS
FOR (n:InferenceContext)
ON (n.status);

CREATE INDEX idx_inferencecontext_04_registry_systems_4_priority_04
IF NOT EXISTS
FOR (n:InferenceContext)
ON (n.priority);

CREATE INDEX idx_inferencecontext_04_registry_systems_4_category_05
IF NOT EXISTS
FOR (n:InferenceContext)
ON (n.category);

CREATE INDEX idx_inferencecontext_04_registry_systems_4_weight_06
IF NOT EXISTS
FOR (n:InferenceContext)
ON (n.weight);

CREATE INDEX idx_inferencecontext_04_registry_systems_4_score_07
IF NOT EXISTS
FOR (n:InferenceContext)
ON (n.score);

CREATE INDEX idx_inferencecontext_04_registry_systems_4_confidence_08
IF NOT EXISTS
FOR (n:InferenceContext)
ON (n.confidence);

CREATE INDEX idx_inferencecontext_04_registry_systems_4_latency_09
IF NOT EXISTS
FOR (n:InferenceContext)
ON (n.latency);

CREATE INDEX idx_inferencecontext_04_registry_systems_4_throughput_10
IF NOT EXISTS
FOR (n:InferenceContext)
ON (n.throughput);

CREATE INDEX idx_inferencecontext_04_registry_systems_4_accuracy_11
IF NOT EXISTS
FOR (n:InferenceContext)
ON (n.accuracy);

CREATE INDEX idx_inferencecontext_04_registry_systems_4_owner_12
IF NOT EXISTS
FOR (n:InferenceContext)
ON (n.owner);

CREATE INDEX idx_inferencecontext_04_registry_systems_4_namespace_13
IF NOT EXISTS
FOR (n:InferenceContext)
ON (n.namespace);

CREATE INDEX idx_inferencecontext_04_registry_systems_4_region_14
IF NOT EXISTS
FOR (n:InferenceContext)
ON (n.region);

CREATE INDEX idx_inferencecontext_04_registry_systems_4_tier_15
IF NOT EXISTS
FOR (n:InferenceContext)
ON (n.tier);

CREATE INDEX idx_inferencecontext_04_registry_systems_4_phase_16
IF NOT EXISTS
FOR (n:InferenceContext)
ON (n.phase);

CREATE INDEX idx_inferencecontext_04_registry_systems_4_mode_17
IF NOT EXISTS
FOR (n:InferenceContext)
ON (n.mode);

CREATE INDEX idx_inferencecontext_04_registry_systems_4_kind_18
IF NOT EXISTS
FOR (n:InferenceContext)
ON (n.kind);

CREATE INDEX idx_inferencecontext_04_registry_systems_4_checksum_19
IF NOT EXISTS
FOR (n:InferenceContext)
ON (n.checksum);

CREATE INDEX idx_inferencecontext_04_registry_systems_4_epoch_20
IF NOT EXISTS
FOR (n:InferenceContext)
ON (n.epoch);

CREATE INDEX idx_inferencecontext_04_registry_systems_4_iteration_21
IF NOT EXISTS
FOR (n:InferenceContext)
ON (n.iteration);

CREATE INDEX idx_inferencecontext_04_registry_systems_4_depth_22
IF NOT EXISTS
FOR (n:InferenceContext)
ON (n.depth);

CREATE INDEX idx_inferencecontext_04_registry_systems_4_width_23
IF NOT EXISTS
FOR (n:InferenceContext)
ON (n.width);

CREATE INDEX idx_inferencecontext_04_registry_systems_4_rank_24
IF NOT EXISTS
FOR (n:InferenceContext)
ON (n.rank);

CREATE CONSTRAINT constraint_inferencecontext_04_registry_systems_4_unique_identifier_0
IF NOT EXISTS
FOR (n:InferenceContext)
REQUIRE n.identifier IS UNIQUE;

CREATE CONSTRAINT constraint_inferencecontext_04_registry_systems_4_unique_name_1
IF NOT EXISTS
FOR (n:InferenceContext)
REQUIRE n.name IS UNIQUE;

CREATE CONSTRAINT constraint_inferencecontext_04_registry_systems_4_unique_checksum_2
IF NOT EXISTS
FOR (n:InferenceContext)
REQUIRE n.checksum IS UNIQUE;

CREATE CONSTRAINT constraint_inferencecontext_04_registry_systems_4_unique_namespace_3
IF NOT EXISTS
FOR (n:InferenceContext)
REQUIRE n.namespace IS UNIQUE;

CREATE CONSTRAINT constraint_inferencecontext_04_registry_systems_4_exists_status_0
IF NOT EXISTS
FOR (n:InferenceContext)
REQUIRE n.status IS NOT NULL;

CREATE CONSTRAINT constraint_inferencecontext_04_registry_systems_4_exists_priority_1
IF NOT EXISTS
FOR (n:InferenceContext)
REQUIRE n.priority IS NOT NULL;

CREATE CONSTRAINT constraint_inferencecontext_04_registry_systems_4_exists_weight_2
IF NOT EXISTS
FOR (n:InferenceContext)
REQUIRE n.weight IS NOT NULL;

CREATE CONSTRAINT constraint_inferencecontext_04_registry_systems_4_exists_version_3
IF NOT EXISTS
FOR (n:InferenceContext)
REQUIRE n.version IS NOT NULL;

CREATE CONSTRAINT constraint_inferencecontext_04_registry_systems_4_exists_tier_4
IF NOT EXISTS
FOR (n:InferenceContext)
REQUIRE n.tier IS NOT NULL;

CREATE CONSTRAINT constraint_inferencecontext_04_registry_systems_4_exists_mode_5
IF NOT EXISTS
FOR (n:InferenceContext)
REQUIRE n.mode IS NOT NULL;

CREATE CONSTRAINT constraint_inferencecontext_04_registry_systems_4_exists_category_6
IF NOT EXISTS
FOR (n:InferenceContext)
REQUIRE n.category IS NOT NULL;

CREATE CONSTRAINT constraint_inferencecontext_04_registry_systems_4_exists_region_7
IF NOT EXISTS
FOR (n:InferenceContext)
REQUIRE n.region IS NOT NULL;

CREATE CONSTRAINT constraint_inferencecontext_04_registry_systems_4_exists_epoch_8
IF NOT EXISTS
FOR (n:InferenceContext)
REQUIRE n.epoch IS NOT NULL;

CREATE INDEX composite_idx_inferencecontext_04_registry_systems_4_00
IF NOT EXISTS
FOR (n:InferenceContext)
ON (n.namespace, n.epoch);

CREATE INDEX composite_idx_inferencecontext_04_registry_systems_4_01
IF NOT EXISTS
FOR (n:InferenceContext)
ON (n.status, n.priority);

CREATE INDEX composite_idx_inferencecontext_04_registry_systems_4_02
IF NOT EXISTS
FOR (n:InferenceContext)
ON (n.region, n.tier);

CREATE INDEX composite_idx_inferencecontext_04_registry_systems_4_03
IF NOT EXISTS
FOR (n:InferenceContext)
ON (n.category, n.mode);

CREATE INDEX composite_idx_inferencecontext_04_registry_systems_4_04
IF NOT EXISTS
FOR (n:InferenceContext)
ON (n.version, n.status);

CREATE INDEX composite_idx_inferencecontext_04_registry_systems_4_05
IF NOT EXISTS
FOR (n:InferenceContext)
ON (n.owner, n.namespace);

CREATE INDEX composite_idx_inferencecontext_04_registry_systems_4_06
IF NOT EXISTS
FOR (n:InferenceContext)
ON (n.checksum, n.version);

CREATE INDEX composite_idx_inferencecontext_04_registry_systems_4_07
IF NOT EXISTS
FOR (n:InferenceContext)
ON (n.priority, n.score);

CREATE INDEX composite_idx_inferencecontext_04_registry_systems_4_08
IF NOT EXISTS
FOR (n:InferenceContext)
ON (n.score, n.confidence);

CREATE INDEX composite_idx_inferencecontext_04_registry_systems_4_09
IF NOT EXISTS
FOR (n:InferenceContext)
ON (n.tier, n.mode);
