#!/usr/bin/env python3
"""
Multi-Scale Graph Neural Network (MSGNN) - Data Generation Module
...
REGIME_TYPES      = ['tick_scale', 'minute_scale', 'hourly_scale', 'daily_scale', 'macro_scale']
OUTPUT_DIR        = "outputs/msgnn_data"
...
class SyntheticMarketDataGenerator:
    """
    Generates synthetic OHLCV + microstructure + sentiment data for MSGNN.
    ...
    def generate_price_series(self, asset_id: str, regime: str = "bull") -> pd.DataFrame:
        ...
        Regimes: ['tick_scale', 'minute_scale', 'hourly_scale', 'daily_scale', 'macro_scale']
        """
        regime_params = {
...
class SentimentDataGenerator:
    ...
    price manipulation events for MSGNN.
    """
...
class OrderBookGenerator:
    ...
    Critical for MSGNN microstructure-based manipulation detection.
    """
...
def main():
    print(f"\n============================================================")
    print(f"  MSGNN - Data Generation Pipeline")
    ...
    # Summary
    print(f"\n============================================================")
    print(f"  Data Generation Complete for MSGNN")
