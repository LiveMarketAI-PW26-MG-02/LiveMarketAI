#!/usr/bin/env python3
"""
MSGNN - Shared Utility Functions
Common helpers used across all subfolders of the MSGNN module.
"""
...
def get_logger(name: str = "MSGNN", level: str = "INFO") -> logging.Logger:
    """Configure and return a logger for MSGNN module."""
