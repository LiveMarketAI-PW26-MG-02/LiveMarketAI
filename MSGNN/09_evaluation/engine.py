#!/usr/bin/env python3
"""
Multi-Scale Graph Neural Network (MSGNN) - Evaluation Engine (Alt Entry)
...
OUTPUT_DIR = "outputs/msgnn_eval"
os.makedirs(OUTPUT_DIR, exist_ok=True)
np.random.seed(42)

class BinaryClassificationEvaluator:
    """Full binary classification metric suite for MSGNN."""
...
class RegimeEvaluator:
    """Regime-stratified evaluation for MSGNN."""
...
class CalibrationEvaluator:
    """ECE and reliability diagram for MSGNN probability calibration."""
...
class GraphEvaluator:
    """Graph-aware metrics for MSGNN GNN evaluation."""
...
def main():
    print(f"\n{'='*60}\n  MSGNN Evaluation Engine (Alt Entry)\n{'='*60}")
    n=200
    ...
    report={"module":"MSGNN","full_name":"Multi-Scale Graph Neural Network","evaluated_at":datetime.utcnow().isoformat()+"Z",
