#!/usr/bin/env python3
"""
Multi-Scale Graph Neural Network (MSGNN) - Demo Runner — End-to-End Pipeline
...
OUTPUT_DIR = "outputs/msgnn_inference"
...
class InferenceFeatureExtractor:
    ...
    for MSGNN inference. Handles normalization using training statistics.
    """
...
class AlertGenerator:
    ...
    def __init__(self, module_name: str = "MSGNN"):
    ...
    def save_alerts(self, alerts: List[dict], filename: str = "alerts.json") -> str:
        ...
        with open(path, "w") as f:
            json.dump({"module": "MSGNN", "alerts": alerts,
                        "total": len(alerts),
...
class InferencePipeline:
    """
    End-to-end MSGNN inference pipeline:
    ...
    def __init__(self, model, n_assets: int = 20, threshold: float = 0.5):
        ...
        self.alert_generator = AlertGenerator("MSGNN")
    ...
    def run_streaming(self, n_windows: int = 50,
        ...
        print(f"  Running MSGNN streaming inference: {n_windows} windows...")
        results = []
...
def main():
    print(f"\n{'='*60}")
    print(f"  MSGNN - Demo Runner — End-to-End Pipeline")
    print(f"  Multi-Scale Graph Neural Network")
    print(f"{'='*60}\n")
    ...
    print(f"\nMSGNN Demo Runner — End-to-End Pipeline Complete.\n")
...
7 + np.random.rand(n) * 0.3, 0, 1),
        ...
        explanation_text = f"""
MANIPULATION DETECTION EXPLANATION - MSGNN
============================================================
...
"""
        ...
        report  = {
            "module":          "MSGNN",
            "full_name":       "Multi-Scale Graph Neural Network",
