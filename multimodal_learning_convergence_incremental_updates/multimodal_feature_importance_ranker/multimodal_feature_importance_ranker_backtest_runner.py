"""
  ...
  File       : multimodal_feature_importance_ranker_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_feature_importance_ranker_backtest_runner'
TOPIC             = 'learning_convergence'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalFeatureImportanceRankerBacktestRunnerConfig:
...
class MultimodalFeatureImportanceRankerEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalFeatureImportanceRankerBacktestRunnerConfig()
        self.state    : Dict = {}
