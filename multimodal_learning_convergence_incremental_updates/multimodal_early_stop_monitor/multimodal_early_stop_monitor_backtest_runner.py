"""
  ...
  File       : multimodal_early_stop_monitor_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_early_stop_monitor_backtest_runner'
TOPIC             = 'learning_convergence'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalEarlyStopMonitorBacktestRunnerConfig:
...
class MultimodalEarlyStopMonitorEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalEarlyStopMonitorBacktestRunnerConfig()
        self.state    : Dict = {}
