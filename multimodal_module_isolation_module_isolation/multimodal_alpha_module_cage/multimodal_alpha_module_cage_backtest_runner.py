"""
  ...
  File       : multimodal_alpha_module_cage_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_alpha_module_cage_backtest_runner'
TOPIC             = 'module_isolation'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalAlphaModuleCageBacktestRunnerConfig:
...
class MultimodalAlphaModuleCageEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalAlphaModuleCageBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalAlphaModuleCageBacktestRunnerConfig()
