"""
  ...
  File       : multimodal_alpha_module_cage_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_alpha_module_cage_risk_metrics'
TOPIC             = 'module_isolation'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalAlphaModuleCageRiskMetricsConfig:
...
class MultimodalAlphaModuleCageEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalAlphaModuleCageRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalAlphaModuleCageRiskMetricsConfig()
