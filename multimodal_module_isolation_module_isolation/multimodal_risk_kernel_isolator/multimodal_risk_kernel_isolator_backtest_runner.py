"""
  ...
  File       : multimodal_risk_kernel_isolator_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_risk_kernel_isolator_backtest_runner'
TOPIC             = 'module_isolation'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRiskKernelIsolatorBacktestRunnerConfig:
...
class MultimodalRiskKernelIsolatorEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalRiskKernelIsolatorBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalRiskKernelIsolatorBacktestRunnerConfig()
