"""
  ...
  File       : multimodal_market_feed_enclave_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_market_feed_enclave_backtest_runner'
TOPIC             = 'module_isolation'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalMarketFeedEnclaveBacktestRunnerConfig:
...
class MultimodalMarketFeedEnclaveEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalMarketFeedEnclaveBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalMarketFeedEnclaveBacktestRunnerConfig()
