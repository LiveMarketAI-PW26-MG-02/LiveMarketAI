"""
  ...
  File       : multimodal_pricing_cell_shield_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_pricing_cell_shield_backtest_runner'
TOPIC             = 'module_isolation'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalPricingCellShieldBacktestRunnerConfig:
...
class MultimodalPricingCellShieldEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalPricingCellShieldBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalPricingCellShieldBacktestRunnerConfig()
