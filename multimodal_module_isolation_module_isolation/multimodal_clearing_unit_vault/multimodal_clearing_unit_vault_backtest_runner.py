"""
  ...
  File       : multimodal_clearing_unit_vault_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_clearing_unit_vault_backtest_runner'
TOPIC             = 'module_isolation'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalClearingUnitVaultBacktestRunnerConfig:
...
class MultimodalClearingUnitVaultEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalClearingUnitVaultBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalClearingUnitVaultBacktestRunnerConfig()
