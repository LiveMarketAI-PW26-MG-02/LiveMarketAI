"""
  ...
  File       : multimodal_signal_bus_isolator_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_signal_bus_isolator_backtest_runner'
TOPIC             = 'module_isolation'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSignalBusIsolatorBacktestRunnerConfig:
...
class MultimodalSignalBusIsolatorEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalSignalBusIsolatorBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalSignalBusIsolatorBacktestRunnerConfig()
