"""
  ...
  File       : multimodal_order_book_isolator_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_order_book_isolator_core_logic'
TOPIC             = 'module_isolation'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalOrderBookIsolatorCoreLogicConfig:
...
class MultimodalOrderBookIsolatorEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalOrderBookIsolatorCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalOrderBookIsolatorCoreLogicConfig()
