"""
  ...
  File       : multimodal_order_book_isolator_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_order_book_isolator_backtest_runner'
TOPIC             = 'module_isolation'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalOrderBookIsolatorBacktestRunnerConfig:
...
class MultimodalOrderBookIsolatorEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalOrderBookIsolatorBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalOrderBookIsolatorBacktestRunnerConfig()
