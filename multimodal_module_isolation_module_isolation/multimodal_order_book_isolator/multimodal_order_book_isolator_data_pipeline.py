"""
  ...
  File       : multimodal_order_book_isolator_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_order_book_isolator_data_pipeline'
TOPIC             = 'module_isolation'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalOrderBookIsolatorDataPipelineConfig:
...
class MultimodalOrderBookIsolatorEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalOrderBookIsolatorDataPipelineConfig] = None):
        self.cfg     = cfg or MultimodalOrderBookIsolatorDataPipelineConfig()
