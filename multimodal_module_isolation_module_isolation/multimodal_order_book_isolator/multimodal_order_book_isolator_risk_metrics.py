"""
  ...
  File       : multimodal_order_book_isolator_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_order_book_isolator_risk_metrics'
TOPIC             = 'module_isolation'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalOrderBookIsolatorRiskMetricsConfig:
...
class MultimodalOrderBookIsolatorEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalOrderBookIsolatorRiskMetricsConfig] = None):
        self.cfg     = cfg or MultimodalOrderBookIsolatorRiskMetricsConfig()
