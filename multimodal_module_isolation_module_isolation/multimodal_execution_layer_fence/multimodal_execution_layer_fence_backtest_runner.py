"""
  ...
  File       : multimodal_execution_layer_fence_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_execution_layer_fence_backtest_runner'
TOPIC             = 'module_isolation'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalExecutionLayerFenceBacktestRunnerConfig:
...
class MultimodalExecutionLayerFenceEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalExecutionLayerFenceBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalExecutionLayerFenceBacktestRunnerConfig()
