"""
  ...
  File       : multimodal_portfolio_module_wall_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_portfolio_module_wall_backtest_runner'
TOPIC             = 'module_isolation'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalPortfolioModuleWallBacktestRunnerConfig:
...
class MultimodalPortfolioModuleWallEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalPortfolioModuleWallBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalPortfolioModuleWallBacktestRunnerConfig()
