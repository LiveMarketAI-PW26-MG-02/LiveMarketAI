"""
  ...
  File       : multimodal_tick_data_sandbox_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_tick_data_sandbox_backtest_runner'
TOPIC             = 'module_isolation'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalTickDataSandboxBacktestRunnerConfig:
...
class MultimodalTickDataSandboxEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalTickDataSandboxBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalTickDataSandboxBacktestRunnerConfig()
