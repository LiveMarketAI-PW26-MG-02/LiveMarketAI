...
WHERE pr_score_000 > 0.242
RETURN nid_000, pr_score_000
ORDER BY pr_score_000 DESC
LIMIT 100;

CALL apoc.periodic.iterate(
  "MATCH (n:GraphNetwork) WHERE n.epoch = 3 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
...
WHERE pr_score_001 > 0.147
RETURN nid_001, pr_score_001
ORDER BY pr_score_001 DESC
LIMIT 100;

CALL apoc.periodic.iterate(
  "MATCH (n:GraphNetwork) WHERE n.epoch = 40 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
  {batchSize: 100, parallel: true}
);
...
WHERE pr_score_004 > 0.318
RETURN nid_004, pr_score_004
ORDER BY pr_score_004 DESC
LIMIT 100;

CALL apoc.periodic.iterate(
  "MATCH (n:GraphNetwork) WHERE n.epoch = 26 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
...
WHERE pr_score_006 > 0.122
RETURN nid_006, pr_score_006
ORDER BY pr_score_006 DESC
LIMIT 100;

CALL apoc.periodic.iterate(
  "MATCH (n:GraphNetwork) WHERE n.epoch = 17 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
...
WHERE pr_score_007 > 0.29
RETURN nid_007, pr_score_007
ORDER BY pr_score_007 DESC
LIMIT 100;

CALL apoc.periodic.iterate(
  "MATCH (n:GraphNetwork) WHERE n.epoch = 33 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
...
WHERE pr_score_008 > 0.174
RETURN nid_008, pr_score_008
ORDER BY pr_score_008 DESC
LIMIT 20;

CALL apoc.periodic.iterate(
  "MATCH (n:GraphNetwork) WHERE n.epoch = 47 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
  {batchSize: 500, parallel: false}
);
...
WHERE pr_score_009 > 0.299
RETURN nid_009, pr_score_009
ORDER BY pr_score_009 DESC
LIMIT 100;

CALL apoc.periodic.iterate(
  "MATCH (n:GraphNetwork) WHERE n.epoch = 21 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
  {batchSize: 500, parallel: false}
);
...
WHERE pr_score_011 > 0.188
RETURN nid_011, pr_score_011
ORDER BY pr_score_011 DESC
LIMIT 20;

CALL apoc.periodic.iterate(
  "MATCH (n:GraphNetwork) WHERE n.epoch = 50 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
  {batchSize: 500, parallel: false}
);
...
WHERE pr_score_013 > 0.357
RETURN nid_013, pr_score_013
ORDER BY pr_score_013 DESC
LIMIT 50;

CALL apoc.periodic.iterate(
  "MATCH (n:GraphNetwork) WHERE n.epoch = 8 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
  {batchSize: 500, parallel: true}
);
...
WHERE pr_score_015 > 0.312
RETURN nid_015, pr_score_015
ORDER BY pr_score_015 DESC
LIMIT 50;

CALL apoc.periodic.iterate(
  "MATCH (n:GraphNetwork) WHERE n.epoch = 9 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
  {batchSize: 500, parallel: false}
);
...
WHERE pr_score_016 > 0.107
RETURN nid_016, pr_score_016
ORDER BY pr_score_016 DESC
LIMIT 50;

CALL apoc.periodic.iterate(
  "MATCH (n:GraphNetwork) WHERE n.epoch = 11 RETURN n",
  "SET n.lastVisited = datetime(), n.visits = coalesce(n.visits, 0) + 1",
  {batchSize: 500, parallel: true}
);
