"""
  ...
  File       : multimodal_monthly_recalibrator_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_monthly_recalibrator_backtest_runner'
TOPIC             = 'update_frequency'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalMonthlyRecalibratorBacktestRunnerConfig:
...
class MultimodalMonthlyRecalibratorEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalMonthlyRecalibratorBacktestRunnerConfig()
        self.state    : Dict = {}
