"""
  ...
  File       : multimodal_bar_aggregator_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_bar_aggregator_backtest_runner'
TOPIC             = 'update_frequency'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalBarAggregatorBacktestRunnerConfig:
...
class MultimodalBarAggregatorEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalBarAggregatorBacktestRunnerConfig()
        self.state    : Dict = {}
