"""
  ...
  File       : multimodal_intraday_refresher_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_intraday_refresher_core_logic'
TOPIC             = 'update_frequency'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalIntradayRefresherCoreLogicConfig:
...
class MultimodalIntradayRefresherEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalIntradayRefresherCoreLogicConfig()
        self.state    : Dict = {}
