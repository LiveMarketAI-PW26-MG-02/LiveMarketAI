"""
  ...
  File       : multimodal_intraday_refresher_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_intraday_refresher_backtest_runner'
TOPIC             = 'update_frequency'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalIntradayRefresherBacktestRunnerConfig:
...
class MultimodalIntradayRefresherEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalIntradayRefresherBacktestRunnerConfig()
        self.state    : Dict = {}
