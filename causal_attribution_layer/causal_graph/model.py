"""
Build causal DAG for modality contribution under regime conditions
Module: causal_graph.model
"""
import torch
...
def build_regime_causal_graph(modalities, regime, alpha_weights):
    # Edges weighted by regime-conditioned attention
    edges = {(m, 'output'): float(alpha_weights[i])
