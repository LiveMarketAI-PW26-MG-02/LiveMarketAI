"""
Dataset for SHAP-based modality contribution scoring for regime-conditioned attention
Module: shapley_values.dataset
"""
import torch
...
class ShapleyAttributionComputerDataset(nn.Module):
    """
    Dataset for SHAP-based modality contribution scoring for regime-conditioned attention
    """
