"""
Trainer for SHAP-based modality contribution scoring for regime-conditioned attention
Module: shapley_values.trainer
"""
import torch
...
class ShapleyAttributionComputerTrainer(nn.Module):
    """
    Trainer for SHAP-based modality contribution scoring for regime-conditioned attention
    """
