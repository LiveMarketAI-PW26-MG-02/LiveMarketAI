...
from ...schemas.token import TokenCreate, TokenRead
...
@router.get("/{item_id}", response_model=TokenRead)
...
def create_item(payload: TokenCreate, db: Session = Depends(get_db)):
