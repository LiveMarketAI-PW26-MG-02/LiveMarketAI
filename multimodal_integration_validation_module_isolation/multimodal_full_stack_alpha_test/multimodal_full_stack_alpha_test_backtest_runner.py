"""
  ...
  File       : multimodal_full_stack_alpha_test_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_full_stack_alpha_test_backtest_runner'
TOPIC             = 'integration_validation'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalFullStackAlphaTestBacktestRunnerConfig:
...
class MultimodalFullStackAlphaTestEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalFullStackAlphaTestBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalFullStackAlphaTestBacktestRunnerConfig()
