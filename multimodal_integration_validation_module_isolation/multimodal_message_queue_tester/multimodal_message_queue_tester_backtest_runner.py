"""
  ...
  File       : multimodal_message_queue_tester_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_message_queue_tester_backtest_runner'
TOPIC             = 'integration_validation'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalMessageQueueTesterBacktestRunnerConfig:
...
class MultimodalMessageQueueTesterEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalMessageQueueTesterBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalMessageQueueTesterBacktestRunnerConfig()
