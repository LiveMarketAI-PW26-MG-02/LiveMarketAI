"""
  ...
  File       : multimodal_api_gateway_validator_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_api_gateway_validator_backtest_runner'
TOPIC             = 'integration_validation'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalApiGatewayValidatorBacktestRunnerConfig:
...
class MultimodalApiGatewayValidatorEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalApiGatewayValidatorBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalApiGatewayValidatorBacktestRunnerConfig()
