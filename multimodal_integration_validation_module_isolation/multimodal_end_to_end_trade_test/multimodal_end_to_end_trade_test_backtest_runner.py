"""
  ...
  File       : multimodal_end_to_end_trade_test_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_end_to_end_trade_test_backtest_runner'
TOPIC             = 'integration_validation'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalEndToEndTradeTestBacktestRunnerConfig:
...
class MultimodalEndToEndTradeTestEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalEndToEndTradeTestBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalEndToEndTradeTestBacktestRunnerConfig()
