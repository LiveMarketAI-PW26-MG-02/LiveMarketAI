"""
  ...
  File       : multimodal_end_to_end_trade_test_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_end_to_end_trade_test_core_logic'
TOPIC             = 'integration_validation'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalEndToEndTradeTestCoreLogicConfig:
...
class MultimodalEndToEndTradeTestEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalEndToEndTradeTestCoreLogicConfig] = None):
        self.cfg     = cfg or MultimodalEndToEndTradeTestCoreLogicConfig()
