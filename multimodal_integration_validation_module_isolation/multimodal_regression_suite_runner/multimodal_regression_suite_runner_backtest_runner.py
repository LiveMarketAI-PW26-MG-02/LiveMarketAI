"""
  ...
  File       : multimodal_regression_suite_runner_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_regression_suite_runner_backtest_runner'
TOPIC             = 'integration_validation'
VERSION           = '1.0.0'

# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegressionSuiteRunnerBacktestRunnerConfig:
...
class MultimodalRegressionSuiteRunnerEngine(MultimodalBaseModule):
    ...
    def __init__(self, cfg: Optional[MultimodalRegressionSuiteRunnerBacktestRunnerConfig] = None):
        self.cfg     = cfg or MultimodalRegressionSuiteRunnerBacktestRunnerConfig()
