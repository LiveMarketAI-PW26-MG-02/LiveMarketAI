#!/usr/bin/env Rscript
# ─────────────────────────────────────────────────────────────────────────────
# InsiderQuantum Drift Defense — R Domain-Specific Statistical Model
# FIEM: Federated Intent Embedding Monitor (FIEM): Privileged command sequences are encoded into vector embeddings. Each environ...
# ─────────────────────────────────────────────────────────────────────────────
...
NODE_ID <- paste0("fiem-r-domain-", Sys.getenv("HOSTNAME", "local"))
