"""
  ...
  File       : multimodal_earnings_recall_db_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_earnings_recall_db_backtest_runner'
TOPIC             = 'forgetting_learning'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalEarningsRecallDbBacktestRunnerConfig:
...
class MultimodalEarningsRecallDbEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalEarningsRecallDbBacktestRunnerConfig()
        self.state    : Dict = {}
