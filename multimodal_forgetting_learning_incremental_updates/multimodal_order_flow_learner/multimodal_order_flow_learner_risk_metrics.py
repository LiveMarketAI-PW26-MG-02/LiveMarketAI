"""
  ...
  File       : multimodal_order_flow_learner_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_order_flow_learner_risk_metrics'
TOPIC             = 'forgetting_learning'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalOrderFlowLearnerRiskMetricsConfig:
...
class MultimodalOrderFlowLearnerEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalOrderFlowLearnerRiskMetricsConfig()
        self.state    : Dict = {}
