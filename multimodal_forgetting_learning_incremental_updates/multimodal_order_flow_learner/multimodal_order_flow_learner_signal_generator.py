"""
  ...
  Folder     : multimodal_order_flow_learner
  File       : multimodal_order_flow_learner_signal_generator.py
  Purpose    : Forgetting Learning — Order Flow Learner
"""
...
MULTIMODAL_MODULE = 'multimodal_order_flow_learner_signal_generator'
TOPIC             = 'forgetting_learning'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalOrderFlowLearnerSignalGeneratorConfig:
    """Configuration for multimodal order_flow_learner module."""
...
# ── Core Engine ──────────────────────────────────────────────────────────────
class MultimodalOrderFlowLearnerEngine:
    """
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalOrderFlowLearnerSignalGeneratorConfig()
        self.state    : Dict = {}
