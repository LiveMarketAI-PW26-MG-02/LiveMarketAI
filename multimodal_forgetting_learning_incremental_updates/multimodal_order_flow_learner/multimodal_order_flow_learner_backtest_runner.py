"""
  ...
  File       : multimodal_order_flow_learner_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_order_flow_learner_backtest_runner'
TOPIC             = 'forgetting_learning'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalOrderFlowLearnerBacktestRunnerConfig:
...
class MultimodalOrderFlowLearnerEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalOrderFlowLearnerBacktestRunnerConfig()
        self.state    : Dict = {}
