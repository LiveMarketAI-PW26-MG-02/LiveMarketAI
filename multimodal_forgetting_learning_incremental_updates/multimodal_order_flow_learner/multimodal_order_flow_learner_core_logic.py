"""
  ...
  File       : multimodal_order_flow_learner_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_order_flow_learner_core_logic'
TOPIC             = 'forgetting_learning'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalOrderFlowLearnerCoreLogicConfig:
...
class MultimodalOrderFlowLearnerEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalOrderFlowLearnerCoreLogicConfig()
        self.state    : Dict = {}
