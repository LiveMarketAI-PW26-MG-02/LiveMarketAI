"""
  ...
  File       : multimodal_order_flow_learner_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_order_flow_learner_data_pipeline'
TOPIC             = 'forgetting_learning'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalOrderFlowLearnerDataPipelineConfig:
...
class MultimodalOrderFlowLearnerEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalOrderFlowLearnerDataPipelineConfig()
        self.state    : Dict = {}
