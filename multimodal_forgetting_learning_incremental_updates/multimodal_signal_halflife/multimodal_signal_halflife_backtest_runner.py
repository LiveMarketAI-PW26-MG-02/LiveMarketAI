"""
  ...
  File       : multimodal_signal_halflife_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_signal_halflife_backtest_runner'
TOPIC             = 'forgetting_learning'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalSignalHalflifeBacktestRunnerConfig:
...
class MultimodalSignalHalflifeEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalSignalHalflifeBacktestRunnerConfig()
        self.state    : Dict = {}
