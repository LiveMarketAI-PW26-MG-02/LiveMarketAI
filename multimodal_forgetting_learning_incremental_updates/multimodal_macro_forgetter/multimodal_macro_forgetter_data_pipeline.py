"""
  ...
  File       : multimodal_macro_forgetter_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_macro_forgetter_data_pipeline'
TOPIC             = 'forgetting_learning'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalMacroForgetterDataPipelineConfig:
...
class MultimodalMacroForgetterEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalMacroForgetterDataPipelineConfig()
        self.state    : Dict = {}
