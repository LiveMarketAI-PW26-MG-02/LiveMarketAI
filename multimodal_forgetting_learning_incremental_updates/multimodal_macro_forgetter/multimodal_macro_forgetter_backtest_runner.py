"""
  ...
  File       : multimodal_macro_forgetter_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_macro_forgetter_backtest_runner'
TOPIC             = 'forgetting_learning'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalMacroForgetterBacktestRunnerConfig:
...
class MultimodalMacroForgetterEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalMacroForgetterBacktestRunnerConfig()
        self.state    : Dict = {}
