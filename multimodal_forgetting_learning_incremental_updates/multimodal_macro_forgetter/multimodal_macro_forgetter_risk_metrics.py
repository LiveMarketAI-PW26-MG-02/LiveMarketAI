"""
  ...
  File       : multimodal_macro_forgetter_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_macro_forgetter_risk_metrics'
TOPIC             = 'forgetting_learning'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalMacroForgetterRiskMetricsConfig:
...
class MultimodalMacroForgetterEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalMacroForgetterRiskMetricsConfig()
        self.state    : Dict = {}
