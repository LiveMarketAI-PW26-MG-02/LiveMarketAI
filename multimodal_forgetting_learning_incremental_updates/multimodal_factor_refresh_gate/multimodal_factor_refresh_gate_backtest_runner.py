"""
  ...
  File       : multimodal_factor_refresh_gate_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_factor_refresh_gate_backtest_runner'
TOPIC             = 'forgetting_learning'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalFactorRefreshGateBacktestRunnerConfig:
...
class MultimodalFactorRefreshGateEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalFactorRefreshGateBacktestRunnerConfig()
        self.state    : Dict = {}
