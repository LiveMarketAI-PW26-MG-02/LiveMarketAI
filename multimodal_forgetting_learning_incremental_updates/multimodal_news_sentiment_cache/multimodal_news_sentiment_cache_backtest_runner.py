"""
  ...
  File       : multimodal_news_sentiment_cache_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_news_sentiment_cache_backtest_runner'
TOPIC             = 'forgetting_learning'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalNewsSentimentCacheBacktestRunnerConfig:
...
class MultimodalNewsSentimentCacheEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalNewsSentimentCacheBacktestRunnerConfig()
        self.state    : Dict = {}
