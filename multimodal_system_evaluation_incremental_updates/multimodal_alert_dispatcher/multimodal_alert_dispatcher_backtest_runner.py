"""
  ...
  File       : multimodal_alert_dispatcher_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_alert_dispatcher_backtest_runner'
TOPIC             = 'system_evaluation'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalAlertDispatcherBacktestRunnerConfig:
...
class MultimodalAlertDispatcherEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalAlertDispatcherBacktestRunnerConfig()
        self.state    : Dict = {}
