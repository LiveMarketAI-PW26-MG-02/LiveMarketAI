#!/usr/bin/env python3
"""
Dynamic Temporal Graph Neural Network (D-TGNN) - Data Generation Module
...
REGIME_TYPES      = ['pre_manipulation', 'active_pump', 'distribution', 'dump', 'recovery']
OUTPUT_DIR        = "outputs/d_tgnn_data"
...
class SyntheticMarketDataGenerator:
    """
    Generates synthetic OHLCV + microstructure + sentiment data for D-TGNN.
    ...
    def generate_price_series(self, asset_id: str, regime: str = "bull") -> pd.DataFrame:
        ...
        Regimes: ['pre_manipulation', 'active_pump', 'distribution', 'dump', 'recovery']
        """
        regime_params = {
...
class SentimentDataGenerator:
    ...
    price manipulation events for D-TGNN.
    """
...
class OrderBookGenerator:
    ...
    Critical for D-TGNN microstructure-based manipulation detection.
    """
...
def main():
    print(f"\n============================================================")
    print(f"  D-TGNN - Data Generation Pipeline")
    ...
    # Summary
    print(f"\n============================================================")
    print(f"  Data Generation Complete for D-TGNN")
