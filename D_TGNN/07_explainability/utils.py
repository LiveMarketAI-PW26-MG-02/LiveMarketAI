#!/usr/bin/env python3
"""
D-TGNN - Shared Utility Functions
Common helpers used across all subfolders of the D-TGNN module.
"""
...
def get_logger(name: str = "D-TGNN", level: str = "INFO") -> logging.Logger:
    """Configure and return a logger for D-TGNN module."""
