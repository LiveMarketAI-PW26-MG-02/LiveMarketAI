#!/usr/bin/env python3
"""
Dynamic Temporal Graph Neural Network (D-TGNN) - Evaluation Engine (Alt Entry)
...
OUTPUT_DIR = "outputs/d_tgnn_eval"
os.makedirs(OUTPUT_DIR, exist_ok=True)
np.random.seed(42)

class BinaryClassificationEvaluator:
    """Full binary classification metric suite for D-TGNN."""
...
class RegimeEvaluator:
    """Regime-stratified evaluation for D-TGNN."""
...
class CalibrationEvaluator:
    """ECE and reliability diagram for D-TGNN probability calibration."""
...
class GraphEvaluator:
    """Graph-aware metrics for D-TGNN GNN evaluation."""
...
def main():
    print(f"\n{'='*60}\n  D-TGNN Evaluation Engine (Alt Entry)\n{'='*60}")
    n=200
    ...
    report={"module":"D-TGNN","full_name":"Dynamic Temporal Graph Neural Network","evaluated_at":datetime.utcnow().isoformat()+"Z",
