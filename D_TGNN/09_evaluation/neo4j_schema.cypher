// ═══════════════════════════════════════════════════════════════════════════
// Dynamic Temporal Graph Neural Network (D-TGNN) — Neo4j Graph Schema
// Module: d_tgnn
// ═══════════════════════════════════════════════════════════════════════════
...
// ── NODE PROPERTIES (sample MERGE for D-TGNN) ─────────────────────────────
...
ON CREATE SET
  ...
  al.description    = 'Pump-and-dump pattern detected by D-TGNN',
