#!/usr/bin/env python3
"""
Dynamic Temporal Graph Neural Network (D-TGNN) - Demo Runner — End-to-End Pipeline
...
OUTPUT_DIR = "outputs/d_tgnn_inference"
...
class InferenceFeatureExtractor:
    ...
    for D-TGNN inference. Handles normalization using training statistics.
    """
...
class AlertGenerator:
    ...
    def __init__(self, module_name: str = "D-TGNN"):
    ...
    def save_alerts(self, alerts: List[dict], filename: str = "alerts.json") -> str:
        ...
        with open(path, "w") as f:
            json.dump({"module": "D-TGNN", "alerts": alerts,
                        "total": len(alerts),
...
class InferencePipeline:
    """
    End-to-end D-TGNN inference pipeline:
    ...
    def __init__(self, model, n_assets: int = 20, threshold: float = 0.5):
        ...
        self.alert_generator = AlertGenerator("D-TGNN")
    ...
    def run_streaming(self, n_windows: int = 50,
        ...
        print(f"  Running D-TGNN streaming inference: {n_windows} windows...")
        results = []
...
def main():
    print(f"\n{'='*60}")
    print(f"  D-TGNN - Demo Runner — End-to-End Pipeline")
    ...
    print(f"\nD-TGNN Demo Runner — End-to-End Pipeline Complete.\n")
...
7 + np.random.rand(n) * 0.3, 0, 1),
        ...
        explanation_text = f"""
MANIPULATION DETECTION EXPLANATION - D-TGNN
============================================================
...
"""
        ...
        report  = {
            "module":          "D-TGNN",
            "full_name":       "Dynamic Temporal Graph Neural Network",
