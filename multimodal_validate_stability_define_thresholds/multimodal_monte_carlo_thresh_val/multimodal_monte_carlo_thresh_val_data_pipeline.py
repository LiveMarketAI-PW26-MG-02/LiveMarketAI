"""
  ...
  File       : multimodal_monte_carlo_thresh_val_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_monte_carlo_thresh_val_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalMonteCarloThreshValDataPipelineConfig:
...
class MultimodalMonteCarloThreshValEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMonteCarloThreshValDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalMonteCarloThreshValDataPipelineConfig()
