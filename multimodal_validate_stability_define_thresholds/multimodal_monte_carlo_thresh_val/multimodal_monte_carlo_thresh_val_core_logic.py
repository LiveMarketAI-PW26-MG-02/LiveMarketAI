"""
  ...
  File       : multimodal_monte_carlo_thresh_val_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_monte_carlo_thresh_val_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalMonteCarloThreshValCoreLogicConfig:
...
class MultimodalMonteCarloThreshValEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMonteCarloThreshValCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalMonteCarloThreshValCoreLogicConfig()
