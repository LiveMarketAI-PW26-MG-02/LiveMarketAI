"""
  ...
  File       : multimodal_monte_carlo_thresh_val_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_monte_carlo_thresh_val_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalMonteCarloThreshValBacktestRunnerConfig:
...
class MultimodalMonteCarloThreshValEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMonteCarloThreshValBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalMonteCarloThreshValBacktestRunnerConfig()
