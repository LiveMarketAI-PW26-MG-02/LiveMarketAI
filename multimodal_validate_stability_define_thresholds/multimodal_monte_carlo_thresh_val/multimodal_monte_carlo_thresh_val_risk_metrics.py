"""
  ...
  File       : multimodal_monte_carlo_thresh_val_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_monte_carlo_thresh_val_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalMonteCarloThreshValRiskMetricsConfig:
...
class MultimodalMonteCarloThreshValEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalMonteCarloThreshValRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalMonteCarloThreshValRiskMetricsConfig()
