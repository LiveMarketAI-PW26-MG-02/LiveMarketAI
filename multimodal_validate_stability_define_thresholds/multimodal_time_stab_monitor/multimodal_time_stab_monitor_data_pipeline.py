"""
  ...
  File       : multimodal_time_stab_monitor_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_time_stab_monitor_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalTimeStabMonitorDataPipelineConfig:
...
class MultimodalTimeStabMonitorEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalTimeStabMonitorDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalTimeStabMonitorDataPipelineConfig()
