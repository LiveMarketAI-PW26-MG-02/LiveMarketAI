"""
  ...
  File       : multimodal_time_stab_monitor_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_time_stab_monitor_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalTimeStabMonitorRiskMetricsConfig:
...
class MultimodalTimeStabMonitorEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalTimeStabMonitorRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalTimeStabMonitorRiskMetricsConfig()
