"""
  ...
  File       : multimodal_time_stab_monitor_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_time_stab_monitor_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalTimeStabMonitorCoreLogicConfig:
...
class MultimodalTimeStabMonitorEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalTimeStabMonitorCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalTimeStabMonitorCoreLogicConfig()
