"""
  ...
  File       : multimodal_time_stab_monitor_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_time_stab_monitor_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalTimeStabMonitorBacktestRunnerConfig:
...
class MultimodalTimeStabMonitorEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalTimeStabMonitorBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalTimeStabMonitorBacktestRunnerConfig()
