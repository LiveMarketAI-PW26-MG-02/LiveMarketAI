"""
  ...
  File       : multimodal_sensitivity_stab_probe_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_sensitivity_stab_probe_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSensitivityStabProbeBacktestRunnerConfig:
...
class MultimodalSensitivityStabProbeEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSensitivityStabProbeBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalSensitivityStabProbeBacktestRunnerConfig()
