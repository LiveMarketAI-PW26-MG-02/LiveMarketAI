"""
  ...
  File       : multimodal_sensitivity_stab_probe_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_sensitivity_stab_probe_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSensitivityStabProbeRiskMetricsConfig:
...
class MultimodalSensitivityStabProbeEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSensitivityStabProbeRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalSensitivityStabProbeRiskMetricsConfig()
