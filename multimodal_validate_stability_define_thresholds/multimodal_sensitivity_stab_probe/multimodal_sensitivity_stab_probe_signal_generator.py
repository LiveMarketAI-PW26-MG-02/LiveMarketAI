"""
  ...
  Folder     : multimodal_sensitivity_stab_probe
  File       : multimodal_sensitivity_stab_probe_signal_generator.py
  Purpose    : Validate Stability — Sensitivity Stab Probe
"""
...
MULTIMODAL_MODULE = 'multimodal_sensitivity_stab_probe_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSensitivityStabProbeSignalGeneratorConfig:
    """Multimodal threshold-sweep config for sensitivity_stab_probe."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalSensitivityStabProbeEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: validate stability — sensitivity stab probe.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalSensitivityStabProbeSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalSensitivityStabProbeSignalGeneratorConfig()
