"""
  ...
  File       : multimodal_sensitivity_stab_probe_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_sensitivity_stab_probe_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalSensitivityStabProbeCoreLogicConfig:
...
class MultimodalSensitivityStabProbeEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalSensitivityStabProbeCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalSensitivityStabProbeCoreLogicConfig()
