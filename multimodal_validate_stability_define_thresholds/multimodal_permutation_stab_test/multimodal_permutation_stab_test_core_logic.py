"""
  ...
  File       : multimodal_permutation_stab_test_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_permutation_stab_test_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalPermutationStabTestCoreLogicConfig:
...
class MultimodalPermutationStabTestEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPermutationStabTestCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalPermutationStabTestCoreLogicConfig()
