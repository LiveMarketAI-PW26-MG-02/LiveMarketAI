"""
  ...
  File       : multimodal_permutation_stab_test_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_permutation_stab_test_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalPermutationStabTestBacktestRunnerConfig:
...
class MultimodalPermutationStabTestEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPermutationStabTestBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalPermutationStabTestBacktestRunnerConfig()
