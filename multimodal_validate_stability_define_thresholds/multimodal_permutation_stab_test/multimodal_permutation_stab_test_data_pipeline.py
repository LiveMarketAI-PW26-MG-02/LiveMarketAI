"""
  ...
  File       : multimodal_permutation_stab_test_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_permutation_stab_test_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalPermutationStabTestDataPipelineConfig:
...
class MultimodalPermutationStabTestEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPermutationStabTestDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalPermutationStabTestDataPipelineConfig()
