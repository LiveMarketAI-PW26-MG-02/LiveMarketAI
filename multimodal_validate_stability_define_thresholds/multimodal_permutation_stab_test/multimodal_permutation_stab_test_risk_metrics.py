"""
  ...
  File       : multimodal_permutation_stab_test_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_permutation_stab_test_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalPermutationStabTestRiskMetricsConfig:
...
class MultimodalPermutationStabTestEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalPermutationStabTestRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalPermutationStabTestRiskMetricsConfig()
