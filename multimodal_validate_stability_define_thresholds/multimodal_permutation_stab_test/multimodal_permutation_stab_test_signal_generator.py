"""
  ...
  Folder     : multimodal_permutation_stab_test
  File       : multimodal_permutation_stab_test_signal_generator.py
  Purpose    : Validate Stability — Permutation Stab Test
"""
...
MULTIMODAL_MODULE = 'multimodal_permutation_stab_test_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalPermutationStabTestSignalGeneratorConfig:
    """Multimodal threshold-sweep config for permutation_stab_test."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalPermutationStabTestEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: validate stability — permutation stab test.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalPermutationStabTestSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalPermutationStabTestSignalGeneratorConfig()
