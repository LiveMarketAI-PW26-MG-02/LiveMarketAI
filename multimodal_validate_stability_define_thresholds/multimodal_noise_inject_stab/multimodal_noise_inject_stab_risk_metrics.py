"""
  ...
  File       : multimodal_noise_inject_stab_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_noise_inject_stab_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalNoiseInjectStabRiskMetricsConfig:
...
class MultimodalNoiseInjectStabEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalNoiseInjectStabRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalNoiseInjectStabRiskMetricsConfig()
