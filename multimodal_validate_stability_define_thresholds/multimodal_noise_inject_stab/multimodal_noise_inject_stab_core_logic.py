"""
  ...
  File       : multimodal_noise_inject_stab_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_noise_inject_stab_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalNoiseInjectStabCoreLogicConfig:
...
class MultimodalNoiseInjectStabEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalNoiseInjectStabCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalNoiseInjectStabCoreLogicConfig()
