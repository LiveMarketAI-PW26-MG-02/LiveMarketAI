"""
  ...
  File       : multimodal_noise_inject_stab_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_noise_inject_stab_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalNoiseInjectStabBacktestRunnerConfig:
...
class MultimodalNoiseInjectStabEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalNoiseInjectStabBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalNoiseInjectStabBacktestRunnerConfig()
