"""
  ...
  File       : multimodal_walk_fwd_stab_checker_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_walk_fwd_stab_checker_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalWalkFwdStabCheckerCoreLogicConfig:
...
class MultimodalWalkFwdStabCheckerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalWalkFwdStabCheckerCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalWalkFwdStabCheckerCoreLogicConfig()
