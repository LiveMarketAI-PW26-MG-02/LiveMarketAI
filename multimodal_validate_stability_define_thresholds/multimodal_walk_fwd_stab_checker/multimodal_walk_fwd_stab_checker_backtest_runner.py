"""
  ...
  File       : multimodal_walk_fwd_stab_checker_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_walk_fwd_stab_checker_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalWalkFwdStabCheckerBacktestRunnerConfig:
...
class MultimodalWalkFwdStabCheckerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalWalkFwdStabCheckerBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalWalkFwdStabCheckerBacktestRunnerConfig()
