"""
  ...
  Folder     : multimodal_walk_fwd_stab_checker
  File       : multimodal_walk_fwd_stab_checker_signal_generator.py
  Purpose    : Validate Stability — Walk Fwd Stab Checker
"""
...
MULTIMODAL_MODULE = 'multimodal_walk_fwd_stab_checker_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalWalkFwdStabCheckerSignalGeneratorConfig:
    """Multimodal threshold-sweep config for walk_fwd_stab_checker."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalWalkFwdStabCheckerEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: validate stability — walk fwd stab checker.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalWalkFwdStabCheckerSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalWalkFwdStabCheckerSignalGeneratorConfig()
