"""
  ...
  File       : multimodal_walk_fwd_stab_checker_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_walk_fwd_stab_checker_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalWalkFwdStabCheckerDataPipelineConfig:
...
class MultimodalWalkFwdStabCheckerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalWalkFwdStabCheckerDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalWalkFwdStabCheckerDataPipelineConfig()
