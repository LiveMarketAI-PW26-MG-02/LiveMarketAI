"""
  ...
  File       : multimodal_walk_fwd_stab_checker_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_walk_fwd_stab_checker_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalWalkFwdStabCheckerRiskMetricsConfig:
...
class MultimodalWalkFwdStabCheckerEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalWalkFwdStabCheckerRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalWalkFwdStabCheckerRiskMetricsConfig()
