"""
  ...
  File       : multimodal_overfitting_stab_guard_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_overfitting_stab_guard_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalOverfittingStabGuardDataPipelineConfig:
...
class MultimodalOverfittingStabGuardEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalOverfittingStabGuardDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalOverfittingStabGuardDataPipelineConfig()
