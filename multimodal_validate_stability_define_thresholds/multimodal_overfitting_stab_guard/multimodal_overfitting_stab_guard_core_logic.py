"""
  ...
  File       : multimodal_overfitting_stab_guard_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_overfitting_stab_guard_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalOverfittingStabGuardCoreLogicConfig:
...
class MultimodalOverfittingStabGuardEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalOverfittingStabGuardCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalOverfittingStabGuardCoreLogicConfig()
