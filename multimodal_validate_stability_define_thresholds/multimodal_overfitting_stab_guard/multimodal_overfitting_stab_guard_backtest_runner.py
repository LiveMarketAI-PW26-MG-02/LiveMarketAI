"""
  ...
  File       : multimodal_overfitting_stab_guard_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_overfitting_stab_guard_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalOverfittingStabGuardBacktestRunnerConfig:
...
class MultimodalOverfittingStabGuardEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalOverfittingStabGuardBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalOverfittingStabGuardBacktestRunnerConfig()
