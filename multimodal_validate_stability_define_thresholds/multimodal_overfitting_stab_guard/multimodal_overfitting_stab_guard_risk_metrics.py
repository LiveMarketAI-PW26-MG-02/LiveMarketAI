"""
  ...
  File       : multimodal_overfitting_stab_guard_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_overfitting_stab_guard_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalOverfittingStabGuardRiskMetricsConfig:
...
class MultimodalOverfittingStabGuardEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalOverfittingStabGuardRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalOverfittingStabGuardRiskMetricsConfig()
