"""
  ...
  Folder     : multimodal_overfitting_stab_guard
  File       : multimodal_overfitting_stab_guard_signal_generator.py
  Purpose    : Validate Stability — Overfitting Stab Guard
"""
...
MULTIMODAL_MODULE = 'multimodal_overfitting_stab_guard_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalOverfittingStabGuardSignalGeneratorConfig:
    """Multimodal threshold-sweep config for overfitting_stab_guard."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalOverfittingStabGuardEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: validate stability — overfitting stab guard.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalOverfittingStabGuardSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalOverfittingStabGuardSignalGeneratorConfig()
