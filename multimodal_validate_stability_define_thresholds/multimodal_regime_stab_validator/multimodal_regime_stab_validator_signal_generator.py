"""
  ...
  Folder     : multimodal_regime_stab_validator
  File       : multimodal_regime_stab_validator_signal_generator.py
  Purpose    : Validate Stability — Regime Stab Validator
"""
...
MULTIMODAL_MODULE = 'multimodal_regime_stab_validator_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeStabValidatorSignalGeneratorConfig:
    """Multimodal threshold-sweep config for regime_stab_validator."""
...
# ── Core Engine ───────────────────────────────────────────────────────────────
class MultimodalRegimeStabValidatorEngine(MultimodalThresholdBase):
    """
    Multimodal threshold engine: validate stability — regime stab validator.
    Sweeps, evaluates, validates and documents signal thresholds.
    """
    def __init__(self, cfg: Optional[MultimodalRegimeStabValidatorSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalRegimeStabValidatorSignalGeneratorConfig()
