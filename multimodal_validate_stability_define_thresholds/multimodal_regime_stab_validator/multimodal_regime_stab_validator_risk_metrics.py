"""
  ...
  File       : multimodal_regime_stab_validator_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_regime_stab_validator_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeStabValidatorRiskMetricsConfig:
...
class MultimodalRegimeStabValidatorEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegimeStabValidatorRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalRegimeStabValidatorRiskMetricsConfig()
