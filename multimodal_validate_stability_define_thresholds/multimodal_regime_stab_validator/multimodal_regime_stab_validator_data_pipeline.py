"""
  ...
  File       : multimodal_regime_stab_validator_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_regime_stab_validator_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeStabValidatorDataPipelineConfig:
...
class MultimodalRegimeStabValidatorEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegimeStabValidatorDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalRegimeStabValidatorDataPipelineConfig()
