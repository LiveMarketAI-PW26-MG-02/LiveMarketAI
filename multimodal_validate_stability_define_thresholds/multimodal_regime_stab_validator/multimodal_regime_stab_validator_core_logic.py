"""
  ...
  File       : multimodal_regime_stab_validator_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_regime_stab_validator_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeStabValidatorCoreLogicConfig:
...
class MultimodalRegimeStabValidatorEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegimeStabValidatorCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalRegimeStabValidatorCoreLogicConfig()
