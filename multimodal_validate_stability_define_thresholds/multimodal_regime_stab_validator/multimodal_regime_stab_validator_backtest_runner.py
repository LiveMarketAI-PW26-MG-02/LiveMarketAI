"""
  ...
  File       : multimodal_regime_stab_validator_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_regime_stab_validator_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalRegimeStabValidatorBacktestRunnerConfig:
...
class MultimodalRegimeStabValidatorEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalRegimeStabValidatorBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalRegimeStabValidatorBacktestRunnerConfig()
