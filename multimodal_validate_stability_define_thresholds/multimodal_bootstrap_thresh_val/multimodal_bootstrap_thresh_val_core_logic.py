"""
  ...
  File       : multimodal_bootstrap_thresh_val_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_bootstrap_thresh_val_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalBootstrapThreshValCoreLogicConfig:
...
class MultimodalBootstrapThreshValEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalBootstrapThreshValCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalBootstrapThreshValCoreLogicConfig()
