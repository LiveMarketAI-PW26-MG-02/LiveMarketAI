"""
  ...
  File       : multimodal_bootstrap_thresh_val_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_bootstrap_thresh_val_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalBootstrapThreshValBacktestRunnerConfig:
...
class MultimodalBootstrapThreshValEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalBootstrapThreshValBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalBootstrapThreshValBacktestRunnerConfig()
