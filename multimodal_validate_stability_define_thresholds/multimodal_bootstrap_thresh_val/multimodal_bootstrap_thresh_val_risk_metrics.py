"""
  ...
  File       : multimodal_bootstrap_thresh_val_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_bootstrap_thresh_val_risk_metrics'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalBootstrapThreshValRiskMetricsConfig:
...
class MultimodalBootstrapThreshValEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalBootstrapThreshValRiskMetricsConfig] = None):
        self.cfg      = cfg or MultimodalBootstrapThreshValRiskMetricsConfig()
