"""
  ...
  File       : multimodal_bootstrap_thresh_val_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_bootstrap_thresh_val_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalBootstrapThreshValDataPipelineConfig:
...
class MultimodalBootstrapThreshValEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalBootstrapThreshValDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalBootstrapThreshValDataPipelineConfig()
