"""
  ...
  File       : multimodal_cross_val_thresh_eng_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_cross_val_thresh_eng_backtest_runner'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCrossValThreshEngBacktestRunnerConfig:
...
class MultimodalCrossValThreshEngEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCrossValThreshEngBacktestRunnerConfig] = None):
        self.cfg      = cfg or MultimodalCrossValThreshEngBacktestRunnerConfig()
