"""
  ...
  File       : multimodal_cross_val_thresh_eng_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_cross_val_thresh_eng_core_logic'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCrossValThreshEngCoreLogicConfig:
...
class MultimodalCrossValThreshEngEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCrossValThreshEngCoreLogicConfig] = None):
        self.cfg      = cfg or MultimodalCrossValThreshEngCoreLogicConfig()
