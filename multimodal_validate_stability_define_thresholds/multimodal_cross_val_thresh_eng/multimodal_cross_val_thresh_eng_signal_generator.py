"""
  ...
  File       : multimodal_cross_val_thresh_eng_signal_generator.py
...
MULTIMODAL_MODULE = 'multimodal_cross_val_thresh_eng_signal_generator'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCrossValThreshEngSignalGeneratorConfig:
...
class MultimodalCrossValThreshEngEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCrossValThreshEngSignalGeneratorConfig] = None):
        self.cfg      = cfg or MultimodalCrossValThreshEngSignalGeneratorConfig()
