"""
  ...
  File       : multimodal_cross_val_thresh_eng_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_cross_val_thresh_eng_data_pipeline'
...
# ── Configuration ─────────────────────────────────────────────────────────────
@dataclass
class MultimodalCrossValThreshEngDataPipelineConfig:
...
class MultimodalCrossValThreshEngEngine(MultimodalThresholdBase):
    ...
    """
    def __init__(self, cfg: Optional[MultimodalCrossValThreshEngDataPipelineConfig] = None):
        self.cfg      = cfg or MultimodalCrossValThreshEngDataPipelineConfig()
