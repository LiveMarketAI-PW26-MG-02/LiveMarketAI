#!/usr/bin/env python3
"""
Uncertainty-Aware Graph Neural Network (UGNN) - Data Generation Module
...
REGIME_TYPES      = ['high_confidence', 'uncertain', 'epistemic_risk', 'aleatoric_risk', 'ood']
OUTPUT_DIR        = "outputs/ugnn_data"
...
class SyntheticMarketDataGenerator:
    """
    Generates synthetic OHLCV + microstructure + sentiment data for UGNN.
    ...
    def generate_price_series(self, asset_id: str, regime: str = "bull") -> pd.DataFrame:
        ...
        Regimes: ['high_confidence', 'uncertain', 'epistemic_risk', 'aleatoric_risk', 'ood']
        """
        regime_params = {
...
class SentimentDataGenerator:
    ...
    price manipulation events for UGNN.
    """
...
class OrderBookGenerator:
    ...
    Critical for UGNN microstructure-based manipulation detection.
    """
...
def main():
    print(f"\n============================================================")
    print(f"  UGNN - Data Generation Pipeline")
    ...
    # Summary
    print(f"\n============================================================")
    print(f"  Data Generation Complete for UGNN")
