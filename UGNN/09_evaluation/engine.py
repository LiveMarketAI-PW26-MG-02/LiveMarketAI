#!/usr/bin/env python3
"""
Uncertainty-Aware Graph Neural Network (UGNN) - Evaluation Engine (Alt Entry)
...
OUTPUT_DIR = "outputs/ugnn_eval"
os.makedirs(OUTPUT_DIR, exist_ok=True)
np.random.seed(42)

class BinaryClassificationEvaluator:
    """Full binary classification metric suite for UGNN."""
...
class RegimeEvaluator:
    """Regime-stratified evaluation for UGNN."""
...
class CalibrationEvaluator:
    """ECE and reliability diagram for UGNN probability calibration."""
...
class GraphEvaluator:
    """Graph-aware metrics for UGNN GNN evaluation."""
...
def main():
    print(f"\n{'='*60}\n  UGNN Evaluation Engine (Alt Entry)\n{'='*60}")
    n=200
    ...
    report={"module":"UGNN","full_name":"Uncertainty-Aware Graph Neural Network","evaluated_at":datetime.utcnow().isoformat()+"Z",
