#!/usr/bin/env python3
"""
UGNN - Shared Utility Functions
Common helpers used across all subfolders of the UGNN module.
"""
...
def get_logger(name: str = "UGNN", level: str = "INFO") -> logging.Logger:
    """Configure and return a logger for UGNN module."""
