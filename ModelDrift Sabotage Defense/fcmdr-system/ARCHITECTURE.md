# ARCHITECTURE — ModelDrift Sabotage Defense
...
## Threat Model
  ...
  Attack Vector: Federated Cross-Model Divergence Ring (FCMDR): Multiple distributed models are independently trained...
