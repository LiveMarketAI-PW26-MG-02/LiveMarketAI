#!/usr/bin/env python3
"""
GhostKey Exfiltration Cascade Defense — Federated Aggregator gRPC Server
...
def serve(port: int = 50051):
    ...
    server.start()
    log.info("GhostKey Exfiltration Cascade Defense Aggregator listening on port %d", port)
    try:
