#!/usr/bin/env python3
"""
GhostKey Exfiltration Cascade Defense — Threat Simulation Injector
...
def parse_args():
    p = argparse.ArgumentParser(description="GhostKey Exfiltration Cascade Defense Threat Injector")
