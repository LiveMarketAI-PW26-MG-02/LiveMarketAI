"""
  ...
  File       : multimodal_liquidity_shock_test_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_liquidity_shock_test_backtest_runner'
TOPIC             = 'robustness_testing'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalLiquidityShockTestBacktestRunnerConfig:
...
class MultimodalLiquidityShockTestEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalLiquidityShockTestBacktestRunnerConfig()
        self.state    : Dict = {}
