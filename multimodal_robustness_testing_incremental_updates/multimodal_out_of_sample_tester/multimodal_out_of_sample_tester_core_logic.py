"""
  ...
  File       : multimodal_out_of_sample_tester_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_out_of_sample_tester_core_logic'
TOPIC             = 'robustness_testing'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalOutOfSampleTesterCoreLogicConfig:
...
class MultimodalOutOfSampleTesterEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalOutOfSampleTesterCoreLogicConfig()
        self.state    : Dict = {}
