"""
  ...
  File       : multimodal_out_of_sample_tester_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_out_of_sample_tester_risk_metrics'
TOPIC             = 'robustness_testing'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalOutOfSampleTesterRiskMetricsConfig:
...
class MultimodalOutOfSampleTesterEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalOutOfSampleTesterRiskMetricsConfig()
        self.state    : Dict = {}
