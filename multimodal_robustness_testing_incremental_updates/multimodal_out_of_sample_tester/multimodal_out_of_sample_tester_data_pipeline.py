"""
  ...
  File       : multimodal_out_of_sample_tester_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_out_of_sample_tester_data_pipeline'
TOPIC             = 'robustness_testing'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalOutOfSampleTesterDataPipelineConfig:
...
class MultimodalOutOfSampleTesterEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalOutOfSampleTesterDataPipelineConfig()
        self.state    : Dict = {}
