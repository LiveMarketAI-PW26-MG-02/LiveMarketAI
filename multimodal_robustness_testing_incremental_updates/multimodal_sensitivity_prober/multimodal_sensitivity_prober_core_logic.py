"""
  ...
  File       : multimodal_sensitivity_prober_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_sensitivity_prober_core_logic'
TOPIC             = 'robustness_testing'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalSensitivityProberCoreLogicConfig:
...
class MultimodalSensitivityProberEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalSensitivityProberCoreLogicConfig()
        self.state    : Dict = {}
