"""
  ...
  File       : multimodal_sensitivity_prober_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_sensitivity_prober_risk_metrics'
TOPIC             = 'robustness_testing'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalSensitivityProberRiskMetricsConfig:
...
class MultimodalSensitivityProberEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalSensitivityProberRiskMetricsConfig()
        self.state    : Dict = {}
