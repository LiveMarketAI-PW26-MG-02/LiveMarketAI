"""
  ...
  File       : multimodal_sensitivity_prober_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_sensitivity_prober_backtest_runner'
TOPIC             = 'robustness_testing'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalSensitivityProberBacktestRunnerConfig:
...
class MultimodalSensitivityProberEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalSensitivityProberBacktestRunnerConfig()
        self.state    : Dict = {}
