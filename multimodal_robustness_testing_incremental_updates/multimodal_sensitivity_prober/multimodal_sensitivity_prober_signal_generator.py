"""
  ...
  Folder     : multimodal_sensitivity_prober
  File       : multimodal_sensitivity_prober_signal_generator.py
  Purpose    : Robustness Testing — Sensitivity Prober
"""
...
MULTIMODAL_MODULE = 'multimodal_sensitivity_prober_signal_generator'
TOPIC             = 'robustness_testing'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalSensitivityProberSignalGeneratorConfig:
    """Configuration for multimodal sensitivity_prober module."""
...
# ── Core Engine ──────────────────────────────────────────────────────────────
class MultimodalSensitivityProberEngine:
    """
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalSensitivityProberSignalGeneratorConfig()
        self.state    : Dict = {}
