"""
  ...
  File       : multimodal_sensitivity_prober_data_pipeline.py
...
MULTIMODAL_MODULE = 'multimodal_sensitivity_prober_data_pipeline'
TOPIC             = 'robustness_testing'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalSensitivityProberDataPipelineConfig:
...
class MultimodalSensitivityProberEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalSensitivityProberDataPipelineConfig()
        self.state    : Dict = {}
