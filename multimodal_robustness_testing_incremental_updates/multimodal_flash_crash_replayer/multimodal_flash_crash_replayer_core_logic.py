"""
  ...
  File       : multimodal_flash_crash_replayer_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_flash_crash_replayer_core_logic'
TOPIC             = 'robustness_testing'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalFlashCrashReplayerCoreLogicConfig:
...
class MultimodalFlashCrashReplayerEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalFlashCrashReplayerCoreLogicConfig()
        self.state    : Dict = {}
