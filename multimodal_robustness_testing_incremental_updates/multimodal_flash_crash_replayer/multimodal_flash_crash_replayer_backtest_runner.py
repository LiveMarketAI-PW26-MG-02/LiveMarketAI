"""
  ...
  File       : multimodal_flash_crash_replayer_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_flash_crash_replayer_backtest_runner'
TOPIC             = 'robustness_testing'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalFlashCrashReplayerBacktestRunnerConfig:
...
class MultimodalFlashCrashReplayerEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalFlashCrashReplayerBacktestRunnerConfig()
        self.state    : Dict = {}
