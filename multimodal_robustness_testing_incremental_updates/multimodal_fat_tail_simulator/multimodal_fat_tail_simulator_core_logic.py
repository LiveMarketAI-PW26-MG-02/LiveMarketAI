"""
  ...
  File       : multimodal_fat_tail_simulator_core_logic.py
...
MULTIMODAL_MODULE = 'multimodal_fat_tail_simulator_core_logic'
TOPIC             = 'robustness_testing'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalFatTailSimulatorCoreLogicConfig:
...
class MultimodalFatTailSimulatorEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalFatTailSimulatorCoreLogicConfig()
        self.state    : Dict = {}
