"""
  ...
  File       : multimodal_fat_tail_simulator_risk_metrics.py
...
MULTIMODAL_MODULE = 'multimodal_fat_tail_simulator_risk_metrics'
TOPIC             = 'robustness_testing'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalFatTailSimulatorRiskMetricsConfig:
...
class MultimodalFatTailSimulatorEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalFatTailSimulatorRiskMetricsConfig()
        self.state    : Dict = {}
