"""
  ...
  File       : multimodal_fat_tail_simulator_backtest_runner.py
...
MULTIMODAL_MODULE = 'multimodal_fat_tail_simulator_backtest_runner'
TOPIC             = 'robustness_testing'
VERSION           = '1.0.0'

# ── Configuration ────────────────────────────────────────────────────────────
@dataclass
class MultimodalFatTailSimulatorBacktestRunnerConfig:
...
class MultimodalFatTailSimulatorEngine:
    ...
    def __init__(self, config: Optional[object] = None):
        self.config   = config or MultimodalFatTailSimulatorBacktestRunnerConfig()
        self.state    : Dict = {}
